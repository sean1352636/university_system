...
from education_system.systems.sixth_form.domain.learners.students import students as data
from education_system.systems.sixth_form.domain.admissions.enrolments import enrolments as enrolments_data
