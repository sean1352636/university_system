...
from education_system.systems.sixth_form.domain.assessment.quality_assurance import (
    quality_assurance as data,
)
from education_system.systems.sixth_form.domain.assessment.quality_assurance.quality_assurance import (
    ACTIVITY_TYPES,
