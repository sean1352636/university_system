...
from education_system.systems.sixth_form.domain.governance.policies import policies as data
from education_system.systems.sixth_form.domain.governance.policies.policies import (
    CATEGORIES,
    DEFAULT_CATEGORY,
