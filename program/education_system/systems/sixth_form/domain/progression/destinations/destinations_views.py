...
from education_system.systems.sixth_form.domain.progression.destinations import (
    destinations as data,
)
from education_system.systems.sixth_form.domain.progression.destinations.destinations import (
    CHECKPOINTS,
    CHECKPOINT_LABELS,
    CONFIRMED_VIA,
    DEFAULT_CHECKPOINT,
