...
from education_system.systems.sixth_form.domain.staff.appraisals import (
    appraisals as data,
)
from education_system.systems.sixth_form.domain.staff.appraisals.appraisals import (
    Appraisal,
