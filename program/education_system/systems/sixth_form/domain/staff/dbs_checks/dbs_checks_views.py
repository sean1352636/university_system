...
from education_system.systems.sixth_form.domain.staff.dbs_checks import (
    dbs_checks as data,
)
from education_system.systems.sixth_form.domain.staff.dbs_checks.dbs_checks import (
    CERTIFICATE_TYPES,
    DBSCheck,
