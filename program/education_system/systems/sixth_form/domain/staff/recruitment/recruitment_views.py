...
from education_system.systems.sixth_form.domain.staff.recruitment import (
    recruitment as data,
)
from education_system.systems.sixth_form.domain.staff.recruitment.recruitment import (
    APPLICANT_SOURCES,
    APPLICANT_STATUSES,
    Applicant,
    CONTRACT_TYPES,
