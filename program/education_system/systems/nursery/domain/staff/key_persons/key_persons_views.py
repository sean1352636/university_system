...
from education_system.systems.nursery.domain.staff.key_persons import (
    key_persons as data,
)
from education_system.systems.nursery.domain.staff.key_persons.key_persons import (
    ValidationError,
)
