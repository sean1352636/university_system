"""Tkinter views for Primary School Appraisals."""
...
from education_system.systems.nursery.domain.staff.appraisals import (
    appraisals as data,
)
from education_system.systems.nursery.domain.staff.appraisals.appraisals import (
    Appraisal,
