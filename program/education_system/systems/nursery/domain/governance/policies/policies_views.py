"""GUI panels for the Primary School Policy register.
...
from education_system.systems.nursery.domain.governance.policies import policies as data
from education_system.systems.nursery.domain.governance.policies.policies import (
    CATEGORIES,
    DEFAULT_CATEGORY,
