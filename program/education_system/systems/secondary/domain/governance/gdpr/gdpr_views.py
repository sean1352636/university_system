"""Tkinter views for Secondary School GDPR."""
...
from education_system.systems.secondary.domain.governance.gdpr import gdpr as data
from education_system.platform import branding
from education_system.systems.secondary.domain.governance.gdpr.gdpr import (
    BREACH_SEVERITIES,
    BREACH_STATUSES,
    CONSENT_PURPOSES,
