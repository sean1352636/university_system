"""Tkinter views for Secondary School Custom Export."""
...
from education_system.systems.secondary.domain.operations.reporting.custom_export.custom_export import (
    DEFAULT_FORMAT,
    DatasetSpec,
    FORMATS,
    ValidationError,
...
def open_custom_export_window(parent=None) -> None:
    ...
    win.title(f"Custom Export — {branding.SYSTEM_NAME}")
