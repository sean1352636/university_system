"""Tkinter views for Secondary School Activity Feed.
...
from education_system.systems.secondary.domain.operations.communications.activity_feed.activity_feed import (
    ACTIONS,
    DEFAULT_SEVERITY,
    Event,
    KNOWN_ENTITY_TYPES,
