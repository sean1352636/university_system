"""Email / Messaging log for the Secondary School System.
...
def init_db() -> None:
    ...
    from education_system.systems.secondary.domain.operations.communications.parent_contacts import parent_contacts as _pc
    ...
    try:
        from education_system.systems.secondary.domain.learners.alumni \
