"""Tkinter views for Secondary School Letter Templates."""
...
from education_system.systems.secondary.domain.operations.communications.letter_templates.letter_templates import (
    CATEGORIES,
    DEFAULT_CATEGORY,
    DEFAULT_FORMAT,
