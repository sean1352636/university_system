...
from education_system.systems.primary.domain.assessment.observations import (
    observations as data,
)
from education_system.systems.primary.domain.assessment.observations.observations import (
