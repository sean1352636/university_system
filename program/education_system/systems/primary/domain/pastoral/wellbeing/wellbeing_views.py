...
from education_system.systems.primary.domain.pastoral.wellbeing import (
    wellbeing as data,
)
from education_system.systems.primary.domain.pastoral.wellbeing.wellbeing import (
