...
from education_system.systems.primary.domain.academics.academic_year import (
    academic_year as data,
)
from education_system.systems.primary.domain.academics.academic_year.academic_year import (
    AcademicYear,
    Break,
    BREAK_TYPES,
    DEFAULT_BREAK_TYPE,
