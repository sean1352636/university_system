...
from education_system.systems.primary.domain.academics.timetable import (
    timetable as data,
)
from education_system.systems.primary.domain.academics.timetable.timetable import (
