"""CLI flows for Primary School Assets."""
...
from education_system.systems.primary.domain.operations.assets import assets as data
from education_system.systems.primary.domain.operations.assets.assets import (
    Asset,
    CATEGORIES,
    CONDITIONS,
    CURRENCY_SYMBOL,
