...
from education_system.systems.university.interfaces.cli.shell.services.cinema_cli.utils import print_subheader, get_current_user
from education_system.systems.university.interfaces.cli.shell.services.cinema_cli.screenings import view_screenings
from education_system.systems.university.interfaces.cli.shell.services.cinema_cli.seats import select_seats, auto_select_seats, mark_seats_as_booked
from education_system.systems.university.interfaces.cli.shell.services.cinema_cli.snacks import suggest_combo_for_party, add_snacks_to_order
from education_system.systems.university.interfaces.cli.shell.services.cinema_cli.membership import get_user_membership, calculate_points_earned, award_points, redeem_points
...
def send_booking_confirmation_email(user_email: str, booking_details: dict):
    ...
    try:
        from education_system.systems.university.interfaces.cli.shell.services.cinema_cli.constants import send_email
