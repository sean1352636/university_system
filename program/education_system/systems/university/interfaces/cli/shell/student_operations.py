...
from education_system.systems.university.interfaces.cli.shell.auth_manager import ensure_user_in_communication_system
from education_system.systems.university.interfaces.cli.shell.database_manager import DatabaseError, ValidationError, safe_db_operation_with_retry, enhanced_db_operation
...
from education_system.systems.university.domain.academics.services.admissions_selection import (
...
from education_system.systems.university.services.student_provisioning import (
...
from education_system.systems.university.infrastructure.database.db import foreign_keys_off
...
def create_student_record():
    ...
    print("The student can now log in and use all system features including messaging.")
    ...
    def perform_delete_operation(conn):
        ...
        try:
            ...
            with foreign_keys_off(conn):
                ...
                if cursor.rowcount > 0:
                    print("Deleted main student record.")
                else:
    ...
    while True:
        ...
        if choice in options:
            ...
            if action == 'create_student':
                ...
                from education_system.systems.university.interfaces.cli.shell.student_search import search_student_by_last_name
                search_student_by_last_name()
            elif action == 'search_id':
                from education_system.systems.university.interfaces.cli.shell.student_search import search_student_by_student_id
                search_student_by_student_id()
            elif action == 'search_date':
                from education_system.systems.university.interfaces.cli.shell.student_search import search_student_by_registration_date
