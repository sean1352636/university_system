...
from education_system.systems.university.interfaces.cli.shell.ai.ai_detector.interface import (
...
from education_system.systems.university.interfaces.cli.shell.ai.ai_detector.demo import ultimate_demo, main
