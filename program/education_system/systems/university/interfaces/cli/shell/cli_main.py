...
from education_system.systems.university.interfaces.cli.shell.auth_manager import (
    initialize_security_modules, ensure_user_in_communication_system,
    ensure_default_users_exist_once
)

from education_system.systems.university.interfaces.cli.shell.menu_router import display_menu

from education_system.systems.university.interfaces.cli.shell.chatbot_integration import setup_chatbot_permissions

from education_system.systems.university.interfaces.cli.shell.ai_tools_integration import (
...
from education_system.systems.university.interfaces.cli.shell.utils import cleanup_connections
...
def login_prompt(auth) -> bool:
    ...
    from education_system.platform.delivery.cli.login_cli import cli_login_prompt
...
def main(user_info=None, role=None, shared_auth=None):
    ...
    try:
        if current_role == 'student':
            from education_system.systems.university.interfaces.cli.shell.student_portal_cli import run_student_portal
            run_student_portal()
        elif current_role == 'staff':
            from education_system.systems.university.interfaces.cli.shell.staff_portal_cli import run_staff_portal
            run_staff_portal()
        elif current_role == 'instructor':
            from education_system.systems.university.interfaces.cli.shell.instructor_portal_cli import run_instructor_portal
            run_instructor_portal()
        elif current_role == 'parent':
            from education_system.systems.university.interfaces.cli.shell.parent_portal_cli import run_parent_portal
            run_parent_portal()
        else:
            display_menu()
    finally:
