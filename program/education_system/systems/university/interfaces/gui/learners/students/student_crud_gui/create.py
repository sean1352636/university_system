...
from education_system.systems.university.infrastructure.database.db import get_db_connection, get_connection, transaction, foreign_keys_off
...
def create_student_dialog(self):
    ...
    def create_student():
        ...
        try:
            ...
            try:
                from education_system.systems.university.domain.finance.services.enrolment_fees import (
            ...
            try:
                from education_system.systems.university.domain.operations.commerce.textbooks.services.library_holds import (
            ...
            try:
                from education_system.systems.university.domain.academics.services.course_management.timetable_sync import (
            ...
            try:
                from education_system.systems.university.infrastructure.email.email_service import send_registration_confirmation
...
- Age: {age}{modules_text}"""
            ...
            if sf_origin:
                try:
                    ...
                    try:
                        from education_system.systems.university.domain.pastoral.health.records import (
