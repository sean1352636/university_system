...
from education_system.systems.university.domain.finance.reporting.revenue_analytics.forecasting import generate_revenue_forecast
...
try:
    from education_system.systems.university.domain.finance.core.analytics import (
