...
try:
    from education_system.systems.university.domain.finance.core.aid import (
...
try:
    from education_system.systems.university.domain.finance.core.communications import (
