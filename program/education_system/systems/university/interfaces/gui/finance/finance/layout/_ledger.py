...
class LedgerMixin:
    ...
    def create_trial_balance_tab(self):
        ...
        def reload_tb(*_a):
            from education_system.systems.university.domain.finance.ledger import trial_balance
    ...
    def create_journals_tab(self):
        ...
        def reload_journals(*_a):
            from education_system.systems.university.domain.finance.ledger.reports import journals_list
    ...
    def _show_journal_lines(self, journal_id):
        from education_system.systems.university.domain.finance.ledger.reports import journal_lines
    ...
    def _init_ledger_action(self):
        from education_system.systems.university.domain.finance.ledger import init_ledger
        try:
            init_ledger()
            messagebox.showinfo(
                "Ledger initialized",
    ...
    def _backfill_action(self):
        from education_system.systems.university.domain.finance.ledger import backfill
    ...
    def create_period_close_tab(self):
        ...
        def reload_periods(*_a):
            from education_system.systems.university.domain.finance.ledger import list_periods
        ...
        def close_action():
            from education_system.systems.university.domain.finance.ledger import close_period
            from education_system.systems.university.domain.finance.ledger.periods import PeriodStateError
        ...
        def reopen_action():
            from education_system.systems.university.domain.finance.ledger import reopen_period
            from education_system.systems.university.domain.finance.ledger.periods import PeriodStateError
            pid, status = _selected_period()
            if pid is None:
                return
        ...
        def lock_action():
            from education_system.systems.university.domain.finance.ledger import lock_period
            pid, status = _selected_period()
            if pid is None:
                return
            if status == 'locked':
