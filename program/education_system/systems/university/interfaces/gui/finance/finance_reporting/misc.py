...
init_i18n()
from education_system.systems.university.interfaces.gui.finance.finance_reporting.analytics_classes import FinancialAlertSystem
...
def launch_financial_gui(auth_instance=None):
    ...
    try:
        ...
        from education_system.systems.university.interfaces.gui.finance.finance_reporting.main import FinancialManagementGUI
        root = tk.Tk()
