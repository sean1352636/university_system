...
try:
    from education_system.systems.university.domain.academics.services.module_scheduling.constants import (
        DAYS_OF_WEEK,
        TIME_SLOTS,
    )
except ImportError:
...
class StudentTimetableGUI:
    ...
    def export_to_ics(self):
        ...
        from education_system.systems.university.domain.academics.services.timetable_ics import (
            prompt_and_save_ics,
        )
    ...
    def _bind_cell_selection(self, cell, module_code):
        ...
        def _on_release(event=None):
            ...
            if target_day_idx is None:
                return
            try:
                from education_system.systems.university.domain.academics.services.module_scheduling.slot_writer import (
                    move_slot,
                )
