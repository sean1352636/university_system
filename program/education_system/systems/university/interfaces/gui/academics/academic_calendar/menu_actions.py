...
def _get_resource_management_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_resources import ResourceManagementDialog
    return ResourceManagementDialog

def _get_course_management_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_resources import CourseManagementDialog
    return CourseManagementDialog

def _get_notification_settings_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_admin import NotificationSettingsDialog
    return NotificationSettingsDialog

def _get_event_categories_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_categories import EventCategoriesDialog
...
def _get_recurring_event_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_recurring import RecurringEventDialog
    return RecurringEventDialog

def _get_recurring_events_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_recurring import RecurringEventsDialog
    return RecurringEventsDialog

def _get_system_maintenance_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_admin import SystemMaintenanceDialog
    return SystemMaintenanceDialog

def _get_audit_logs_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_admin import AuditLogsDialog
    return AuditLogsDialog

def _get_project_milestones_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_reports import ProjectMilestonesDialog
    return ProjectMilestonesDialog

def _get_data_visualization_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_reports import DataVisualizationDialog
    return DataVisualizationDialog

def _get_timezone_settings_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_admin import TimezoneSettingsDialog
    return TimezoneSettingsDialog

def _get_reports_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_reports import ReportsDialog
    return ReportsDialog

def _get_export_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_misc import ExportDialog
    return ExportDialog

def _get_settings_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_admin import SettingsDialog
    return SettingsDialog

def _get_import_calendar_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_misc import ImportCalendarDialog
    return ImportCalendarDialog

def _get_calendar_sync_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_misc import CalendarSyncDialog
    return CalendarSyncDialog

def _get_import_holidays_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_misc import ImportHolidaysDialog
    return ImportHolidaysDialog

def _get_bulk_operations_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_misc import BulkOperationsDialog
    return BulkOperationsDialog

def _get_help_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_misc import HelpDialog
    return HelpDialog

def _get_about_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_misc import AboutDialog
    return AboutDialog
...
class MenuActionsMixin:
    ...
    def _create_trip_calendar_event(self):
        ...
        try:
            from education_system.systems.university.interfaces.gui.operations.campus.mobility.trip_management_gui.calendar_dialogs import CreateCalendarEventDialog
    ...
    def _view_trip_calendar_links(self):
        ...
        try:
            from education_system.systems.university.interfaces.gui.operations.campus.mobility.trip_management_gui._imports import safe_db_operation
