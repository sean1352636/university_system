...
from education_system.systems.university.interfaces.gui.academics.module_scheduling.dialogs import AddScheduleDialog, EditScheduleDialog
...
def create_schedules_tab(self):
    ...
    from education_system.systems.university.interfaces.gui.academics.module_scheduling.tooltip import Tooltip
...
def _show_clone_term_dialog(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.module_scheduling.clone_term_dialog import CloneTermDialog
...
def _show_bulk_actions_dialog(self):
    ...
    if not schedule_ids:
        ...
        return
    try:
        from education_system.systems.university.interfaces.gui.academics.module_scheduling.bulk_actions_dialog import BulkActionsDialog
