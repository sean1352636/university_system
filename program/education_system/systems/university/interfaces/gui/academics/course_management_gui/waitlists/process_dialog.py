...
from education_system.systems.university.interfaces.gui.academics.course_management_gui.waitlists._imports import _, messagebox, tk, ttk, sqlite3, DEFAULT_DB_PATH
