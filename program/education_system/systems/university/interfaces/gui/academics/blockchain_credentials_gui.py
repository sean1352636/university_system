...
from education_system.systems.university.infrastructure.shared_context import get_auth as get_centralized_auth
...
class BlockchainCredentialsGUI:
    ...
    def init_database(self):
        ...
        try:
            from education_system.systems.university.infrastructure.database.remaining_features_schema import BLOCKCHAIN_SCHEMA
    ...
    def setup_styles(self):
        ...
        # ttk.Style is process-global; theme_use() restyles every widget
        # in the parent app. Only switch themes when this window is the
        # standalone root, otherwise inherit the parent's theme.
