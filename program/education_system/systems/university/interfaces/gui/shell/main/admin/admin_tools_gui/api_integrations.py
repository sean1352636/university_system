...
def show_integration_status_dashboard(self):
    ...
    try:
        ...
        def check_statuses():
            ...
            # Backup
            try:
                from education_system.systems.university.infrastructure.database.data_backup.config import DEFAULT_CONFIG
        ...
        try:
            from education_system.systems.university.infrastructure.database.data_backup.config import DEFAULT_CONFIG as bkp_cfg
