...
class StudentPortalGUI:
    ...
    def _build_sidebar(self):
        ...
        self._add_button("💬 Assistant", self._open_chatbot)
        ...
        self._add_button("To-Do", self._launch('show_todo_app_gui'))
    ...
    def _open_chatbot(self):
        ...
        try:
            from education_system.systems.university.infrastructure.ai.university_chatbot import (
                UniversityChatbot,
            )
            from education_system.systems.university.interfaces.gui.shell.ai.chatbot_gui import (
                ChatbotGUI,
            )
    ...
    def _open_helpdesk(self):
        try:
            from education_system.systems.university.interfaces.gui.pastoral.helpdesk.base import (
                HelpdeskGUI,
            )
    ...
    def _open_internship_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.pastoral.internship_management.internship_gui import (
                InternshipGUI,
            )
    ...
    def _open_student_support(self):
        try:
            from education_system.systems.university.interfaces.gui.pastoral.student_support import (
                StudentSupportGUI,
            )
    ...
    def _open_accessibility(self):
        try:
            from education_system.systems.university.interfaces.gui.pastoral.accessibility_tools_gui import (
    ...
    def _show_dashboard(self):
        ...
        try:
            from education_system.systems.university.interfaces.gui.shell.main.dashboard.student_dashboard import create_student_dashboard
            from education_system.systems.university.services.dashboard.dashboard_service import DashboardService
            service = DashboardService()
            create_student_dashboard(self.content_frame, self.auth, service)
        except Exception as e:
            logger.error(f"Error loading student dashboard: {e}")
            ttk.Label(self.content_frame, text="Welcome, student!",
