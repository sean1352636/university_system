...
from education_system.systems.university.infrastructure.paths import PROJECT_ROOT, LOG_DIR
import logging
...
def get_student_db_connection():
    ...
    from education_system.systems.university.infrastructure.database.db import sqlite3
    import os
    from education_system.systems.university.infrastructure.database.db import DEFAULT_DB_PATH as DB_PATH
