...
from education_system.systems.university.interfaces.gui.shell.batch_operations.mixins import (
    ImportHandlersMixin,
    BatchUpdatesMixin,
    ValidationMixin,
    DuplicatesMixin,
...
def main():
    ...
    if len(sys.argv) > 1 and sys.argv[1] == '--cli':
        ...
        from education_system.systems.university.interfaces.gui.shell.batch_operations.main_gui import BatchOperationsGUI
