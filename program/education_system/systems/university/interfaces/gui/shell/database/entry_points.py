...
from education_system.systems.university.interfaces.gui.shell.database.scheduling.scheduler import stop_scheduler
...
from education_system.systems.university.interfaces.gui.shell.database.operations.restore_ops import restore_from_backup
...
def display_enhanced_backup_menu_gui():
    ...
    try:
        from education_system.systems.university.infrastructure.database.data_backup import display_enhanced_backup_menu
    except ImportError:
        from education_system.systems.university.infrastructure.database.data_backup import display_enhanced_backup_menu
...
if __name__ != "__main__":
    ...
    try:
        from education_system.systems.university.infrastructure.database.data_backup import (
