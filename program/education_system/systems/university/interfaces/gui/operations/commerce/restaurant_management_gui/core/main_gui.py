    ...
    try:
        ...
        if init_enhanced_restaurant_db:
            try:
                ...
                import education_system.systems.university.domain.operations.commerce.services.restaurant_management as _rm_mod
...
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.core.tabs import create_menu_tab, create_place_order_tab, create_orders_tab, create_refunds_tab, create_customers_tab, create_tables_tab, create_staff_tab, create_inventory_tab, create_reports_tab
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.menu.menu_management import view_menu_items, add_menu_item_dialog, update_menu_item_dialog, show_menu_analytics, generate_menu_analytics_text
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.orders.order_management import view_orders_gui, update_order_status_dialog, process_payment_dialog, show_order_analytics, generate_order_analytics
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.orders.payments import add_tip, refund_order, apply_discount, process_cash_payment, process_card_payment, process_meal_plan_payment, open_finance_gui_for_payment, add_finance_button_to_payment_options
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.customers.customer_management import view_customers_gui, add_customer_dialog, update_customer_dialog
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.customers.feedback import manage_customer_feedback, view_recent_feedback, respond_to_feedback, submit_demo_feedback, export_feedback_report, export_feedback_report_pdf
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.customers.loyalty import manage_loyalty_dialog, view_loyalty_tiers, promote_customer_tier, award_bonus_points
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.customers.meal_plan import manage_meal_plan_dialog, manage_staff_subsidy_dialog
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.tables.table_management import view_tables_gui, add_table_dialog, manage_reservations_dialog, optimize_table_structure
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.tables.qr_codes import generate_qr_dialog, create_qr_code_image, create_enhanced_qr_image, print_qr_codes, scan_qr_code_usage, update_qr_database_record
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.staff.staff_management import view_staff_gui, add_staff_dialog, manage_schedules_dialog, show_staff_analytics, generate_staff_analytics, view_schedule_conflicts
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.staff.performance import staff_performance, view_performance_rankings, update_performance_scores, export_performance_report
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.inventory.inventory_management import view_inventory_gui, waste_tracking_dialog, inventory_transactions, low_stock_alerts
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.inventory.purchase_orders import manage_purchase_orders_dialog, view_purchase_orders, create_purchase_order, update_purchase_order, receive_purchase_order, purchase_order_reports, manage_suppliers_dialog
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.inventory.inventory_reports import inventory_reports, inventory_valuation_report, stock_movement_report, low_stock_report, expiry_report, abc_analysis
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.reports.sales_reports import show_report_window, daily_sales_report, monthly_summary_report, profit_analysis_report, menu_performance_report, customer_analytics_report, generate_customer_analytics_text, staff_performance_report
from education_system.systems.university.interfaces.gui.operations.commerce.restaurant_management_gui.reports.waste_reports import view_waste_reports, generate_waste_by_date_range, generate_waste_by_category, generate_waste_by_reason, generate_waste_trends, generate_waste_cost_analysis
