...
class UniversityShopGUI:
    ...
    def launch_cli_mode(self):
        ...
        try:
            ...
            cli_text.insert(tk.END, "python -m education_system.systems.university.domain.operations.commerce.services.shop_management\n\n")
            ...
            def launch_external_cli():
                try:
                    ...
                    subprocess.Popen(
                        [sys.executable, "-m", "education_system.systems.university.domain.operations.commerce.services.shop_management"],
                        cwd=project_root,
                        env=env
                    )
                    messagebox.showinfo(
    ...
    def generate_sales_reports(self, days=30):
        ...
        try:
            ...
            from education_system.systems.university.domain.operations.commerce.services.shop_management.reports import (
...
try:
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import dashboard_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import product_browser
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import product_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import cart_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import checkout_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import order_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import inventory_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import discount_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import refund_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import report_manager
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import bulk_operations
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import utils
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import ui_components
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import email_notifications
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui import textbook_manager
