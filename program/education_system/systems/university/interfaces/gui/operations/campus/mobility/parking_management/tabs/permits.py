...
class PermitsMixin:
    ...
    def create_permit_from_data(self, data):
        ...
        try:
            from education_system.systems.university.infrastructure.email.email_service import send_permit_confirmation
    ...
    def update_permit_from_data(self, permit_id, data):
        ...
        try:
            from education_system.systems.university.infrastructure.email.email_service import send_permit_update_confirmation
