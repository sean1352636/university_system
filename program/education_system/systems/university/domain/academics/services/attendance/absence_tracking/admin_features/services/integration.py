...
class IntegrationService:
    ...
    def show_upcoming_calendar_events(self) -> None:
        ...
        def _open_calendar_gui():
            ...
            try:
                from education_system.systems.university.interfaces.gui.academics.academic_calendar.main_gui import (  # noqa: E501
                    CalendarGUI,
                )
        ...
        def _open_scheduling_gui(schedule_id: Optional[int] = None) -> None:
            ...
            try:
                ...
                if schedule_id is not None:
                    try:
                        from education_system.systems.university.interfaces.gui.academics.module_scheduling.dialogs import (
                            EditScheduleDialog,
                        )
    ...
    def feed_student_risk_assessment(self, quiet: bool = False) -> None:
        ...
        def _open_risk_gui():
            ...
            try:
                ...
                from education_system.systems.university.interfaces.gui.academics.grade_tracking.analytics_manager.manager import (  # noqa: E501
                    AnalyticsManager,
                )
    ...
    def show_grade_penalty_candidates(self) -> None:
        ...
        def _open_grade_manager():
            ...
            try:
                from education_system.systems.university.interfaces.gui.academics.grade_tracking.grade_tracking_app import (  # noqa: E501
                    GradeTrackingApp,
                )
    ...
    def show_absences_vs_mood(self) -> None:
        ...
        def _open_wellbeing_gui():
            try:
                import tkinter as tk
                from education_system.systems.university.interfaces.gui.pastoral.wellbeing.student_wellbeing.wellbeing_gui import (  # noqa: E501
                    WellbeingFrame,
                )
                win = tk.Toplevel(self.ctx.parent)
                win.title("Wellbeing")
    ...
    def raise_disciplinary_action(self) -> None:
        ...
        if Prompt.confirm(
            ...
            try:
                from education_system.systems.university.domain.governance.legal.disciplinary.disciplinary_portal import (  # noqa: E501
                    DisciplinaryPortal,
                )
                win = tk.Toplevel(self.ctx.parent)
    ...
    def show_scholarship_attendance_check(self) -> None:
        ...
        def _open_scholarship_gui(student_id: Optional[str] = None) -> None:
            ...
            try:
                from education_system.systems.university.interfaces.gui.finance.financial_aid.scholarship_manager import (
