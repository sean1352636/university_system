...
class PlannerIntegrations:
    ...
    def list_tutor_groups(self, *, academic_year=None, programme=None):
        try:
            from education_system.systems.university.domain.pastoral.tutor_groups import (
                TutorGroupService,
            )
    ...
    def list_advisors(self):
        try:
            from education_system.systems.university.domain.pastoral.advising.services.advising_service import (
                get_all_advisors,
            )
    ...
    def notify_users(self, recipients, subject, body):
        ...
        if not recipients:
            return 0
        try:
            from education_system.systems.university.services.communication.communication_manager import (
    ...
    def export_schedule_csv(self, lessons, filepath):
        try:
            from education_system.platform.features.reporting.csv_exporter import export_to_csv
    ...
    def export_schedule_html(self, lessons, filepath, *, title="Weekly Timetable"):
        try:
            from education_system.platform.features.reporting.pdf_exporter import save_report_html
            rows = [{
                "day": lesson.get("day", ""),
    ...
    def audit(self, action, *, target_type="lesson", target_id=None, details=None):
        ...
        try:
            from education_system.platform.governance.audit.logger import AuditLogger
    ...
    def status(self):
        ...
        probes = {
            "event_bus": "education_system.systems.university.services.bus.integration_bus",
            "room_booking": "education_system.systems.university.domain.operations.campus.room_booking.services.room_booking_service",
            "equipment": "education_system.systems.university.domain.operations.campus.equipment.services.equipment_core",
            "curriculum": "education_system.systems.university.domain.academics.curriculum_specification.services.curriculum_specification_service",
            "attendance": "education_system.systems.university.domain.academics.services.course_management.attendance_sessions_sync",
            "tutor_groups": "education_system.systems.university.domain.pastoral.tutor_groups",
            "staff_hr": "education_system.systems.university.domain.staff.staff_hr.services.managers.leave_manager",
            "email": "education_system.systems.university.infrastructure.email",
            "audit": "education_system.platform.governance.audit.logger",
            "roles": "education_system.platform.identity.auth.role_manager",
        }
        import importlib
        out = {}
