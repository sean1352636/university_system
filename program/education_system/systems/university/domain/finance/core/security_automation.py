...
from education_system.systems.university.domain.finance.core.students import get_student_phone
# Configure logging
...
def enhanced_notification_system():
    ...
    from education_system.systems.university.domain.finance.core.communications import setup_email_config, setup_sms_config, test_email_service, test_sms_service
    from education_system.systems.university.domain.finance.reporting.budget_analysis import create_budget_category
    while True:
...
def budget_approval_workflow():
    ...
    from education_system.systems.university.domain.finance.reporting.budget_analysis import view_budget_plan_detail
    try:
        conn = get_connection()
        cursor = conn.cursor()
