...
from education_system.systems.university.domain.finance.bank_rec.schema import init_bank_rec
from education_system.systems.university.domain.finance.bank_rec.service import (
