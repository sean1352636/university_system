...
def generate_financial_reports():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.finance.reporting.revenue_analytics.dashboard import student_account_summary_report
            student_account_summary_report()
        elif choice == '5':
            from education_system.systems.university.domain.finance.reporting.revenue_analytics.dashboard import fee_type_analysis_report
            fee_type_analysis_report()
        elif choice == '6':
            from education_system.systems.university.domain.finance.reporting.revenue_analytics.dashboard import payment_method_analysis_report
            payment_method_analysis_report()
        elif choice == '7':
            from education_system.systems.university.domain.finance.reporting.revenue_analytics.dashboard import monthly_revenue_trend_report
