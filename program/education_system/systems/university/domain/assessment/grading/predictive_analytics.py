...
def predictive_analytics_menu():
    ...
    from education_system.systems.university.domain.assessment.grading.grade_calculation.risk_assessment import student_risk_assessment
    from education_system.systems.university.domain.assessment.grading.performance_analytics import performance_prediction_models
    from education_system.systems.university.domain.assessment.grading.interventions import intervention_recommendations
    from education_system.systems.university.domain.assessment.grading.progress import success_probability_calculator
    from education_system.systems.university.domain.assessment.grading.curve_analysis import dropout_risk_analysis
    from education_system.systems.university.domain.assessment.grading.grade_calculation.menus import grade_prediction
    from education_system.systems.university.domain.assessment.grading.trends import trend_forecasting
    while True:
...
def build_at_risk_prediction_model(cursor):
    ...
    from education_system.systems.university.domain.assessment.grading.forecasting import extract_comprehensive_student_features
...
def collect_comprehensive_risk_data(cursor):
    ...
    from education_system.systems.university.domain.assessment.grading.competency_assessment import assess_comprehensive_student_risk
    risk_data = {
    ...
    try:
        from education_system.systems.university.domain.assessment.grading import generate_system_recommendations
...
def generate_comprehensive_risk_report(risk_data):
    ...
    from education_system.systems.university.infrastructure.paths import REPORTS_DIR
