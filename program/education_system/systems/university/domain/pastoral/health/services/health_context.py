...
def get_user_student_id(auth):
    ...
    from education_system.systems.university.domain.pastoral.health.services import contacts
    return contacts.get_user_student_id(auth)

def ensure_templates_schema():
    """Ensure the templates schema exists."""
    from education_system.systems.university.domain.pastoral.health.services import health_db_backup
