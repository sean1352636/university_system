...
from education_system.systems.university.domain.pastoral.health.services.operations import (
    block_time_slots,
    patient_queue,
    pending_tasks,
...
# Dashboard functions
from education_system.systems.university.domain.pastoral.health.services.dashboards import (
    critical_alerts_dashboard,
    generate_custom_report,
)

# Template functions
from education_system.systems.university.domain.pastoral.health.services.templates import (
...
# Directory functions
from education_system.systems.university.domain.pastoral.health.services.directory import (
    specialist_directory,
    emergency_information,
)

# Contact functions
from education_system.systems.university.domain.pastoral.health.services.contacts import (
    get_user_student_id,
...
# Audit functions
from education_system.systems.university.domain.pastoral.health.services.audit import (
    log_audit_event,
...
from education_system.systems.university.domain.pastoral.health.services.surveillance import (
...
from education_system.systems.university.domain.pastoral.health.services.allergies import (
...
from education_system.systems.university.domain.pastoral.health.services.medication import (
    track_medication_adherence,
    manage_refill_reminders,
)

# Vital signs functions
from education_system.systems.university.domain.pastoral.health.services.vitals import (
    manage_vital_signs,
    record_vital_signs,
...
# Security functions
from education_system.systems.university.domain.pastoral.health.services.security import (
    validate_csv_format,
...
# Context (encryption)
from education_system.systems.university.domain.pastoral.health.services.health_context import (
    cipher_suite,
)

# Report functions
from education_system.systems.university.domain.pastoral.health.services.reports import (
