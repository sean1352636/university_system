...
def create_ticket_template(auth):
    ...
    from education_system.systems.university.domain.pastoral.services.helpdesk.tickets.creation import get_priority_selection, get_impact_selection, get_urgency_selection
