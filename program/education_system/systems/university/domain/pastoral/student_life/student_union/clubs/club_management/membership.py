...
from education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management import clubs as _clubs

def _view_clubs():
    try:
        import sys
        pkg = sys.modules.get(
            "education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management"
        )
