...
def manage_equipment_system():
    ...
    global auth
    from education_system.systems.university.domain.pastoral.student_life.student_union.services.points import view_all_checkouts
...
def update_equipment_location(cursor, conn):
    """Backwards-compatible helper for updating equipment location."""
    return update_equipment_status(cursor, conn)
...
def request_facility_booking():
    ...
    global auth
    from education_system.systems.university.domain.pastoral.student_life.student_union.services.facilities import view_facilities
