...
def set_auth_all(auth_obj):
    ...
    try:
        from education_system.systems.university.domain.pastoral.student_life.student_union.services import union_context as su_misc
...
def display_student_union_menu():
    ...
    global auth
    from education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.rewards import manage_engagement_rewards
    from education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.competitions import manage_interclub_competitions
    from education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.mentorship import manage_mentorship_system
    from education_system.systems.university.domain.pastoral.student_life.student_union.facilities.facility_management import manage_equipment_system
    from education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.community import manage_community_engagement
    from education_system.systems.university.domain.pastoral.student_life.student_union.events.event_management import manage_virtual_events
