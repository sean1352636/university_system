...
from education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing import manage_purchase_orders
import random
import re
import os
import csv
...
def manage_suppliers():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.operations.commerce.services.restaurant.staff.staff_administration import supplier_performance
...
def waste_tracking():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.operations.commerce.services.restaurant.menu.menu_management import waste_analytics
            waste_analytics()
        elif choice == '4':
            return
        else:
