    ...
    while True:
        try:
            ...
            if choice in ['1', '2', '3', '4', '5', '6', '7']:
                ...
                print(get_text("campus.events.menu.use_instruction", "Use: from education_system.systems.university.domain.operations.campus.services import CampusEventManager"))
            elif choice == '8':
                break
            else:
