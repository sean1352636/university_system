...
from education_system.systems.university.infrastructure.workflows.database import WorkflowDatabase
...
class WorkflowEngine:
    ...
    def _execute_notification_step(
        ...
        try:
            from education_system.systems.university.infrastructure.communication.realtime_notifications import get_notification_service
