...
Usage:
    from education_system.systems.university.infrastructure.search import get_search_service

    search = get_search_service()
    results = search.search("computer science", entity_type="students")
"""

from education_system.systems.university.infrastructure.search.search_service import (
    SearchService,
    get_search_service,
    SearchResult,
    SearchQuery,
...
from education_system.systems.university.infrastructure.search.autocomplete import (
    AutocompleteService,
    get_autocomplete_service,
)

from education_system.systems.university.infrastructure.search.analytics import (
    SearchAnalytics,
    get_search_analytics,
)

from education_system.systems.university.infrastructure.search.indexer import (
    SearchIndexer,
    get_search_indexer,
)
