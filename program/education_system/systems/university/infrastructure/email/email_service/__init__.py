...
# === Core sending engine ===
from education_system.systems.university.infrastructure.email.email_service.core import (
    _get_current_auth,
    auth,
    safe_log_email,
    send_email,
...
# === Stored email CRUD ===
from education_system.systems.university.infrastructure.email.email_service.storage import (
    get_stored_emails,
    delete_stored_email,
    clear_stored_emails,
)
...
from education_system.systems.university.infrastructure.email.email_service.scheduling import (
    scheduled_jobs,
    scheduled_jobs_lock,
    send_bulk,
    schedule_send,
...
from education_system.systems.university.infrastructure.email.email_service.cli import (
...
from education_system.systems.university.infrastructure.email.email_service.maintenance import (
...
from education_system.systems.university.infrastructure.email.email_service.notifications import (
    # Academic
...
from education_system.systems.university.infrastructure.email.email_db_utilities import _ensure_db_ready, execute_db_operation
