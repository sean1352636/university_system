...
try:
    from education_system.systems.university.infrastructure.shared_context import get_auth as _get_shared_auth
...
from education_system.systems.university.infrastructure.email.state import auth_proxy as _state_auth
