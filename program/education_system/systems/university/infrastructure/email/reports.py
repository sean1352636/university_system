...
def get_system_health_info():
    ...
    from education_system.systems.university.infrastructure.email.email_service import email_queue, worker_threads  # Local import to avoid circular dependency
