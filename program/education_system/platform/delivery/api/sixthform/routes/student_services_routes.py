...
def _admissions():
    from education_system.systems.sixth_form.domain.admissions import (  # noqa: E501
        admissions as data,
    )
    return data
...
def _enrolments():
    from education_system.systems.sixth_form.domain.admissions.enrolments import (  # noqa: E501
        enrolments as data,
    )
    return data
...
def _alumni():
    from education_system.systems.sixth_form.domain.learners.alumni import (  # noqa: E501
        alumni as data,
    )
    return data
