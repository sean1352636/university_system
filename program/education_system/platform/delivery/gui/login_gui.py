...
from education_system.platform.identity.auth.exceptions import AuthError, MFAError
...
class UniversalLoginWindow(tk.Tk):
        ...
        try:
            ...
            if user_email and username:
                ...
                try:
                    ...
                    pass
                try:
                    from education_system.platform.integrations.email.otp_sender import send_otp
    ...
    def _forgot_lookup_questions(self):
        ...
        try:
            from education_system.platform.identity.auth.forgot_password import ForgotPasswordService
