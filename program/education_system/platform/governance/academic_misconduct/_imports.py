...
try:
    import importlib
    _m = importlib.import_module("education_system.systems.university.infrastructure.i18n")
...
# Try university
try:
    from education_system.systems.university.infrastructure.paths import DEFAULT_DB_PATH as _p
    DEFAULT_DB_PATH = _p
except ImportError:
    pass
...
try:
    from education_system.systems.university.infrastructure.shared_context import get_auth, is_auth_initialized
    AUTH_AVAILABLE = True
except ImportError:
    pass
