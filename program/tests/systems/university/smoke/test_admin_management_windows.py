...
class TestApiManagementWindow:
    ...
    def test_window_initialization(self, root_window):
        ...
        from education_system.systems.university.interfaces.gui.shell.admin_management_windows import ApiManagementWindow
    ...
    @patch('education_system.systems.university.interfaces.gui.shell.admin_management_windows.messagebox')
...
class TestAuditLogsWindow:
    ...
    def test_window_initialization(self, root_window):
        ...
        from education_system.systems.university.interfaces.gui.shell.admin_management_windows import AuditLogsWindow
    ...
    @patch('education_system.systems.university.interfaces.gui.shell.admin_management_windows.filedialog')
    def test_export_logs(self, mock_filedialog, root_window):
        ...
        with patch('education_system.systems.university.interfaces.gui.shell.admin_management_windows.messagebox'):
            window.export_logs()
...
class TestDiagnosticsWindow:
    ...
    def test_window_initialization(self, root_window):
        ...
        from education_system.systems.university.interfaces.gui.shell.admin_management_windows import DiagnosticsWindow
...
class TestDatabaseMaintenanceWindow:
    ...
    def test_window_initialization(self, root_window):
        ...
        from education_system.systems.university.interfaces.gui.shell.admin_management_windows import DatabaseMaintenanceWindow
...
class TestWindowIntegration:
    ...
    def test_all_windows_have_close_button(self, root_window):
        ...
        from education_system.systems.university.interfaces.gui.shell.admin_management_windows import (
            ApiManagementWindow,
            AuditLogsWindow,
            DiagnosticsWindow,
