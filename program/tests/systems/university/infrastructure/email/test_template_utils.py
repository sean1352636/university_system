...
class TestInitializeAnalyticsTemplates:
    ...
    @patch('education_system.systems.university.infrastructure.email.template_utils.log_event')
...
class TestEnsureTemplatesDirectory:
    ...
    def test_ensure_templates_directory_exists(self, mock_log):
        ...
        with patch('education_system.systems.university.infrastructure.email.template_utils.paths') as mock_paths:
...
class TestSaveDefaultTemplates:
    ...
    @patch('education_system.systems.university.infrastructure.email.template_utils.ensure_templates_directory')
    @patch('education_system.systems.university.infrastructure.email.template_utils.log_event')
...
class TestLoadTemplate:
    ...
    @patch('education_system.systems.university.infrastructure.email.template_utils._load_mapping')
    @patch('education_system.systems.university.infrastructure.email.template_utils.ensure_templates_directory')
    @patch('education_system.systems.university.infrastructure.email.template_utils.log_event')
    ...
    @patch('education_system.systems.university.infrastructure.email.template_utils.ensure_templates_directory')
    @patch('education_system.systems.university.infrastructure.email.template_utils.log_event')
    @patch('education_system.systems.university.infrastructure.email.template_utils.DEFAULT_TEMPLATES', {'test_default': {'subject': 'Default', 'body': 'Default body'}})
...
class TestUpdateTemplate:
    ...
    @patch('education_system.systems.university.infrastructure.email.template_utils._load_mapping')
    @patch('education_system.systems.university.infrastructure.email.template_utils.load_template')
    @patch('education_system.systems.university.infrastructure.email.template_utils.ensure_templates_directory')
    @patch('education_system.systems.university.infrastructure.email.template_utils.log_event')
    @patch('builtins.open', new_callable=mock_open)
...
class TestDeleteTemplate:
    ...
    @patch('education_system.systems.university.infrastructure.email.template_utils.DEFAULT_TEMPLATES', {'default_template': {}})
    @patch('education_system.systems.university.infrastructure.email.template_utils.log_event')
...
class TestRenderTemplate:
    ...
    @patch('education_system.systems.university.infrastructure.email.template_utils.load_template')
    @patch('education_system.systems.university.infrastructure.email.template_utils.config')
    ...
    def test_render_template_handles_errors(self, mock_log, mock_load):
        ...
        with patch('education_system.systems.university.infrastructure.email.template_utils.Template', side_effect=Exception("Template error")):
...
class TestTemplateManagementMenu:
    ...
    @patch('builtins.print')
    @patch('education_system.systems.university.infrastructure.email.template_utils.list_templates')
