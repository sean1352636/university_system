...
from education_system.systems.university.domain.governance.legal.services import (
...
class TestSendLegalEmail:
    ...
    def test_returns_false_when_infrastructure_unavailable(self):
        ...
        with patch.dict(
            "sys.modules",
            {"education_system.systems.university.infrastructure.email.template_utils": None,
             "education_system.systems.university.infrastructure.email.email_service": None},
        ):
    ...
    def test_returns_false_when_render_yields_empty(self):
        ...
        with patch.dict(
            "sys.modules",
            {"education_system.systems.university.infrastructure.email.template_utils": fake_template_utils,
             "education_system.systems.university.infrastructure.email.email_service": fake_email_service},
        ):
            assert core._send_legal_email("template", "to@x", {}) is False
