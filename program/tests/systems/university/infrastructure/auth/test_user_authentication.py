...
class TestUserAuthInitialization:
    ...
    def test_init_with_custom_db_path(self, temp_db):
        ...
        with patch('education_system.systems.university.infrastructure.auth.core.UserAuth._init_db'):
...
class TestUserCreation:
    ...
    @patch('education_system.systems.university.infrastructure.auth.core.UserAuth._init_db')
    @patch('education_system.systems.university.infrastructure.auth.core.UserAuth.log_activity_with_connection')
...
class TestTwoFactorAuthentication:
    ...
    @patch('education_system.systems.university.infrastructure.auth.core.UserAuth._init_db')
    @patch('education_system.systems.university.infrastructure.auth.managers.mfa_manager.pyotp.TOTP')
