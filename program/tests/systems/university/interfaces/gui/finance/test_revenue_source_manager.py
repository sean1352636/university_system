...
from education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager import RevenueSourceManager
...
class TestRevenueSourceManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.StringVar', side_effect=lambda **kw: _make_string_var(kw.get('value', ''))):
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Frame')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Label')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Button')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.ttk.Treeview')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.ttk.PanedWindow')
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.get_revenue_by_source')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.messagebox.showinfo')
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.messagebox.showwarning')
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.get_revenue_by_source')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.messagebox.showerror')
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Toplevel')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.FigureCanvasTkAgg')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.Figure')
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.FigureCanvasTkAgg')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.Figure')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.plt')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Toplevel')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Frame')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Label')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.Button')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.tk.StringVar')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.ttk.Combobox')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.ttk.Entry')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.get_source_revenue_trend')
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.filedialog.asksaveasfilename')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.export_revenue_by_source_csv')
    @patch('education_system.systems.university.interfaces.gui.finance.finance.revenue_source_manager.messagebox.showinfo')
