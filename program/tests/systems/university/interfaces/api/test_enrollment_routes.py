...
from education_system.platform.delivery.api.university.routes.enrollment_routes import enrollment_bp, _row_to_dict
...
class TestListEnrollments:
    ...
    @patch("education_system.platform.delivery.api.university.routes.enrollment_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.enrollment_routes.get_connection")
...
class TestEnroll:
    ...
    @patch("education_system.platform.delivery.api.university.routes.enrollment_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.enrollment_routes.transaction")
    @patch("education_system.platform.delivery.api.university.routes.enrollment_routes.get_connection")
    ...
    @patch("education_system.platform.delivery.api.university.routes.enrollment_routes.AlreadyEnrolledError",
