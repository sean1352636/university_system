...
from education_system.systems.university.domain.pastoral.student_life.student_union.administration import admin_management
...
class TestSetupPermissions:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.administration.admin_management.get_connection')
...
class TestComplianceReporting:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.administration.admin_management.send_confirmation_email')
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.administration.admin_management.render_template')
...
class TestAuthSetup:
    ...
    def test_set_auth_with_has_auth(self, mock_auth):
        ...
        with patch('education_system.systems.university.domain.pastoral.student_life.student_union.administration.admin_management.set_auth_instance') as mock_set:
            admin_management.set_auth(mock_auth)
