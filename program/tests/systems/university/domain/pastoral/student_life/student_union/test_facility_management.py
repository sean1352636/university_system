...
from education_system.systems.university.domain.pastoral.student_life.student_union.facilities import facility_management
...
class TestEquipmentCheckout:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.facilities.facility_management.datetime')
...
class TestFacilityBooking:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.facilities.facility_management.view_facilities', create=True)
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.facilities.facility_management.send_confirmation_email')
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.facilities.facility_management.get_connection')
...
class TestEdgeCases:
    ...
    def test_manage_equipment_system_not_logged_in(self):
        ...
        with patch('builtins.print') as mock_print:
            with patch('education_system.systems.university.domain.pastoral.student_life.student_union.facilities.facility_management.get_connection'):
