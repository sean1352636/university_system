...
from education_system.systems.university.domain.pastoral.health.portal.health_portal_core import (
    SecurityManager,
...
class TestEncryptionFunctions:
    ...
    def test_get_or_create_encryption_key(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Retrieve the key
            with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.os.path.exists', return_value=True):
    ...
    def test_encrypt_decrypt_sensitive_data(self):
        ...
        with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.cipher_suite', cipher_suite):
...
class TestAuditLogging:
    ...
    @patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.audit_logger')
...
class TestHealthPortalMenu:
    ...
    def test_display_health_portal_menu_requires_login(self, monkeypatch, capsys):
        ...
        with patch('education_system.systems.university.infrastructure.shared_context.get_auth', return_value=no_auth):
    ...
    def test_display_health_portal_menu_logout(self, mock_auth, monkeypatch, capsys):
        ...
        with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.setup_health_permissions'):
            with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.init_enhanced_health_db'):
    ...
    @patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.manage_health_records_enhanced')
...
class TestSessionTimeout:
    ...
    def test_session_timeout_with_no_settings(self, mock_auth):
        ...
        # Mock database error
        with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.get_connection', side_effect=Exception("DB Error")):
            result = SecurityManager.check_session_timeout(mock_auth)
...
class TestErrorHandling:
    ...
    def test_init_enhanced_health_db_handles_errors(self):
        ...
        with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.get_connection', side_effect=sqlite3.Error("Test error")):
            try:
                init_enhanced_health_db()
                # Should not crash
    ...
    def test_encrypt_sensitive_data_handles_errors(self):
        ...
        with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.cipher_suite', None):
            try:
...
class TestIntegration:
    ...
    def test_audit_and_security_workflow(self, mock_auth, test_db):
        ...
        # Log audit event
        with patch('education_system.systems.university.domain.pastoral.health.portal.health_portal_core.audit_logger') as mock_logger:
