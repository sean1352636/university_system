...
from education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.update_grades_dialog import (
    UpdateGradesDialog,
    safe_grab_set
)
...
class TestUpdateGradesDialog(unittest.TestCase):
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.update_grades_dialog.get_connection')
