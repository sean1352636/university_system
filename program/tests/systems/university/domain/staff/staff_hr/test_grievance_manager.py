...
from education_system.systems.university.domain.staff.staff_hr.services.managers.grievance_manager import GrievanceManager
...
class TestGrievanceCreation:
    ...
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.grievance_manager.get_connection')
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.grievance_manager.transaction')
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.grievance_manager.log_activity')
