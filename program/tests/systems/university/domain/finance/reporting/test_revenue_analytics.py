...
from education_system.systems.university.domain.finance.reporting import revenue_analytics
...
class TestRevenueAnalytics:
    ...
    def test_generate_budget_variance_report(self, temp_db, capsys):
        ...
        with patch('education_system.systems.university.domain.finance.reporting.revenue_analytics.reports.DEFAULT_DB_PATH', temp_db):
    ...
    def test_revenue_summary_report(self, temp_db, capsys, monkeypatch):
        ...
        with patch('education_system.systems.university.domain.finance.reporting.revenue_analytics.reports.get_connection') as mock_conn:
    ...
    def test_generate_payment_collection_report(self, temp_db, capsys, monkeypatch):
        ...
        with patch('education_system.systems.university.domain.finance.reporting.revenue_analytics.get_connection') as mock_conn:
            mock_conn.return_value = sqlite3.connect(temp_db)
...
class TestFinancialReportsMenu:
    ...
    def test_generate_financial_reports_menu_exit(self, monkeypatch, capsys):
        ...
        from education_system.systems.university.domain.finance.reporting.revenue_analytics import reports as ra_reports
