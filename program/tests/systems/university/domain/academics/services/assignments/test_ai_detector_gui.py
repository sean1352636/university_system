...
class TestAIDetectorGUIImport:
    ...
    def test_module_structure(self):
        ...
        from education_system.systems.university.interfaces.gui.academics import ai_detector
...
class TestAIDetectorGUIInitialization:
    ...
    @patch('tkinter.Tk')
    @patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.get_auth')
    ...
    @patch('tkinter.Tk')
    @patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.get_auth')
    @patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.AIDetector')
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.AIDetector', None)
    @patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.get_auth')
...
class TestAuthenticationInitialization:
    ...
    @patch('tkinter.Tk')
    @patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.get_auth')
    @patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.UserAuth')
...
class TestErrorHandling:
    ...
    def test_initialization_shows_error_when_detector_unavailable(self, mock_error, mock_tk_class, mock_auth):
        ...
        with patch('education_system.systems.university.interfaces.gui.academics.ai_detector_gui.AIDetector', None):
            with pytest.raises(RuntimeError):
                gui = AIDetectorGUI(root=mock_root, auth=mock_auth)
