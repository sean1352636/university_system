...
from education_system.platform.integrations.email.email_service import EmailService, EmailMessage
...
def test_unconfigured_service(monkeypatch):
    ...
    monkeypatch.setattr(
        "education_system.platform.integrations.email.email_service.load_email_config", _empty_config,
    )
...
def test_validate_header_rejects_newlines():
    from education_system.platform.integrations.email.email_service import EmailError
