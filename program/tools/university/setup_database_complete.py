...
def remove_invalid_modules(conn):
    ...
    print("\n=== " + get_text("setup.database.removing_invalid_modules") + " ===")
    ...
    for code, name in current_modules:
        if code not in VALID_MODULES:
            print(get_text("setup.database.removing_module", code=code, name=name))
...
def create_user_accounts_for_students(conn):
    ...
    print("\n=== " + get_text("setup.database.creating_user_accounts") + " ===")
...
def assign_students_to_modules(conn):
    ...
    print("\n=== " + get_text("setup.database.assigning_students_to_modules") + " ===")
    ...
    for student_id, course in students:
        ...
        print(get_text("setup.database.assigned_modules_to_student", student_id=student_id, course=course))
...
def create_student_timetables(conn):
    ...
    print("\n=== " + get_text("setup.database.creating_student_timetables") + " ===")
    ...
    for student_id, modules in student_schedule.items():
        ...
        print(get_text("setup.database.created_timetable", student_id=student_id, module_count=len(modules)))
...
def add_instructors(conn):
    ...
    print("\n=== " + get_text("setup.database.adding_instructors") + " ===")
