...
from education_system.platform.kernel.database.sql_safety import (
    validate_identifier,
    escape_like,
    build_where_clause,
    build_set_clause,
...
from education_system.platform.identity.auth.role_manager import RoleManager, ROLE_HIERARCHY
