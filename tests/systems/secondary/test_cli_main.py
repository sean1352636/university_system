...
def test_categories_catalogue_shape():
    from education_system.systems.secondary.cli_main import CATEGORIES
...
def test_run_raises_without_shared_auth():
    from education_system.systems.secondary import cli_main
