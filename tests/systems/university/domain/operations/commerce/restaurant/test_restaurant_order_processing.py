...
from education_system.systems.university.domain.operations.commerce.services.restaurant.operations import order_processing
...
class TestViewOrders:
    ...
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing.get_db_connection')
...
class TestPaymentProcessing:
    ...
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing.record_payment_to_finance')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing.log_audit_action')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing.get_db_connection')
...
class TestRefundProcessing:
    ...
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing.backup_before_operation')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing.log_audit_action')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.operations.order_processing.get_db_connection')
