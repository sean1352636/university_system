...
from education_system.systems.university.domain.staff.staff_hr.services.managers.contract_manager import ContractManager
...
class TestContractCreation:
    ...
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.contract_manager.get_connection')
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.contract_manager.transaction')
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.contract_manager.log_activity')
