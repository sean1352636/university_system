...
from education_system.systems.university.domain.pastoral.health.records import data_purge
...
class TestUpdateRetentionPolicy:
    ...
    @patch('education_system.systems.university.domain.pastoral.health.records.data_purge.backup_before_operation')
...
class TestPurgeExpiredData:
    ...
    @patch('builtins.print')
    @patch('education_system.systems.university.domain.pastoral.health.records.data_purge.create_sqlite_backup')
