...
from education_system.systems.university.domain.finance.core.payments import (
    manual_rate_update,
...
class TestGenerateQRPaymentCode:
    ...
    @patch('education_system.systems.university.domain.finance.core.payments.qrcode')
