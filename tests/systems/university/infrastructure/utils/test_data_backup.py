...
from education_system.systems.university.infrastructure.database import data_backup
...
class TestDatabaseOperations:
    ...
    def test_get_database_tables(self, temp_db):
        ...
        with patch('education_system.systems.university.infrastructure.database.data_backup.operations.get_connection') as mock_conn:
...
class TestBackupCreation:
    ...
    @patch('education_system.systems.university.infrastructure.database.data_backup.operations.DEFAULT_DB_PATH')
    def test_create_manual_backup(self, mock_path, temp_db, temp_backup_dir):
        ...
        with patch('education_system.systems.university.infrastructure.database.data_backup.operations.ensure_backup_directory') as mock_dir:
...
class TestBackupConfiguration:
    ...
    def test_save_config(self, temp_backup_dir, reset_backup_config):
        ...
        with patch('education_system.systems.university.infrastructure.database.data_backup.config.DATA_DIR', Path(temp_backup_dir)):
...
class TestBackupRestoration:
    ...
    def test_restore_from_backup(self, mock_path, temp_db, temp_backup_dir):
        ...
        with patch('education_system.systems.university.infrastructure.database.data_backup.operations.create_enhanced_backup') as mock_backup:
