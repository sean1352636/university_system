...
from education_system.systems.university.infrastructure.email import misc
...
class TestDebugFunctionDefinition:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_manager.display_chat_rooms_menu')
