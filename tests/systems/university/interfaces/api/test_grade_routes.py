...
from education_system.platform.delivery.api.university.routes.grade_routes import grade_bp, _row_to_dict
...
class TestListGrades:
    ...
    @patch("education_system.platform.delivery.api.university.routes.grade_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.grade_routes.get_connection")
...
class TestRecordGrade:
    ...
    @patch("education_system.platform.delivery.api.university.routes.grade_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.grade_routes.get_connection")
    @patch("education_system.platform.delivery.api.university.routes.grade_routes.transaction")
