...
class TestEmailIntegration:
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_email_as_system')
    def test_send_email_unified_simple(self, mock_send):
        """Test simple email sending"""
        from education_system.systems.university.infrastructure.utils.communication_integration import send_email_unified
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_template_email')
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_email')
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_bulk')
    def test_send_bulk_email_unified(self, mock_bulk):
        """Test bulk email sending"""
        from education_system.systems.university.infrastructure.utils.communication_integration import send_bulk_email_unified
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.queue_email')
    def test_queue_email_unified(self, mock_queue):
        """Test queueing email"""
        from education_system.systems.university.infrastructure.utils.communication_integration import queue_email_unified
...
class TestSMSIntegration:
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_sms')
    def test_send_sms_unified_simple(self, mock_send):
        """Test simple SMS sending"""
        from education_system.systems.university.infrastructure.utils.communication_integration import send_sms_unified
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_bulk_sms')
    def test_send_bulk_sms_unified(self, mock_bulk):
        """Test bulk SMS sending"""
        from education_system.systems.university.infrastructure.utils.communication_integration import send_bulk_sms_unified
...
class TestLibraryNotifications:
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_email_unified')
    def test_library_notification_due_soon_email(self, mock_email):
        """Test library due soon notification via email"""
        from education_system.systems.university.infrastructure.utils.communication_integration import send_library_notification
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_sms_unified')
    ...
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.send_email_unified')
    @patch('education_system.systems.university.infrastructure.utils.communication_integration.render_template')
...
class TestCalendarReminder:
    ...
    def test_calendar_reminder_email(self, mock_render, mock_email):
        ...
        from education_system.systems.university.infrastructure.utils.communication_integration import send_calendar_reminder
...
class TestRestaurantNotifications:
    ...
    def test_restaurant_order_confirmation(self, mock_render, mock_email):
        ...
        from education_system.systems.university.infrastructure.utils.communication_integration import send_restaurant_notification
...
class TestMigrationHelpers:
    ...
    def test_migrate_standalone_email(self, mock_email):
        ...
        from education_system.systems.university.infrastructure.utils.communication_integration import migrate_standalone_email
    ...
    def test_migrate_standalone_sms(self, mock_sms):
        ...
        from education_system.systems.university.infrastructure.utils.communication_integration import migrate_standalone_sms
