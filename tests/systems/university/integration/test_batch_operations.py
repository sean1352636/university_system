...
class TestBatchOperationManagerInit:
    ...
    def test_initialization_default(self):
        ...
        with patch('education_system.systems.university.infrastructure.paths.DEFAULT_DB_PATH', '/tmp/test.db'):
            with patch('education_system.systems.university.infrastructure.paths.BACKUP_DIR', '/tmp/backup'):
