"""SkillsTrackerFrame GUI for the Primary School."""

import tkinter as tk
from tkinter import ttk, messagebox

from education_system.primary_school.modules.domain.academics.skills_tracker.services.skills_tracker_service import SkillsTrackerService


class SkillsTrackerFrame(tk.Frame):
    """GUI for managing skills tracker."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = SkillsTrackerService(db_path)

        # Header
        header = tk.Frame(self, bg=self.HEADER_BG, height=40)
        header.pack(fill="x")
        header.pack_propagate(False)
        tk.Label(header, text="Skills Tracker",
        ...
        self._skills_tab = tk.Frame(self._notebook)
        self._notebook.add(self._skills_tab, text="Skills")
        self._record_tab = tk.Frame(self._notebook)
        self._notebook.add(self._record_tab, text="Record")
        self._progress_tab = tk.Frame(self._notebook)
        self._notebook.add(self._progress_tab, text="Progress")
