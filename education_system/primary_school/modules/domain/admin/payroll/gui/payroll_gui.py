"""PayrollFrame GUI for the Primary School."""

import tkinter as tk
from tkinter import ttk, messagebox

from education_system.primary_school.modules.domain.admin.payroll.services.payroll_service import PayrollService


class PayrollFrame(tk.Frame):
    """GUI for managing payroll."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = PayrollService(db_path)

        # Header
        header = tk.Frame(self, bg=self.HEADER_BG, height=40)
        header.pack(fill="x")
        header.pack_propagate(False)
        tk.Label(header, text="Payroll",
        ...
        self._records_tab = tk.Frame(self._notebook)
        self._notebook.add(self._records_tab, text="Records")
        self._run_payroll_tab = tk.Frame(self._notebook)
        self._notebook.add(self._run_payroll_tab, text="Run Payroll")
        self._payslips_tab = tk.Frame(self._notebook)
        self._notebook.add(self._payslips_tab, text="Payslips")
