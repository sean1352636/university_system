"""GDPRFrame GUI for the Primary School."""

import tkinter as tk
from tkinter import ttk, messagebox

from education_system.primary_school.modules.domain.admin.gdpr.services.gdpr_service import GDPRService


class GDPRFrame(tk.Frame):
    """GUI for managing gdpr."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = GDPRService(db_path)

        # Header
        header = tk.Frame(self, bg=self.HEADER_BG, height=40)
        header.pack(fill="x")
        header.pack_propagate(False)
        tk.Label(header, text="Gdpr",
        ...
        self._data_requests_tab = tk.Frame(self._notebook)
        self._notebook.add(self._data_requests_tab, text="Data Requests")
        self._consent_tab = tk.Frame(self._notebook)
        self._notebook.add(self._consent_tab, text="Consent")
        self._data_deletion_tab = tk.Frame(self._notebook)
        self._notebook.add(self._data_deletion_tab, text="Data Deletion")
