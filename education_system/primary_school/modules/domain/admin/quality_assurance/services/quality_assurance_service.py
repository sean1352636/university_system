...
class QualityAssuranceService:
    ...
    def create(self, **kwargs):
        ...
        values: list = []
        for col in ('review_type', 'subject_area', 'reviewer', 'review_date', 'rating', 'strengths', 'areas_for_improvement', 'action_plan', 'follow_up_date', 'status'):
    ...
    def list_all(self, limit=100, offset=0, **filters):
        ...
        params: list = []
        for col in ('id', 'review_type', 'subject_area', 'reviewer', 'review_date', 'rating', 'strengths', 'areas_for_improvement', 'action_plan', 'follow_up_date', 'status'):
            val = filters.get(col)
            if val is not None:
