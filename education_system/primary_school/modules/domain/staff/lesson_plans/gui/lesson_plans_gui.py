"""LessonPlansFrame GUI for the Primary School."""

import tkinter as tk
from tkinter import ttk, messagebox

from education_system.primary_school.modules.domain.staff.lesson_plans.services.lesson_plans_service import LessonPlansService
