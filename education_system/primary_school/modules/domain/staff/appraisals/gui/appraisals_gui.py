"""AppraisalsFrame GUI for the Primary School."""

import tkinter as tk
from tkinter import ttk, messagebox

from education_system.primary_school.modules.domain.staff.appraisals.services.appraisals_service import AppraisalsService


class AppraisalsFrame(tk.Frame):
    """GUI for managing appraisals."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = AppraisalsService(db_path)

        # Header
        header = tk.Frame(self, bg=self.HEADER_BG, height=40)
        header.pack(fill="x")
        header.pack_propagate(False)
        tk.Label(header, text="Appraisals",
        ...
        self._appraisals_tab = tk.Frame(self._notebook)
        self._notebook.add(self._appraisals_tab, text="Appraisals")
        self._objectives_tab = tk.Frame(self._notebook)
        self._notebook.add(self._objectives_tab, text="Objectives")
        self._history_tab = tk.Frame(self._notebook)
