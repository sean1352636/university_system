"""FeedbackFrame GUI for the Primary School."""

import tkinter as tk
from tkinter import ttk, messagebox

from education_system.primary_school.modules.domain.communication.feedback.services.feedback_service import FeedbackService


class FeedbackFrame(tk.Frame):
    """GUI for managing feedback."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = FeedbackService(db_path)
        ...
        self._all_feedback_tab = tk.Frame(self._notebook)
        self._notebook.add(self._all_feedback_tab, text="All Feedback")
