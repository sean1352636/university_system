...
A thin GUI over :class:`education_system.shared.analytics.warehouse.Warehouse`:
...
from education_system.shared.database.paths import SYSTEM_LABELS, SYSTEM_ORDER
