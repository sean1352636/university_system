...
def create_destination():
    ...
    return jsonify({"message": t("api.destination.created"), "data": dest}), 201
...
def get_destination(dest_id):
    ...
    if not dest:
        return jsonify({"error": t("api.destination.not_found")}), 404
...
def update_destination(dest_id):
    ...
    return jsonify({"message": t("api.destination.updated"), "data": dest})
...
def record_contact(dest_id):
    ...
    return jsonify({"message": t("api.common.updated"), "data": dest})
