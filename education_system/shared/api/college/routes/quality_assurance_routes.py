...
def get_review(pk):
    ...
    if not item:
        return jsonify({"error": t("api.quality_assurance.not_found")}), 404
...
def create_review():
    ...
    return jsonify({"message": t("api.quality_assurance.created"), "data": item}), 201
...
def update_review(pk):
    ...
    return jsonify({"message": t("api.quality_assurance.updated"), "data": item})
...
def delete_review(pk):
    ...
    return jsonify({"message": t("api.quality_assurance.deleted")})
