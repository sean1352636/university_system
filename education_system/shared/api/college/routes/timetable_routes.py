...
def add_slot():
    ...
    return jsonify({"message": t("api.timetable.slot_created"), "data": slot}), 201
...
def update_slot(slot_id):
    ...
    return jsonify({"message": t("api.timetable.slot_updated"), "data": slot})
...
def delete_slot(slot_id):
    ...
    return jsonify({"message": t("api.timetable.slot_deleted")})
