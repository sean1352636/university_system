...
def create_risk():
    ...
    return jsonify({"message": t("api.common.created"), "data": risk}), 201
...
def update_risk(rid):
    ...
    return jsonify({"message": t("api.common.updated"), "data": risk})
...
def upload_document():
    ...
    return jsonify({"message": t("api.common.created"), "data": doc}), 201
...
def verify_document(did):
    ...
    return jsonify({"message": t("api.common.updated"), "data": doc})
