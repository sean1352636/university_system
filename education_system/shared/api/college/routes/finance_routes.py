...
def create_fee_item():
    ...
    return jsonify({"message": t("api.common.created"), "data": fee}), 201
...
def create_invoice():
    ...
    return jsonify({"message": t("api.common.created"), "data": inv}), 201
...
def get_invoice(invoice_id):
    ...
    if not inv:
        return jsonify({"error": t("api.finance.not_found")}), 404
...
def record_payment():
    ...
    return jsonify({"message": t("api.common.created"), "data": payment}), 201
...
def create_payroll():
    ...
    return jsonify({"message": t("api.common.created"), "data": record}), 201
