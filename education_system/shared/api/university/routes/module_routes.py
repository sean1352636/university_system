...
from education_system.shared.api.university.validators import validate_module_create, validate_module_update
from education_system.post_18.university_system.core.exceptions import CourseNotFoundError, ValidationError
