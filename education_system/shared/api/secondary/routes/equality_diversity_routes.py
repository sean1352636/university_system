...
from education_system.secondary_school.modules.domain.student_life.equality_diversity.services.equality_diversity_service import EqualityDiversityService
