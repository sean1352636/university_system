...
Usage
-----
    from education_system.shared.api.websocket_server import init_socketio, socketio
...
def _validate_token(token: str) -> dict | None:
    ...
    try:
        from education_system.shared.api.auth import _jwt_manager  # type: ignore[attr-defined]
...
if SOCKETIO_AVAILABLE:
    ...
    class ChatNamespace(Namespace):
        ...
        def on_chat_message(self, data):
            ...
            # Persist the message
            try:
                from education_system.shared.services.chat_service import ChatService
