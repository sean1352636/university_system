...
@_token_required
def list_records():
    from education_system.nursery_system.modules.domain.dsl.dsl import list_records as _list
    rows = _list()
...
@_token_required
def summary():
    from education_system.nursery_system.modules.domain.dsl.dsl import summary as _summary
...
def get_record(record_id):
    from education_system.nursery_system.modules.domain.dsl.dsl import get_record as _get
    rec = _get(record_id)
    if rec is None:
