...
@_token_required
def list_fees():
    from education_system.secondarysch_system.modules.domain.finance.fees import fees as data
    try:
...
@_token_required
def list_trips():
    from education_system.secondarysch_system.modules.domain.finance.trips import trips as data
    try:
...
def list_expense_claims():
    from education_system.secondarysch_system.modules.domain.finance.expense_claims import expense_claims as data
    try:
