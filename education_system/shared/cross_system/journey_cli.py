...
from education_system.shared.cross_system import progression, student_view
...
_PROMOTERS = {
    "nursery": (
        "education_system.nursery_system.modules.domain.children.primary_transfer:move_to_primary_school",
        "plain"),
    "primary": (
