...
def test_staff_directory_links_one_person_across_systems(auth_db):
    from education_system.shared.staff_directory import staff_directory_service as sd
...
def test_parent_overview_aggregates_children(auth_db):
    ...
    from education_system.shared.services import parent_overview
...
def test_warehouse_api_role_gating(monkeypatch):
    ...
    from education_system.shared.analytics import warehouse as wh_mod
    from education_system.shared.api import auth as api_auth
    from education_system.shared.api.warehouse_routes import warehouse_bp
