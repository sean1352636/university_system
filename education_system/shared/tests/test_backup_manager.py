...
class TestBackup:
    def test_backup_compressed(self, source_db, backup_dir):
        from education_system.shared.backup.backup_manager import backup
...
class TestVerify:
    def test_verify_valid_backup(self, source_db, backup_dir):
        from education_system.shared.backup.backup_manager import backup, verify_backup
        path = backup(source_db, backup_dir)
    ...
    def test_verify_no_metadata(self, tmp_path):
        from education_system.shared.backup.backup_manager import verify_backup
...
class TestRestore:
    def test_roundtrip_compressed(self, source_db, backup_dir, tmp_path):
        from education_system.shared.backup.backup_manager import backup, restore
...
class TestListBackups:
    def test_list_backups(self, source_db, backup_dir):
        from education_system.shared.backup.backup_manager import backup, list_backups
    ...
    def test_list_empty_dir(self, backup_dir):
        from education_system.shared.backup.backup_manager import list_backups
