"""Tkinter views for Secondary School Expense Claims."""
...
from education_system.secondarysch_system.modules.domain.finance.expense_claims.expense_claims import (
    CATEGORIES,
    CLAIM_STATUSES,
    CLAIMANT_TYPES,
    Claim,
