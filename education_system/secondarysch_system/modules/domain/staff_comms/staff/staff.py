...
from education_system.secondarysch_system.modules.domain.staff_comms.staff import staff as data
...
ID_PREFIX = "T"
ID_DIGITS = 7
EMAIL_DOMAIN = "secondary.sch.uk"

ROLES: tuple[str, ...] = (
    "Principal", "Vice Principal", "Head of Key Stage 3", "Head of Key Stage 4", 
...
DEPARTMENTS: tuple[str, ...] = (
    ...
    "School Office", "Pastoral", "Safeguarding",
...
def create_staff(data: dict[str, Any]) -> Staff:
    ...
    try:
        ...
        staff_directory_service.register_local_staff(
            "school", staff_id=sid, first_name=out.first_name,
