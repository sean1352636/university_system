"""Tkinter views for Secondary School Staff Wellbeing."""
...
from education_system.secondarysch_system.modules.domain.staff_comms.staff_wellbeing.staff_wellbeing import (
    ACTION_TYPES,
    CONCERN_FLAGS,
    DEFAULT_ENTRY_TYPE,
    DEFAULT_STATUS,
