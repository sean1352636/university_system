"""Tkinter views for Secondary School Staff Absence."""
...
from education_system.secondarysch_system.modules.domain.staff_comms.staff_absence.staff_absence import (
    ABSENCE_TYPES,
    Absence,
    CERTIFICATE_TYPES,
    COVER_SOURCES,
