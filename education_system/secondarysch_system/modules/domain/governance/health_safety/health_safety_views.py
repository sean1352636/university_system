"""Tkinter views for Secondary School Health & Safety register."""
...
from education_system.secondarysch_system.modules.domain.governance.health_safety.health_safety import (
    ACTION_PRIORITIES,
    ACTION_STATUSES,
    AFFECTED_PARTIES,
    CATEGORIES,
