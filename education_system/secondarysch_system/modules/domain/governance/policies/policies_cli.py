"""CLI flows for the Secondary School Policy register."""
...
from education_system.secondarysch_system.modules.domain.governance.policies import policies as data
from education_system.secondarysch_system.modules.domain.governance.policies.policies import (
    CATEGORIES,
    DEFAULT_CATEGORY,
