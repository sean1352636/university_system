"""CLI flows for the Secondary School Compliance register."""
...
from education_system.secondarysch_system.modules.domain.governance.compliance import compliance as data
from education_system.secondarysch_system.modules.domain.governance.compliance.compliance import (
    CATEGORIES,
    DEFAULT_FREQUENCY,
    DEFAULT_STATUS,
    DERIVED_STATUSES,
