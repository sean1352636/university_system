...
from education_system.secondarysch_system.modules.domain.governance.assets import assets as data
from education_system.secondarysch_system.modules.domain.governance.assets.assets import (
    Asset,
    CATEGORIES,
    CONDITIONS,
    CURRENCY_SYMBOL,
