"""Tkinter views for Secondary School Risk Management."""
...
from education_system.secondarysch_system.modules.domain.governance.risk_management.risk_management import (
    ACTION_STATUSES,
    CATEGORIES,
