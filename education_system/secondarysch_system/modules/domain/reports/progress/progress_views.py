...
from education_system.secondarysch_system.modules.domain.reports.progress import progress as data
...
from education_system.secondarysch_system.modules.domain.reports.progress.progress import (
    DEFAULT_PERIOD,
    DEFAULT_RATING,
    DEFAULT_RISK,
