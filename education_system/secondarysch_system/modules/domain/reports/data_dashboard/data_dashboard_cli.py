...
from education_system.secondarysch_system.modules.domain.reports.data_dashboard import data_dashboard as data
from education_system.secondarysch_system.modules.domain.reports.data_dashboard.data_dashboard import (
    DEFAULT_WINDOW_DAYS,
    Panel,
)
