...
from education_system.secondarysch_system.modules.domain.reports.kpi_dashboard import kpi_dashboard as data
from education_system.secondarysch_system.modules.domain.reports.kpi_dashboard.kpi_dashboard import (
    DEFAULT_THRESHOLD,
    DEFAULT_WINDOW_DAYS,
    Snapshot,
)
