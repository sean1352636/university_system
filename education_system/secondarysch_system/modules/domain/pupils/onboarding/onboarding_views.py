"""Tk views for onboarding in the Secondary School System."""
...
from education_system.secondarysch_system.modules.domain.pupils.onboarding.onboarding import (
...
def _open_checklist_dialog(parent, pupil_id: str, on_changed: Callable[[], None]) -> None:
    ...
    def _apply() -> None:
        # Apply each toggled step. We compare against the latest known
        # record so we only push changed steps to the data layer.
        try:
