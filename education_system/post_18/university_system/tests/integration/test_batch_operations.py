...
class TestBatchOperationManagerInit:
    ...
    def test_initialization_default(self):
        ...
        with patch('education_system.post_18.university_system.core.paths.DEFAULT_DB_PATH', '/tmp/test.db'):
            with patch('education_system.post_18.university_system.core.paths.BACKUP_DIR', '/tmp/backup'):
