...
class TestDisplayInterfaceMenu:
    ...
    @patch('education_system.post_18.university_system.tests.run_all_tests.main')
...
class TestRunCliMode:
    ...
    @patch('run.log_error')
    @patch('education_system.post_18.university_system.modules.shared.cli.cli_main.main')
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('run.log_error')
    @patch('education_system.post_18.university_system.modules.shared.cli.cli_main.main', side_effect=ImportError("Module not found"))
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('run.log_error')
    @patch('education_system.post_18.university_system.modules.shared.cli.cli_main.main', side_effect=OSError("File system error"))
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('run.log_error')
    @patch('education_system.post_18.university_system.modules.shared.cli.cli_main.main', side_effect=RuntimeError("Runtime issue"))
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('run.log_error')
    @patch('education_system.post_18.university_system.modules.shared.cli.cli_main.main', side_effect=ValueError("Invalid value"))
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('run.log_error')
    @patch('education_system.post_18.university_system.modules.shared.cli.cli_main.main', side_effect=Exception("Unexpected error"))
    @patch('sys.stdout', new_callable=StringIO)
...
class TestRunGuiMode:
    ...
    def test_successful_gui_execution(self, mock_stdout, mock_log_error):
        ...
        with patch.dict('sys.modules', {'education_system.post_18.university_system.modules.shared.gui.main_gui': fake_module}):
...
class TestMain:
    ...
    def test_main_with_cli_argument(self, mock_stdout, mock_input):
        ...
        with patch.object(sys, 'argv', ['run.py', '--cli']), \
             ...
             patch('education_system.shared.i18n.selector_cli.show_language_selector_cli', return_value='en'), \
             patch('education_system.shared.i18n.init_i18n', Mock()):
            run.main()
    ...
    def test_main_with_gui_argument(self, mock_stdout, mock_input):
        ...
        with patch.object(sys, 'argv', ['run.py', '--gui']), \
             ...
             patch('education_system.shared.i18n.selector_gui.show_language_selector', return_value='en'), \
             patch('education_system.shared.i18n.init_i18n', Mock()):
            run.main()
    ...
    @patch('builtins.input', return_value='0')
    @patch('education_system.post_18.university_system.infrastructure.database.database_utils.init_db')
    @patch('education_system.post_18.university_system.infrastructure.shared_context.set_auth')
    @patch('education_system.post_18.university_system.infrastructure.auth.core.UserAuth')
    @patch('education_system.post_18.university_system.core.paths.ensure_directories')
    @patch('sys.stdout', new_callable=StringIO)
...
class TestErrorLoggingIntegration:
    ...
    @patch('run.log_error')
    @patch('education_system.post_18.university_system.modules.shared.cli.cli_main.main', side_effect=ImportError("Test error"))
    @patch('sys.stdout', new_callable=StringIO)
