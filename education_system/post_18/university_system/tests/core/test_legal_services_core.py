...
from education_system.post_18.university_system.modules.domain.operations.legal.services import (
...
class TestSendLegalEmail:
    ...
    def test_returns_false_when_infrastructure_unavailable(self):
        ...
        with patch.dict(
            "sys.modules",
            {"education_system.post_18.university_system.infrastructure.email.template_utils": None,
             "education_system.post_18.university_system.infrastructure.email.email_service": None},
        ):
    ...
    def test_returns_false_when_render_yields_empty(self):
        ...
        with patch.dict(
            "sys.modules",
            {"education_system.post_18.university_system.infrastructure.email.template_utils": fake_template_utils,
             "education_system.post_18.university_system.infrastructure.email.email_service": fake_email_service},
        ):
            assert core._send_legal_email("template", "to@x", {}) is False
