...
class TestGetEnv:
    ...
    def test_get_env_returns_default_when_not_set(self):
        from education_system.post_18.university_system.core.defaults import _get_env
    ...
    def test_get_env_int_returns_default_when_not_set(self):
        from education_system.post_18.university_system.core.defaults import _get_env_int
...
class TestPasswordGeneration:
    ...
    def test_default_length_is_16(self):
        from education_system.post_18.university_system.core.defaults import _generate_random_password
...
class TestRequirePasswordEnv:
    ...
    def test_returns_env_value_when_set(self):
        from education_system.post_18.university_system.core.defaults import _require_password_env
    ...
    def test_generates_random_when_not_set(self):
        import education_system.post_18.university_system.core.defaults as defaults_mod
...
class TestDefaultConstants:
    ...
    def test_university_name_is_string(self):
        from education_system.post_18.university_system.core.defaults import UNIVERSITY_NAME
    ...
    def test_demo_mode_is_bool(self):
        from education_system.post_18.university_system.core.defaults import DEMO_MODE
...
class TestHelperFunctions:
    ...
    def test_get_admin_email(self):
        from education_system.post_18.university_system.core.defaults import get_admin_email, SYSTEM_ADMIN_EMAIL

        result = get_admin_email()
        assert result == SYSTEM_ADMIN_EMAIL

    def test_get_fallback_email_admin(self):
        from education_system.post_18.university_system.core.defaults import get_fallback_email, SYSTEM_ADMIN_EMAIL

        result = get_fallback_email("admin")
        assert result == SYSTEM_ADMIN_EMAIL

    def test_get_fallback_email_support(self):
        from education_system.post_18.university_system.core.defaults import get_fallback_email, SYSTEM_SUPPORT_EMAIL

        result = get_fallback_email("support")
        assert result == SYSTEM_SUPPORT_EMAIL

    def test_get_fallback_email_noreply(self):
        from education_system.post_18.university_system.core.defaults import get_fallback_email, UNIVERSITY_NOREPLY_EMAIL
    ...
    def test_get_default_student_data_returns_dict(self):
        from education_system.post_18.university_system.core.defaults import get_default_student_data
    ...
    def test_get_default_admin_data_returns_dict(self):
        from education_system.post_18.university_system.core.defaults import get_default_admin_data
...
class TestDefaultsAllExports:
    ...
    def test_all_includes_key_items(self):
        from education_system.post_18.university_system.core.defaults import __all__
