...
class TestLazyI18n:
    ...
    def test_load_i18n_success(self):
        ...
        import education_system.post_18.university_system.core.exceptions as exc_mod
...
class TestUniversitySystemError:
    ...
    def test_basic_construction(self):
        from education_system.post_18.university_system.core.exceptions import UniversitySystemError
...
class TestDatabaseExceptions:
    ...
    def test_database_error_is_university_error(self):
        from education_system.post_18.university_system.core.exceptions import DatabaseError, UniversitySystemError
    ...
    def test_query_error(self):
        from education_system.post_18.university_system.core.exceptions import QueryError
    ...
    def test_transaction_error_defaults(self):
        from education_system.post_18.university_system.core.exceptions import TransactionError
    ...
    def test_integrity_error_defaults(self):
        from education_system.post_18.university_system.core.exceptions import IntegrityError
...
class TestAuthenticationExceptions:
    ...
    def test_authentication_error_base(self):
        from education_system.post_18.university_system.core.exceptions import AuthenticationError, UniversitySystemError

        err = AuthenticationError("auth fail")
        assert isinstance(err, UniversitySystemError)

    def test_invalid_credentials_error_defaults(self):
        from education_system.post_18.university_system.core.exceptions import InvalidCredentialsError
    ...
    def test_session_expired_error_defaults(self):
        from education_system.post_18.university_system.core.exceptions import SessionExpiredError
    ...
    def test_permission_denied_error_without_resource(self):
        from education_system.post_18.university_system.core.exceptions import PermissionDeniedError
    ...
    def test_mfa_required_error_defaults(self):
        from education_system.post_18.university_system.core.exceptions import MFARequiredError
...
class TestValidationExceptions:
    ...
    def test_validation_error_base(self):
        from education_system.post_18.university_system.core.exceptions import ValidationError, UniversitySystemError

        err = ValidationError("invalid")
        assert isinstance(err, UniversitySystemError)

    def test_invalid_input_error_with_field(self):
        from education_system.post_18.university_system.core.exceptions import InvalidInputError
    ...
    def test_missing_field_error(self):
        from education_system.post_18.university_system.core.exceptions import MissingFieldError
    ...
    def test_format_error_with_expected(self):
        from education_system.post_18.university_system.core.exceptions import FormatError
...
class TestStudentExceptions:
    ...
    def test_student_error_base(self):
        from education_system.post_18.university_system.core.exceptions import StudentError, UniversitySystemError
    ...
    def test_duplicate_student_error(self):
        from education_system.post_18.university_system.core.exceptions import DuplicateStudentError
    ...
    def test_student_enrollment_error(self):
        from education_system.post_18.university_system.core.exceptions import StudentEnrollmentError, StudentError
...
class TestCourseExceptions:
    ...
    def test_course_error_base(self):
        from education_system.post_18.university_system.core.exceptions import CourseError, UniversitySystemError

        err = CourseError("course err")
        assert isinstance(err, UniversitySystemError)

    def test_course_not_found_with_id(self):
        from education_system.post_18.university_system.core.exceptions import CourseNotFoundError
    ...
    def test_course_full_with_id(self):
        from education_system.post_18.university_system.core.exceptions import CourseFullError
    ...
    def test_prerequisite_error_with_missing(self):
        from education_system.post_18.university_system.core.exceptions import PrerequisiteError
...
class TestEnrollmentExceptions:
    ...
    def test_enrollment_error_base(self):
        from education_system.post_18.university_system.core.exceptions import EnrollmentError, UniversitySystemError

        err = EnrollmentError("enroll err")
        assert isinstance(err, UniversitySystemError)

    def test_already_enrolled_error(self):
        from education_system.post_18.university_system.core.exceptions import AlreadyEnrolledError
    ...
    def test_enrollment_closed_with_course(self):
        from education_system.post_18.university_system.core.exceptions import EnrollmentClosedError
    ...
    def test_capacity_exceeded_error(self):
        from education_system.post_18.university_system.core.exceptions import CapacityExceededError, EnrollmentError
...
class TestGradeExceptions:
    ...
    def test_grade_error_base(self):
        from education_system.post_18.university_system.core.exceptions import GradeError, UniversitySystemError

        err = GradeError("grade err")
        assert isinstance(err, UniversitySystemError)

    def test_invalid_grade_error(self):
        from education_system.post_18.university_system.core.exceptions import InvalidGradeError
    ...
    def test_grade_not_found_error(self):
        from education_system.post_18.university_system.core.exceptions import GradeNotFoundError, GradeError
...
class TestFinanceExceptions:
    ...
    def test_finance_error_base(self):
        from education_system.post_18.university_system.core.exceptions import FinanceError, UniversitySystemError

        err = FinanceError("finance err")
        assert isinstance(err, UniversitySystemError)

    def test_payment_error(self):
        from education_system.post_18.university_system.core.exceptions import PaymentError, FinanceError

        err = PaymentError("Payment declined")
        assert isinstance(err, FinanceError)

    def test_insufficient_funds_error(self):
        from education_system.post_18.university_system.core.exceptions import InsufficientFundsError
    ...
    def test_transaction_failed_error(self):
        from education_system.post_18.university_system.core.exceptions import TransactionFailedError, FinanceError
...
class TestEmailExceptions:
    ...
    def test_email_error_base(self):
        from education_system.post_18.university_system.core.exceptions import EmailError, UniversitySystemError

        err = EmailError("email err")
        assert isinstance(err, UniversitySystemError)

    def test_email_delivery_error_with_reason(self):
        from education_system.post_18.university_system.core.exceptions import EmailDeliveryError
    ...
    def test_template_error(self):
        from education_system.post_18.university_system.core.exceptions import TemplateError, EmailError

        err = TemplateError("Bad template")
        assert isinstance(err, EmailError)

    def test_attachment_error(self):
        from education_system.post_18.university_system.core.exceptions import AttachmentError, EmailError
...
class TestFileExceptions:
    ...
    def test_file_error_base(self):
        from education_system.post_18.university_system.core.exceptions import FileError, UniversitySystemError

        err = FileError("file err")
        assert isinstance(err, UniversitySystemError)

    def test_university_file_not_found_error(self):
        from education_system.post_18.university_system.core.exceptions import UniversityFileNotFoundError
    ...
    def test_file_upload_error(self):
        from education_system.post_18.university_system.core.exceptions import FileUploadError, FileError

        err = FileUploadError("Upload failed")
        assert isinstance(err, FileError)

    def test_file_validation_error_with_filename(self):
        from education_system.post_18.university_system.core.exceptions import FileValidationError
...
class TestConfigurationExceptions:
    ...
    def test_configuration_error_base(self):
        from education_system.post_18.university_system.core.exceptions import ConfigurationError, UniversitySystemError

        err = ConfigurationError("config err")
        assert isinstance(err, UniversitySystemError)

    def test_missing_config_error(self):
        from education_system.post_18.university_system.core.exceptions import MissingConfigError
    ...
    def test_invalid_config_error_with_reason(self):
        from education_system.post_18.university_system.core.exceptions import InvalidConfigError
...
class TestExceptionsCrossCutting:
    ...
    def test_all_exports_are_importable(self):
        ...
        from education_system.post_18.university_system.core import exceptions
