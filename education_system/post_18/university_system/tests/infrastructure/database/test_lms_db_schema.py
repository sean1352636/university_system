...
import os
import tempfile
from education_system.post_18.university_system.modules.domain.academics.services.lms.db_schema import (
...
class TestLMSDatabaseSchema:
    ...
    def db_connection(self, temp_db, monkeypatch):
        ...
        from education_system.post_18.university_system.infrastructure.database import db
        from education_system.post_18.university_system.modules.domain.academics.services.lms import db_schema as lms_schema
