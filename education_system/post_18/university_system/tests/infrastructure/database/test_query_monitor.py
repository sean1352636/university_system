...
def monitor():
    ...
    from education_system.post_18.university_system.infrastructure.database.query_monitor import QueryMonitor
...
class TestQueryMetrics:
    ...
    def test_creation(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.query_monitor import QueryMetrics
        now = datetime.now()
        qm = QueryMetrics(
...
class TestQueryStats:
    ...
    def test_creation(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.query_monitor import QueryStats
...
class TestQueryTimer:
    ...
    def test_measures_elapsed_time(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.query_monitor import QueryTimer
    ...
    def test_slow_query_logging(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.query_monitor import QueryTimer
        with patch('education_system.post_18.university_system.infrastructure.database.query_monitor.query_logger') as mock_logger:
...
class TestGetQueryMonitor:
    ...
    def test_returns_monitor(self):
        ...
        import education_system.post_18.university_system.infrastructure.database.query_monitor as mod
...
class TestModuleExports:
    ...
    def test_all_is_list(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.query_monitor import __all__
