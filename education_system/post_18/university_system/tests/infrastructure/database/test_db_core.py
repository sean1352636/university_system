...
class TestApplyPragmas:
    ...
    def test_apply_pragmas_sets_all_settings(self, temp_db_path):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import _apply_pragmas
        conn = _sqlite3.connect(temp_db_path)
        _apply_pragmas(conn)
...
class TestEnsureParentDir:
    ...
    def test_creates_parent_directory(self, temp_dir):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import ensure_parent_dir
...
class TestConnectFunction:
    ...
    def test_connect_default_timeout(self, temp_db_path):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import connect
        with patch('education_system.post_18.university_system.infrastructure.database.db._sqlite3.connect') as mock_connect:
            mock_conn = MagicMock()
    ...
    def test_connect_none_uses_default_path(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import connect, DEFAULT_DB_PATH
        with patch('education_system.post_18.university_system.infrastructure.database.db._sqlite3.connect') as mock_connect:
            mock_conn = MagicMock()
            mock_connect.return_value = mock_conn
            connect(None)
...
class TestGetDbConnection:
    ...
    def test_get_db_connection_delegates_to_get_connection(self, temp_db_path):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import get_db_connection
        with patch('education_system.post_18.university_system.infrastructure.database.db.get_connection') as mock_gc:
...
class TestDatabaseManager:
    ...
    def test_context_manager_enter_exit(self, temp_db_path):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import DatabaseManager
    ...
    def test_default_db_path(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import DatabaseManager, DEFAULT_DB_PATH
        dm = DatabaseManager()
    ...
    def test_retry_on_database_locked(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import DatabaseManager
        with patch('education_system.post_18.university_system.infrastructure.database.db.connect') as mock_connect:
...
class TestAtomicOperation:
    ...
    def test_atomic_with_existing_connection(self, temp_db_with_table):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import atomic_operation, get_connection
        conn = get_connection(temp_db_with_table, row_factory=False)
    ...
    def test_atomic_creates_new_connection_if_none(self, temp_db_with_table):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import atomic_operation
...
class TestSavepoint:
    ...
    def test_savepoint_success(self, temp_db_with_table):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import savepoint
        conn = _sqlite3.connect(temp_db_with_table)
        conn.execute("BEGIN")
...
class TestSQLiteProxy:
    ...
    def test_proxy_connect_returns_connection(self, temp_db_path):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import sqlite3 as proxy
...
class TestConnectionPool:
    ...
    def test_pool_connection_validation(self, temp_db_path):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import ConnectionPool, PooledConnection
...
class TestPooledConnection:
    ...
    def test_pooled_connection_creation(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import PooledConnection
        conn = MagicMock()
        now = datetime.now()
...
class TestGetConnectionPool:
    ...
    def test_get_connection_pool_returns_pool(self, temp_db_path):
        ...
        import education_system.post_18.university_system.infrastructure.database.db as db_mod
        # Reset global pool
...
class TestModuleExports:
    ...
    def test_all_contains_key_names(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.db import __all__
        expected = [
