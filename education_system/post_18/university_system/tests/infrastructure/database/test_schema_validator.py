...
class TestTableSchema:
    ...
    def test_creation_defaults(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.schema_validator import TableSchema
...
class TestSchemaDifference:
    ...
    def test_creation(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.schema_validator import SchemaDifference
        sd = SchemaDifference(
            type='missing_table',
            table='test',
            severity='error',
...
class TestSchemaValidationError:
    ...
    def test_basic_creation(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.schema_validator import SchemaValidationError
...
class TestGetActualSchema:
    ...
    def test_returns_all_tables(self, temp_db):
        ...
        from education_system.post_18.university_system.infrastructure.database.schema_validator import SchemaValidator
...
class TestCompareSchemas:
    ...
    def test_identical_schemas_no_differences(self, temp_db):
        ...
        from education_system.post_18.university_system.infrastructure.database.schema_validator import SchemaValidator, TableSchema
        validator = SchemaValidator(db_path=temp_db)
    ...
    def test_type_normalization(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.schema_validator import (
...
class TestModuleExports:
    ...
    def test_all_is_list(self):
        ...
        from education_system.post_18.university_system.infrastructure.database.schema_validator import __all__
    ...
    def test_all_names_accessible(self):
        ...
        import education_system.post_18.university_system.infrastructure.database.schema_validator as mod
