...
from education_system.post_18.university_system.infrastructure.database import database_utils
...
class TestInitDB:
    ...
    @patch('education_system.post_18.university_system.modules.scripts.setup_unified_database.create_unified_database')
    @patch('education_system.post_18.university_system.infrastructure.database.database_utils.DEFAULT_DB_PATH')
    ...
    @patch('education_system.post_18.university_system.infrastructure.database.database_utils.sqlite3.connect')
    @patch('education_system.post_18.university_system.infrastructure.database.database_utils.DEFAULT_DB_PATH')
    ...
    def test_init_db_parking(self):
        ...
        try:
            with patch('education_system.post_18.university_system.infrastructure.database.database_utils.DatabaseManager') as mock_manager:
                mock_db = MagicMock()
