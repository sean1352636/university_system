...
def ai_gui(root_window, mock_auth, setup_db):
    ...
    from education_system.post_18.university_system.modules.shared.services.ai_features.gui.ai_features_gui import AIFeaturesGUI
...
class TestChatbotTab:
    ...
    @patch('education_system.post_18.university_system.infrastructure.ai.gui.chatbot_gui.ChatbotGUI', create=True)
    @patch('education_system.post_18.university_system.infrastructure.ai.university_chatbot.UniversityChatbot', create=True)
...
class TestPlagiarismTab:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.PlagiarismCheckerGUI', create=True)
...
class TestAIDetectorTab:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.ai_detector.AIDetectorGUI', create=True)
...
class TestLauncherFunction:
    ...
    def test_launch_ai_features_gui(self, root_window, mock_auth, setup_db):
        ...
        from education_system.post_18.university_system.modules.shared.services.ai_features.gui.ai_features_gui import (
