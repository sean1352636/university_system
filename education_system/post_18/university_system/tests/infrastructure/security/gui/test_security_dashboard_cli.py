...
from education_system.post_18.university_system.infrastructure.security.security_dashboard_cli import SecurityDashboardCLI
...
class TestDashboardInitialization:
    ...
    def test_init_initializes_security_tables(self, test_db):
        ...
        with patch('education_system.post_18.university_system.infrastructure.security.security_dashboard_cli.DEFAULT_DB_PATH', test_db):
            dashboard = SecurityDashboardCLI(admin_user_id=1)
...
class TestCLIIntegration:
    ...
    def test_encryption_through_cli(self, test_db):
        ...
        with patch('education_system.post_18.university_system.infrastructure.security.security_dashboard_cli.DEFAULT_DB_PATH', test_db), \
             patch('education_system.post_18.university_system.infrastructure.security.data_encryption.DEFAULT_DB_PATH', test_db), \
             patch('education_system.post_18.university_system.infrastructure.security.comprehensive_security.DEFAULT_DB_PATH', test_db), \
             patch('education_system.post_18.university_system.infrastructure.security.session_management.DEFAULT_DB_PATH', test_db), \
             patch('education_system.post_18.university_system.infrastructure.security.init_security_tables.DEFAULT_DB_PATH', test_db):
            dashboard = SecurityDashboardCLI(admin_user_id=1)
...
class TestTabulateHelper:
    ...
    def test_tabulate_available(self):
        ...
        from education_system.post_18.university_system.infrastructure.security.security_dashboard_cli import TABULATE_AVAILABLE
    ...
    def test_fallback_tabulate_function(self):
        ...
        from education_system.post_18.university_system.infrastructure.security.security_dashboard_cli import tabulate
    ...
    def test_fallback_tabulate_no_data(self):
        ...
        from education_system.post_18.university_system.infrastructure.security.security_dashboard_cli import tabulate, TABULATE_AVAILABLE
...
class TestCLIErrorHandling:
    ...
    def test_manager_operations_with_corrupted_db(self):
        ...
        with patch('education_system.post_18.university_system.infrastructure.security.security_dashboard_cli.DEFAULT_DB_PATH', invalid_path):
...
class TestModuleImports:
    ...
    def test_all_security_modules_imported(self):
        ...
        from education_system.post_18.university_system.infrastructure.security import security_dashboard_cli
    ...
    def test_auth_module_availability(self):
        ...
        from education_system.post_18.university_system.infrastructure.security.security_dashboard_cli import AUTH_MODULE_AVAILABLE
