...
class TestGetDefaultCsp:
    def test_returns_string(self):
        from education_system.post_18.university_system.infrastructure.security.flask_security_headers import get_default_csp
        csp = get_default_csp()
...
class TestGetHstsValue:
    def test_default_max_age(self):
        from education_system.post_18.university_system.infrastructure.security.flask_security_headers import get_hsts_value
        val = get_hsts_value()
...
class TestAddSecurityHeaders:
    def test_sets_x_frame_options(self):
        from education_system.post_18.university_system.infrastructure.security.flask_security_headers import add_security_headers
        resp = _make_response()
...
class TestInitCookieSecurity:
    ...
    def test_production_sets_secure_cookie(self):
        from education_system.post_18.university_system.infrastructure.security.flask_security_headers import init_cookie_security
        app = _make_app()
...
class TestInitSecurityHeaders:
    ...
    def test_registers_after_request(self):
        import education_system.post_18.university_system.infrastructure.security.flask_security_headers as mod
