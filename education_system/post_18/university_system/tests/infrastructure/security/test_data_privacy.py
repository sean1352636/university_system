...
from education_system.post_18.university_system.modules.domain.health.portal.data_privacy import (
...
class TestEncryptionManagement:
    ...
    def test_get_or_create_encryption_key_creates_new(self):
        ...
        with patch('education_system.post_18.university_system.modules.domain.health.portal.data_privacy.os.path.exists', return_value=False), \
             patch('education_system.post_18.university_system.modules.domain.health.portal.data_privacy.os.chmod'), \
    ...
    def test_get_or_create_encryption_key_uses_existing(self):
        ...
        with patch('education_system.post_18.university_system.modules.domain.health.portal.data_privacy.os.path.exists', return_value=True):
...
class TestAuditLogging:
    ...
    @patch('education_system.post_18.university_system.modules.domain.health.portal.data_privacy.audit_logger')
