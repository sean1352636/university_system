...
def reset_global():
    ...
    import education_system.post_18.university_system.infrastructure.security.security_alerts as mod
...
class TestSendEmailAlert:
    @patch("education_system.post_18.university_system.infrastructure.security.security_alerts.smtplib.SMTP")
...
class TestSendSlackAlert:
    @patch("education_system.post_18.university_system.infrastructure.security.security_alerts.requests")
...
class TestConvenienceFunctions:
    @patch("education_system.post_18.university_system.infrastructure.security.security_alerts.get_alert_manager")
    ...
    @patch("education_system.post_18.university_system.infrastructure.security.security_alerts.send_security_alert")
