...
class TestCreateToken:
    @patch("education_system.post_18.university_system.infrastructure.security.remember_me.transaction")
...
class TestGetUserTokens:
    @patch("education_system.post_18.university_system.infrastructure.security.remember_me.get_connection")
