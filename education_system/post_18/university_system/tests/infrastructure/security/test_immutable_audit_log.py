...
def reset_globals():
    ...
    import education_system.post_18.university_system.infrastructure.security.immutable_audit_log as mod
...
def in_memory_audit_log():
    ...
    from education_system.post_18.university_system.infrastructure.security.immutable_audit_log import ImmutableAuditLog

    with patch("education_system.post_18.university_system.infrastructure.security.immutable_audit_log.transaction") as mock_tx, \
         patch("education_system.post_18.university_system.infrastructure.security.immutable_audit_log.get_connection") as mock_gc:
...
class TestImmutableAuditLogInit:
    @patch("education_system.post_18.university_system.infrastructure.security.immutable_audit_log.transaction")
...
class TestCalculateHmac:
    ...
    def test_matches_manual_hmac(self, mock_tx):
        ...
        # _calculate_hmac uses PBKDF2-HMAC-SHA256 keyed by the (process-wide)
        # log secret. Derive the expectation from the same key the source uses,
        # since the secret is a class-level singleton set on first init.
        expected = hashlib.pbkdf2_hmac(
            "sha256", b"hello", ImmutableAuditLog._SECRET_KEY, 1_000
        ).hex()
...
class TestConvenienceFunctions:
    def test_log_security_event(self, in_memory_audit_log):
        ...
        with patch(
            ...
            from education_system.post_18.university_system.infrastructure.security.immutable_audit_log import log_security_event
    ...
    def test_verify_audit_log_integrity(self, in_memory_audit_log):
        ...
        with patch(
            ...
            from education_system.post_18.university_system.infrastructure.security.immutable_audit_log import verify_audit_log_integrity
