...
from education_system.post_18.university_system.infrastructure.email import announcements
...
class TestSendBatchAnnouncement:
    ...
    def test_send_batch_announcement_all_students(self):
        ...
        with patch('education_system.post_18.university_system.infrastructure.email.announcements.execute_db_operation') as mock_db, \
             patch('education_system.post_18.university_system.infrastructure.email.announcements.send_bulk') as mock_send_bulk:
...
class TestMarkAnnouncementViewed:
    ...
    def test_mark_announcement_viewed_already_viewed(self):
        ...
        with patch('education_system.post_18.university_system.infrastructure.email.announcements.execute_db_operation', side_effect=mock_operation):
            result = announcements.mark_announcement_viewed(mock_dashboard, 123)
