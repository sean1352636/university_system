...
from education_system.post_18.university_system.modules.shared.gui.email import email_manager_management_gui
...
class TestEmailManagerManagementGUIInitialization:
    ...
    def test_gui_initializes_theme_manager(self, root_window, mock_auth):
        ...
        try:
            with patch('education_system.post_18.university_system.modules.shared.gui.theme_config.get_theme_manager'):
                gui = email_manager_management_gui.EmailManagerManagementGUI(
                    root_window,
                    mock_auth
                )
