...
from education_system.post_18.university_system.infrastructure.email import misc
...
class TestDebugFunctionDefinition:
    ...
    @patch('education_system.post_18.university_system.infrastructure.email.email_manager.display_chat_rooms_menu')
