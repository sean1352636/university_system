...
from education_system.post_18.university_system.infrastructure.email import admin
...
_EMAIL_DB_PATH = 'education_system.post_18.university_system.infrastructure.database.db.DEFAULT_DB_PATH'
...
class TestCommunicationDashboard:
    ...
    @patch('education_system.post_18.university_system.infrastructure.email.email_service.send_email_as_user')
...
class TestEmailSystem:
    ...
    @patch('education_system.post_18.university_system.infrastructure.email.email_service.send_email')
