...
from education_system.post_18.university_system.infrastructure.auth.email_otp_service import (
    EmailProvider,
    SMTPEmailProvider,
    AWS_SES_Provider,
    MockEmailProvider,
...
class TestSMTPEmailProvider:
    ...
    @patch('education_system.post_18.university_system.infrastructure.auth.email_otp_service.smtplib.SMTP')
...
class TestEmailConfiguration:
    ...
    def test_load_email_config_from_file(self, tmp_path):
        ...
        with patch('education_system.post_18.university_system.infrastructure.auth.email_otp_service.paths') as mock_paths:
...
class TestConvenienceFunctions:
    ...
    def test_get_email_service_singleton(self):
        ...
        # Reset the singleton
        import education_system.post_18.university_system.infrastructure.auth.email_otp_service as email_module
