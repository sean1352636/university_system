...
from education_system.post_18.university_system.infrastructure.email import chat_rooms
...
class TestInitializeChatTables:
    ...
    def test_initialize_chat_tables_success(self):
        ...
        with patch('education_system.post_18.university_system.infrastructure.email.chat_rooms.execute_db_operation') as mock_db:
    ...
    def test_initialize_chat_tables_creates_invitations_table(self):
        ...
        with patch('education_system.post_18.university_system.infrastructure.email.chat_rooms.execute_db_operation', side_effect=mock_operation):
            result = chat_rooms.initialize_chat_tables()
...
class TestEnterChatRoom:
    ...
    def test_enter_chat_room_invite_command_as_admin(self):
        ...
        with patch('builtins.input', side_effect=['/invite', 'otheruser', '/quit']), \
             patch('builtins.print'), \
             patch('education_system.post_18.university_system.infrastructure.email.admin.search_users') as mock_search:
...
class TestManageChatRoom:
    ...
    def test_manage_chat_room_remove_member(self):
        ...
        with patch('builtins.input', side_effect=['3', 'otheruser', '', '7']), \
             patch('builtins.print'), \
             patch('education_system.post_18.university_system.infrastructure.email.chat_rooms.execute_db_operation', side_effect=mock_operation):
