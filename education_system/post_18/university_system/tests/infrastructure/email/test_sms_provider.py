...
from education_system.post_18.university_system.infrastructure.auth.sms_provider import (
    SMSProvider,
    TwilioSMSProvider,
    AWS_SNS_Provider,
    MockSMSProvider,
...
class TestSMSConfiguration:
    ...
    def test_load_sms_config_from_file(self, tmp_path):
        ...
        with patch('education_system.post_18.university_system.infrastructure.auth.sms_provider.paths') as mock_paths:
    ...
    def test_load_sms_config_file_not_found(self, monkeypatch):
        ...
        with patch('education_system.post_18.university_system.infrastructure.auth.sms_provider.paths') as mock_paths, \
             patch.dict('sys.modules', {'education_system.shared.email.config': None}):
...
class TestConvenienceFunctions:
    ...
    def test_get_sms_service_singleton(self):
        ...
        # Reset the singleton
        import education_system.post_18.university_system.infrastructure.auth.sms_provider as sms_module
