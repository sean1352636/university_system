...
from education_system.post_18.university_system.infrastructure.auth.managers.account_security import (
...
class TestIncrementLoginAttempts:
    ...
    @patch(
        "education_system.post_18.university_system.infrastructure.auth.managers.account_security.SECURITY_ALERTS_AVAILABLE",
        True,
    )
    @patch(
        "education_system.post_18.university_system.infrastructure.auth.managers.account_security.alert_account_lockout",
    )
