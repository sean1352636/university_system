...
from education_system.post_18.university_system.infrastructure.auth.managers.password_manager import (
    hash_password,
    verify_password,
...
class TestChangeUserPassword:
    ...
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.hash_password")
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.verify_password", return_value=True)
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.validate_password", return_value=True)
    ...
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.validate_password", return_value=False)
    ...
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.verify_password", return_value=False)
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.validate_password", return_value=True)
...
class TestResetUserPassword:
    ...
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.hash_password")
    @patch("education_system.post_18.university_system.infrastructure.auth.managers.password_manager.generate_temp_password",
