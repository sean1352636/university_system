...
_ADMIN_MOD = 'education_system.post_18.university_system.modules.shared.gui.auth.mfa_admin_gui'
...
def make_panel(mock_mfa_service):
    ...
    def _make():
        with patch(f'{_ADMIN_MOD}.MFAService', return_value=mock_mfa_service):
            from education_system.post_18.university_system.modules.shared.gui.auth.mfa_admin_gui import MFAAdminPanel
            parent = MagicMock()
...
class TestSettingsTab:
    ...
    def test_test_sms_provider(self, make_panel, mock_tkinter):
        ...
        panel = make_panel()
        with patch('education_system.post_18.university_system.infrastructure.auth.sms_provider.get_sms_service', mock_get_sms):
    ...
    def test_test_email_provider(self, make_panel, mock_tkinter):
        ...
        panel = make_panel()
        with patch('education_system.post_18.university_system.infrastructure.auth.email_otp_service.get_email_service', mock_get_email):
...
class TestConvenienceFunction:
    ...
    @patch('education_system.post_18.university_system.modules.shared.gui.auth.mfa_admin_gui.MFAAdminPanel')
    def test_show_mfa_admin(self, mock_panel_class):
        ...
        from education_system.post_18.university_system.modules.shared.gui.auth.mfa_admin_gui import show_mfa_admin
