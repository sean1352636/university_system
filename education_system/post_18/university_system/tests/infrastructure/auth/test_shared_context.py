...
def reset_auth():
    ...
    import education_system.post_18.university_system.infrastructure.shared_context as context_module
...
class TestInitializeAuth:
    ...
    def test_initialize_auth_uses_default_path(self):
        ...
        with patch('education_system.post_18.university_system.infrastructure.shared_context.UserAuth') as MockUserAuth:
            mock_instance = Mock()
