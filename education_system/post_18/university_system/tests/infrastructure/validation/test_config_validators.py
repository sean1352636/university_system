...
from education_system.post_18.university_system.infrastructure.validation.config_validators import (
...
class TestConfigValidatorIntegration:
    ...
    def test_all_validators_return_validation_result(
        ...
        from education_system.post_18.university_system.infrastructure.validation.validators import ValidationResult
    ...
    def test_raise_if_invalid_works_on_config_results(self):
        result = validate_email_config({})
        assert not result.is_valid
        from education_system.post_18.university_system.infrastructure.validation.validators import ValidationError
