...
Usage:
    python -m education_system.post_18.university_system.tests.generate_test_report [pytest args...]

Examples:
    # Run all university tests and generate report
    python -m education_system.post_18.university_system.tests.generate_test_report

    # Run specific test directory
    python -m education_system.post_18.university_system.tests.generate_test_report education_system/post_18/university_system/tests/cli/

    # Pass extra pytest flags
    python -m education_system.post_18.university_system.tests.generate_test_report -x --timeout=30
"""
...
def run_tests(extra_args: list[str] | None = None) -> dict:
    ...
    if extra_args:
        ...
        cmd.append("education_system/post_18/university_system/tests/")
