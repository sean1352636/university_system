...
class TestDocumentManagerGUI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch('education_system.post_18.university_system.core.paths.DEFAULT_DB_PATH',
                            self.test_db)
        self.patcher.start()
        self.patcher_db = patch('education_system.post_18.university_system.infrastructure.database.db.DEFAULT_DB_PATH',
                                self.test_db)
