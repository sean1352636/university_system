...
class TestPDFExportGUI:
    ...
    def test_initialization(self, mock_tk, mock_root, mock_auth):
        ...
        from education_system.post_18.university_system.modules.shared.gui.pdf_export_gui import PDFExportGUI
    ...
    def test_show_export_window(self, mock_tk, mock_root, mock_auth):
        ...
        with patch.object(gui, '_create_widgets'), \
             ...
             patch('education_system.post_18.university_system.modules.shared.gui.pdf_export_gui.tk.Toplevel') as mock_toplevel:
...
class TestShowPDFExportGUIFunction:
    ...
    def test_show_pdf_export_gui_function(self):
        ...
        with patch(
            "education_system.post_18.university_system.modules.shared.gui.pdf_export_gui.PDFExportGUI"
        ) as mock_class:
            from education_system.post_18.university_system.modules.shared.gui.pdf_export_gui import (
                show_pdf_export_gui,
            )
