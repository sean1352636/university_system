...
class TestPDFExportManager:
    ...
    def export_manager(self, temp_db, temp_output_dir):
        ...
        from education_system.post_18.university_system.modules.shared.services.pdf_export.export_manager import (
            PDFExportManager,
        )
...
class TestExportDatabaseToPDF:
    ...
    def test_export_database_to_pdf_function(self, temp_db):
        ...
        with patch(
            "education_system.post_18.university_system.modules.shared.services.pdf_export.export_manager.paths"
        ) as mock_paths:
