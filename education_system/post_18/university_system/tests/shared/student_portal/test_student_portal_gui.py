...
class TestStudentPortalGUIBackend:
    ...
    def test_get_backend_gui_creates_backend_with_correct_attributes(self, mock_auth, mock_tk):
        ...
        with patch(
            'education_system.post_18.university_system.modules.shared.gui.main.student_portal.'
...
class TestStudentPortalGUIDashboard:
    ...
    def test_show_dashboard_calls_create_student_dashboard(self, mock_auth, mock_tk):
        ...
        with patch(
            'education_system.post_18.university_system.modules.shared.gui.main.dashboard.'
            'student_dashboard.create_student_dashboard'
        ) as mock_create_dash, patch(
            'education_system.post_18.university_system.modules.shared.services.dashboard.'
...
class TestStudentPortalGUILogout:
    """Tests for _return_to_login."""

    def test_logout_calls_auth_logout(self, mock_auth, mock_tk):
        """_return_to_login should call auth.logout() and destroy the root window."""
        from education_system.post_18.university_system.modules.shared.gui.main.student_portal import StudentPortalGUI
...
class TestInitGUIRouting:
    ...
    @patch('education_system.post_18.university_system.modules.shared.gui.main.main_gui.safe_auth_check')
    @patch('education_system.post_18.university_system.modules.shared.gui.main.main_gui.get_auth')
    @patch('education_system.post_18.university_system.modules.shared.gui.main.main_gui.UserAuth')
    def test_init_gui_routes_student_to_student_portal(self, mock_user_auth_cls,
        ...
        import education_system.post_18.university_system.modules.shared.gui.main.main_gui as main_gui_mod
        original_auth = main_gui_mod.auth

        with patch(
            'education_system.post_18.university_system.modules.shared.gui.main.student_portal.StudentPortalGUI'
        ) as mock_portal_cls:
    ...
    @patch('education_system.post_18.university_system.modules.shared.gui.main.main_gui.get_auth')
    @patch('education_system.post_18.university_system.modules.shared.gui.main.main_gui.UserAuth')
    @patch('education_system.post_18.university_system.modules.shared.gui.main.main_gui.UnifiedManagementGUI')
