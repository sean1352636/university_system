...
def activity_logger_instance(temp_log_dir):
    ...
    with patch('education_system.post_18.university_system.core.activity_logger.ActivityLogger._instance', None):
        with patch('education_system.post_18.university_system.core.activity_logger.ActivityLogger._get_log_directory') as mock_get_dir:
...
class TestActivityLoggerInitialization:
    ...
    def test_log_directory_created(self, temp_log_dir):
        ...
        with patch('education_system.post_18.university_system.core.activity_logger.ActivityLogger._instance', None):
            with patch('education_system.post_18.university_system.core.paths.LOG_DIR', new_log_dir):
                logger_instance = ActivityLogger()
...
class TestLogFormatting:
    ...
    @patch('education_system.post_18.university_system.core.activity_logger.ActivityLogger.logger')
