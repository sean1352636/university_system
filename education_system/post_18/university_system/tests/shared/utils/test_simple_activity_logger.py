...
class TestEnhancedActivityLogger:
    ...
    def test_logger_initialization_with_config(self, logger_config, temp_log_dir):
        ...
        with patch('education_system.post_18.university_system.core.paths.LOG_DIR', temp_log_dir):
...
class TestHelperFunctions:
    ...
    @patch('education_system.post_18.university_system.modules.shared.utils.simple_activity_logger.get_logger_instance')
    ...
    @patch('education_system.post_18.university_system.modules.shared.utils.simple_activity_logger.enhanced_log_activity')
    ...
    @patch('education_system.post_18.university_system.modules.shared.utils.simple_activity_logger.logger')
    ...
    def test_load_logger_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('education_system.post_18.university_system.core.paths.LOG_DIR', tmpdir):
...
class TestIntegration:
    ...
    def test_full_logging_workflow(self, temp_dir):
        ...
        with patch('education_system.post_18.university_system.core.paths.LOG_DIR', temp_dir):
            logger = EnhancedActivityLogger(config_path)
