...
def doc_manager(temp_db, mock_auth):
    ...
    with patch('education_system.post_18.university_system.modules.shared.utils.document_manager.get_connection') as mock_conn, \
         patch('education_system.post_18.university_system.modules.shared.utils.document_manager.get_current_user') as mock_user, \
         patch('education_system.post_18.university_system.modules.shared.utils.document_manager.set_auth_instance'):

        # Mock database connection
        mock_conn.return_value = sqlite3.connect(temp_db)
        mock_user.return_value = mock_auth.current_user

        from education_system.post_18.university_system.modules.shared.utils.document_manager import DocumentManager
