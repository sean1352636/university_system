...
from education_system.post_18.university_system.modules.shared.utils import shared_db_utilities
...
class TestCoreImports:
    ...
    def test_sqlite3_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import sqlite3
        assert sqlite3 is not None

    def test_database_manager_import(self):
        """Test that DatabaseManager is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import DatabaseManager
        assert DatabaseManager is not None

    def test_get_connection_import(self):
        """Test that get_connection is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import get_connection
        assert callable(get_connection)

    def test_get_db_connection_import(self):
        """Test that get_db_connection is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import get_db_connection
...
class TestPathConstants:
    ...
    def test_default_db_path_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import DEFAULT_DB_PATH
    ...
    def test_db_dir_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import DB_DIR
        assert DB_DIR is not None

    def test_exports_dir_import(self):
        """Test that EXPORTS_DIR is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import EXPORTS_DIR
...
class TestEmailDatabaseUtilities:
    ...
    def test_get_unified_connection_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import get_unified_connection
        assert callable(get_unified_connection)

    def test_simple_db_manager_import(self):
        """Test that SimpleDBManager is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import SimpleDBManager
        assert SimpleDBManager is not None

    def test_get_db_manager_import(self):
        """Test that get_db_manager is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import get_db_manager
        assert callable(get_db_manager)

    def test_execute_db_operation_import(self):
        """Test that execute_db_operation is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import execute_db_operation
        assert callable(execute_db_operation)

    def test_safe_db_operation_import(self):
        """Test that safe_db_operation is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import safe_db_operation
        assert callable(safe_db_operation)

    def test_initialize_email_db_import(self):
        """Test that initialize_email_db is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import initialize_email_db
    ...
    def test_migrate_email_log_table_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import migrate_email_log_table
    ...
    def test_schedule_database_maintenance_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import schedule_database_maintenance
    ...
    def test_optimize_database_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import optimize_database
        assert callable(optimize_database)

    def test_ensure_db_directory_import(self):
        """Test that ensure_db_directory is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import ensure_db_directory
        assert callable(ensure_db_directory)

    def test_ensure_parent_dir_import(self):
        """Test that ensure_parent_dir is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import ensure_parent_dir
...
class TestBackwardCompatibility:
    ...
    def test_db_ready_import(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import _DB_READY
        assert isinstance(_DB_READY, bool)

    def test_main_dir_import(self):
        """Test that MAIN_DIR is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import MAIN_DIR
        assert MAIN_DIR is not None

    def test_project_root_import(self):
        """Test that PROJECT_ROOT is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import PROJECT_ROOT
        assert PROJECT_ROOT is not None

    def test_db_path_import(self):
        """Test that DB_PATH is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import DB_PATH
        assert DB_PATH is not None

    def test_db_manager_import(self):
        """Test that _db_manager is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import _db_manager
        # Can be None initially

    def test_db_manager_lock_import(self):
        """Test that _db_manager_lock is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import _db_manager_lock
        assert _db_manager_lock is not None

    def test_ensure_db_ready_import(self):
        """Test that _ensure_db_ready is imported"""
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import _ensure_db_ready
...
class TestAuthDatabaseFlag:
    ...
    def test_use_auth_db_flag(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import USE_AUTH_DB
    ...
    def test_auth_get_connection_when_available(self):
        ...
        from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import (
            USE_AUTH_DB,
            auth_get_connection
        )
        if USE_AUTH_DB:
...
class TestIntegration:
    ...
    def test_can_import_all_from_module(self):
        ...
        namespace = {}
        exec("from education_system.post_18.university_system.modules.shared.utils.shared_db_utilities import *", namespace)
