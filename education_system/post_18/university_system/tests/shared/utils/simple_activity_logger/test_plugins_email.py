...
from education_system.post_18.university_system.modules.shared.utils.simple_activity_logger.plugins.email import (
...
class TestRateLimiting:
    def test_rate_limit_blocks_repeats(self, make_log_entry):
        ...
        with patch(
            "education_system.post_18.university_system.infrastructure.email.smtp.send_email_via_smtp",
            return_value=True,
        ) as send_mock:
...
class TestSendEmail:
    def test_sends_via_smtp_with_cc(self, make_log_entry):
        ...
        with patch(
            ...
            "education_system.post_18.university_system.infrastructure.email.template_utils.render_template",
