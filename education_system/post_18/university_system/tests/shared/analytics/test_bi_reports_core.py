...
class TestReportDefinitionManager:
    ...
    def test_create_report_success(self):
        ...
        with patch('education_system.post_18.university_system.modules.shared.services.business_intelligence.bi_reports_core.transaction', return_value=mock_conn):
