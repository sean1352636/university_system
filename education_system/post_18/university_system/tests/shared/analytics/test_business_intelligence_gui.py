...
from education_system.post_18.university_system.modules.shared.services.business_intelligence.business_intelligence_gui import (
...
_BI_MOD = 'education_system.post_18.university_system.modules.shared.services.business_intelligence.business_intelligence_gui'
...
class TestBusinessIntelligenceGUI:
    ...
    def test_init_database(self, root_window, mock_auth):
        ...
        with patch('education_system.post_18.university_system.infrastructure.database.schemas.analytics_bi_schemas.init_business_intelligence_system_db') as mock_init:
            with patch.object(BusinessIntelligenceGUI, '_create_widgets'):
                with patch(f'{_BI_MOD}.log_activity'):
                    gui = BusinessIntelligenceGUI(root_window, mock_auth)
