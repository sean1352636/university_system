...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer import reservation_system
...
class TestTableManagement:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system.get_db_connection')
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system.get_db_connection')
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system.backup_before_operation')
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system.log_audit_action')
...
class TestQRCodeManagement:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system.get_db_connection')
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system.QR_CODES_DIR')
    @patch('builtins.input')
    def test_generate_qr_codes_for_all_tables(self, mock_input, mock_qr_dir,
        ...
        with patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system.QR_CODES_DIR', tmp_path / "qr_codes"):
