...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import inventory_management
...
class TestSupplierManagement:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.inventory_management.get_db_connection')
