...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import financial_reporting
...
class TestDailySalesReport:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.financial_reporting.get_db_connection')
...
class TestFinancialReportsMenu:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.financial_reporting.daily_sales_report')
