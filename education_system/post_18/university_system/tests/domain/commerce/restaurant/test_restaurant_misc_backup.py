...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import backup
...
class TestSystemBackup:
    ...
    def test_system_backup_database_only(self):
        ...
        with mock.patch('builtins.input', return_value='1'):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.backup_database') as mock_backup_db:
    ...
    def test_system_backup_full_system(self):
        ...
        with mock.patch('builtins.input', return_value='2'):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.backup_full_system') as mock_backup_full:
                with mock.patch('sys.stdout', new=StringIO()):
                    backup.system_backup()
    ...
    def test_system_backup_exception(self):
        ...
        with mock.patch('builtins.input', side_effect=Exception("Test error")):
            with mock.patch('sys.stdout', new=StringIO()) as fake_out:
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.logging.error') as mock_log:
                    backup.system_backup()
...
class TestBackupDatabase:
    ...
    def test_backup_database_success(self, temp_db_file, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.DATABASE_FILE', temp_db_file):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.ctx') as mock_ctx:
                mock_ctx.auth = mock_auth

                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.log_audit_action') as mock_log:
                    with mock.patch('sys.stdout', new=StringIO()) as fake_out:
    ...
    def test_backup_database_file_not_found(self):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.DATABASE_FILE', 'nonexistent.db'):
            with mock.patch('sys.stdout', new=StringIO()) as fake_out:
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.logging.error') as mock_log:
                    backup.backup_database()
    ...
    def test_backup_database_creates_unique_filename(self, temp_db_file, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.DATABASE_FILE', temp_db_file):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.ctx') as mock_ctx:
                ...
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.log_audit_action'):
                    with mock.patch('sys.stdout', new=StringIO()) as fake_out:
                        backup.backup_database()
...
class TestBackupFullSystem:
    ...
    def test_backup_full_system_success(self, temp_db_file, mock_auth):
        ...
        try:
            ...
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.DATABASE_FILE', temp_db_file):
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.get_log_file', return_value=log_file):
                    with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.backup.ctx') as mock_ctx:
                        mock_ctx.auth = mock_auth
