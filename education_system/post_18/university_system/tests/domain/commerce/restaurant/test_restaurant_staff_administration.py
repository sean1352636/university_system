...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff import staff_administration
...
class TestViewAllStaff:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff.staff_administration.get_db_connection')
...
class TestAddNewStaff:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff.staff_administration.log_audit_action')
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff.staff_administration.backup_before_operation')
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff.staff_administration.get_db_connection')
