...
class TestMain:
    ...
    def test_main_initialization_success(self, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.init_db', return_value=True):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.UserAuth', return_value=mock_auth):
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.set_auth') as mock_set_auth:
                    with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_auth_menu', return_value=False):
    ...
    def test_main_database_init_failure(self):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.init_db', return_value=False):
            with mock.patch('sys.stdout', new=StringIO()) as fake_out:
                cli.main()
    ...
    def test_main_login_then_display_menu(self, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.init_db', return_value=True):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.UserAuth', return_value=mock_auth):
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.set_auth'):
                    with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_auth_menu', side_effect=[True, False]) as mock_auth_menu:
                        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_main_menu', side_effect=Exception("Exit")):
    ...
    def test_main_creates_user_auth_with_database_file(self, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.init_db', return_value=True):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.UserAuth', return_value=mock_auth) as mock_user_auth:
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.set_auth'):
                    with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_auth_menu', return_value=False):
                        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.DATABASE_FILE', 'test.db'):
    ...
    def test_main_sets_auth_context(self, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.init_db', return_value=True):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.UserAuth', return_value=mock_auth):
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.set_auth') as mock_set_auth:
                    with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_auth_menu', return_value=False):
                        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.ctx') as mock_ctx:
                            with mock.patch('sys.stdout', new=StringIO()):
                                cli.main()
    ...
    def test_main_infinite_loop_until_exit(self, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.init_db', return_value=True):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.UserAuth', return_value=mock_auth):
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.set_auth'):
                    with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_auth_menu', side_effect=side_effect):
                        with mock.patch('sys.stdout', new=StringIO()):
                            cli.main()
    ...
    def test_main_switches_between_auth_and_main_menu(self, mock_auth):
        ...
        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.init_db', return_value=True):
            with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.UserAuth', return_value=mock_auth):
                with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.set_auth'):
                    with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_auth_menu', side_effect=auth_menu_side_effect):
                        with mock.patch('education_system.post_18.university_system.modules.core.services.restaurant_misc.cli.display_main_menu', side_effect=main_menu_side_effect):
                            with mock.patch('sys.stdout', new=StringIO()):
                                try:
                                    cli.main()
                                except Exception:
