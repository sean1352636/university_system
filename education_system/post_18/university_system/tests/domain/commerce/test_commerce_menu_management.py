...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu import menu_management
...
class TestMenuItemCreation:
    ...
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management.get_db_connection')
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management.backup_before_operation')
    @patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management.log_audit_action')
...
class TestOrderAnalytics:
    ...
    def test_feedback_analytics(self, mock_input, mock_get_conn,
        ...
        # Execute
        with patch('education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management.feedback_analytics') as mock_feedback:
