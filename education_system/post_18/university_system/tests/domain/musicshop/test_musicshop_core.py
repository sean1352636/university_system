...
from education_system.post_18.university_system.modules.domain.commerce.musicshop.services.musicshop_core import (
    ProductManager, OrderManager, TransactionManager, WishlistManager,
    ReportManager, init_musicshop_db,
)

PATCH_TARGET = 'education_system.post_18.university_system.modules.domain.commerce.musicshop.services.musicshop_core.get_musicshop_db_path'
