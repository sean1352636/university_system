...
from education_system.post_18.university_system.modules.domain.health.gui.health_portal import (
    HealthPortalGUI,
...
class TestHealthPortalGUIInit:
    ...
    @patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.main.messagebox')
    def test_gui_init_with_auth(self, mock_messagebox, root_window, mock_auth):
        """Test GUI initialization with authenticated user"""
        with patch('education_system.post_18.university_system.infrastructure.shared_context.get_auth', return_value=mock_auth):
    ...
    @patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.main.messagebox')
    @patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.main.get_auth')
    ...
    def test_encryption_key_generation(self, root_window, mock_auth):
        ...
        with patch('education_system.post_18.university_system.infrastructure.shared_context.get_auth', return_value=mock_auth):
            with patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.main.messagebox'):
                gui = HealthPortalGUI(root_window, auth_system=mock_auth)
...
class TestDatabaseOperations:
    ...
    def test_database_initialization(self, mock_messagebox, mock_get_auth, root_window, mock_auth, temp_db_path):
        ...
        with patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.auth_encryption.paths.DEFAULT_DB_PATH', temp_db_path), \
             patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.database.paths.DEFAULT_DB_PATH', temp_db_path), \
             patch('education_system.post_18.university_system.infrastructure.database.db.DEFAULT_DB_PATH', temp_db_path):
            gui = HealthPortalGUI(root_window, auth_system=mock_auth)
...
class TestLaunchFunction:
    ...
    @patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.main.tk.Tk')
    @patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.main.HealthPortalGUI')
...
class TestSecurityFeatures:
    ...
    def test_encryption_key_persistence(self, mock_messagebox, mock_get_auth, root_window, mock_auth):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('education_system.post_18.university_system.modules.domain.health.gui.health_portal.auth_encryption.paths.DATA_DIR', Path(temp_dir)):
