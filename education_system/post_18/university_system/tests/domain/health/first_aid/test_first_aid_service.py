...
from education_system.post_18.university_system.modules.domain.academics.gui import (
...
from education_system.post_18.university_system.modules.domain.health.first_aid import (
    first_aid_service as mod,
)
from education_system.post_18.university_system.modules.domain.health.first_aid.first_aid_service import (
    EMERGENCY_CONTACTS,
    IncidentDB,
)
