...
from education_system.post_18.university_system.modules.domain.health.records import quality_assurance
...
class TestErrorHandling:
    ...
    def test_database_connection_error(self, mock_print, mock_input, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.health.records.quality_assurance.get_connection', side_effect=Exception("Connection error")):
            # Should handle gracefully
            try:
                quality_assurance.data_quality_metrics(mock_auth)
            except Exception:
