...
from education_system.post_18.university_system.modules.domain.health.records import data_purge
...
class TestUpdateRetentionPolicy:
    ...
    @patch('education_system.post_18.university_system.modules.domain.health.records.data_purge.backup_before_operation')
...
class TestPurgeExpiredData:
    ...
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.health.records.data_purge.create_sqlite_backup')
