...
from education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui import (
    VirtualClassroomGUI,
...
class TestVirtualClassroomGUIInitialization:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.messagebox')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.VirtualClassroomManager')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.SessionManager')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.ParticipantManager')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.RecordingManager')
...
class TestParticipantManagement:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.ParticipantManager')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.filedialog')
...
class TestLauncherFunction:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.virtual_classroom_gui.VirtualClassroomGUI')
