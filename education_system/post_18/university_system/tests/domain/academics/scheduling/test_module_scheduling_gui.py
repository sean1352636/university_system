...
def _patch_gui_init():
    ...
    gui_path = 'education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.main_gui.ModuleSchedulingGUI'
...
class TestModuleSchedulingGUIInitialization:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.main_gui.ModuleScheduler')
    def test_initialization(self, mock_scheduler_class, mock_root):
        """Test initialization of ModuleSchedulingGUI"""
        from education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling import ModuleSchedulingGUI
...
class TestExportFunctionality:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.main_gui.ModuleScheduler')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.main_gui.filedialog')
...
class TestDatabaseMigration:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.main_gui.ModuleScheduler')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.main_gui.get_connection')
