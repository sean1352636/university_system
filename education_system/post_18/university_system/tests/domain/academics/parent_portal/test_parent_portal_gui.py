...
class TestParentPortalGUIInitialization:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.parent_portal.base.ParentPortal')
...
class TestReportsDownload:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.parent_portal.base.ParentPortal')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.parent_portal.base.filedialog')
