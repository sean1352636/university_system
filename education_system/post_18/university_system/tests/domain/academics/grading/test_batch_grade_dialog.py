...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.batch_grade_dialog import (
...
class TestBatchGradeDialog:
    ...
    def test_load_students_with_existing_grades(self, root_window, mock_connection):
        ...
        assert values[2] == '85.0'  # Current score (Treeview stores values as strings)
