...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.module_dialog import (
    ModuleDialog
)
...
class TestModuleDialog:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.module_dialog.messagebox')
    ...
    def test_credits_range_validation(self, root):
        ...
        # save_module() destroys the dialog, so recreate it each iteration.
