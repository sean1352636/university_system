...
class TestModuleManager(unittest.TestCase):
    ...
    def test_refresh_modules(self):
        ...
        # refresh_modules() loads via the module-level get_connection(), so point
        # it at the test's temp database that holds the seeded module row.
        with patch(
            'education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.module_manager.get_connection',
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.module_manager.get_connection')
