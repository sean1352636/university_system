...
class TestManageCompetencyLevels:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.get_connection')
...
class TestViewStudentCompetencyProfile:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.select_student')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.plt')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.os.makedirs')
...
class TestGenerateCompetencyReport:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.select_student')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.generate_student_competency_report')
...
class TestGenerateStudentCompetencyReport:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.SimpleDocTemplate')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.plt')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.os.makedirs')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.os.path.exists')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.os.remove')
    @patch('builtins.print')
...
class TestAssessStudentRisk:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment.calculate_student_gpa')
