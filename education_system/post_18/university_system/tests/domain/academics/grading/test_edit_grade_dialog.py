...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_grade_dialog import (
    EditGradeDialog,
    GRADE_SYSTEMS,
...
class TestEditGradeDialog:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_grade_dialog.get_connection')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_grade_dialog.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_grade_dialog.messagebox')
    ...
    def test_ui_components_exist(self, mock_get_conn, root, mock_connection):
        ...
        # Check grade combo has correct values (ttk returns a tuple)
        expected_grades = list(GRADE_SYSTEMS["letter"].keys())
        assert list(dialog.grade_combo['values']) == expected_grades

        dialog.dialog.destroy()

    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_grade_dialog.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_grade_dialog.messagebox')
    def test_boundary_score_values(self, mock_msgbox, mock_get_conn, root, mock_connection):
        ...
        # update_grade() destroys the dialog on success; keep the widgets alive
        # so both boundary values can be exercised on the same dialog.
