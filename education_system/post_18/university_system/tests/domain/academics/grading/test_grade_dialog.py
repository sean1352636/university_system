...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.grade_dialog import (
    GradeDialog,
    GRADE_SYSTEMS
)
...
class TestGradeDialog:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.grade_dialog.messagebox')
