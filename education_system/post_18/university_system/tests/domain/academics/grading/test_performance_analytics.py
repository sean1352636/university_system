...
def test_db(tmp_path):
    ...
    with patch('education_system.post_18.university_system.infrastructure.database.db.get_connection', mock_get_connection):
        with patch('education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics.get_connection', mock_get_connection):
...
class TestCalculateCourseStatistics:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics.calculate_student_gpa')
...
class TestGeneratePerformanceDashboard:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics.display_performance_dashboard')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics.generate_dashboard_report', create=True)
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics.create_dashboard_visualizations', create=True)
    @patch('builtins.print')
...
class TestDisplayModulePerformanceResults:
    ...
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics.letter_to_gpa')
