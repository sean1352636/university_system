...
class TestInitEnhancedGradesDb:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.get_connection')
...
class TestDisplayEnhancedGradeMenu:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.init_basic_database')
    ...
    def test_display_enhanced_grade_menu_exit(self, mock_print, mock_input, mock_init):
        ...
        with patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.init_enhanced_grades_db'):
            display_enhanced_grade_menu()
    ...
    def test_display_enhanced_grade_menu_record_grades(
        ...
        with patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.init_enhanced_grades_db'):
            with patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.record_assessment_grades'):
                display_enhanced_grade_menu()
...
class TestCreateTrendVisualization:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.plt')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.os.makedirs')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.os.path.exists')
    @patch('builtins.print')
