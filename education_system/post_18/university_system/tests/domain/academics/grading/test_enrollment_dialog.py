...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.enrollment_dialog import (
...
class TestModuleEnrollmentDialog:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.enrollment_dialog.messagebox')
    def test_refresh_enrollments_database_error(self, mock_msgbox, root, mock_connection):
        ...
        # The dialog refreshes once during __init__; build it cleanly, then
        # force the error for the explicit refresh under test.
        dialog = ModuleEnrollmentDialog(root, mock_cursor, mock_conn)
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.enrollment_dialog.safe_grab_set')
    ...
    def test_remove_enrollment_database_error(self, mock_msgbox, root, mock_connection):
        ...
        # Make the DELETE fail (remove_enrollment issues a single execute).
