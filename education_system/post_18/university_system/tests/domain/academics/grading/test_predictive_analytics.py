...
def test_db(tmp_path):
    ...
    with patch('education_system.post_18.university_system.infrastructure.database.db.get_connection', mock_get_connection):
        with patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.get_connection', mock_get_connection):
...
class TestIdentifyAtRiskStudents:
    ...
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.calculate_student_gpa')
...
class TestDropoutRiskAnalysis:
    ...
    @patch('builtins.input', side_effect=['n'])  # Don't export
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.calculate_dropout_risk_score')
...
class TestInterventionGeneration:
    ...
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.generate_dropout_intervention_plan')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.calculate_dropout_risk_score')
...
class TestRiskReporting:
    ...
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.collect_comprehensive_risk_data')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.assess_comprehensive_student_risk', create=True)
    ...
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.SimpleDocTemplate')
...
class TestPredictionModels:
    ...
    @patch('builtins.print')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.extract_comprehensive_student_features', create=True)
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics.calculate_student_gpa')
