...
def test_db(tmp_path):
    ...
    with patch('education_system.post_18.university_system.infrastructure.database.db.get_connection', mock_get_connection):
        with patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_tracking.get_connection', mock_get_connection):
...
class TestErrorHandling:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_tracking.get_connection')
    @patch('builtins.print')
