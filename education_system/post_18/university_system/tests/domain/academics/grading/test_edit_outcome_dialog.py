...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_outcome_dialog import (
...
class TestEditLearningOutcomeDialog:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_outcome_dialog.get_connection')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_outcome_dialog.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.edit_outcome_dialog.messagebox')
    ...
    def test_update_outcome_database_error(self, mock_msgbox, mock_get_conn, root, mock_connection):
        ...
        # Make the UPDATE fail (update_outcome issues a single execute).
