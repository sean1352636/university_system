...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.update_grades_dialog import (
    UpdateGradesDialog,
    safe_grab_set
)
...
class TestUpdateGradesDialog(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.update_grades_dialog.get_connection')
