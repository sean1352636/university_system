...
class TestStudentProgressTracking:
    ...
    def test_student_progress_tracking_no_grades(self, setup_progress_data, capsys):
        ...
        try:
            with mock.patch('education_system.post_18.university_system.modules.domain.academics.grading.progress.select_student', return_value='PROG999'):
    ...
    def test_student_progress_tracking_db_error(self, capsys):
        ...
        with mock.patch('education_system.post_18.university_system.modules.domain.academics.grading.progress.get_connection') as mock_conn:
...
class TestCalculateStudentSuccessProbability:
    ...
    def test_calculate_student_success_probability(self, setup_progress_data):
        ...
        with get_connection() as conn:
            ...
            with mock.patch('education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.calculate_student_gpa', return_value=(3.5, 1, [('PROG101', 'Test Module', 'A', 3.5)])):
