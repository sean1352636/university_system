...
class TestGradeTrackingApp(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        try:
            # Individual tests already destroy app.root (== self.root); tolerate
            # the resulting "application has been destroyed" here.
            self.root.destroy()
        except (OSError, IOError, tk.TclError):
            pass

    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.grade_tracking_app.get_connection')
