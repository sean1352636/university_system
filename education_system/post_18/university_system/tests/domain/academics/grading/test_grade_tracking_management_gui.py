...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking_management_gui import (
...
class TestGradeTrackingManagementGUIFallbacks(unittest.TestCase):
    ...
    def test_percentage_to_letter_function(self):
        ...
        from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking_management_gui import percentage_to_letter
    ...
    def test_letter_to_percentage_function(self):
        ...
        from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking_management_gui import letter_to_percentage
...
class TestGradeTrackingManagementGUIStructure(unittest.TestCase):
    ...
    def test_module_has_required_functions(self):
        ...
        import education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking_management_gui as mgmt_gui
