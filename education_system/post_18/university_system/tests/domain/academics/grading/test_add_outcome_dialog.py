...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.add_outcome_dialog import (
...
class TestAddLearningOutcomeDialog:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.dialogs.add_outcome_dialog.get_connection')
