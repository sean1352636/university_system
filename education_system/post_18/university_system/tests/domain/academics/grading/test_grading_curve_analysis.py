...
from education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis import (
    apply_grading_curve,
...
class TestApplyGradingCurve:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.select_assessment')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.select_assessment')
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.update_module_grade')
...
class TestPerformanceAnalysisMenu:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.identify_at_risk_students')
...
class TestComparativePerformanceAnalysis:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.compare_by_course')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.compare_by_gender')
...
class TestPerformanceTrendsAnalysis:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.analyze_overall_grade_trends')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.analyze_individual_student_trends')
...
class TestAnalyzeDistributionByCourse:
    ...
    def test_analyze_distribution_by_course_success(self, mock_print):
        ...
        with patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.letter_to_gpa', return_value=4.0):
...
class TestDropoutRiskAnalysis:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.identify_high_dropout_risk')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.analyze_dropout_risk_factors')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.build_dropout_prediction_model')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis.generate_dropout_interventions')
