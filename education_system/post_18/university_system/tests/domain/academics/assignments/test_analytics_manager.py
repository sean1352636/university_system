...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.analytics_manager import (
    AnalyticsManager
)

_RISK_MOD = 'education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.analytics_manager.risk'
_PERF_MOD = 'education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.analytics_manager.performance'
_RPT_MOD = 'education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.analytics_manager.reports'
...
class TestAnalyticsIntegration:
    ...
    def test_full_analytics_workflow(self, mock_risk_conn, mock_perf_conn, mock_app):
        ...
        conn.cursor.return_value = cursor
        mock_risk_conn.return_value.__enter__.return_value = conn
        mock_perf_conn.return_value.__enter__.return_value = conn
