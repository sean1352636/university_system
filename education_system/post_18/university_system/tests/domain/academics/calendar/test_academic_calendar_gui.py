...
# Import GUI module
try:
    from education_system.post_18.university_system.modules.domain.academics.gui.academic_calendar import (
        CalendarError,
        ValidationError,
        DatabaseError,
        AuthenticationError,
...
class TestCalendarGUIInitialization:
    ...
    @patch('tkinter.Tk')
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.academic_calendar.main_gui.CalendarGUI.__init__', return_value=None)
...
class TestModuleStructure:
    ...
    def test_module_has_calendar_gui_class(self):
        ...
        from education_system.post_18.university_system.modules.domain.academics.gui import academic_calendar as academic_calendar_gui
