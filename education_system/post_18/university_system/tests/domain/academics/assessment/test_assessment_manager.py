...
from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.assessment_manager import (
...
class TestAssessmentManager:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.assessment_manager.get_connection')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.assessment_manager.sqlite3')
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.assessment_manager.AssessmentAssignmentService')
    @patch('tkinter.messagebox.showinfo')
