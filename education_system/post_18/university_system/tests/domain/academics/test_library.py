...
from education_system.post_18.university_system.modules.domain.academics.services.library.models import (
...
from education_system.post_18.university_system.modules.domain.academics.services.library.settings import set_auth
from education_system.post_18.university_system.modules.domain.academics.services.library.barcode import generate_barcode
...
class TestLibraryDatabaseFunctions:
    ...
    def mock_db_path(self, temp_db, monkeypatch):
        ...
        from education_system.post_18.university_system.modules.domain.academics.services.library import database
...
class TestLibraryAuth:
    ...
    def test_set_auth(self):
        ...
        from education_system.post_18.university_system.modules.domain.academics.services.library import settings
...
class TestLibraryUtilityFunctions:
    ...
    @patch('education_system.post_18.university_system.modules.domain.academics.services.library.database.get_db_connection')
