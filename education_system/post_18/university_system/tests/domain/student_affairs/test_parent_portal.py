...
DB_PATH_TARGET = 'education_system.post_18.university_system.modules.domain.academics.services.parent_portal.database.DEFAULT_DB_PATH'
ACCOUNTS_DB_PATH_TARGET = 'education_system.post_18.university_system.modules.domain.academics.services.parent_portal.accounts.DEFAULT_DB_PATH'
