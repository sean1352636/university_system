...
from education_system.post_18.university_system.modules.domain.student_affairs.services.accessibility_tools import (
...
def mock_log_activity():
    ...
    with patch('education_system.post_18.university_system.modules.domain.student_affairs.services.accessibility_tools.log_activity'):
        yield
