...
class TestAccessibilityToolsGUI:
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.tk.Toplevel')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.log_activity')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.messagebox')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.tk.Toplevel')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.ttk')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.tk.Toplevel')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.get_connection')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.tk.Toplevel')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.transaction')
    def test_save_accessibility_settings_new(self, mock_transaction, mock_conn, mock_toplevel,
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.messagebox'):
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.AccessibilityToolsGUI')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.messagebox')
    ...
    def test_error_handling_load_profiles(self, mock_conn, mock_toplevel, mock_root, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.messagebox') as mock_msg:
            gui.load_profiles()
            # Should show error message
    ...
    def test_notebook_tabs_created(self, mock_toplevel, mock_root, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.accessibility_tools_gui.ttk') as mock_ttk:
            gui = AccessibilityToolsGUI(mock_root, mock_auth)
