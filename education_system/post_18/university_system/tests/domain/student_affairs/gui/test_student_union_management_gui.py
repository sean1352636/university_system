...
from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui import StudentUnionManagementGUI
...
class TestStudentUnionManagementGUI:
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.StudentUnionGUI')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.tk.Toplevel')
    def test_open_student_union_portal_gui_no_auth(self, mock_toplevel, mock_union_gui, mock_root):
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.messagebox') as mock_msg:
            gui.open_student_union_portal_gui()

            # Should show error
            mock_msg.showerror.assert_called_once()

    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.STUDENT_UNION_GUI_AVAILABLE', False)
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.STUDENT_UNION_GUI_AVAILABLE', True)
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.StudentUnionGUI')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.tk.Toplevel')
    def test_open_student_union_portal_gui_success(self, mock_toplevel, mock_union_gui, mock_root, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.DEFAULT_DB_PATH', '/path/to/db'):
            gui.open_student_union_portal_gui()
    ...
    def test_open_student_union_portal_gui_error_handling(self, mock_toplevel, mock_union_gui,
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.messagebox') as mock_msg, \
             patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.display_student_union_menu') as mock_cli:
    ...
    def test_auth_context_passed_to_union_gui(self, mock_root, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.STUDENT_UNION_GUI_AVAILABLE', True), \
             patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.StudentUnionGUI') as mock_union_gui, \
             patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_management_gui.tk.Toplevel'):
