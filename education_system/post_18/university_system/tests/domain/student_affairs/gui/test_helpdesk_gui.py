...
class TestHelpdeskGUI:
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.init_helpdesk_db')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.setup_enhanced_helpdesk_permissions')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.get_auth')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.setup_enhanced_helpdesk_permissions')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.get_auth')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.get_global_auth')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.messagebox')
    ...
    def test_setup_styles(self, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch.object(HelpdeskGUI, 'ensure_subject_column'), \
            ...
            with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.ttk.Style') as mock_style:
                gui = HelpdeskGUI(mock_root, mock_auth)
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.init_helpdesk_db')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.setup_enhanced_helpdesk_permissions')
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base._t', side_effect=lambda key, **kw: kw.get('default', key))
    def test_setup_main_window(self, mock_t, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch.object(HelpdeskGUI, 'ensure_subject_column'), \
             ...
             patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.ttk.Frame'):
    ...
    def test_activity_logging_integration(self, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base.log_activity') as mock_log:
            with patch.object(HelpdeskGUI, 'ensure_subject_column'), \
                 patch.object(HelpdeskGUI, 'setup_current_user'), \
                 patch.object(HelpdeskGUI, 'setup_styles'), \
                 patch.object(HelpdeskGUI, 'setup_main_window'), \
