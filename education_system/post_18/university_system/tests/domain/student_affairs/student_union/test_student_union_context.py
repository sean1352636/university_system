...
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.services import union_context


class TestHelperFunctions:
    """Tests for helper functions that delegate to other modules."""

    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.points.auto_award_points')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.support.manage_peer_support_system')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.support.manage_academic_support')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.sustainability.manage_green_initiatives')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.voting.manage_enhanced_voting')
...
class TestModuleDelegation:
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.analytics.learning_analytics_dashboard')
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.analytics.generate_advanced_analytics')
