...
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.elections import election_management
...
class TestNominateForElection:
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.elections.election_management.send_confirmation_email')
...
class TestElectionResults:
    ...
    def test_appoint_winner(self, mock_input, mock_cursor, mock_conn, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.elections.election_management.send_confirmation_email'):
            election_management.view_election_results(mock_cursor, mock_conn)
...
class TestElectionMenu:
    ...
    @patch('education_system.post_18.university_system.modules.domain.student_affairs.student_union.elections.election_management.get_connection')
