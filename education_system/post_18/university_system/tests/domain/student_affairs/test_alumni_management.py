...
class TestDatabaseSetup:
    ...
    def test_setup_alumni_permissions(self, setup_alumni_database):
        ...
        with patch(
            'education_system.post_18.university_system.modules.domain.student_affairs.services.alumni_management.core.get_db_connection',
...
class TestAlumniRegistration:
    ...
    def test_register_alumni_basic(self, setup_alumni_database, mock_auth):
        ...
        with patch('builtins.input', side_effect=[
            ...
            with patch('education_system.post_18.university_system.modules.domain.student_affairs.services.alumni_management.profiles.auth', mock_auth):
                from education_system.post_18.university_system.modules.domain.student_affairs.services.alumni_management import register_alumni
                register_alumni()
