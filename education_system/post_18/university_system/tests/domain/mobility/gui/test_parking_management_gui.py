...
class TestParkingManagementGUIBasic(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.transaction')
    def test_gui_can_be_imported(self, mock_transaction, mock_conn):
        """Test that GUI module can be imported"""
        try:
            from education_system.post_18.university_system.modules.domain.campus.mobility.gui import parking_management_gui
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.get_centralized_auth')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.transaction')
...
class TestParkingPermitsManagement(unittest.TestCase):
    ...
    def test_load_permits(self, mock_conn):
        ...
        try:
            ...
            with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.transaction'):
                with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.get_centralized_auth',
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.transaction')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.log_activity')
...
class TestReportsAndAnalytics(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.messagebox')
...
class TestDataExport(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.filedialog')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management_gui.get_connection')
