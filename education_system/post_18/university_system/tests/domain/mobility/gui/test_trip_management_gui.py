...
class TestTripManagementGUIBasic(unittest.TestCase):
    ...
    def test_gui_can_be_imported(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.campus.mobility.gui import trip_management_gui
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.get_centralized_auth')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.transaction')
...
class TestTripCreation(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.transaction')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.log_activity')
    def test_create_trip(self, mock_log, mock_transaction):
        ...
        try:
            ...
            with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.get_centralized_auth',
...
class TestTripListing(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.get_connection')
    def test_load_trips(self, mock_conn):
        ...
        try:
            ...
            with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.transaction'):
                with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.get_centralized_auth',
                          return_value=self.mock_auth):
                    app = TripManagementGUI(self.root, self.mock_auth)
...
class TestTripReports(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.messagebox')
