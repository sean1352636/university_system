...
class TestMobileAppPWAGUI(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.get_centralized_auth')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.transaction')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.get_connection')
    def test_gui_initialization(self, mock_conn, mock_transaction, mock_auth):
        """Test GUI initialization"""
        from education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui import MobileAppPWAGUI
    ...
    def test_database_initialization(self, mock_transaction, mock_conn):
        ...
        with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.get_centralized_auth',
    ...
    def test_load_devices(self, mock_conn):
        ...
        with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.get_centralized_auth',
                   return_value=self.mock_auth):
            with patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.transaction'):
                try:
                    app = MobileAppPWAGUI(self.root, self.mock_auth)
    ...
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.transaction')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.log_activity')
    @patch('education_system.post_18.university_system.modules.domain.campus.mobility.gui.mobile_app_pwa_gui.messagebox')
    ...
    def test_launch_function(self):
        ...
        from education_system.post_18.university_system.modules.domain.campus.mobility.gui import mobile_app_pwa_gui
