...
from education_system.post_18.university_system.modules.domain.finance.core import students
...
class TestAddStudentCredit:
    ...
    def test_add_student_credit_creates_credit(self, test_db_connection, sample_student, monkeypatch, capsys):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.students.get_current_user') as mock_user:
...
class TestAPIFinancialSummary:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.core.security_automation.verify_jwt_in_request')
