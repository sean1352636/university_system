...
from education_system.post_18.university_system.modules.domain.finance.core import aid
...
class TestAidApplicationApproval:
    ...
    def test_approve_full_amount(self, sample_data):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.aid.get_connection') as mock_conn, \
             patch('builtins.input', side_effect=['1', '1']), \
             patch('education_system.post_18.university_system.modules.domain.finance.core.aid.get_current_user', return_value={'username': 'admin'}), \
             patch('education_system.post_18.university_system.modules.domain.finance.core.aid.log_audit_action'):
...
class TestPaymentArrangement:
    ...
    def test_create_payment_arrangement(self, sample_data):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.aid.get_connection') as mock_conn, \
             ...
             patch('education_system.post_18.university_system.modules.domain.finance.core.aid.student_exists', return_value=True), \
             patch('education_system.post_18.university_system.modules.domain.finance.core.aid.get_student_name', return_value='Jane Smith'), \
             patch('education_system.post_18.university_system.modules.domain.finance.core.aid.get_current_user', return_value={'username': 'admin'}), \
             patch('education_system.post_18.university_system.modules.domain.finance.core.aid.send_arrangement_confirmation'):
