...
class TestCreateBudgetPlan:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.get_auth')
