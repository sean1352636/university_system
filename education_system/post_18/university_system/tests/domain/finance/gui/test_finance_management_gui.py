...
from education_system.post_18.university_system.modules.domain.finance.gui.finance_management_gui import (
...
_MOD = 'education_system.post_18.university_system.modules.domain.finance.gui.finance_management_gui'
