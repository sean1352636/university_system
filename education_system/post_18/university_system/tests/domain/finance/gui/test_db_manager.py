...
DM_MODULE = 'education_system.post_18.university_system.modules.domain.finance.gui.finance.db_manager'
...
class TestDatabaseBackup:
    ...
    def test_backup_database_no_db_file(self, mock_msgbox, db_manager):
        ...
        with patch(f'{DM_MODULE}.os.path.exists', return_value=False), \
             patch('education_system.post_18.university_system.core.paths') as mock_paths:
...
class TestDatabaseStats:
    ...
    def test_show_database_stats(self, mock_os_path, mock_get_conn, mock_toplevel, db_manager):
        ...
        with patch('education_system.post_18.university_system.core.paths') as mock_paths:
            mock_paths.DEFAULT_DB_PATH = '/test/db.db'
