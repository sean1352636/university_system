...
class TestInvoiceGenerationDialog:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.invoice_manager.get_connection')
...
class TestInvoiceGeneration:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.invoice_manager.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.invoice_manager.filedialog')
...
class TestInvoiceSaving:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.invoice_manager.filedialog')
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.invoice_manager.messagebox')
