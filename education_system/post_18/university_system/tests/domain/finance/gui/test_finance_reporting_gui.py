...
try:
    from education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting import (
...
class TestFinancialManagementGUI(unittest.TestCase):
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting.main.tk.Tk')
...
class TestFinanceReportingGUIComponents(unittest.TestCase):
    ...
    def test_module_level_constants(self):
        ...
        from education_system.post_18.university_system.modules.domain.finance.gui import finance_reporting as frg
...
class TestFinanceReportingGUIAuthIntegration(unittest.TestCase):
    ...
    def test_auth_imports(self):
        ...
        from education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting import main as frg_main
