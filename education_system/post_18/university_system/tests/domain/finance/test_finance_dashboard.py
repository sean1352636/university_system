...
class TestDashboardRefresh:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.dashboard.get_connection')
...
class TestStatCardCreation:
    ...
    def test_create_stat_card(self, dashboard_manager):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.dashboard.tk.Frame'), \
             patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.dashboard.tk.Label'):
...
class TestQuickActions:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting.launch_financial_gui')
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.dashboard.messagebox')
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting.launch_financial_gui')
...
class TestUpdateQuickStats:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.dashboard.tk.Label')
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.dashboard.tk.Frame')
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.dashboard.get_connection')
