...
from education_system.post_18.university_system.modules.domain.finance.gui.finance import common_imports
...
class TestBudgetFunctions:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.gui.finance.common_imports.get_connection')
