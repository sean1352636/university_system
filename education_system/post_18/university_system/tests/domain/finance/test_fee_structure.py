...
from education_system.post_18.university_system.modules.domain.finance.billing import fee_structure
...
class TestLateFeeCalculations:
    ...
    def test_calculate_fixed_late_fees(self, sample_data, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.get_connection') as mock_conn, \
             patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.auth', mock_auth):
...
class TestLateFeeWaiver:
    ...
    def test_waive_single_late_fee(self, sample_data, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.get_connection') as mock_conn, \
             ...
             patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.student_exists', return_value=True), \
             patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.get_student_name', return_value='John Doe'), \
             patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.log_audit_action'):
...
class TestCurrencyConversionTool:
    ...
    def test_currency_conversion_tool_valid_input(self, sample_data):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.get_connection') as mock_conn, \
             ...
             patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.convert_currency', return_value=127.00):
...
class TestPermissions:
    ...
    def test_calculate_late_fees_without_permission(self, sample_data):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.billing.fee_structure.auth', mock_auth):
            fee_structure.calculate_late_fees()
