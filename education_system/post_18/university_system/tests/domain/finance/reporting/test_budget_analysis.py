...
from education_system.post_18.university_system.modules.domain.finance.reporting.budget_analysis import (
    manage_budgets,
    create_budget_plan,
    view_budget_plans,
    update_budget_plan,
...
class TestBudgetCreation:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.reporting.budget_analysis.get_connection')
    ...
    def test_create_budget_plan(self, mock_input, mock_get_conn):
        ...
        # Mock auth
        with patch('education_system.post_18.university_system.modules.domain.finance.reporting.budget_analysis.auth') as mock_auth:
