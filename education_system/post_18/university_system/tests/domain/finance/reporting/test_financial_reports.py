...
from education_system.post_18.university_system.modules.domain.finance.reporting.financial_reports import (
...
class TestAuthSetup:
    ...
    def test_set_auth(self):
        ...
        from education_system.post_18.university_system.modules.domain.finance.reporting.financial_reports._common import auth
...
class TestFinancialAlertSystem:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.reporting.financial_reports.get_connection')
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.reporting.financial_reports.alerts.get_connection')
