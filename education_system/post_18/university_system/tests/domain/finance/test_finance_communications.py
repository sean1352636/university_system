...
class TestEmailService:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.core.communications.send_email_notification')
    ...
    def test_email_service_default_email(self, mock_print, mock_input, mock_render):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.communications.send_email_notification') as mock_send:
            mock_send.return_value = True
            test_email_service()
...
class TestSMSService:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.core.communications.send_sms_notification')
    ...
    def test_sms_service_exception(self, mock_print, mock_input):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.communications.send_sms_notification') as mock_send:
...
class TestSendArrangementConfirmation:
    ...
    @patch('education_system.post_18.university_system.modules.domain.finance.core.communications.get_connection')
    @patch('education_system.post_18.university_system.modules.domain.finance.core.communications.send_email_notification')
    @patch('education_system.post_18.university_system.modules.domain.finance.core.communications.render_template')
    @patch('builtins.print')
