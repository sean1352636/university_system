...
from education_system.post_18.university_system.modules.domain.finance.core import financial_core
...
class TestDatabaseInitialization:
    ...
    def test_init_enhanced_finance_db(self, temp_db):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.financial_core.get_connection') as mock_conn:
...
class TestInitialization:
    ...
    def test_initialize_finance(self, temp_db):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.financial_core.get_connection') as mock_conn, \
             patch('education_system.post_18.university_system.modules.domain.finance.core.financial_core.get_auth') as mock_get_auth, \
             patch('education_system.post_18.university_system.modules.domain.finance.core.financial_core.init_enhanced_finance_db'), \
             patch('education_system.post_18.university_system.modules.domain.finance.core.financial_core.warn_if_table_empty'):
...
class TestFinanceMenu:
    ...
    def test_display_enhanced_finance_menu_exits(self, mock_auth):
        ...
        with patch('education_system.post_18.university_system.modules.domain.finance.core.financial_core.auth', mock_auth), \
