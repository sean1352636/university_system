...
MODULE = "education_system.post_18.university_system.modules.domain.commerce.phoneshop.services.phoneshop_core"
...
class TestReportManager:
    ...
    def test_get_top_selling_products(self, temp_db):
        ...
        with patch(f"{MODULE}.get_phoneshop_db_path", return_value=temp_db):
            from education_system.post_18.university_system.modules.domain.commerce.phoneshop.services.phoneshop_core import OrderManager, ReportManager
