...
from education_system.post_18.university_system.core import (
    # Exceptions
...
def _load_infrastructure():
    ...
    if not _infrastructure_loaded:
        from education_system.post_18.university_system import infrastructure
...
def _get_ml_exports():
    ...
    from education_system.post_18.university_system.infrastructure import ML_AVAILABLE
    if ML_AVAILABLE:
        from education_system.post_18.university_system.infrastructure.ml import (
