...
def update_file(filepath):
    ...
    try:
        ...
        if not filepath.exists():
            return False, get_text("scripts.update_auth.file_not_found", filepath=filepath)
        ...
        if 'from education_system.post_18.university_system.infrastructure.auth import get_current_user, set_auth_instance' in content:
            return True, get_text("scripts.update_auth.already_updated")
        ...
        if start_pos is None:
            ...
            if match:
                ...
                return False, get_text("scripts.update_auth.pattern_not_found")
        ...
        return True, get_text("scripts.update_auth.updated_successfully")
