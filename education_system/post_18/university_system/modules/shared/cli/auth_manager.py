...
from education_system.post_18.university_system.modules.shared.cli.imports import logging, sqlite3, hashlib, secrets, datetime, DB_PATH, logger, _t, log_activity, get_auth, UserAuth, get_global_auth, set_global_auth, set_auth_instance, defaults
...
try:
    from education_system.post_18.university_system.infrastructure.auth import set_auth_instance as _test_auth
    from education_system.post_18.university_system.infrastructure.auth import MFA_AVAILABLE
    HAS_AUTH = True
except ImportError:
    HAS_AUTH = False
    MFA_AVAILABLE = False
...
try:
    from education_system.post_18.university_system.infrastructure.security import session_management
...
try:
    from education_system.post_18.university_system.infrastructure.security import comprehensive_security
...
try:
    from education_system.post_18.university_system.infrastructure.security import data_encryption
...
try:
    from education_system.post_18.university_system.infrastructure.auth import email_otp_service
...
try:
    from education_system.post_18.university_system.infrastructure.auth import sms_provider
...
def _link_auth_to_student_union(auth):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs import student_union
