...
from education_system.post_18.university_system.core import defaults
...
# Assignment system
from education_system.post_18.university_system.modules.domain.academics.services.assignments.assignment_submission import (
...
try:
    from education_system.post_18.university_system.modules.services.cli.academic_misconduct_cli import academic_misconduct_menu
...
# Security Desk CLI
try:
    from education_system.post_18.university_system.modules.services.cli.security_desk_cli import security_desk_menu
...
# To-Do List CLI
try:
    from education_system.post_18.university_system.modules.services.cli.todo_cli import todo_menu
    TODO_AVAILABLE = True
except ImportError as e:
    todo_menu = None
...
try:
    from education_system.post_18.university_system.modules.services.cli.church_cli import church_menu
...
# Police Station CLI
try:
    from education_system.post_18.university_system.modules.services.cli.police_station_cli import police_station_menu
...
# Taxi Booking CLI
try:
    from education_system.post_18.university_system.modules.services.cli.taxi_booking_cli import taxi_booking_menu
...
# Train Station CLI
try:
    from education_system.post_18.university_system.modules.services.cli.train_station_cli import train_station_menu
...
# Legal Services CLI
try:
    from education_system.post_18.university_system.modules.services.cli.legal_services_cli import legal_services_menu
...
try:
    from education_system.post_18.university_system.modules.domain.operations.legal.information_rights.cli.information_rights_cli import (  # noqa: E501
...
# Car Rental CLI
try:
    from education_system.post_18.university_system.modules.services.cli.carrental_cli import carrental_menu
...
try:
    from education_system.post_18.university_system.modules.services.cli.equipment_rental_cli import equipment_rental_menu
...
# Phone Shop CLI
try:
    from education_system.post_18.university_system.modules.services.cli.phone_shop_cli import phone_shop_menu
...
# Music Shop CLI
try:
    from education_system.post_18.university_system.modules.services.cli.music_shop_cli import music_shop_menu
...
# Bar CLI
try:
    from education_system.post_18.university_system.modules.services.cli.bar_cli import bar_menu
    BAR_AVAILABLE = True
except ImportError as e:
    bar_menu = None
    BAR_AVAILABLE = False
...
# Betting Shop CLI
try:
    from education_system.post_18.university_system.modules.services.cli.betting_shop_cli import launch_betting_shop_cli
...
# Butcher Shop CLI
try:
    from education_system.post_18.university_system.modules.services.cli.butcher_cli import launch_butcher_cli
...
# Barber Shop CLI
try:
    from education_system.post_18.university_system.modules.services.cli.barber_cli import launch_barber_cli
...
# Nail Bar CLI
try:
    from education_system.post_18.university_system.modules.services.cli.nailbar_cli import launch_nailbar_cli
...
# Cinema CLI
try:
    from education_system.post_18.university_system.modules.services.cli.cinema_cli import launch_cinema_cli
...
try:
    from education_system.post_18.university_system.modules.services.cli.medical_accommodation_cli import launch_medical_accommodation_cli
...
# Mail/Post CLI
try:
    from education_system.post_18.university_system.modules.services.cli.mail_post_cli import mail_post_menu
...
# Gym CLI
try:
    from education_system.post_18.university_system.modules.services.cli.gym_cli import gym_menu
    GYM_AVAILABLE = True
except ImportError as e:
    gym_menu = None
    GYM_AVAILABLE = False
...
from education_system.post_18.university_system.infrastructure.shared_context import get_auth, set_auth
...
try:
    from education_system.post_18.university_system.infrastructure.security.security_dashboard_cli import display_security_dashboard_menu
...
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.clubs import club_management as su_club
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.events import event_management as su_event
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.facilities import facility_management as su_fac
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.administration import (
    admin_management as su_admin,
    finance_oversight as su_fin,
    student_union_core,
)
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.elections import election_management as su_elec

# Trip Management
from education_system.post_18.university_system.modules.domain.campus.mobility.services.trip_management import (
...
# Course Management
from education_system.post_18.university_system.modules.domain.academics.services.course_management import display_course_management_menu

# Log Management
from education_system.post_18.university_system.infrastructure.logging.log_management import display_log_management_menu

# Parent Portal
from education_system.post_18.university_system.modules.domain.academics.services.parent_portal import (
    ParentPortal,
...
# Takeaway System
try:
    from education_system.post_18.university_system.modules.domain.commerce.services.takeaway import (
        init_takeaway_db,
...
# Grocery Shop
try:
    from education_system.post_18.university_system.modules.domain.commerce.services.grocery import (
        init_grocery_db,
...
def get_predictive_analytics():
    ...
    try:
        from education_system.post_18.university_system.modules.shared.services.analytics.predictive_analytics_gui import PredictiveAnalyticsGUI
...
def get_business_intelligence():
    ...
    try:
        from education_system.post_18.university_system.modules.shared.services.business_intelligence import display_business_intelligence_menu
...
def get_enhanced_menu():
    ...
    try:
        from education_system.post_18.university_system.modules.shared.gui.advanced_search import display_enhanced_menu
