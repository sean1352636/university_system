...
try:
    from education_system.post_18.university_system.modules.domain.campus.mobility.services.trip_management.menu import display_trip_management_menu
except ImportError:
...
def add_communication_dashboard_to_main_menu(auth):
    ...
    try:
        from education_system.post_18.university_system.infrastructure.email.admin.menus import display_communication_dashboard
