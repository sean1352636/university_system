...
from education_system.post_18.university_system.modules.shared.cli.auth_manager import (
    initialize_security_modules, ensure_user_in_communication_system,
    ensure_default_users_exist_once
)

from education_system.post_18.university_system.modules.shared.cli.menu_router import display_menu

from education_system.post_18.university_system.modules.shared.cli.chatbot_integration import setup_chatbot_permissions

from education_system.post_18.university_system.modules.shared.cli.ai_tools_integration import (
...
from education_system.post_18.university_system.modules.shared.cli.utils import cleanup_connections
...
def main(user_info=None, role=None, shared_auth=None):
    ...
    try:
        if current_role == 'student':
            from education_system.post_18.university_system.modules.shared.cli.student_portal_cli import run_student_portal
            run_student_portal()
        elif current_role == 'staff':
            from education_system.post_18.university_system.modules.shared.cli.staff_portal_cli import run_staff_portal
            run_staff_portal()
        elif current_role == 'instructor':
            from education_system.post_18.university_system.modules.shared.cli.instructor_portal_cli import run_instructor_portal
            run_instructor_portal()
        elif current_role == 'parent':
            from education_system.post_18.university_system.modules.shared.cli.parent_portal_cli import run_parent_portal
            run_parent_portal()
        else:
            display_menu()
    finally:
