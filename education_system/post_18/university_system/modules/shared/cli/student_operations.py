...
from education_system.post_18.university_system.modules.shared.cli.auth_manager import ensure_user_in_communication_system
from education_system.post_18.university_system.modules.shared.cli.database_manager import DatabaseError, ValidationError, safe_db_operation_with_retry, enhanced_db_operation
...
from education_system.post_18.university_system.infrastructure.database.db import foreign_keys_off
    ...
    while True:
        ...
        if choice in options:
            ...
            if action == 'create_student':
                ...
                from education_system.post_18.university_system.modules.shared.cli.student_search import search_student_by_last_name
                search_student_by_last_name()
            elif action == 'search_id':
                from education_system.post_18.university_system.modules.shared.cli.student_search import search_student_by_student_id
                search_student_by_student_id()
            elif action == 'search_date':
                from education_system.post_18.university_system.modules.shared.cli.student_search import search_student_by_registration_date
