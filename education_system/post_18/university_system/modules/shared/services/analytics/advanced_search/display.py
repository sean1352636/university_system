...
from education_system.post_18.university_system.modules.shared.services.analytics.advanced_search.export import export_single_student
...
def display_search_results(results):
    ...
    while True:
        ...
        if choice == 'p' and current_page > 0:
            ...
            from education_system.post_18.university_system.modules.shared.services.analytics.advanced_search.bulk_ops import save_last_search_results
            save_last_search_results()
        elif choice == 'b':
            _bulk_actions_menu(results)
        elif choice == 's':
            from education_system.post_18.university_system.modules.shared.services.analytics.advanced_search.saved_searches import save_search_profile
            save_search_profile()
