...
from education_system.post_18.university_system.modules.shared.services.analytics.enhanced_reporting._compat import (
    pd, SimpleDocTemplate, Paragraph, Spacer, Image,
    getSampleStyleSheet, ParagraphStyle, colors, A4, inch,
)
from education_system.post_18.university_system.modules.shared.services.analytics.enhanced_reporting.config import CONFIG, AVAILABLE_SECTIONS, SystemConfig, logger
...
from education_system.post_18.university_system.modules.shared.services.analytics.enhanced_reporting.templates_db import get_template as _get_template
