...
from education_system.post_18.university_system.modules.shared.services.analytics.student_analytics.config import CONFIG, GUI_AVAILABLE
...
class StudentAnalyticsBase:
    ...
    def save_or_display_plot(self, plt_figure, plot_type, export_format='png'):
        ...
        if GUI_AVAILABLE:
            while True:
                choice = input("Would you like to (1) save, (2) display, or (3) both? Enter 1, 2, or 3: ")
