...
class StudentPortalGUI:
    ...
    def _open_helpdesk(self):
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.gui.helpdesk.base import (
                HelpdeskGUI,
            )
    ...
    def _open_internship_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.gui.internship_management.internship_gui import (
                InternshipGUI,
            )
    ...
    def _open_student_support(self):
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_support import (
                StudentSupportGUI,
            )
    ...
    def _show_dashboard(self):
        ...
        try:
            from education_system.post_18.university_system.modules.shared.gui.main.dashboard.student_dashboard import create_student_dashboard
