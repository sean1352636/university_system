...
class StaffPortalGUI:
    ...
    def _open_assignments_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.academics.gui.assignment_system.assignment_gui import (
    ...
    def _open_auto_grading_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.academics.gui.assignment_system.auto_grading_portal import (
    ...
    def _open_course_catalog(self):
        try:
            from education_system.post_18.university_system.modules.domain.academics.gui.course_catalog.course_catalog_gui import (
                CourseCatalogGUI,
            )
    ...
    def _open_library_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.academics.gui.library.base import (
                LibraryGUI,
            )
    ...
    def _open_health_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.health.gui.health_portal.main import (
                HealthPortalGUI,
            )
    ...
    def _open_student_union_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui import (
                StudentUnionGUI,
            )
    ...
    def _open_cafe_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.commerce.gui.cafe_system_gui import (
                CafeSystemGUI,
            )
    ...
    def _open_bar_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.commerce.gui.bar_gui import (
                BarGUI,
            )
    ...
    def _open_takeaway_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.commerce.gui.takeaway_gui import (
                TakeawayGUI,
            )
    ...
    def _open_cinema_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.commerce.cinema.gui.cinema_gui import (
                CinemaApp,
            )
    ...
    def _open_barber_portal(self):
        try:
            from education_system.post_18.university_system.modules.domain.commerce.barber.gui.barber_gui import (
                BarberGUI,
            )
    ...
    def _get_backend_gui(self):
        ...
        if not hasattr(self, '_backend_gui'):
            ...
            try:
                from education_system.post_18.university_system.modules.shared.gui.main import main_gui as _mg
