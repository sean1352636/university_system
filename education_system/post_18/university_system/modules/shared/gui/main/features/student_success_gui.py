...
def show_ai_study_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.ai_study.gui.ai_study_gui import AIStudyGUI
    except ImportError as e:
...
def show_budget_tracker_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.finance.budget.gui.budget_gui import BudgetTrackerGUI
...
def show_student_jobs_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.student_jobs.gui.jobs_gui import StudentJobsGUI
        from education_system.post_18.university_system.infrastructure.shared_context import get_auth
        auth = get_auth()
...
def show_study_matching_gui(self):
    ...
    (8.117.38)."""
    try:
        from education_system.post_18.university_system.modules.domain.academics.study_matching.gui.study_matching_gui import StudyMatchingGUI
...
def show_course_planning_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.course_planning_gui import CoursePlanningGUI
        from education_system.post_18.university_system.infrastructure.shared_context import get_auth
        auth = get_auth()
...
def show_lost_found_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.campus.lost_found.gui.lost_found_gui import LostFoundGUI
...
def show_wellness_hub_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.wellness.gui.wellness_gui import WellnessGUI
...
def show_accessibility_portal_gui(self):
    ...
    Toplevel otherwise — same pattern as Student Records (8.117.38)."""
    try:
        from education_system.post_18.university_system.modules.domain.campus.accessibility.gui.accessibility_gui import AccessibilityGUI
    except ImportError as e:
...
def show_events_discovery_gui(self):
    ...
    try:
        import tkinter as tk
        from education_system.post_18.university_system.modules.domain.student_affairs.events.gui.events_gui import EventsGUI
        # Create a new Toplevel window
        window = tk.Toplevel(self.root)
        _install_clean_close(window)
...
def show_social_matching_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.social_matching.gui.social_matching_gui import SocialMatchingGUI
...
def show_notifications_hub_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.operations.communications.notifications.gui.notifications_gui import NotificationsGUI
...
def show_feedback_system_gui(self):
    ...
    otherwise — same pattern as Student Records (8.117.38)."""
    try:
        from education_system.post_18.university_system.modules.domain.operations.communications.feedback.gui.feedback_gui import FeedbackGUI
    except ImportError as e:
...
def show_visa_compliance_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.international_compliance.gui.visa_compliance_gui import VisaComplianceGUI
...
def show_qa_dashboard_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.research.external_quality_assurance.gui.qa_dashboard_gui import QADashboardGUI
...
def show_study_room_booking_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.campus.study_rooms.gui.study_room_gui import StudyRoomBookingGUI
...
def show_printing_services_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.campus.printing.gui.printing_gui import PrintingServicesGUI
...
def show_todo_app_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.shared.gui.tools.todo_app_gui import TodoApp
        window = tk.Toplevel(self.root)
        _install_clean_close(window)
...
def show_student_app_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.student_app.gui.student_app_gui import StudentAppGUI
...
def show_enrolment_letters_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.student_app.documentation.gui.documentation_gui import DocumentationGUI
...
def show_achievement_badge_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.achievement_badges.gui.achievement_badge_gui import AchievementBadgeGUI
...
def show_study_recommendations_gui(self):
    ...
    otherwise — same pattern as Student Records (8.117.38)."""
    try:
        from education_system.post_18.university_system.modules.domain.academics.study_recommendations.gui.study_recommendation_gui import StudyRecommendationGUI
    except ImportError as e:
