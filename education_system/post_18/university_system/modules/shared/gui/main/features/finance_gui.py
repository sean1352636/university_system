...
def show_finance_management(self):
    ...
    if self.finance_gui:
        ...
        try:
            from education_system.post_18.university_system.modules.shared.cli.cli_main import display_finance_menu
            from education_system.post_18.university_system.modules.domain.finance.core.financial_core import set_finance_auth
            if self.auth:
                try:
