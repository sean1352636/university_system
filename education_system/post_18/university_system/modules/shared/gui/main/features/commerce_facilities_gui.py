...
def show_grocery_shop(self):
    ...
    if not hasattr(self, 'grocery_gui') or not self.grocery_gui:
        try:
            ...
            from education_system.post_18.university_system.modules.domain.commerce.gui.grocery_gui import GroceryManagementGUI
            if self.auth and self.auth.current_user and self.auth.current_user.get('role') in ['admin', 'staff']:
                ...
                from education_system.post_18.university_system.modules.domain.commerce.gui.grocery_gui import GroceryGUI
...
def show_medical_accommodations(self):
    ...
    try:
        ...
        from education_system.post_18.university_system.modules.domain.health.gui.medical_accommodation import AccommodationGUI, main as accommodation_main
        ...
        try:
            from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation import display_accommodation_menu
...
def show_campus_events_gui(self):
    ...
    if callable(opener):
        from education_system.post_18.university_system.modules.domain.campus.services.campus_events_gui import CampusEventsGUI
...
def show_gym_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import GYM_GUI_AVAILABLE, GymGUI
    try:
...
def show_dentist_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import DENTIST_GUI_AVAILABLE, DentistGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_butcher_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import BUTCHER_GUI_AVAILABLE, ButcherGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_barber_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import BARBER_GUI_AVAILABLE, BarberGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_nailbar_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import NAILBAR_GUI_AVAILABLE, NailBarGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_carrental_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import CARRENTAL_GUI_AVAILABLE, CarRentalGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_equipment_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import EQUIPMENT_GUI_AVAILABLE, EquipmentGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_phoneshop_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import PHONESHOP_GUI_AVAILABLE, PhoneShopGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_musicshop_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import MUSICSHOP_GUI_AVAILABLE, MusicShopGUI
    try:
        if not self.auth or not self.auth.current_user:
...
def show_taxi_booking_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import TAXI_BOOKING_GUI_AVAILABLE, TaxiBookingApp
    try:
        if not self.auth or not self.auth.current_user:
...
def show_train_station_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import TRAIN_STATION_GUI_AVAILABLE, TrainStationApp
    try:
        if not self.auth or not self.auth.current_user:
...
def show_cinema_gui(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.main.imports.gui_imports import CINEMA_GUI_AVAILABLE, CinemaApp, init_cinema_database
    try:
        if not self.auth or not self.auth.current_user:
