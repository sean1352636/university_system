...
import os
import logging
from education_system.post_18.university_system.core.i18n import get_text as _t, get_current_language
...
def logout_user(self):
    ...
    try:
        from education_system.post_18.university_system.infrastructure.auth.enhanced_auth import EnhancedAuth
...
def switch_to_cli(self):
    ...
    if messagebox.askyesno(_t("gui.switch_to_cli"), _t("gui.switch_to_cli_confirm")):
        try:
            ...
            try:
                from education_system.post_18.university_system.infrastructure.database.db import _connection_pool, _pool_lock
                with _pool_lock:
            ...
            try:
                from education_system.post_18.university_system.infrastructure.shared_context import set_auth as reset_shared_auth
...
def _reenable_mfa_with_confirmation(self, user_id, username, user_email, mfa_service, saved_methods):
    ...
    try:
        ...
        if email_to_notify:
            try:
                from education_system.post_18.university_system.infrastructure.auth.email_otp_service import SMTPEmailProvider
...
def _open_mfa_wizard(self, user_id, username):
    ...
    try:
        from education_system.post_18.university_system.modules.shared.gui.auth.mfa_gui import show_mfa_setup as mfa_setup_wizard
