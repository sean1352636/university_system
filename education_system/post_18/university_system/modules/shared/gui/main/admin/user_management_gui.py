...
from education_system.post_18.university_system.infrastructure.auth.core_utils.constants import ROLES
...
# Activity logging (guarded: usages below check ACTIVITY_LOGGER_AVAILABLE first)
try:
...
def _safe_entry_insert(entry, value):
    """Safely insert value into an Entry widget, coercing None to empty string."""
    try:
