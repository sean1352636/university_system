...
def create_admin_dashboard(parent_frame, auth, service):
    ...
    def _open_alert_config():
        try:
            from education_system.post_18.university_system.modules.shared.gui.admin.alert_config_gui import AlertConfigConsole
    ...
    def _open_dept_management():
        try:
            from education_system.post_18.university_system.modules.shared.gui.admin.department_management_gui import DepartmentManagementGUI
            root = parent_frame.winfo_toplevel()
    ...
    def _open_branding():
        try:
            from education_system.post_18.university_system.modules.shared.gui.admin.branding_config_gui import BrandingConfigGUI
            root = parent_frame.winfo_toplevel()
