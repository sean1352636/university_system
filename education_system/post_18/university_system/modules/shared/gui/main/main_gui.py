...
from education_system.post_18.university_system.infrastructure.auth import UserAuth, set_auth_instance
...
from education_system.post_18.university_system.infrastructure.logging.log_config import patch_messagebox_logging
...
def set_auth(auth_instance):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.operations.legal.disciplinary.fitness_to_practise._db_init import (  # noqa: E501
            ensure_ftp_schema,
        )
        ensure_ftp_schema()
    except Exception:
...
def init_gui(session_user=None):
    ...
    if role == 'student':
        from education_system.post_18.university_system.modules.shared.gui.main.student_portal import StudentPortalGUI
        app = StudentPortalGUI(auth)
    elif role == 'staff':
        from education_system.post_18.university_system.modules.shared.gui.main.staff_portal import StaffPortalGUI
        app = StaffPortalGUI(auth)
    elif role in ('instructor', 'teacher'):
        from education_system.post_18.university_system.modules.shared.gui.main.instructor_portal import InstructorPortalGUI
        app = InstructorPortalGUI(auth)
    elif role == 'parent':
        from education_system.post_18.university_system.modules.shared.gui.main.parent_portal_wrapper import ParentPortalWrapper
        app = ParentPortalWrapper(auth)
    elif role == 'alumni':
        from education_system.post_18.university_system.modules.shared.gui.main.alumni_portal_wrapper import AlumniPortalWrapper
...
from education_system.post_18.university_system.modules.shared.gui.main.core.gui_setup import (
...
from education_system.post_18.university_system.modules.shared.gui.main.auth_gui import (
    logout_user,
    toggle_login_logout,
...
from education_system.post_18.university_system.modules.shared.gui.main.students.student_records_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.students.student_crud_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.students.student_export_gui import (
    export_student_data,
...
from education_system.post_18.university_system.modules.shared.gui.main.staff.staff_crud_gui import (
    create_staff_dialog,
    update_staff_dialog,
    view_staff,
    delete_staff_dialog,
...
from education_system.post_18.university_system.modules.shared.gui.main.admin.user_management_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.admin.system_admin_gui import (
    show_system_admin,
...
from education_system.post_18.university_system.modules.shared.gui.main.admin.database_admin_gui import (
    show_backup,
...
from education_system.post_18.university_system.modules.shared.gui.main.admin.config_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.admin.admin_tools_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.features.academic_launchers_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.features.student_affairs_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.features.finance_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.features.commerce_facilities_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.features.student_success_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.email.email_helpers_gui import (
    compose_email,
...
from education_system.post_18.university_system.modules.shared.gui.main.dashboard.dashboard_gui import (
...
def show_analytics_dashboard_gui(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.research.external_quality_assurance.gui.qa_widgets import EQAStatusStrip
    ...
    frame.pack(fill='both', expand=True)
    try:
        from education_system.post_18.university_system.modules.domain.academics.research.external_quality_assurance.gui.qa_receivers import consume_eqa_context
...
def show_information_rights_gui(self):
    ...
    drill-throughs work."""
    try:
        from education_system.post_18.university_system.modules.domain.operations.legal.information_rights.gui.information_rights_gui import (
...
def show_fitness_to_practise_gui(self):
    ...
    handler)."""
    try:
        from education_system.post_18.university_system.modules.domain.operations.legal.disciplinary.fitness_to_practise.gui.ftp_portal_gui import (
...
from education_system.post_18.university_system.modules.shared.gui.main.features.academic_link_bar import (  # noqa: E402
...
_NEW_FEATURE_MODULES = [
    ...
    ("complaints_portal", "Complaints Portal",
     "education_system.post_18.university_system.modules.domain.operations.communications.feedback.complaints_portal"),
    ("course_evaluation_system", "Course Evaluation",
     "education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.course_evaluation_system"),
    ("lecturer_evaluation", "Lecturer Evaluation",
     "education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.lecturer_evaluation"),
    ("module_evaluation_portal", "Module Evaluation",
     "education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.module_evaluation_portal"),
    ("disciplinary_portal", "Disciplinary Portal",
     "education_system.post_18.university_system.modules.domain.operations.legal.disciplinary.disciplinary_portal"),
    ("fitness_to_practise", "Fitness to Practise",
     "education_system.post_18.university_system.modules.domain.operations.legal.disciplinary.fitness_to_practise.fitness_to_practise"),
    ("risk_management", "Risk Management",
     "education_system.post_18.university_system.modules.domain.operations.legal.risk_management.university_risk_management"),
    ("information_rights", "SAR / FOI Requests",
     "education_system.post_18.university_system.modules.domain.operations.legal.information_rights.gui.information_rights_gui"),
    ("first_aid_portal", "First Aid Portal",
     "education_system.post_18.university_system.modules.domain.health.first_aid.first_aid_portal"),
    ("health_safety_portal", "Health & Safety",
     "education_system.post_18.university_system.modules.domain.health.health_safety.health_safety_portal"),
    ("intervention_support", "Intervention Support",
     "education_system.post_18.university_system.modules.domain.student_affairs.student_wellbeing.intervention_support"),
    ("safeguarding_system", "Safeguarding",
     "education_system.post_18.university_system.modules.domain.student_affairs.safeguarding.safeguarding_system"),
    ("lesson_planner", "Lesson Planner",
     "education_system.post_18.university_system.modules.domain.academics.course_planning.lesson_planner"),
    ("background_checker", "Background Checker",
     "education_system.post_18.university_system.modules.domain.operations.staff_hr.background_checks.university_bg_checker"),
    ("university_research", "Research Portal",
     "education_system.post_18.university_system.modules.domain.academics.research.services.university_research"),
    # Cross-system ports added 2026-04 — services with their own Tk launchers.
    ("employer_portal", "Employer Portal",
     "education_system.post_18.university_system.modules.domain.student_affairs.employer_portal.employer_portal_app"),
    ("intervention_outcomes", "Intervention Outcomes",
     "education_system.post_18.university_system.modules.domain.student_affairs.services.early_warning.outcomes.intervention_outcomes_app"),
    ("kpi_dashboard", "KPI Dashboard",
     "education_system.post_18.university_system.modules.domain.analytics.kpi_dashboard.kpi_dashboard_app"),
    ("bursary", "Bursary Management",
     "education_system.post_18.university_system.modules.domain.finance.bursary.bursary_app"),
    ("mentoring_matching", "Peer Mentoring Matching",
     "education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.mentoring_matching.mentoring_matching_app"),
    ("room_booking", "Room Booking",
     "education_system.post_18.university_system.modules.domain.campus.facilities.gui.room_booking_app"),
    ("building_management", "Building Management",
     "education_system.post_18.university_system.modules.domain.campus.facilities.gui.building_management_app"),
    ("tutor_groups", "Tutor Groups",
     "education_system.post_18.university_system.modules.domain.academics.tutor_groups.tutor_groups_app"),
    # Standalone Tk apps moved from /add 2026-04
    ("apprenticeship_system", "Apprenticeships",
     "education_system.post_18.university_system.modules.domain.academics.apprenticeships.apprenticeship_system"),
    ("placement_tracker", "Placement Hours",
     "education_system.post_18.university_system.modules.domain.academics.placements.placement_tracker"),
    ("bakery_shop", "Bakery Shop",
     "education_system.post_18.university_system.modules.domain.commerce.bakery_shop.app"),
]
...
def show_new_feature_university_research(self):
    ...
    if callable(opener):
        try:
            from education_system.post_18.university_system.modules.domain.academics.research.services.university_research import UniversityApp
...
def show_new_feature_module_evaluation_portal(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.module_evaluation_portal import ModuleEvaluationPortal
...
def show_new_feature_lecturer_evaluation(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.lecturer_evaluation import App
        app = App(host=host)
        app.run()
        return app
    self._embed_or_subprocess(title, module_dotted, _build)
...
def show_new_feature_lesson_planner(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.academics.course_planning.lesson_planner import LessonPlannerApp
...
def show_new_feature_course_evaluation_system(self):
    ...
    import tkinter as tk
    from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.course_evaluation_system import (
        CourseEvaluationApp,
    )
...
def show_new_feature_complaints_portal(self):
    ...
    module_dotted = (
        "education_system.post_18.university_system.modules.domain.operations.communications."
        "feedback.complaints_portal"
    )

    def _build(host):
        from education_system.post_18.university_system.modules.domain.operations.communications.feedback.complaints_portal import ComplaintsPortal
...
def show_new_feature_intervention_outcomes(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.student_affairs.services.early_warning.outcomes.intervention_outcomes_app import (
...
def show_new_feature_safeguarding_system(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.safeguarding.safeguarding_system import (
            SafeguardingApp,
        )
    except Exception as e:
        from tkinter import messagebox
...
def show_new_feature_mentoring_matching(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.mentoring_matching.mentoring_matching_app import (
...
def show_new_feature_tutor_groups(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.academics.tutor_groups.tutor_groups_app import (
...
def show_new_feature_employer_portal(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.student_affairs.employer_portal.gui.employer_portal_gui import (
            EmployerPortalFrame,
        )
        from education_system.post_18.university_system.modules.domain.student_affairs.employer_portal.employer_portal_app import _get_current_user
...
def show_new_feature_kpi_dashboard(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.analytics.kpi_dashboard.kpi_dashboard_app import (
            _Frame as _KpiFrame,
            _get_current_user,
        )
...
def show_new_feature_institutional_analytics(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.analytics.institutional_analytics.institutional_analytics_app import (
...
def show_new_feature_apprenticeship_system(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.academics.apprenticeships.apprenticeship_system import ApprenticeshipApp
...
def show_new_feature_first_aid_portal(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.health.first_aid.first_aid_portal import (
            FirstAidPortal,
        )
    except Exception as e:
        from tkinter import messagebox
...
def show_new_feature_room_booking(self):
    ...
    def _build(host):
        from education_system.post_18.university_system.modules.domain.campus.facilities.gui.room_booking_app import (
...
def show_new_feature_background_checker(self):
    ...
    module_dotted = (
        "education_system.post_18.university_system.modules.domain.operations.staff_hr."
        "background_checks.university_bg_checker"
    )

    def _build(host):
        from education_system.post_18.university_system.modules.domain.operations.staff_hr.background_checks.university_bg_checker import BGCheckerApp
