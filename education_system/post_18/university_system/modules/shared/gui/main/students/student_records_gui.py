...
def _build_student_records(self, host, close_action):
    ...
    *close_action* is a no-arg callable that closes the host —
    ...
    try:
        from education_system.post_18.university_system.modules.shared.gui.main.students._cross_links import (
...
def show_student_details(self, student_id):
    ...
    try:
        ...
        try:
            from education_system.post_18.university_system.modules.domain.academics.gui.library.cross_module_api import (
                LibrarySummaryFrame,
            )
