...
try:
    from education_system.post_18.university_system.infrastructure.database.db import DatabaseManager as InfraDBManager, get_connection
...
class DocumentDatabaseManager:
    ...
    def insert_default_data(self, cursor):
        ...
        if cursor.fetchone()[0] == 0:
            ...
            from education_system.post_18.university_system.core.defaults import DEFAULT_ADMIN_PASSWORD
