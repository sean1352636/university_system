...
class MFAAdminPanel(tk.Toplevel):
    ...
    def _load_settings(self):
        ...
        try:
            from education_system.post_18.university_system.infrastructure.auth.sms_provider import get_sms_service
        ...
        try:
            from education_system.post_18.university_system.infrastructure.auth.email_otp_service import get_email_service
