...
class SchedulingMixin:
    ...
    def edit_schedule(self):
        ...
        try:
            ...
            try:
                if ENHANCED_AVAILABLE:
                    from education_system.post_18.university_system.modules.shared.services.analytics.enhanced_reporting import load_templates as get_available_templates
            ...
            def save_schedule():
                try:
                    ...
                    # Save to file
                    if ENHANCED_AVAILABLE:
                        from education_system.post_18.university_system.modules.shared.services.analytics.enhanced_reporting import save_scheduled_reports
