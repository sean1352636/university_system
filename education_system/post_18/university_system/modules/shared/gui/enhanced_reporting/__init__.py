...
try:
    ...
    from education_system.post_18.university_system.modules.shared.services.analytics import enhanced_reporting  # type: ignore
    ENHANCED_AVAILABLE: bool = True
except ImportError:
    ENHANCED_AVAILABLE = False

from education_system.post_18.university_system.modules.shared.gui.enhanced_reporting.core import ReportingSystemGUI, start_gui, start_enhanced_reporting_gui
from education_system.post_18.university_system.modules.shared.gui.enhanced_reporting.template_dialog import TemplateDialog
