...
def clear_search_cache(self):
    ...
    try:
        ...
        messagebox.showinfo(_t('advanced_search.search_history.cache_cleared'), _t('advanced_search.search_history.search_cache_cleared'))
    except Exception as e:
...
def show_repeat_last_search(self):
    ...
    if not hasattr(self, 'last_search_criteria') or not self.last_search_criteria:
        messagebox.showinfo(_t("advanced_search.search_history.no_previous_search"), _t("advanced_search.search_history.no_search_to_repeat"))
        return
...
def save_last_search_results(self):
    ...
    try:
        ...
        messagebox.showinfo(_t("advanced_search.search_history.results_saved"), f"Last search results saved to {filename}")
        self.log_output(f"Search results saved to {filename} and archived.")

    except Exception as e:
        messagebox.showerror(_t("advanced_search.search_history.save_error"), f"Could not save search results: {str(e)}")
