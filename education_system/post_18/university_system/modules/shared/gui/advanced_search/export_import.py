...
def show_data_quality(self):
    ...
    self.update_status(_t("advanced_search.export_import.generating_data_quality_reports"))

    try:
        result = self.capture_function_output(data_quality_reports)
        self._show_report_viewer(result, _t("advanced_search.export_import.data_quality_report_title"))
        self.update_status(_t("advanced_search.export_import.data_quality_report_generated"))
    except Exception as e:
        messagebox.showerror(_t("advanced_search.error_title"), _t("advanced_search.export_import.error_generating_data_quality_report", error=str(e)))
        self.update_status(_t("advanced_search.export_import.data_quality_report_failed"))
