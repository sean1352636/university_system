...
def identify_at_risk_students(self, criteria):
    ...
    try:
        ...
        result = "🚨 AT-RISK STUDENTS ANALYSIS\n"
        result += "═" * 50 + "\n"
...
def calculate_module_success_probability(self, module_code):
    ...
    try:
        ...
        result = "🎯 MODULE SUCCESS PROBABILITY\n"
        result += "═" * 50 + "\n"
...
def generate_graduation_forecast(self, selection, course, min_modules, min_gpa):
    ...
    try:
        ...
        result = "🎓 GRADUATION TIMELINE FORECAST\n"
        result += "═" * 50 + "\n"
        result += f"Analysis Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n"
...
def module_success_probability(self):
    ...
    def calculate():
        ...
        if not module_code:
            messagebox.showwarning(_t("advanced_search.predictive.missing_input_title"), _t("advanced_search.predictive.missing_module_code_msg"))
            return
        ...
        try:
            ...
            messagebox.showerror(_t("advanced_search.error_title"), _t("advanced_search.predictive.failed_to_calculate", error=str(e)))
