...
def show_scheduled_reports_manager(self):
    ...
    dialog.title(_t('advanced_search.scheduled_reports_dialog_title'))
...
AdvancedSearchGUI.delete_selected_report = delete_selected_report
...
def view_scheduled_reports(self):
    ...
    if not hasattr(self, 'reports_tree'):
        ...
        self.load_scheduled_reports()
AdvancedSearchGUI.view_scheduled_reports = view_scheduled_reports
...
def create_scheduled_report(self):
    ...
    """
    self.show_scheduled_reports()
AdvancedSearchGUI.create_scheduled_report = create_scheduled_report
...
def modify_scheduled_report(self):
    ...
    if hasattr(self, 'reports_tree') and self.reports_tree.get_children():
        ...
        messagebox.showwarning(_t("advanced_search.scheduled_reports.no_reports_title"), _t("advanced_search.scheduled_reports.no_reports_msg"))
AdvancedSearchGUI.modify_scheduled_report = modify_scheduled_report
...
def delete_scheduled_report(self):
    ...
    if hasattr(self, 'reports_tree') and self.reports_tree.get_children():
        ...
        messagebox.showwarning(_t("advanced_search.scheduled_reports.no_reports_title"), _t("advanced_search.scheduled_reports.no_reports_msg"))
AdvancedSearchGUI.delete_scheduled_report = delete_scheduled_report
...
def run_scheduled_report(self):
    ...
    if hasattr(self, 'reports_tree') and self.reports_tree.get_children():
        ...
        messagebox.showwarning(_t("advanced_search.scheduled_reports.no_reports_title"), _t("advanced_search.scheduled_reports.no_reports_msg"))
AdvancedSearchGUI.run_scheduled_report = run_scheduled_report
