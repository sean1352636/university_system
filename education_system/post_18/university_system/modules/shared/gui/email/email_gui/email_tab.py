...
from education_system.post_18.university_system.modules.shared.gui.email.email_gui.email_manager_main import EmailManagerGUI, get_stored_emails, delete_stored_email
...
def open_queue_manager(self):
    ...
    from education_system.post_18.university_system.modules.shared.gui.email.email_queue_scheduler_gui import EmailQueueSchedulerGUI
