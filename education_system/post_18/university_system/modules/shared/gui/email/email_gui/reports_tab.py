...
from education_system.post_18.university_system.modules.shared.gui.email.email_gui.email_manager_main import EmailManagerGUI, get_stored_emails
...
try:
    from education_system.post_18.university_system.infrastructure.email.reports import get_user_communication_stats
except ImportError:
