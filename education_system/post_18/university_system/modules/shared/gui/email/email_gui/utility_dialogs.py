...
try:
    from education_system.post_18.university_system.modules.shared.gui.email.email_gui.email_manager_main import (
...
# Import config
try:
    from education_system.post_18.university_system.modules.shared.gui.email.email_gui.email_manager_main import config
except ImportError:
    config = {}
        ...
        try:
            ...
            try:
                ...
                if report_type == "Email Statistics":
                    ...
                    report_content += "EMAIL LOG (Sent Emails)\n"
                    report_content += "-" * 40 + "\n"
                    ...
                    report_content += "STORED EMAILS (Last 50)\n"
                    report_content += "-" * 70 + "\n\n"
                    ...
                    """)
                    rows = cursor.fetchall()
                    report_content += "EMAIL SEND LOG (Last 50)\n"
                    report_content += "-" * 70 + "\n\n"
                    ...
                    """)
                    rows = cursor.fetchall()
                    report_content += "INTERNAL MESSAGES (Last 50)\n"
                    report_content += "-" * 70 + "\n\n"
                    ...
                    report_content += "EMAIL TEMPLATES\n"
                    report_content += "-" * 70 + "\n"
