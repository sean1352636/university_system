...
from education_system.post_18.university_system.modules.shared.gui.email.email_queue_scheduler_gui import EmailQueueSchedulerGUI, main as email_scheduler_main
