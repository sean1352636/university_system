...
from education_system.post_18.university_system.modules.shared.utils.simple_activity_logger.storage import LogRotationManager, DatabaseLogger
...
from education_system.post_18.university_system.modules.shared.utils.simple_activity_logger.analytics import AnalyticsEngine
...
class EnhancedActivityLogger:
    ...
    def _send_security_webhook(self, log_entry: LogEntry):
        ...
        if hostname in ('localhost', '127.0.0.1', '0.0.0.0', '::1') or hostname.startswith('10.') or hostname.startswith('192.168.') or hostname.startswith('172.'):
            print("Webhook URL points to internal network, blocked for security")
            return
