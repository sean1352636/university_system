...
class UIFrameworkMixin:
    ...
    def create_show_dentist(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.health.gui.health_portal.dentist_gui import DentistGUI
    ...
    def _embed_health_panel(self, module_suffix, attr):
        ...
        try:
            import importlib
            base = "education_system.post_18.university_system.modules.domain.health.gui.health_portal."
