...
from education_system.post_18.university_system.modules.domain.health.gui.medical_accommodation.utils import resolve_user_identifier
...
class DocumentUploadDialog:
    ...
    def upload(self):
        ...
        try:
            self.do_upload()
            if CLI_AVAILABLE:
                from education_system.post_18.university_system.modules.domain.health.gui.medical_accommodation._common import log_action
    ...
    def _notify_student_of_upload(self):
        ...
        try:
            ...
            if CLI_AVAILABLE:
                from education_system.post_18.university_system.modules.domain.health.gui.medical_accommodation._common import cli_notify_student
                cli_notify_student(
                    row['student_id'],
                ...
                from education_system.post_18.university_system.modules.domain.health.gui.medical_accommodation._common import send_email
                send_email(
                    row['email_address'],
                    'Document Uploaded to Your Accommodation Record',
                    f"Dear {student_name},\n\nA new document '{doc_name}' has been uploaded to your accommodation record.\n\nPlease log in to view the document."
