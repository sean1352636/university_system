...
from education_system.post_18.university_system.modules.domain.health.gui.medical_accommodation.utils import resolve_user_identifier, check_conflict
...
class ApplyTemplateDialog:
    ...
    def apply(self):
        ...
        if CLI_AVAILABLE:
            from education_system.post_18.university_system.modules.domain.health.gui.medical_accommodation._common import validate_student_id
