...
from education_system.post_18.university_system.modules.domain.health.records.analytics.population import show_population_health_metrics
from education_system.post_18.university_system.modules.domain.health.records.analytics.provider import analyze_provider_workload, show_appointment_utilization_stats
from education_system.post_18.university_system.modules.domain.health.records.analytics.quality import show_quality_metrics
from education_system.post_18.university_system.modules.domain.health.records.analytics.reports import generate_custom_report
from education_system.post_18.university_system.modules.domain.health.records.vaccinations.reports import generate_vaccination_coverage_report
