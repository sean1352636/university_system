...
from education_system.post_18.university_system.modules.domain.health.services.health_context import get_user_student_id
...
def manage_allergies(auth):
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.health.records.clinical.allergies import add_allergy
            add_allergy(auth)
        elif choice == '2':
            view_allergies(auth)
        elif choice == '3':
            # Import the function locally to avoid circular imports
            from education_system.post_18.university_system.modules.domain.health.records.clinical.allergies import update_allergy
            update_allergy(auth)
        elif choice == '4':
            # Import the function locally to avoid circular imports
            from education_system.post_18.university_system.modules.domain.health.records.clinical.allergies import delete_allergy
            delete_allergy(auth)
        elif choice == '5':
