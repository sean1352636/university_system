...
from education_system.post_18.university_system.modules.domain.health.services.health_context import cipher_suite
...
try:
    from education_system.post_18.university_system.modules.domain.health.portal.data_privacy import advanced_security_menu, user_session_management, ip_restriction_management, two_factor_authentication_setup, integration_management, api_key_management, integration_health_check, add_missing_menu_integrations, generate_security_report, population_risk_analysis, review_security_settings, update_security_settings, assess_contact_risk, security_audit_menu, view_audit_log, health_risk_assessment, conduct_risk_assessment, calculate_risk_score, get_risk_factors, generate_risk_recommendations
except ImportError:
...
from education_system.post_18.university_system.modules.domain.health.records.data_purge  import update_retention_policy, archive_old_data, data_purge_menu, view_purgeable_data, purge_expired_data, retention_compliance_report, compliance_monitoring, data_retention_management, view_retention_policies, custom_data_purge
from education_system.post_18.university_system.modules.domain.health.records.quality_assurance  import generate_quality_metrics_report, clinical_quality_indicators, quality_assurance_menu, data_quality_metrics, show_quality_metrics
from education_system.post_18.university_system.modules.domain.health.records.backup_export  import export_vaccination_records, export_appointment_data, export_lab_results, export_custom_dataset, restore_from_backup, manage_backup_schedule, backup_recovery_menu, create_database_backup, view_backup_history, export_data_menu, export_health_records, bulk_import_records
from education_system.post_18.university_system.modules.domain.health.appointments.appointment_booking  import manage_provider_schedules, add_provider_schedule, view_provider_schedules, show_upcoming_appointments, provider_dashboard, todays_schedule, manage_screening_schedules, create_screening_schedule, schedule_screening_appointment, manage_provider_time_off, schedule_templates, provider_availability_report, update_provider_schedule, provider_statistics, schedule_appointment, view_appointments, update_appointment_status, generate_provider_utilization_report, generate_appointment_schedule_report, generate_provider_performance_report, show_appointment_utilization_stats, analyze_provider_workload
from education_system.post_18.university_system.modules.domain.health.records.admin.advisories import add_health_advisory, view_health_advisories
from education_system.post_18.university_system.modules.domain.health.records.admin.permissions import manage_health_records_enhanced, setup_health_permissions
from education_system.post_18.university_system.modules.domain.health.records.analytics.population import generate_population_health_report, show_population_health_metrics, generate_student_health_summary
from education_system.post_18.university_system.modules.domain.health.records.analytics.quality import patient_safety_metrics
from education_system.post_18.university_system.modules.domain.health.records.analytics.reports import generate_public_health_report
from education_system.post_18.university_system.modules.domain.health.records.analytics.trends import generate_health_condition_analysis, health_analytics_dashboard, analyze_health_trends
from education_system.post_18.university_system.modules.domain.health.records.clinical.allergies import add_allergy, update_allergy, delete_allergy
from education_system.post_18.university_system.modules.domain.health.records.clinical.care_plans import manage_care_plans, create_care_plan, view_care_plans, update_care_plan, track_care_plan_progress
from education_system.post_18.university_system.modules.domain.health.records.clinical.conditions import manage_medical_conditions, add_medical_condition, view_medical_conditions, update_condition_status, condition_management_plans
from education_system.post_18.university_system.modules.domain.health.records.clinical.lab_results import manage_lab_results, add_lab_result, view_lab_results, lab_trends_analysis, recent_lab_results_dashboard
from education_system.post_18.university_system.modules.domain.health.records.clinical.prescriptions import manage_prescriptions, add_prescription, view_prescriptions, update_prescription_status
from education_system.post_18.university_system.modules.domain.health.records.records.crud import add_health_record, view_health_records, update_health_record, delete_health_record
from education_system.post_18.university_system.modules.domain.health.records.records.reports import generate_health_report
from education_system.post_18.university_system.modules.domain.health.records.records.templates import enhanced_health_record_templates, health_record_templates
from education_system.post_18.university_system.modules.domain.health.records.referrals.referrals import manage_referrals, create_referral, view_referrals, update_referral_status, referral_followup, referral_reports
from education_system.post_18.university_system.modules.domain.health.records.screening.guidelines import screening_guidelines, screening_recommendations
...
from education_system.post_18.university_system.modules.domain.health.records.screening.schedules import calculate_screening_due_date, calculate_next_screening_date, view_due_screenings, overdue_screenings
from education_system.post_18.university_system.modules.domain.health.records.student.dashboard import student_health_dashboard, show_personal_health_summary, show_health_reminders
from education_system.post_18.university_system.modules.domain.health.records.student.insurance import view_insurance_info, update_insurance_info
from education_system.post_18.university_system.modules.domain.health.records.student.resources import student_health_resources, view_health_resources
from education_system.post_18.university_system.modules.domain.health.records.student.wellness import manage_wellness_goals, track_personal_metrics, quick_wellness_assessment
from education_system.post_18.university_system.modules.domain.health.records.vaccinations.management import record_vaccination, view_vaccinations, verify_vaccination
from education_system.post_18.university_system.modules.domain.health.records.vaccinations.reports import generate_vaccination_analysis_report, generate_vaccination_status_report, generate_vaccination_coverage_report
from education_system.post_18.university_system.modules.domain.health.records.vaccinations.tracking import immunization_status, vaccination_due_list
...
from education_system.post_18.university_system.modules.domain.health.records.wellness.programs import wellness_programs, view_wellness_programs, enroll_in_wellness_program, track_wellness_progress, wellness_program_analytics
...
def _launch_wellness_cli(auth):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.wellness.cli.wellness_cli import WellnessCLI
        cli = WellnessCLI()
        cli.auth = auth
        cli.main_menu()
...
def _launch_dentist_cli():
    ...
    try:
        from education_system.post_18.university_system.modules.domain.health.portal.dentist_cli import dentist_menu
        dentist_menu()
    except ImportError as e:
