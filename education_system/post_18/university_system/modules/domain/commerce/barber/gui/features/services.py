    ...
    def create_service_package(self):
        ...
        def save_package():
            ...
            try:
                ...
                from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import ServicePackageManager
    ...
    def add_service_addon(self):
        ...
        def save_addon():
            ...
            try:
                ...
                from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import ServiceAddonManager
