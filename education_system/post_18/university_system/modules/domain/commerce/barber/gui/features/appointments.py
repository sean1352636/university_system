...
class AppointmentsMixin:
    ...
    def process_payment(self):
        ...
        from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import AppointmentManager, TransactionManager
        appt = AppointmentManager.get_appointment_by_number(appt_number)
    ...
    def view_waitlist(self):
        ...
        def load_waitlist():
            for item in tree.get_children():
                tree.delete(item)
            try:
                from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import WaitlistManager
    ...
    def block_time_slot(self):
        ...
        def block_slot():
            try:
                ...
                from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import BlockedSlotManager
    ...
    def recurring_appointment(self):
        ...
        def create_recurring():
            try:
                ...
                from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import RecurringAppointmentManager
