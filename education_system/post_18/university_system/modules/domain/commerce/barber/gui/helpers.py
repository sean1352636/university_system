...
class HelpersMixin:
    ...
    def _get_time_slots(self) -> list:
        ...
        from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import TIME_SLOTS
        return TIME_SLOTS

    def _get_service_types(self) -> dict:
        """Get service types."""
        from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import SERVICE_TYPES
    ...
    def _load_services(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import ServiceManager
    ...
    def _load_customers(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.commerce.barber.services.barber_core import CustomerManager
