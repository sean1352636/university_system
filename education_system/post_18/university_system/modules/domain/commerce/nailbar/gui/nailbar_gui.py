...
from education_system.post_18.university_system.infrastructure.database.db import get_db_connection, transaction
from education_system.post_18.university_system.core.activity_logger import log_activity

# Authentication imports
try:
    from education_system.post_18.university_system.infrastructure.shared_context import get_auth, _DummyAuth
    AUTH_AVAILABLE = True
except ImportError:
...
class NailBarGUI:
    ...
    def _init_database(self):
        ...
        from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import init_nailbar_db
        try:
            init_nailbar_db()
    ...
    def show_daily_revenue(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import TransactionManager
    ...
    def show_appointments_by_date(self):
        ...
        if not date:
            ...
            return
        try:
            from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import AppointmentManager
    ...
    def _get_time_slots(self) -> list:
        ...
        from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import TIME_SLOTS
        return TIME_SLOTS

    def _get_categories(self) -> dict:
        """Get treatment categories - Function 11"""
        from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import TREATMENT_CATEGORIES
    ...
    def _load_treatments(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import TreatmentManager
    ...
    def _load_technicians(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import TechnicianManager
    ...
    def process_payment(self):
        ...
        from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import AppointmentManager, TransactionManager
        appt = AppointmentManager.get_appointment_by_reference(booking_ref)
    ...
    def _send_payment_receipt(self, appt: dict, total_amount: float, tip: float,
        ...
        try:
            ...
            try:
                from education_system.post_18.university_system.infrastructure.email.email_service import send_email as send_email_func
    ...
    def generate_admin_report(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.commerce.nailbar.services.nailbar_core import ReportManager
