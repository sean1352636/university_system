...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.financials import (
    profit_loss_statement,
    expense_tracking,
    budget_management,
)
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.exports import (
...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.forecasting import (
    revenue_forecast,
    expense_forecast,
...
def display_financial_reports():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management import revenue_analytics
            revenue_analytics()
        elif choice == '5':
            expense_tracking()
        elif choice == '6':
