...
from education_system.post_18.university_system.infrastructure.database.data_backup import backup_before_operation, display_backup_menu
from education_system.post_18.university_system.infrastructure.database.db import DatabaseManager, get_connection as get_db_connection
...
def expense_analytics():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import exports
...
def analyze_query_performance():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import maintenance
...
def user_management():
    """Manage users."""
    from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import users
...
def view_audit_logs():
    """View audit logs."""
    from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import audit
    return audit.view_audit_logs()

def manage_notifications():
    """Manage notifications."""
    from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations import notifications
