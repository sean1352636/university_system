from education_system.post_18.university_system.infrastructure.auth import UserAuth, display_auth_menu
from education_system.post_18.university_system.infrastructure.database.data_backup import display_backup_menu, backup_before_operation
...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.connection import get_db_connection
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.audit import log_audit_action
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.order_processing import (
    view_orders,
    update_order_status,
    process_payments,
)
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.reservation_system import display_table_management
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff.staff_administration import display_staff_management
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.inventory_management import display_inventory_management
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.financial_reporting import display_financial_reports
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.settings import display_system_settings
...
def display_customer_menu():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import create_customer
            create_customer()
        elif choice == '2':
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import view_customers
            view_customers()
        elif choice == '3':
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import update_customer
            update_customer()
        elif choice == '4':
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import manage_customer_feedback
            manage_customer_feedback()
        elif choice == '5':
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import manage_loyalty_program
