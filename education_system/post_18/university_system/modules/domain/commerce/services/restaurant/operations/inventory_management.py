...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.operations.order_processing import manage_purchase_orders
import random
import re
import os
import csv
...
def manage_suppliers():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff.staff_administration import supplier_performance
...
def waste_tracking():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management import waste_analytics
            waste_analytics()
        elif choice == '4':
            return
        else:
...
def expiry_report():
    ...
    try:
        ...
        print("Items expiring in the next 7 days:")
        print("-"*80)
...
def abc_analysis():
    ...
    try:
        ...
        if b_items:
            ...
            print("-"*80)
            print("Sample items (showing first 5):")
