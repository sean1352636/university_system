...
from education_system.post_18.university_system.core.paths import QR_CODES_DIR
...
def display_table_management():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management import table_analytics
            table_analytics()
        elif choice == '9':
            generate_qr_codes()
        elif choice == '10':
