...
from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.staff.payroll import payroll_calculations
import random
import re
import os
import csv
...
def display_staff_management():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management import staff_analytics
            staff_analytics()
        elif choice == '9':
            return
        else:
...
def staff_performance():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.post_18.university_system.modules.domain.commerce.services.restaurant.menu.menu_management import performance_analytics
...
def update_performance_scores():
    ...
    try:
        ...
        print("✅ Performance score updated!")
