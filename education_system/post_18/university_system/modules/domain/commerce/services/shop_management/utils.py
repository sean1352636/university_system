...
from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.config import get_system_settings
from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.inventory import get_inventory_valuation
...
def log_shop_activity(activity_type, description, user_id=None, details=None):
    ...
    try:
        ...
        from education_system.post_18.university_system.modules.shared.utils.simple_activity_logger import log_dynamic_activity
