...
from education_system.post_18.university_system.modules.domain.commerce.services.shop_management import config
from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.database import init_shop_db, setup_shop_permissions, create_sample_users
...
def _cli_db_helpers():
    ...
    """
    from education_system.post_18.university_system.modules.shared.cli.database_manager import (
...
def display_shop_menu():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.shopping import (browse_products, view_shopping_cart, checkout_process,
                           view_purchase_history, view_all_transactions)
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.products import quick_add_product, bulk_update_prices
...
def display_product_management_menu():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.products import add_new_product, edit_product, toggle_product_status, view_all_products
...
def display_inventory_management_menu():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.inventory import (update_stock_levels, restock_products,
...
def display_discount_management_menu():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.discounts import (create_discount, edit_discount,
...
def display_sales_reports_menu():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.reports import (generate_daily_sales_report, generate_weekly_sales_report,
...
def display_textbook_menu():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.textbooks import (
...
def display_main_menu_extended():
    ...
    while True:
        ...
        if not config.auth or not config.auth.current_user:
            ...
            from education_system.post_18.university_system.infrastructure.auth import display_auth_menu
...
def setup_shop_system():
    ...
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.discounts import cleanup_expired_discounts
...
def integrate_shop_with_main():
    ...
    """
    from education_system.post_18.university_system.modules.domain.commerce.services.shop_management.utils import test_shop_system
