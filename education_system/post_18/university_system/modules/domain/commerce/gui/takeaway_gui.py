...
from education_system.post_18.university_system.infrastructure.database.db import DEFAULT_DB_PATH, get_connection
...
from education_system.post_18.university_system.modules.domain.commerce.services.takeaway.takeaway_service import (
    init_takeaway_db,
    get_restaurants,
    get_menu_items,
    add_to_cart,
...
"""
    ...
    def open_takeaway_gui(self):
        ...
        self.takeaway_window.geometry("1400x900+%d+%d" % ((self.takeaway_window.winfo_screenwidth() - 1400) // 2, (self.takeaway_window.winfo_screenheight() - 900) // 2))
