...
``integrate_gui_with_main``) so the canonical import is:
    ...
    from education_system.post_18.university_system.modules.domain.commerce.gui.shop_management_gui \\
...
from education_system.post_18.university_system.modules.domain.commerce.gui.shop_management_gui.main_gui import (
    UniversityShopGUI,
