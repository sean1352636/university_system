...
from education_system.post_18.university_system.modules.domain.commerce.cinema.gui.cinema_gui.database import DB_FILE, generate_booking_ref
from education_system.post_18.university_system.modules.domain.commerce.cinema.gui.cinema_gui.constants import SNACKS_MENU
...
def show_payment_page(self, screening, movie):
    ...
    def configure_split_payment():
        ...
        def confirm_split():
            ...
            messagebox.showinfo(_t("cinema.common.success"), "Split payment configured:\n" +
