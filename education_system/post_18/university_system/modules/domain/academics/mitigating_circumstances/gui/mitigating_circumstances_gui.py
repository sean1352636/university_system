...
class MitigatingCircumstancesGUI:
    ...
    def _submit_claim(self):
        from education_system.post_18.university_system.modules.domain.academics.mitigating_circumstances.services.mitigating_circumstances_service import VALID_GROUNDS
    ...
    def _view_claim(self):
        from education_system.post_18.university_system.modules.domain.academics.mitigating_circumstances.services.mitigating_circumstances_service import VALID_STATUSES
    ...
    def _record_decision(self):
        from education_system.post_18.university_system.modules.domain.academics.mitigating_circumstances.services.mitigating_circumstances_service import VALID_OUTCOMES
