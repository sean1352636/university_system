...
def display_mitigating_circumstances_menu(auth):
    ...
    while True:
        ...
        print(" 11. Statistics")
        print(" 12. Withdraw Claim")
        print(" 13. Close Panel")
        print(" 14. Mark Extension Applied")
        print("\n  0. Back")
        print("=" * 70)
        ...
        try:
            if choice == '0':
                ...
                cid = int(input("Claim ID: ").strip())
                service.withdraw_claim(cid)
                print("Claim withdrawn.")
            elif choice == '13':
                pid = int(input("Panel ID: ").strip())
                service.close_panel(pid)
                print("Panel closed.")
            elif choice == '14':
                ext_id = int(input("Extension ID: ").strip())
                service.mark_extension_applied(ext_id)
                print("Extension marked as applied.")
