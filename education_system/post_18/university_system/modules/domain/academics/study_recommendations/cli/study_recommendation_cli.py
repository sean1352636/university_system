...
def display_study_recommendation_menu(auth):
    from education_system.post_18.university_system.modules.domain.academics.study_recommendations.services.study_recommendation_service import StudyRecommendationService
