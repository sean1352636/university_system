...
# Data/persistence layer lives in the Tkinter-free service module so the
# text CLI can reuse it without importing Tkinter. Imported here (after the
# sys.path bootstrap above) so `education_system` is importable even when
# this file is launched directly as a subprocess.
from education_system.post_18.university_system.modules.domain.academics.apprenticeships.apprenticeship_service import (  # noqa: E402
    Database,
    _LEGACY_DB_FILE,
    _remove_legacy_db,
)
