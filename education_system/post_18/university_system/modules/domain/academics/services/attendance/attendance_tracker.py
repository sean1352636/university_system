...
# --- Settings ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.settings import (
    get_setting,
...
# --- Records (core CRUD) ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.records import (
    get_modules,
...
# --- Audit ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.audit import (
    log_audit_event,
)

# --- Gamification ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.gamification import (
    update_gamification_points,
)

# --- QR Code System ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.qr_system import (
    QRAttendanceSystem,
)

# --- Geofencing ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.geofencing import (
    GeofencingSystem,
    GEOFENCING_SUPPORT,
)

# --- Face Recognition ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.face_recognition_system import (
    FaceRecognitionSystem,
    FACE_RECOGNITION_SUPPORT,
)

# --- Predictive Analytics ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.predictive_analytics import (
    AttendancePredictiveAnalytics,
)

# --- Notifications ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.notifications import (
    EnhancedNotificationSystem,
)

# --- Dashboard ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.dashboard import (
    AttendanceDashboard,
)

# --- API ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.api import (
    AttendanceAPI,
)

# --- Reporting ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.reporting import (
...
# --- Backup ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.backup import (
    BackupRecoverySystem,
)

# --- CLI (menu + all handlers) ---
from education_system.post_18.university_system.modules.domain.academics.services.attendance.cli.menu import (
