...
class Database:
    ...
    def record_absence(self, student_id, module_code, d, status, reason, recorded_by=None):
        ...
        try:
            ...
            logger.debug(
                "attendance_records mirror insert skipped for student_id=%s module=%s",
                student_id, module_code, exc_info=True)
        self.conn.commit()
    ...
    def submit_request(self, student_id, module_code, d, reason):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.academics.services.attendance.absence_tracking.email_notifications import (  # noqa: E501
    ...
    def decide_request(self, request_id, decision,
        ...
        if (decision == "approved"
            ...
            try:
                from education_system.post_18.university_system.modules.domain.academics.gui._absence_to_deferred import (
...
class AdminDashboard(BaseDashboard):
    def build_tabs(self):
        ...
        self._reports_tab()
        try:
            from education_system.post_18.university_system.modules.domain.academics.services.attendance.absence_tracking \
...
def launch_in_frame(frame, user, prefill=None):
    ...
    db = Database()
    try:
        from education_system.post_18.university_system.infrastructure.shared_context import (  # noqa: E501
