    ...
    while True:
        ...
        try:
            ...
            # --- 4. Activate Form ---
                ...
                print("Form is now ACTIVE. Students can submit responses.")
...
def launch_course_evaluation_gui(*args, **kwargs):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.course_evaluation_gui import (
