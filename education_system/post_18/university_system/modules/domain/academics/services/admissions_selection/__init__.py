...
from education_system.post_18.university_system.modules.domain.academics.services.admissions_selection.schema import (
    ensure_selection_schema,
)
from education_system.post_18.university_system.modules.domain.academics.services.admissions_selection.tariff import (
    ALEVEL_POINTS,
    GRADE_CHOICES,
    compute_tariff,
...
from education_system.post_18.university_system.modules.domain.academics.services.admissions_selection.course_catalogue import (
    get_course,
    list_active_courses,
)
from education_system.post_18.university_system.modules.domain.academics.services.admissions_selection.eligibility import (
    eligible_courses,
    is_eligible,
)
from education_system.post_18.university_system.modules.domain.academics.services.admissions_selection.curriculum import (
    TOTAL_MODULES,
