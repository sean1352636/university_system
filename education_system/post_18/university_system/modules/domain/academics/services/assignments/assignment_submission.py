from education_system.post_18.university_system.infrastructure.database.db import sqlite3, DatabaseManager, ensure_parent_dir
from education_system.post_18.university_system.core.paths import DEFAULT_DB_PATH, SUBMISSIONS_DIR
...
from education_system.post_18.university_system.modules.domain.academics.services.assignments.core.database import DatabaseMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.core.permissions import PermissionsMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.core.utils import UtilsMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.assignments.crud import AssignmentCrudMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.assignments.submissions import SubmissionsMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.grading.grading import GradingMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.groups.group_management import GroupManagementMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.peer_review.peer_review import PeerReviewMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.extensions.extensions import ExtensionsMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.templates.templates import TemplatesMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.notifications.messaging import MessagingMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.analytics.analytics import AnalyticsMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.maintenance.maintenance import MaintenanceMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.auto_grading.auto_grading import AutoGradingMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.exam_integrity.exam_integrity import ExamIntegrityMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.student_experience.student_experience import StudentExperienceMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.grade_disputes.grade_disputes import GradeDisputeMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.late_policy.late_policy import LatePolicyMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.annotations.annotations import AnnotationMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.multi_stage.multi_stage import MultiStageMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.admin_tools.admin_tools import AdminToolsMixin
from education_system.post_18.university_system.modules.domain.academics.services.assignments.ai_assistant.ai_assistant import AIAssistantMixin
