...
from education_system.post_18.university_system.modules.domain.academics.services.course_management.validation import validate_time_format, validate_days_of_week
...
def _sync_derived_timetables(module_schedule_ids):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.services.course_management.calendar_lecture_sync import (
...
def _push_in_app_notification(user_id, title: str, message: str,
    ...
    if user_id is None:
        return False
    try:
        from education_system.post_18.university_system.infrastructure.email.messages_inbox import (
...
def create_course_schedule(auth):
    ...
    try:
        ...
        try:
            from education_system.post_18.university_system.modules.domain.academics.services.course_management.workload_sync import (
