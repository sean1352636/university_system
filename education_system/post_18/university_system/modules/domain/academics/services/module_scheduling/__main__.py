...
if __name__ == "__main__":
    ...
    from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.menus import display_enhanced_scheduling_menu, display_main_menu_info, handle_graceful_exit
