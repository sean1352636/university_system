...
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.constants import DAYS_OF_WEEK, TIME_SLOTS, SESSION_TYPES
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.analytics import AnalyticsMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.conflicts import ConflictsMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.optimization import OptimizationMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.import_export import ImportExportMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.templates import TemplatesMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.timetables import TimetablesMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.viewing import ViewingMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.visualization import VisualizationMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.notifications import NotificationsMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.holidays import HolidaysMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.backup import BackupMixin
from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.settings import SettingsMixin
import os
...
class ModuleScheduler(
    ...
    def update_module_schedule(self, schedule_id, **kwargs):
        ...
        if 'day_of_week' in kwargs or 'start_time' in kwargs or 'end_time' in kwargs or 'room_id' in kwargs:
            ...
            if conflicts:
                print("Room conflict detected: Room is already scheduled during this time.")
                conn.close()
                return False
        ...
        if 'day_of_week' in kwargs or 'start_time' in kwargs or 'end_time' in kwargs or 'instructor_id' in kwargs:
            ...
            conflicts = [c for c in conflicts if c[0] != schedule_id]
            if conflicts:
                print("Instructor conflict detected: Instructor is already scheduled during this time.")
                conn.close()
                return False
