...
def _resolve_file_path(stored_path: str) -> Optional[str]:
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.gui.assignment_system._file_viewer import (
...
def _extract_submission_text(path: str) -> Optional[str]:
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.services.plagiarism.checker import (
            PlagiarismChecker,
        )
