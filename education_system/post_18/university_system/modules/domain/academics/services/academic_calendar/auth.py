...
from education_system.post_18.university_system.modules.domain.academics.services.academic_calendar.config import ValidationUtils, SecurityUtils
...
class AuthenticationManager:
    ...
    def create_user(self, username: str, password: str, email: str, role: str = 'student') -> bool:
        ...
        try:
            ...
            from education_system.post_18.university_system.infrastructure.auth import UserAuthentication
