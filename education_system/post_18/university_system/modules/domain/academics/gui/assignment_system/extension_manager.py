...
class ExtensionManager:
    ...
    def show_extension_details(self, request_id):
        ...
        try:
            ...
            details_label = ttk.Label(self.extension_details_frame, text=f"Student: {request[11]} {request[12]}")
                ...
                if decision == 'approved':
                    try:
                        ...
                        if result:
                            ...
                            from education_system.post_18.university_system.infrastructure.email.email_service import send_extension_notification
                            import logging
