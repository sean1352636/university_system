...
from education_system.post_18.university_system.modules.domain.academics.gui.student_registration.common_imports import COLORS, create_stat_card, get_connection, logger
