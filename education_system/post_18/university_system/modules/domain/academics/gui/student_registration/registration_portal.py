...
from education_system.post_18.university_system.modules.domain.academics.gui.student_registration.common_imports import (
    get_auth, get_connection, get_student_id, get_user_role, logger,
)
from education_system.post_18.university_system.modules.domain.academics.gui.student_registration.browse_modules import BrowseModulesMixin
from education_system.post_18.university_system.modules.domain.academics.gui.student_registration.enrollment import EnrollmentMixin
