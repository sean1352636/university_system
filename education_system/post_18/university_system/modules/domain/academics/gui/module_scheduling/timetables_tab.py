...
"""
from education_system.post_18.university_system.infrastructure.database.db import DEFAULT_DB_PATH, get_connection  # noqa: F401
...
from education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.dialogs import GridViewWindow
...
def view_calendar(self):
    ...
    """
    try:
        from education_system.post_18.university_system.modules.domain.academics.gui.academic_calendar.main_gui import CalendarGUI
...
def _show_student_timetable_dialog(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.student_timetable_dialog import StudentTimetableDialog
...
def _show_drag_drop_grid(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.drag_grid_dialog import DragDropTimetableDialog
