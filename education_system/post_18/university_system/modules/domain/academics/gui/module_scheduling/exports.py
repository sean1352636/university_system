...
def export_to_ical(self, entity_type, entity_id, filename=None):
    ...
    # Get schedule data (shared helpers now live in timetable_management)
    ...
    if entity_type == 'student':
        schedules = get_student_schedule_data(entity_id)
        cal.add('x-wr-calname', f'Student {entity_id} Schedule')
    elif entity_type == 'instructor':
        schedules = get_instructor_schedule_data(entity_id)
