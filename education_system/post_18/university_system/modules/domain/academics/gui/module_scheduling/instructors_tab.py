...
from education_system.post_18.university_system.modules.domain.academics.gui.module_scheduling.dialogs import AddInstructorDialog, EditInstructorDialog
...
def view_instructor_schedule(self, instructor_id=None):
    ...
    # Shared schedule-data helper now lives in timetable_management.
    from education_system.post_18.university_system.modules.domain.academics.gui.timetable_management import (
        get_instructor_schedule_data,
    )
    schedules = get_instructor_schedule_data(instructor_id)
