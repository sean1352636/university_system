...
class GradeManager:
    ...
    def calculate_all_gpas(self):
        ...
        try:
            ...
            from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking.integrations import (
                push_grade_kpi,
                notify_aid_of_gpa,
            )
    ...
    def _open_exam_results_for_grade(self, student_grades_id: int):
        ...
        try:
            ...
            from education_system.post_18.university_system.modules.domain.academics.gui.exam_management.tabs.results_tab import ResultsEntryDialog
