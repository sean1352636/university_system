...
class GradeEditDialog:
    def __init__(self, parent, student_id, student_name, max_points, current_score, current_grade, current_comments, callback):
        ...
        self.setup_dialog(student_name, current_score, current_grade, current_comments)

        # Set grab after dialog is fully set up
        try:
