...
from education_system.post_18.university_system.core import paths as _paths
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.config import GuiConfig
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.common import (
    logger,
...
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.submission import DocumentSubmissionDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.check import PlagiarismCheckDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.search import RepositorySearchDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.advanced_search import AdvancedRepositorySearchDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.bulk_operations import BulkOperationsDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.system_testing import SystemTestingDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.comparison import DocumentComparisonDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.converter import FileFormatConverterDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.backup_restore import BackupRestoreDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.workflow import DocumentWorkflowDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.results import CheckResultDialog, ResultDetailsDialog
from education_system.post_18.university_system.modules.domain.academics.gui.plagiarism_main_gui.dialogs.statistics import StatisticsDialog
...
class PlagiarismCheckerGUI:
    ...
    def __init__(self, parent=None, auth=None):
        ...
        # Stop the after() poll loop with a flag rather than racing after_cancel
        # against a firing timer, which can trigger a Tcl "invalid command
        # name ...process_tasks" background error on teardown.
        self._closing = False
    ...
    def _show_plagiarism_email_fallback(self, email, subject, message, result_data):
        ...
        try:
            ...
            ttk.Label(fallback_window,
                     text="Email system unavailable. Please manually send this report:",
