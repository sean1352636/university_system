...
from education_system.post_18.university_system.modules.domain.academics.gui.exam_management.data_manager import DataManager
from education_system.post_18.university_system.modules.domain.academics.gui.exam_management.tabs import ScheduleTabMixin, ExamsTabMixin, RoomsTabMixin, CalendarTabMixin, DeferredExamTabMixin, AtRiskTabMixin, ExamEligibilityTabMixin, ResultsTabMixin, SeatingTabMixin
from education_system.post_18.university_system.modules.domain.academics.gui.exam_management.dialogs import DialogsMixin
