...
from education_system.post_18.university_system.infrastructure.database.db import get_connection as get_db_connection
...
try:
    ...
    from education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.trip_dialogs import (
        TripDetailsDialog, CreateTripDialog, TripSelectionDialog
    )
    from education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.registration_dialogs import (
        RegisterForTripDialog
    )
    from education_system.post_18.university_system.modules.domain.campus.mobility.gui.trip_management_gui.calendar_dialogs import (
...
try:
    from education_system.post_18.university_system.modules.domain.campus.mobility.services import trip_management
...
from education_system.post_18.university_system.modules.domain.academics.gui.academic_calendar.dialogs_search import (
...
def launch_calendar_gui(auth_manager=None):
    ...
    try:
        ...
        from education_system.post_18.university_system.modules.domain.academics.services.academic_calendar.cli import ensure_calendar_permissions
