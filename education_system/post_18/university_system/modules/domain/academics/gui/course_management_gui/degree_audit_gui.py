...
from education_system.post_18.university_system.modules.domain.academics.services.degree_audit.db_schema import initialize_degree_audit_database
...
class DegreeAuditGUI:
    ...
    def _open_ceremony_gui(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.graduation_ceremony_gui import (
