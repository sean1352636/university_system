from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.recommendations._imports import (
    tk, ttk, messagebox, sqlite3, _, DEFAULT_DB_PATH, datetime,
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.recommendations.validation import ValidationMixin
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.recommendations.prerequisites import PrerequisitesMixin
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.recommendations.scheduling import SchedulingMixin
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.recommendations.waitlists import WaitlistsMixin
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.recommendations.course_status import CourseStatusMixin
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.recommendations.wrappers import WrappersMixin
