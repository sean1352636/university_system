...
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.courses.course_crud import (
    CourseCreateDialog, CourseEditDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.courses.course_status import (
...
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.schedules.conflict_report import (
...
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.prerequisites.chain_viewer import (
    PrerequisiteChainDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.search.search import (
...
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.analytics.analytics import (
    CourseAnalyticsDialog, EnrollmentReportDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.bulk.bulk_operations import (
    BulkUpdateDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.maintenance.maintenance import (
    MaintenanceDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.maintenance.audit_log import (
    AuditLogViewerDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.import_export.import_export import (
    ImportExportDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.core.validation import (
    CourseValidationDialog
)
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.instructors.instructors import (
...
try:
    from education_system.post_18.university_system.modules.domain.academics.gui.course_health.course_health_gui import CourseHealthDashboardGUI
...
from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.academic_systems.templates_viewer import (
