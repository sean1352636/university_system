from education_system.post_18.university_system.modules.domain.academics.gui.course_management_gui.core._imports import _, messagebox, sqlite3, DEFAULT_DB_PATH, CourseEditDialog
