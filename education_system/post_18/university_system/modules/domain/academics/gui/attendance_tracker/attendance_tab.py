...
from education_system.post_18.university_system.modules.domain.academics.gui.attendance_tracker.attendance_windows import ManualAttendanceWindow, BatchAttendanceWindow, EditAttendanceWindow
from education_system.post_18.university_system.modules.domain.academics.gui.attendance_tracker.qr_windows import QRAttendanceWindow
from education_system.post_18.university_system.modules.domain.academics.gui.attendance_tracker.face_recognition_windows import FaceRecognitionAttendanceWindow
...
def _resolve_absence_user(self):
    ...
    if not user:
        return None
    try:
        from education_system.post_18.university_system.modules.domain.academics.services.attendance.absence_tracking import absence_tracker as at
        db = at.Database()
        try:
            resolved = None
...
def open_today_dashboard(self):
        try:
            from education_system.post_18.university_system.modules.domain.academics.services.attendance.absence_tracking.today_dashboard import (  # noqa: E501
                open_today_window,
            )
