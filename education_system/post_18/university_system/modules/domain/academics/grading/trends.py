...
from education_system.post_18.university_system.modules.domain.academics.grading.utils import calculate_trend_slope, select_student
from education_system.post_18.university_system.modules.domain.academics.grading.forecasting import forecast_success_rates
...
def analyze_single_course_trends(cursor, course):
    ...
    if len(monthly_data) < 3:
        print("Insufficient data for trend analysis (need at least 3 months)")
        return
...
def trend_forecasting():
    ...
    try:
        ...
        if choice == '1':
            try:
                from education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics import forecast_overall_performance
            ...
            try:
                from education_system.post_18.university_system.modules.domain.academics.grading.performance_analytics import forecast_course_performance
            ...
            try:
                from education_system.post_18.university_system.modules.domain.academics.grading.forecasting import forecast_module_difficulty
            ...
            try:
                from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation import forecast_assessment_performance
