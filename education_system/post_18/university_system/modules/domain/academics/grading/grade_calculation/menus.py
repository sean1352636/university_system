from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.db_init import init_enhanced_grades_db
...
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.views import view_student_grades
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.gpa import calculate_gpa
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.transcripts import generate_transcript
...
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.visualization import view_grade_distribution
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.learning_outcomes import map_assessments_to_competencies
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.utils import select_student
...
def display_enhanced_grade_menu():
    ...
    from education_system.post_18.university_system.modules.domain.academics.grading.learning_outcomes.menu import learning_outcome_menu
    from education_system.post_18.university_system.modules.domain.academics.grading.predictive_analytics import predictive_analytics_menu
    from education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis import performance_analysis_menu
...
def grade_curve_analysis_menu():
    ...
    from education_system.post_18.university_system.modules.domain.academics.grading.curve_analysis import apply_grading_curve
    from education_system.post_18.university_system.modules.domain.academics.grading.reports import generate_statistical_report
    while True:
...
def competency_assessment_menu():
    ...
    from education_system.post_18.university_system.modules.domain.academics.grading.competency import manage_competencies, record_student_competencies
    from education_system.post_18.university_system.modules.domain.academics.grading.competency_assessment import manage_competency_levels, view_student_competency_profile, generate_competency_report
    while True:
