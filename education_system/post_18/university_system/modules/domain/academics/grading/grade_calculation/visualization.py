...
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation.utils import select_assessment
...
def generate_assessment_stats_report(cursor, assessment_id, reports_dir, timestamp):
    ...
    try:
        ...
        elements.append(Paragraph("Assessment Statistical Report", title_style))
