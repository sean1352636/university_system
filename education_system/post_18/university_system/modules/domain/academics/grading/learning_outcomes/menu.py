from education_system.post_18.university_system.modules.domain.academics.grading.learning_outcomes.management import manage_learning_outcomes
from education_system.post_18.university_system.modules.domain.academics.grading.learning_outcomes.achievement import (
    record_outcome_achievement,
    view_student_outcome_achievement,
)
from education_system.post_18.university_system.modules.domain.academics.grading.learning_outcomes.reports import (
...
from education_system.post_18.university_system.modules.domain.academics.grading.grade_calculation import map_assessments_to_outcomes
