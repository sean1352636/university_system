...
def _bootstrap_auth_from_env():
    ...
    try:
        ...
        from education_system.post_18.university_system.infrastructure.auth import set_global_auth
        set_global_auth(shim)
        try:
            from education_system.post_18.university_system.infrastructure.shared_context import set_auth as _shared_set_auth
