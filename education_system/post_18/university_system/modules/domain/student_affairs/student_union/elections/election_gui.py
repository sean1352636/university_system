...
def _send_candidate_email(db, template_name, template_vars, student_id):
    ...
    try:
        from education_system.post_18.university_system.infrastructure.email.template_utils import (  # noqa: E501
            render_template,
        )
        ...
        return False
    try:
        from education_system.post_18.university_system.modules.shared.utils.email_service import (  # noqa: E501
            queue_email,
        )
...
class App:
    ...
    def _resolve_user(self):
        ...
        """
        try:
            from education_system.post_18.university_system.infrastructure.auth import (  # noqa: E501
                get_global_auth,
            )
            ga = get_global_auth()
