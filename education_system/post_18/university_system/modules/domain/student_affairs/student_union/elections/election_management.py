...
from education_system.post_18.university_system.core.institution_settings import get_elections_phone
...
def monitor_campaign_compliance(cursor):
    ...
    global auth
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.voting import (
...
def election_security_audit(cursor):
    ...
    global auth
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.voting import access_control_review
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.administration.admin_management import (
