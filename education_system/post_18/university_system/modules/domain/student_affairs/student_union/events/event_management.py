...
from education_system.post_18.university_system.core.institution_settings import get_events_support_phone
...
def manage_sustainable_events(student_id, cursor, conn):
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.points import auto_award_points
    try:
...
def manage_virtual_events():
    ...
    global auth
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.events import (
