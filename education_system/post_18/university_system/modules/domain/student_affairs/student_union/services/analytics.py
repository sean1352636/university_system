...
def generate_advanced_analytics():
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.events.event_management import event_popularity_predictions
