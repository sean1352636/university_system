...
def manage_green_initiatives():
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.events.event_management import manage_sustainable_events
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.administration.admin_management import generate_environmental_reports
