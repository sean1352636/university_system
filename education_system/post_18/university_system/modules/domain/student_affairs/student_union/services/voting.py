...
from education_system.post_18.university_system.modules.domain.student_affairs.student_union.services.communications import send_confirmation_email
...
def manage_enhanced_voting():
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union.elections.election_management import (
...
def test_email_notifications(cursor, conn):
    ...
    try:
        ...
        try:
            ...
            from education_system.post_18.university_system.infrastructure.email import queue_email
