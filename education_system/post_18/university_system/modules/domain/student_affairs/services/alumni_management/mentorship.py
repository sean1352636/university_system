...
from education_system.post_18.university_system.infrastructure.email import send_mentorship_notification
            ...
            if 0 <= mentor_index < len(mentor_matches):
                ...
                try:
                    ...
                    if mentor_email and mentee_email:
                        ...
                        print("   \u2709\ufe0f  Email notifications sent to mentor and mentee")
                    else:
                        print("   \u26a0\ufe0f  Could not send emails: Missing email address(es)")
                except Exception as e:
