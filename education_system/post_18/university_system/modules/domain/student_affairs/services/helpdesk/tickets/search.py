...
def execute_search(auth, criteria):
    ...
    # Text search
    if 'text' in criteria:
        where_conditions.append("(t.subject LIKE ? OR t.description LIKE ?)")
...
def display_search_results(auth, results):
    ...
    if ticket_choice:
        try:
            ...
            from education_system.post_18.university_system.modules.domain.student_affairs.services.helpdesk.tickets.display import view_ticket_detail_enhanced
