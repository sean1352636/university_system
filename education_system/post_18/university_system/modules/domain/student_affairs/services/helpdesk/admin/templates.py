...
def view_ticket_templates():
    ...
    cursor.execute('''
    SELECT template_id, name, category, priority, is_active
...
def create_ticket_template(auth):
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.services.helpdesk.tickets.creation import get_priority_selection, get_impact_selection, get_urgency_selection
