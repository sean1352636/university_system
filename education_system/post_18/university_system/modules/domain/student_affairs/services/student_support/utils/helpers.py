...
from education_system.post_18.university_system.core.sql_safety import validate_field_for_query
...
from education_system.post_18.university_system.modules.domain.student_affairs.services.student_support.config import NotificationType, TicketSentiment, FileType, SupportConfig
...
from education_system.post_18.university_system.modules.domain.student_affairs.services.student_support.utils.audit import audit_action
...
def validate_ticket_permissions(ticket, current_user):
    ...
    if current_user['role'] == 'student':
        ...
        if result and result[0] == ticket['user_id']:
            return True
...
def create_enhanced_ticket(support):
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.services.student_support.core.ticket_manager import display_ticket_details_enhanced
    try:
