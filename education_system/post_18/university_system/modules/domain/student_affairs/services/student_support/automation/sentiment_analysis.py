...
def _get_auto_assignment(category, priority, staff_assignments=None):
    ...
    if staff_assignments is None:
        from education_system.post_18.university_system.modules.domain.student_affairs.services.student_support.automation.background_tasks import _load_staff_assignments
