...
from education_system.post_18.university_system.modules.domain.student_affairs.services.student_support.core.attachment_manager import _process_attachments
...
def _update_ticket_on_response(ticket_id, ticket, response_time, cursor):
    ...
    SET updated_at = ?, status = ?, assigned_to = ?
    WHERE ticket_id = ?
