...
def create_ticket_template(name, title_template, description_template, category, priority):
    ...
    try:
        ...
        INSERT INTO ticket_templates (
            name, subject_template, message_template, category, priority,
...
def view_ticket_templates(support):
    ...
    try:
        ...
        for template in templates:
            ...
            print(f"   ✏️ Created by: {template['created_by']} on {template['created_at']}")
            print(f"   📝 Title: {template['subject_template'][:60]}...")
            print()
    except Exception as e:
