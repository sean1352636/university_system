...
try:
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui import StudentUnionGUI
...
# Import CLI fallback
try:
    from education_system.post_18.university_system.modules.domain.student_affairs.student_union import display_student_union_menu
except ImportError:
...
try:
    from education_system.post_18.university_system.core.paths import PROJECT_ROOT, DEFAULT_DB_PATH
except ImportError:
