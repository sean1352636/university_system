...
def system_maintenance_gui(self):
    ...
    def check_integrity():
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.services.helpdesk import check_data_integrity
    ...
    def backup_db():
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.services.helpdesk import backup_database
