from education_system.post_18.university_system.modules.domain.student_affairs.gui.internship_management._imports import messagebox, tk, ttk, sqlite3, get_connection
