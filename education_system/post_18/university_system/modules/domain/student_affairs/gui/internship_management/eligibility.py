...
from education_system.post_18.university_system.modules.domain.student_affairs.gui.internship_management._imports import tk, ttk, messagebox, scrolledtext, get_connection
...
• Status: {course_status}"""
    ...
    def open_grade_report(self, student_id):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.academics.gui.grade_tracking_management_gui import GradeTrackingManagementGUI as GradeManagementGUI
