from education_system.post_18.university_system.modules.domain.student_affairs.gui.internship_management._imports import datetime, messagebox, get_connection, tk, scrolledtext
