...
class EquipmentBrowseDialog:
    ...
    def checkout(self):
        ...
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.equipment.equipment_checkout import EquipmentCheckoutDialog
        dialog = EquipmentCheckoutDialog(self.dialog, self.auth, equipment_id, equipment_name)
        self.dialog.wait_window(dialog.dialog)
        self.load_data()

    def view_my_equipment(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.equipment.equipment_checkout import MyEquipmentDialog
...
class SearchEquipmentDialog:
    ...
    def checkout(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.equipment.equipment_checkout import CheckOutEquipmentDialog
