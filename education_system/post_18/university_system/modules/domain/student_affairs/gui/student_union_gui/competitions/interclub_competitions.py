...
"""
    ...
    def view_results(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.competitions.competition_results import CompetitionResultsDialog
        dialog = CompetitionResultsDialog(self.dialog, self.auth)
        self.dialog.wait_window(dialog.dialog)

    def create_competition(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.competitions.competition_admin import CreateCompetitionDialog
        dialog = CreateCompetitionDialog(self.dialog, self.auth)
        self.dialog.wait_window(dialog.dialog)

    def update_scores(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.competitions.competition_admin import UpdateCompetitionScoresDialog
