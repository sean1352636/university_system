...
from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.academic.resources import SharedResourcesDialog
from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.academic.tutoring import PeerTutoringDialog, AcademicWorkshopsDialog
from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.academic.study_groups import StudyGroupsDialog, ExamPrepGroupsDialog
...
class LearningIntegrationDialog:
    ...
    def organize_academic_conferences(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.conferences.conferences import AcademicConferencesOrganizerDialog
        dialog = AcademicConferencesOrganizerDialog(self.dialog, self.auth)
        self.dialog.wait_window(dialog.dialog)

    def research_presentation_platform(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.conferences.conferences import ResearchPresentationDialog
        dialog = ResearchPresentationDialog(self.dialog, self.auth)
        self.dialog.wait_window(dialog.dialog)

    def learning_analytics_dashboard(self):
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.analytics.analytics import LearningAnalyticsDashboardDialog
