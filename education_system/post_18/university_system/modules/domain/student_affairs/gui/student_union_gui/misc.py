...
def _get_event_attendance_dialog():
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.events.event_dialogs import EventAttendanceDialog
...
def main():
    """Main entry point"""
    import argparse
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.core.utilities import launch_cli, launch_gui
