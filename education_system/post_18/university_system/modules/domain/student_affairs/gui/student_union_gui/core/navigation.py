...
def switch_to_cli(self):
    ...
    if response:
        ...
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.student_union.administration.student_union_core import display_student_union_menu
            # Get current auth from GUI
            auth = get_auth()
            if auth:
                from education_system.post_18.university_system.modules.domain.student_affairs.student_union.administration.student_union_core import set_auth
                set_auth(auth)
...
def open_student_council_dialog(self):
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.student_union.student_council import (
