...
def join_club_gui(self):
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.clubs.club_dialogs import ClubJoinDialog
...
def create_club_gui(self):
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.clubs.club_dialogs import ClubCreateDialog
...
def manage_club_gui(self):
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.clubs.club_dialogs import ClubManageDialog
