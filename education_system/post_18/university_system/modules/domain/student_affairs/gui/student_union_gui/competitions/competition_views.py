...
class CompetitionsDialog:
    ...
    def register_competition(self):
        ...
        from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.competitions.competition_registration import CompetitionRegistrationDialog
