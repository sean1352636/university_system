...
"""
    ...
    def open_shop_for_club_merchandise(self, club_name):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.commerce.gui.shop_management_gui.main_gui import UniversityShopGUI
...
def get_gui_instance():
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.core.main_gui import StudentUnionGUI
...
def main_menu():
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.misc import launch_student_union_gui
    try:
...
def launch_cli():
    ...
    if CLI_AVAILABLE:
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.student_union.administration.student_union_core import main as cli_main
            cli_main()
        except ImportError:
            print("Error: Cannot import CLI system")
    else:
...
if __name__ == "__main__":
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.misc import main
    main()
