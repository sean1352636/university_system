...
def register_club_for_competition_gui(self):
    ...
    from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.competitions.competition_views import CompetitionsDialog
    try:
