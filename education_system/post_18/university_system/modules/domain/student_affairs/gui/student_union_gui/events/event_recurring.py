...
from education_system.post_18.university_system.modules.domain.student_affairs.gui.student_union_gui.events.event_dialogs import EventManagementDialog
