...
from education_system.post_18.university_system.modules.domain.student_affairs.services.career_services.career_services_core import (
...
class CareerServicesGUI:
    ...
    def _init_database(self):
        ...
        try:
            from education_system.post_18.university_system.infrastructure.database.schemas.career_alumni_schemas import init_career_services_system_db
    ...
    def create_job_posting(self):
        ...
        try:
            ...
            print("🔄 Calling load_jobs() to refresh the list...")
            self.load_jobs()
