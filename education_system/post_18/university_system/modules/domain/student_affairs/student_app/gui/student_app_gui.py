...
class StudentAppGUI:
    def __init__(self, parent=None, auth=None):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.student_app.services.student_app_service import StudentAppService
    ...
    def _open_documents(self):
        try:
            from education_system.post_18.university_system.modules.domain.student_affairs.student_app.documentation.gui.documentation_gui import (
                DocumentationGUI,
            )
