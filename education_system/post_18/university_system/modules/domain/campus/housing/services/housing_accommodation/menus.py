...
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.database import init_housing_db
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.buildings import create_building, create_rooms_for_building, view_building, update_building, delete_building
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.applications import create_application, view_application, process_application
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.assignments import view_assignment, update_assignment_status
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.maintenance import create_maintenance_request, view_maintenance_requests, update_maintenance_request
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.payments import record_payment, view_payment_history
...
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.interest import (
    accrue_deposit_interest, view_interest_accruals,
)
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.deposit_state import (
    view_deposit_state,
)
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.inventory import manage_inventory
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.inspections import create_inspection, view_inspections
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.reports import display_reports_menu
from education_system.post_18.university_system.modules.domain.campus.housing.services.housing_accommodation.extended_cli import display_extended_housing_menu
...
def display_housing_accommodation_menu(auth_instance=None):
    ...
    while True:
        ...
        if auth.check_permission('manage_accommodations'):
            ...
            print("   - Move-out · Waitlist · Vacancy board · Bulk ops · "
                  "Broadcasts · Resident search · Keys · Contracts · "
                  "Checklists · Guests · Damages · Audit log · Roommate finder")
            ...
            print("4. My Deposit Deductions (review / dispute)")
