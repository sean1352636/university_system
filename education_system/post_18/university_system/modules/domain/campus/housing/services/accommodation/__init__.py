...
#
#     from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation \
...
# -- auth / audit --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.audit import (
    auth,
    set_auth,
    log_action,
)
...
# -- database / schema --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.db import (
...
# -- CRUD operations --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.crud import (
    add_accommodation,
...
# -- document upload --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.documents import (
    upload_accommodation_document,
)

# -- templates --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.templates import (
    save_template,
    apply_template,
)

# -- approval workflow --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.approval import (
    approve_accommodation,
)

# -- notifications --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.notifications import (
    notify_student,
    check_expiry_notifications,
)

# -- import / export --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.import_export import (
...
# -- dashboard & reports --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.dashboard import (
...
# -- CLI menu --
from education_system.post_18.university_system.modules.domain.campus.housing.services.accommodation.menu import (
