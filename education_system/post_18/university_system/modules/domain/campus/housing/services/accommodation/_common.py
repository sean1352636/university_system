...
try:
    from education_system.post_18.university_system.infrastructure.auth import get_current_user, UserAuth
except ImportError:
...
try:
    from education_system.post_18.university_system.infrastructure import email as email_manager
except ImportError:
    email_manager = None
