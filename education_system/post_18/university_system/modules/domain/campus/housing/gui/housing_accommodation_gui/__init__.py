...
try:
    from education_system.post_18.university_system.modules.domain.campus.housing.gui.housing_accommodation_gui.finance_integration import HousingFinanceManager
except ImportError:
