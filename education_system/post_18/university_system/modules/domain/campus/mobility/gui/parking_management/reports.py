...
from education_system.post_18.university_system.modules.domain.campus.mobility.gui.parking_management import get_connection, _t, PARKING_ZONES, TEMPLATE_AVAILABLE, render_template
