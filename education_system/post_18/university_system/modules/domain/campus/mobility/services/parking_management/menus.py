...
from education_system.post_18.university_system.core.i18n import get_text, get_current_language
...
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management.permits import create_parking_permit, view_parking_permit, update_parking_permit, delete_parking_permit
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management.vehicles import register_vehicle, view_vehicle, update_vehicle, delete_vehicle
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management.violations import record_violation, view_violations, update_violation, delete_violation
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management.lots import view_parking_lots, add_parking_lot, update_parking_lot, delete_parking_lot, update_available_spaces
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management.reports import (generate_permit_report, generate_violation_report, generate_compliance_report,
                      generate_analytics_dashboard, generate_revenue_report, generate_user_activity_report)
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management.exports import export_data
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management.core import init_db
from education_system.post_18.university_system.infrastructure.database.data_backup import backup_before_operation
from education_system.post_18.university_system.modules.domain.campus.mobility.services.parking_management import core
...
def display_reports_menu():
    ...
    while True:
        ...
        print("6. " + get_text("parking.menu.analytics_dashboard", default="Analytics Dashboard"))
        print("7. " + get_text("parking.menu.manual_backup", default="Manual Backup"))
        print("8. " + _t("parking.menu.return_to_main"))
        ...
        elif choice == '6' and auth.check_permission('generate_reports'):
            generate_analytics_dashboard()
        elif choice == '7' and auth.check_permission('generate_reports'):
            backup_path = backup_before_operation('manual_backup')
            if backup_path:
                print(get_text("parking.msg.backup_created",
                               default="Backup created: {path}").format(path=backup_path))
            else:
                print(get_text("parking.msg.backup_failed",
                               default="Backup could not be created."))
        elif choice == '8':
            return
        else:
            print(_t("parking.error.invalid_choice_or_no_permission"))
