...
from education_system.post_18.university_system.modules.domain.campus.mobility.services.trip_management._common import (
    sqlite3, get_text, logging, datetime, os, log_create,
    REPORTS_DIR, PDF_AVAILABLE,
)
from education_system.post_18.university_system.modules.domain.campus.mobility.services.trip_management.database import safe_db_operation, get_db_connection
...
class TripReportGenerator:
    ...
    def _write_participant_list_txt(self, f, data):
        ...
        try:
            ...
            f.write("PARTICIPANT LIST REPORT\n")
