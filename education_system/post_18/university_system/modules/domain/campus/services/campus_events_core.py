...
def _add_to_academic_calendar(event_name, event_date, description, event_type, created_by=None):
    ...
    try:
        ...
        logger.debug(
            "Academic-calendar mirror insert failed for event '%s'; continuing",
    ...
    while True:
        try:
            ...
            if choice in ['1', '2', '3', '4', '5', '6', '7']:
                ...
                print(get_text("campus.events.menu.use_instruction", "Use: from education_system.post_18.university_system.modules.domain.campus.services import CampusEventManager"))
            elif choice == '8':
                break
            else:
