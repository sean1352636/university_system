...
def get_student_account_balance(student_id):
    ...
    try:
        from education_system.post_18.university_system.modules.shared.utils.finance_integration import get_student_finance_account_balance
...
def process_student_payment(student_id, amount, description, transaction_ref):
    ...
    try:
        from education_system.post_18.university_system.modules.shared.utils.finance_integration import process_student_finance_account_payment
...
def send_receipt_email(recipient_email, recipient_name, amount, donation_type, transaction_ref, payment_method):
    ...
    try:
        ...
        try:
            ...
            subject = "Donation Receipt - Grace Community Church"
