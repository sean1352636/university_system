...
def display_facilities_management_menu(auth):
    ...
    """
    from education_system.post_18.university_system.modules.domain.campus.facilities.cli.facilities_cli import (
        run_facilities_menu,
    )
...
def launch_facilities_management_gui(root, auth):
    ...
    """
    try:
        from education_system.post_18.university_system.modules.domain.campus.facilities.gui.building_management_app import (
            launch_in_window,
        )
...
try:
    from education_system.post_18.university_system.modules.domain.campus.room_booking.services.room_booking_service import (  # noqa: F401
        RoomBookingService,
        RoomBookingError,
    )
