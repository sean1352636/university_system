...
import os
import csv
from education_system.post_18.university_system.core.paths import FINANCE_TEMPLATES_DIR
import numpy as np
...
from education_system.post_18.university_system.modules.domain.finance.core.account_management import assign_fees_to_student, record_payment, generate_invoice, view_student_financial_statement, process_refund, api_record_payment, manage_student_credits
from education_system.post_18.university_system.modules.domain.finance.billing.payment_plans import create_payment_plan, manage_payment_plans, view_active_payment_plans, process_payment_plan_payment, send_payment_plan_notification, modify_payment_plan, cancel_payment_plan
from education_system.post_18.university_system.modules.domain.finance.billing.fee_structure import calculate_late_fees, waive_late_fee, update_exchange_rates, convert_currency, api_get_exchange_rates, currency_conversion_tool
from education_system.post_18.university_system.modules.domain.finance.reporting.revenue_analytics import generate_financial_reports, revenue_summary_report, generate_budget_variance_report, generate_outstanding_fees_report, generate_payment_collection_report, generate_predictive_analytics, generate_financial_dashboard, student_account_summary_report, fee_type_analysis_report, payment_method_analysis_report, monthly_revenue_trend_report, scholarship_reports, student_scholarship_report, generate_audit_report, generate_revenue_forecast, generate_forecast_values, generate_enrollment_based_forecast, create_revenue_forecast_chart, save_forecast_to_database, manage_collections, create_collection_case, send_collection_notice, generate_aid_reports, loan_repayment_status_report, generate_financial_forecasting, generate_budget_variance_forecast, generate_comprehensive_forecast_report, generate_budget_reports, budget_summary_report, variance_analysis_report, category_performance_report, assign_to_collection_agency, track_collection_progress, update_collection_case_status, generate_collection_reports, collection_performance_summary, agency_performance_report, manage_collection_agencies, view_collection_agencies, add_collection_agency, setup_collection_workflows, aging_analysis_report, collection_case_status_report, view_student_collection_detail, edit_collection_agency, deactivate_collection_agency, export_forecast_report
from education_system.post_18.university_system.modules.domain.finance.scholarships.scholarship_programs import manage_scholarships, view_available_scholarships, create_new_scholarship, award_scholarship_to_student, view_student_scholarships, scholarship_distribution_summary, scholarship_utilization_analysis, manage_financial_aid, view_financial_aid_applications, create_financial_aid_application, disburse_financial_aid
from education_system.post_18.university_system.modules.domain.finance.core.security_automation import detect_payment_fraud, create_approval_workflow, setup_automated_notifications, send_automated_notifications
...
# from education_system.post_18.university_system.modules.domain.finance.core.security_automation  import setup_automated_notifications, send_automated_notifications, send_notification, send_email_notification, send_sms_notification, enhanced_notification_system, detect_payment_fraud, log_audit_action, create_approval_workflow, send_aid_decision_notification, send_disbursement_notification, budget_approval_workflow, verify_jwt_in_request, api_endpoint
# from education_system.post_18.university_system.modules.domain.finance.finance_budgeting_collection import manage_budgets, create_budget_plan, add_budget_line_items, view_budget_plans, view_budget_plan_detail, update_budget_plan, update_budget_line_items, recalculate_budget_totals, budget_vs_actual_analysis, manage_budget_categories, view_budget_categories, create_budget_category, edit_budget_category, deactivate_budget_category, budget_performance_trends
try:
    # finance_misc is optional in some deployments; keep the import best-effort
    from education_system.post_18.university_system.modules.domain.finance.core import set_auth as set_finance_misc_auth
except ImportError:
...
def init_enhanced_finance_db():
    ...
    try:
        ...
        # context_json, step_history_json, etc.). The finance schema
        # used to create a different-shaped table with the same name
        # but no finance code ever queried it — leaving the dead
        # CREATE here would clobber the generic engine's table on a
        # fresh DB. Removed.
    ...
    while True:
        ...
        try:
            ...
            # Advanced Reports Menu
                ...
                from education_system.post_18.university_system.modules.domain.finance.reporting.financial_reports import display_enhanced_finance_menu as display_finance_reporting_menu
