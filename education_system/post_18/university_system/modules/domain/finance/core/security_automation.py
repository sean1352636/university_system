...
from education_system.post_18.university_system.modules.domain.finance.core.students import get_student_phone
# Configure logging
...
def send_email_notification(email, subject, body, method='smtp'):
    ...
    try:
        ...
        return send_email(recipient_email=email, subject=subject, body=body)
    except ImportError:
...
def enhanced_notification_system():
    ...
    from education_system.post_18.university_system.modules.domain.finance.core.communications import setup_email_config, setup_sms_config, test_email_service, test_sms_service
    from education_system.post_18.university_system.modules.domain.finance.reporting.budget_analysis import create_budget_category
    while True:
...
def budget_approval_workflow():
    ...
    from education_system.post_18.university_system.modules.domain.finance.reporting.budget_analysis import view_budget_plan_detail
    try:
        conn = get_connection()
        cursor = conn.cursor()
