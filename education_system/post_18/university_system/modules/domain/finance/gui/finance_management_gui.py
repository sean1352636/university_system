...
try:
    ...
    from education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting import FinancialManagementGUI as FinanceReportingGUI
...
# Import CLI fallback
try:
    from education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting.misc import display_finance_menu as _display_finance_menu
...
try:
    from education_system.post_18.university_system.modules.domain.finance.core.financial_core import set_finance_auth as _set_finance_cli_auth
except Exception:
    _set_finance_cli_auth = None

from education_system.post_18.university_system.infrastructure.auth import UserAuth
from education_system.post_18.university_system.modules.shared.gui.theme_config import get_theme_manager
