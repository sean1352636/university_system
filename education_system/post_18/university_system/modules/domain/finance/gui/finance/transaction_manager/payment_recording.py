...
try:
    from education_system.post_18.university_system.infrastructure.email.email_service import send_email as _send_email
except Exception:
...
class PaymentRecordingMixin:
    ...
    def view_payment_details(self):
        ...
        from education_system.post_18.university_system.modules.domain.finance.gui.finance.invoice_manager import PaymentDetailsDialog
