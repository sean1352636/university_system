...
This fine has been removed from your account.
...
"""
    ...
    def create_library_finance_tab(self):
        ...
        notebook.add(fines_tab, text="📋 " + _("library_finance.tabs.fine_management"))
        self.create_fines_section(fines_tab)

        # Tab 2: Revenue Analytics
        revenue_tab = tk.Frame(notebook, bg='white')
        notebook.add(revenue_tab, text="💰 " + _("library_finance.tabs.revenue_analytics"))
        self.create_revenue_section(revenue_tab)

        # Tab 3: Book Costs
        costs_tab = tk.Frame(notebook, bg='white')
        notebook.add(costs_tab, text="📖 " + _("library_finance.tabs.book_costs"))
        self.create_costs_section(costs_tab)

        # Tab 4: Financial Overview
        overview_tab = tk.Frame(notebook, bg='white')
        notebook.add(overview_tab, text="📊 " + _("library_finance.tabs.overview"))
    ...
    def create_fines_section(self, parent):
        ...
        tk.Label(toolbar, text=_("library_finance.labels.search_user"), bg='white', font=('Arial', 10)).pack(side='left', padx=5)
