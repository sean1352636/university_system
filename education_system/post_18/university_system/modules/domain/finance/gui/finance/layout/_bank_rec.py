...
class BankRecMixin:
    ...
    def create_bank_rec_tab(self):
        ...
        def reload_statements():
            from education_system.post_18.university_system.modules.domain.finance.bank_rec import list_statements
            try:
        ...
        def reload_lines(*_a):
            ...
            if sid is None:
                ...
                return
            from education_system.post_18.university_system.modules.domain.finance.bank_rec import list_lines
            try:
    ...
    def _bank_rec_init_action(self):
        from education_system.post_18.university_system.modules.domain.finance.bank_rec import init_bank_rec
        try:
            init_bank_rec()
    ...
    def _bank_rec_import_action(self, reload_statements):
        ...
        from education_system.post_18.university_system.modules.domain.finance.bank_rec import import_csv
    ...
    def _bank_rec_automatch_action(self, statement_var, reload_lines):
        from education_system.post_18.university_system.modules.domain.finance.bank_rec import auto_match_statement
    ...
    def _bank_rec_manual_match_action(self, tree, reload_lines):
        ...
        from education_system.post_18.university_system.modules.domain.finance.bank_rec import manual_match
        from education_system.post_18.university_system.infrastructure.shared_context import get_auth
        try:
            auth = get_auth()
            user = (auth.current_user.get('username', 'admin')
    ...
    def _bank_rec_unmatch_action(self, tree, reload_lines):
        ...
        if not messagebox.askyesno("Unmatch", f"Reset line {line_id} to 'unmatched'?"):
            return
        from education_system.post_18.university_system.modules.domain.finance.bank_rec import unmatch
        try:
            unmatch(line_id)
        except Exception as e:
    ...
    def _bank_rec_discard_action(self, tree, reload_lines):
        ...
        from education_system.post_18.university_system.modules.domain.finance.bank_rec import discard
        from education_system.post_18.university_system.infrastructure.shared_context import get_auth
        try:
            auth = get_auth()
            user = (auth.current_user.get('username', 'admin')
