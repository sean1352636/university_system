...
class CurrencyMixin:
    ...
    def update_exchange_rates_table(self, rates):
        ...
        try:
            ...
            for rate in rates:
                # Convert sqlite3.Row to a tuple so the Treeview renders the
                # column values rather than the "<sqlite3.Row>" repr.
                self.exchange_rates_tree.insert('', 'end', values=tuple(rate))
