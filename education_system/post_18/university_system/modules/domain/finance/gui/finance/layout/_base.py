...
import base64
from education_system.post_18.university_system.modules.domain.finance.gui.finance_reporting import launch_financial_gui
from education_system.post_18.university_system.core.i18n import get_text as _

# Import Research & Grants GUI
try:
    from education_system.post_18.university_system.modules.domain.academics.research.gui.research_grants_gui import launch_research_grants_gui
...
try:
    from education_system.post_18.university_system.modules.domain.finance.gui.financial_aid.financial_aid_gui import launch_financial_aid_gui
...
try:
    from education_system.post_18.university_system.modules.domain.finance.core.financial_core import (
...
# ---------------------------------------------------------------------------
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._styles import StylesMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._navigation import NavigationMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._dashboard import DashboardMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._core_finance import CoreFinanceMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._refunds import RefundsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._payments import PaymentsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._payment_plans import PaymentPlansMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._fees import FeesMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._late_fees import LateFeesMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._students import StudentsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._currency import CurrencyMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._analytics import AnalyticsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._scholarships import ScholarshipsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._reports import ReportsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._revenue import RevenueMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._collections import CollectionsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._financial_aid import FinancialAidMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._budget import BudgetMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._forecasting import ForecastingMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._admin import AdminMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._research_grants import ResearchGrantsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._bank_app import BankAppMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._club_payments import ClubPaymentsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._settings import SettingsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._status_bar import StatusBarMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._ledger import LedgerMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._bank_rec import BankRecMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.layout._statements import StatementsMixin
