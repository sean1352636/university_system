...
class StatementsMixin:
    ...
    def create_statements_tab(self):
        ...
        def reload_runs():
            from education_system.post_18.university_system.modules.domain.finance.statements import list_runs
            try:
                runs = list_runs()
            except Exception:
                runs = []
        ...
        def reload_lines(*_a):
            ...
            if rid is None:
                ...
                return
            from education_system.post_18.university_system.modules.domain.finance.statements import list_statements
            try:
    ...
    def _statements_init_action(self):
        from education_system.post_18.university_system.modules.domain.finance.statements import init_statements
        try:
            init_statements()
    ...
    def _statements_run_action(self, reload_runs):
        ...
        from education_system.post_18.university_system.modules.domain.finance.statements import run_statements_batch
