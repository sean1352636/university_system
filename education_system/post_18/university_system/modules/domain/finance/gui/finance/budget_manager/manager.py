...
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.plans import BudgetPlansMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.categories import BudgetCategoriesMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.personal import PersonalBudgetMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.expenses_income import ExpensesIncomeMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.savings import SavingsGoalsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.meal_plan import MealPlanMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.textbooks import TextbooksMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.reports import BudgetReportsMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.institutional import InstitutionalBudgetMixin
from education_system.post_18.university_system.modules.domain.finance.gui.finance.budget_manager.utils import BudgetUtilsMixin
...
class BudgetManager(
    ...
    def create_budget_tab(self):
        ...
        try:
            from education_system.post_18.university_system.modules.domain.finance.budget.services.budget_service import BudgetManager
