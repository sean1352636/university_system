...
class MealPlanMixin:
    ...
    def log_meal_transaction(self):
        ...
        try:
            ...
            from education_system.post_18.university_system.modules.domain.finance.budget.services.budget_service import MealPlanManager
            ...
            messagebox.showinfo("Success", "Meal transaction logged!")
