...
class RecommendationsMixin:
    ...
    def _load_recommendations(self):
        ...
        try:
            ...
            from education_system.post_18.university_system.modules.domain.finance.scholarship_finder.services.scholarship_service import RecommendationEngine
    ...
    def _on_rec_selection(self, event):
        ...
        try:
            ...
            if tags:
                ...
                from education_system.post_18.university_system.modules.domain.finance.scholarship_finder.services.scholarship_service import ScholarshipDatabase
    ...
    def _start_application_from_rec(self):
        ...
        try:
            ...
            if messagebox.askyesno(get_text("financial_aid.student_portal.confirm", "Confirm"), get_text("financial_aid.student_portal.recommendations.confirm_start_application", "Start application for this scholarship?")):
                from education_system.post_18.university_system.modules.domain.finance.scholarship_finder.services.scholarship_service import ApplicationManager
