...
def sweep_cohort_attendance_risk(*, threshold_pct: float = _COHORT_RISK_THRESHOLD,
    ...
    try:
        from education_system.post_18.university_system.modules.services.attendance_bus import (
...
def _on_enrolment_added(**payload: Any) -> None:
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.study_matching.services.study_matching_service import (
