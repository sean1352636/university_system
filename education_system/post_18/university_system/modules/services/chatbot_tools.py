...
def tool_balance(student_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.post_18.university_system.modules.services.finance_bus import (
            student_balance,
        )
...
def tool_qualified_for(instructor_id: int | str, module_code: str) -> dict[str, Any]:
    try:
        from education_system.post_18.university_system.modules.services.staff_hr_bus import (
            is_qualified_for,
        )
...
def tool_certs_expiring(within_days: int = 30,
    ...
    try:
        from education_system.post_18.university_system.modules.services.cert_bus import (
...
def tool_documents_for(domain: str, ref_id: str | int) -> dict[str, Any]:
    try:
        from education_system.post_18.university_system.modules.services.document_bus import (
            get_documents_for,
        )
...
def tool_move_slot(schedule_id: int,
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.services.module_scheduling.slot_writer import (
            move_slot,
        )
...
def tool_schedule_exam(*, module_code: str, date: str,
    ...
    try:
        from education_system.post_18.university_system.modules.domain.academics.gui.exam_management.models import (
            Exam,
        )
        from education_system.post_18.university_system.modules.domain.academics.gui.exam_management.data_manager import (
            ExamDataManager,
        )
        exam = Exam(
            id=0,
...
def tool_my_open_cases(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.post_18.university_system.modules.services.cases_bus import (
            list_open,
        )
...
def tool_my_engagements(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.post_18.university_system.modules.services.careers_bus import (
            list_engagements,
        )
...
def tool_my_trips(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.post_18.university_system.modules.services.trip_bus import (
...
def tool_my_parking(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.post_18.university_system.modules.services.parking_bus import (
...
def tool_todays_menu() -> dict[str, Any]:
    ...
    try:
        from education_system.post_18.university_system.modules.services.restaurant_bus import (
            menu_for,
        )
