...
from education_system.post_18.university_system.modules.services.cli.betting_shop_cli.menus import betting_shop_menu, launch_betting_shop_cli

__all__ = ['betting_shop_menu', 'launch_betting_shop_cli']
