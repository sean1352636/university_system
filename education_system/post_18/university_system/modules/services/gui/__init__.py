...
Usage:
    from education_system.post_18.university_system.modules.services.gui import health_portal_gui
...
try:
    from education_system.post_18.university_system.modules.services.gui.health_portal_gui import HealthPortalGUI
    __all__.append('HealthPortalGUI')
except ImportError:
    pass

try:
    from education_system.post_18.university_system.modules.services.gui.integration_marketplace_gui import launch_integration_marketplace_gui
