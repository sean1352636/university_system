...
try:
    from education_system.post_18.university_system.infrastructure.auth.sso_providers import SAMLProvider
    SAML_AVAILABLE = True
except ImportError:
    SAMLProvider = None
...
try:
    from education_system.post_18.university_system.infrastructure.auth.sso_providers import OIDCProvider
    OIDC_AVAILABLE = True
except ImportError:
    OIDCProvider = None
