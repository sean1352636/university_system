...
Usage:
    from education_system.post_18.university_system.infrastructure.auth.webauthn_service import WebAuthnService
...
class WebAuthnService:
    ...
    Examples
    --------
    >>> from education_system.post_18.university_system.infrastructure.auth.managers import DatabaseConnectionManager
