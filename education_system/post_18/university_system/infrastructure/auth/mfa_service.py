...
try:
    from education_system.post_18.university_system.infrastructure.auth.sms_provider import send_otp as send_sms_otp
...
try:
    from education_system.post_18.university_system.infrastructure.auth.email_otp_service import send_otp as send_email_otp
