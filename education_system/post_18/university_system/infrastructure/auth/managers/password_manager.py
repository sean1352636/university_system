...
from education_system.post_18.university_system.infrastructure.auth.core_utils.utils import validate_password
        ...
        try:
            ...
            try:
                ...
                if student_result and student_result[0]:
                    ...
                    from education_system.post_18.university_system.infrastructure.email.email_service import send_password_reset
