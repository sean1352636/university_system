...
try:
    from education_system.post_18.university_system.infrastructure.auth.optional_dependencies import is_chatbot_available
except ImportError:
...
def initialize_complete_system():
    ...
    try:
        ...
        from education_system.post_18.university_system.infrastructure.auth.integrations.chatbot_integration import setup_chatbot_permissions
        setup_chatbot_permissions(auth)

        # Initialize chatbot integration
        print("3. Initializing chatbot integration...")
        from education_system.post_18.university_system.infrastructure.auth.integrations.chatbot_integration import initialize_chatbot_integration
...
def verify_ai_detector_setup():
    ...
    try:
        ...
        if missing_tables or missing_permissions:
            print("❌ AI Detector setup incomplete:")
            if missing_tables:
