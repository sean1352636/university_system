...
try:
    from education_system.post_18.university_system.infrastructure.shared_context import get_auth as _get_shared_auth
...
from education_system.post_18.university_system.infrastructure.email.state import auth_proxy as _state_auth
