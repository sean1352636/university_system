...
from education_system.post_18.university_system.infrastructure.email.email_service.queue import (
    email_queue,
    worker_threads,
    worker_threads_lock,
    stop_workers_event,
...
from education_system.post_18.university_system.infrastructure.email.email_service.scheduling import (
    scheduled_jobs,
    scheduled_jobs_lock,
    send_bulk,
    schedule_send,
...
from education_system.post_18.university_system.infrastructure.email.email_service.cli import (
...
from education_system.post_18.university_system.infrastructure.email.email_service.maintenance import (
...
from education_system.post_18.university_system.infrastructure.email.email_service.notifications import (
    # Academic
...
from education_system.post_18.university_system.infrastructure.email.email_db_utilities import _ensure_db_ready, execute_db_operation
from education_system.post_18.university_system.core.logs import handle_exception, log_event
from education_system.post_18.university_system.infrastructure.email.templates import (
