...
from education_system.post_18.university_system.core import paths as sys_paths
...
def load_config(path: str | Path | None = None) -> Dict[str, Any]:
    ...
    try:
        from education_system.shared.email.config import load_email_config as _shared_load
...
def save_config(path: str | Path | None = None) -> None:
    ...
    """
    try:
        from education_system.shared.email.config import save_email_config
