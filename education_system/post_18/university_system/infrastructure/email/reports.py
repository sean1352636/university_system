...
def get_system_health_info():
    ...
    from education_system.post_18.university_system.infrastructure.email.email_service import email_queue, worker_threads  # Local import to avoid circular dependency
