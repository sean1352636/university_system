...
Usage:
    ...
    from education_system.post_18.university_system.infrastructure.email.email_scheduler import start_scheduler, stop_scheduler
...
from education_system.post_18.university_system.infrastructure.email.email_manager import send_sla_alert
from education_system.post_18.university_system.core.logs import log_event
...
def check_visa_expiry_alerts():
    ...
    try:
        from education_system.post_18.university_system.modules.domain.student_affairs.international_compliance.services import visa_service as _vs
...
def refresh_external_qa_kpis():
    ...
    try:
        from education_system.post_18.university_system.modules.domain.analytics.external_qa_kpis import (
