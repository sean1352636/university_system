...
from education_system.post_18.university_system.infrastructure.database import db as _db_module
...
try:
    from education_system.post_18.university_system.infrastructure.database.schemas.core_schemas import init_grade_system_db
    from education_system.post_18.university_system.infrastructure.database.schemas.finance_schemas import init_finance_system_db
    from education_system.post_18.university_system.infrastructure.database.schemas.student_union_schemas import init_student_union_db
    from education_system.post_18.university_system.infrastructure.database.schemas.communication_schemas import init_email_system_db
