...
from education_system.post_18.university_system.core.paths import DEFAULT_DB_PATH, DATA_DIR
from education_system.post_18.university_system.infrastructure.database.db import get_connection

# ── Config / globals ──────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.config import (
    DEFAULT_CONFIG,
    backup_history,
    backup_thread,
    config,
...
# ── Metadata ──────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.metadata import (
    BackupMetadata,
    metadata_manager,
)
...
# ── Storage ───────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.storage import (
...
# ── Notifications ─────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.notifications import (
...
# ── Core operations ───────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.operations import (
    ProgressTracker,
...
# ── Exports ───────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.exports import (
    export_to_csv,
    export_to_json,
    export_to_xml,
)
...
# ── Analysis ──────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.analysis import (
    compare_backups,
    compare_table_data,
...
# ── Retention ─────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.retention import (
    cleanup_old_backups,
    delete_backup,
...
# ── Templates ─────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.templates import (
    load_backup_template,
    save_backup_template,
)

# ── Scheduling ────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.scheduling import (
    parse_cron_schedule,
...
# ── CLI menus ─────────────────────────────────────────────────────────────────
from education_system.post_18.university_system.infrastructure.database.data_backup.cli_menu import (
    configure_backups,
