...
import education_system.post_18.university_system.infrastructure.database.data_backup.config as _cfg
from education_system.post_18.university_system.infrastructure.database.data_backup.operations import create_enhanced_backup
...
def scheduled_backup_job():
    ...
    try:
        ...
        if config["auto_validate"] and backup_path:
            from education_system.post_18.university_system.infrastructure.database.data_backup.analysis import validate_backup
