...
from education_system.post_18.university_system.infrastructure.ai.ai_detector.core.constants import logger, ML_AVAILABLE
from education_system.post_18.university_system.infrastructure.ai.ai_detector.core.exceptions import AIDetectionError
