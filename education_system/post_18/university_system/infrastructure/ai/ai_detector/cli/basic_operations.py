...
def _get_ai_detector():
    ...
    import education_system.post_18.university_system.infrastructure.ai.ai_detector.cli.interface as _iface
...
def view_submission_history_safe():
    ...
    try:
        ...
        try:
            ...
            from education_system.post_18.university_system.infrastructure.ai.ai_detector.cli.interface import fix_ai_detector_database_schema
