...
from education_system.post_18.university_system.infrastructure.ai.university_chatbot.chatbot import UniversityChatbot
from education_system.post_18.university_system.infrastructure.ai.university_chatbot.minimal_chatbot import MinimalChatbot
...
from education_system.post_18.university_system.infrastructure.ai.university_chatbot.services import (
    AdminPanel,
    AnalyticsService,
    BackgroundScheduler,
...
def _lazy_auth():
    ...
    if AUTH_AVAILABLE:
        return
    try:
        from education_system.post_18.university_system.infrastructure.auth import UserAuth as _UA, get_current_user as _gcu, PERMISSIONS as _P
        UserAuth = _UA
