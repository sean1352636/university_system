...
from education_system.post_18.university_system.infrastructure.ai.gui.manager import ChatbotManager
from education_system.post_18.university_system.infrastructure.ai.gui.compat import BackwardCompatibilityWrapper
...
def run_enhanced_chatbot():
    ...
    try:
        from education_system.post_18.university_system.infrastructure.ai.university_chatbot import _lazy_auth, AUTH_AVAILABLE, MinimalChatbot
    except ImportError:
