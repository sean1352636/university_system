...
from education_system.post_18.university_system.core.paths import PROJECT_ROOT, LOG_DIR
import logging
...
def get_student_db_connection():
    ...
    from education_system.post_18.university_system.infrastructure.database.db import sqlite3
    import os
    from education_system.post_18.university_system.infrastructure.database.db import DEFAULT_DB_PATH as DB_PATH
