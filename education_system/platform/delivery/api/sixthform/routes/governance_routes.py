...
def list_policies_route():
    from education_system.systems.sixth_form.domain.governance.policies import (  # noqa: E501
        policies as data,
    )
    try:
...
def list_risks_route():
    from education_system.systems.sixth_form.domain.governance.risk_management import (  # noqa: E501
