...
from education_system.platform.delivery.api.university.auth import token_required, token_or_mfa_token_required
from education_system.systems.university.infrastructure.auth import MFAService
