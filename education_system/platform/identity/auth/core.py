...
class UserAuth:
    ...
    def _try_recovery_code_login(self, conn, user_id: int, candidate: str) -> bool:
        ...
        try:
            from education_system.platform.identity.auth.mfa_service import MFAService, MFAError
        except ImportError:
            return False
    ...
    def get_role_for_system(self, system_key: str) -> str | None:
        ...
        if not self._current_user:
            return None
        from education_system.platform.kernel.core.system_keys import canonical_system_key
