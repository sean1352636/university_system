...
def create_assignment():
    ...
    return jsonify({"message": "Assignment created.", "data": assignment}), 201
...
def update_assignment(assignment_id):
    ...
    return jsonify({"message": "Assignment updated.", "data": assignment})
...
def submit_assignment(assignment_id):
    ...
    return jsonify({"message": "Submission recorded.", "data": sub}), 201
...
def grade_submission(submission_id):
    ...
    return jsonify({"message": "Submission graded.", "data": result})
