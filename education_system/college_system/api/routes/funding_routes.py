...
def create_record():
    ...
    return jsonify({"message": "Funding record created.", "data": record}), 201
...
def update_record(rid):
    ...
    return jsonify({"message": "Record updated.", "data": record})
...
def complete_record(rid):
    ...
    return jsonify({"message": "Record completed.", "data": record})
...
def withdraw_record(rid):
    ...
    return jsonify({"message": "Record withdrawn.", "data": record})
...
def add_evidence():
    ...
    return jsonify({"message": "Evidence added.", "data": ev}), 201
...
def verify_evidence(eid):
    ...
    return jsonify({"message": "Evidence verified.", "data": ev})
...
def create_rule():
    ...
    return jsonify({"message": "Rule created.", "data": rule}), 201
...
def create_resit():
    ...
    return jsonify({"message": "Resit created.", "data": resit}), 201
...
def update_resit(rid):
    ...
    return jsonify({"message": "Resit updated.", "data": resit})
