...
class _RequestDialog(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        tk.Label(container, text="Reason", anchor="w",
...
class AbsenceRequestFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="Absence Requests",
        ...
        self._tree.heading("absence_type", text="Type")
    ...
    def _on_delete(self):
        ...
        if pk is None:
            return
        if not messagebox.askyesno("Confirm", "Delete this request?"):
            return
        try:
