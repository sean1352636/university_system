...
class _ColumnDialog(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        tk.Label(container, text=t("markbook.course_id"), anchor="w",
        ...
        tk.Label(container, text=t("markbook.column"), anchor="w",
        ...
        tk.Label(container, text=t("markbook.type"), anchor="w",
        ...
        tk.Label(container, text=t("markbook.max_score"), anchor="w",
        ...
        tk.Label(container, text=t("markbook.weight"), anchor="w",
        ...
        tk.Label(container, text=t("markbook.due_date"), anchor="w",
...
class MarkbookFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text=t("markbook.title"),
                 font=("Helvetica", 15, "bold"),
                 bg="#2c3e50", fg="white").pack(side="left", padx=20, pady=10)

        toolbar = tk.Frame(self, bg="#ecf0f1", pady=8)
        toolbar.pack(fill="x", padx=15)
        ttk.Button(toolbar, text=t("markbook.add"), command=self._on_add).pack(side="left", padx=4)
        ttk.Button(toolbar, text=t("markbook.edit"), command=self._on_edit).pack(side="left", padx=4)
        ttk.Button(toolbar, text=t("markbook.delete"), command=self._on_delete).pack(side="left", padx=4)
        ...
        self._tree.heading("course_id", text=t("markbook.col_course_id"))
        self._tree.column("course_id", width=80, anchor="center")
        self._tree.heading("column_name", text=t("markbook.col_column"))
        self._tree.column("column_name", width=150, anchor="center")
        self._tree.heading("column_type", text=t("markbook.col_type"))
        self._tree.column("column_type", width=100, anchor="center")
        self._tree.heading("max_score", text=t("markbook.col_max_score"))
        self._tree.column("max_score", width=80, anchor="center")
        self._tree.heading("weight", text=t("markbook.col_weight"))
        self._tree.column("weight", width=60, anchor="center")
        self._tree.heading("due_date", text=t("markbook.col_due_date"))
    ...
    def _load_items(self):
        ...
        try:
            ...
            count = len(items)
            self._status_var.set(t("markbook.count_loaded", count=count))
    ...
    def _on_add(self):
        ...
        try:
            ...
            messagebox.showinfo(t("common.success"), t("markbook.column_created"))
            self._load_items()
        except Exception as exc:
    ...
    def _on_edit(self):
        ...
        if not item:
            messagebox.showerror(t("common.error"), t("markbook.column_not_found"))
            return
        ...
        try:
            ...
            messagebox.showinfo(t("common.success"), t("markbook.column_updated"))
            self._load_items()
        except Exception as exc:
            messagebox.showerror(t("common.error"), str(exc))
    ...
    def _export_csv(self):
        ...
        export_treeview_to_csv(self._tree, "markbook.csv")

    def _on_delete(self):
        pk = self._selected_pk()
        if pk is None:
            return
        if not messagebox.askyesno(t("common.confirm_delete"), t("markbook.confirm_delete")):
            return
        try:
            self._svc.delete_column(pk)
            messagebox.showinfo(t("common.success"), t("markbook.column_deleted"))
            self._load_items()
        except Exception as exc:
            messagebox.showerror(t("common.error"), str(exc))
