...
class _FeedbackDialog(tk.Toplevel):
    """Modal dialog for adding or editing a feedback."""

    def __init__(self, parent, title="Feedback", item=None):
...
class FeedbackFrame(tk.Frame):
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._svc = FeedbackService(db_path)
        self._build_ui()
    ...
    def _load_items(self):
        ...
        try:
            items = self._svc.list_feedbacks()
            for item in items:
    ...
    def _on_add(self):
        dlg = _FeedbackDialog(self, title="Add Feedback")
