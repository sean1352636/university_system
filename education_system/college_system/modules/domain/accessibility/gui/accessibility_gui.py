...
class _PreferenceDialog(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        tk.Label(container, text=t("accessibility.theme"), anchor="w",
        ...
        tk.Label(container, text=t("accessibility.font_size"), anchor="w",
        ...
        tk.Label(container, text=t("accessibility.font"), anchor="w",
...
class AccessibilityFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text=t("accessibility.management"),
                 font=("Helvetica", 15, "bold"),
                 bg="#2c3e50", fg="white").pack(side="left", padx=20, pady=10)

        toolbar = tk.Frame(self, bg="#ecf0f1", pady=8)
        toolbar.pack(fill="x", padx=15)
        ttk.Button(toolbar, text=t("accessibility.add"), command=self._on_add).pack(side="left", padx=4)
        ...
        self._tree.heading("theme", text=t("accessibility.theme"))
        self._tree.column("theme", width=100, anchor="center")
        self._tree.heading("font_size", text=t("accessibility.font_size"))
        self._tree.column("font_size", width=60, anchor="center")
        self._tree.heading("font_family", text=t("accessibility.font"))
        self._tree.column("font_family", width=100, anchor="center")
        self._tree.heading("reduce_animations", text=t("accessibility.reduce_anim"))
        self._tree.column("reduce_animations", width=60, anchor="center")
        self._tree.heading("screen_reader_mode", text=t("accessibility.reader_mode"))
    ...
    def _load_items(self):
        ...
        try:
            ...
            self._status_var.set(t("accessibility.count_loaded", count=len(items)))
    ...
    def _export_csv(self):
        ...
        export_treeview_to_csv(self._tree, "accessibility.csv")
    ...
    def _on_add(self):
        ...
        try:
            ...
            messagebox.showinfo(t("common.success"), t("accessibility.created"))
            self._load_items()
        except Exception as exc:
    ...
    def _on_edit(self):
        ...
        if not item:
            messagebox.showerror(t("common.error"), t("accessibility.not_found"))
            return
        ...
        try:
            ...
            messagebox.showinfo(t("common.success"), t("accessibility.updated"))
            self._load_items()
        except Exception as exc:
            messagebox.showerror(t("common.error"), str(exc))
    ...
    def _on_delete(self):
        ...
        if pk is None:
            return
        if not messagebox.askyesno(t("common.confirm"), t("accessibility.delete_confirm")):
            return
        try:
            self._svc.delete_preference(pk)
            messagebox.showinfo(t("common.success"), t("accessibility.deleted"))
            self._load_items()
        except Exception as exc:
            messagebox.showerror(t("common.error"), str(exc))
