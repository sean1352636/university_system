...
class _PreferenceDialog(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        tk.Label(container, text="Phone", anchor="w",
        ...
        tk.Label(container, text="Digest", anchor="w",
...
class SmsEmailFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="SMS & Email",
        ...
        self._tree.heading("email_enabled", text="Email")
        self._tree.column("email_enabled", width=50, anchor="center")
        self._tree.heading("sms_enabled", text="SMS")
        self._tree.column("sms_enabled", width=50, anchor="center")
        self._tree.heading("phone_number", text="Phone")
        self._tree.column("phone_number", width=120, anchor="center")
        self._tree.heading("attendance_alerts", text="Attendance")
        self._tree.column("attendance_alerts", width=60, anchor="center")
        self._tree.heading("grade_alerts", text="Grades")
