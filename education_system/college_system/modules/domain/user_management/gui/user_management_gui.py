"""GUI for user management management."""
...
class _TemplateDialog(tk.Toplevel):
    """Modal dialog for adding or editing a template."""

    def __init__(self, parent, title="Template", item=None):
...
class UserManagementFrame(tk.Frame):
    """User Management management screen."""

    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        super().__init__(parent, **kwargs)
        self._db_path = db_path
        self._auth = auth
        self._svc = UserManagementService(db_path)
        self._build_ui()
    ...
    def _build_ui(self):
        ...
        columns = ('template_name', 'role', 'permissions', 'description')
        self._tree = ttk.Treeview(tree_frame, columns=columns, show="headings", selectmode="browse")

        self._tree.heading("template_name", text="Name")
        self._tree.column("template_name", width=150, anchor="center")
        self._tree.heading("role", text="Role")
        self._tree.column("role", width=100, anchor="center")
        self._tree.heading("permissions", text="Permissions")
        self._tree.column("permissions", width=200, anchor="center")
    ...
    def _load_items(self):
        ...
        try:
            items = self._svc.list_templates()
            for item in items:
    ...
    def _on_add(self):
        dlg = _TemplateDialog(self, title="Add Template")
