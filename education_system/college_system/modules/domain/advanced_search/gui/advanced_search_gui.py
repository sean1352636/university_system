...
class _SearchDialog(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        tk.Label(container, text="Query", anchor="w",
        ...
        tk.Label(container, text="Module", anchor="w",
        ...
        tk.Label(container, text="Searched At", anchor="w",
...
class AdvancedSearchFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="Advanced Search",
        ...
        self._tree.heading("query", text="Query")
        self._tree.column("query", width=200, anchor="center")
        self._tree.heading("module_filter", text="Module")
        self._tree.column("module_filter", width=100, anchor="center")
        self._tree.heading("result_count", text="Results")
        self._tree.column("result_count", width=60, anchor="center")
        self._tree.heading("searched_at", text="Searched At")
    ...
    def _on_add(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Search created.")
            self._load_items()
        except Exception as exc:
    ...
    def _on_edit(self):
        ...
        if not item:
            messagebox.showerror("Error", "Search not found.")
            return
        ...
        try:
            ...
            messagebox.showinfo("Success", "Search updated.")
            self._load_items()
        except Exception as exc:
            messagebox.showerror("Error", str(exc))
    ...
    def _on_delete(self):
        ...
        if pk is None:
            return
        if not messagebox.askyesno("Confirm", "Delete this search?"):
            return
        try:
