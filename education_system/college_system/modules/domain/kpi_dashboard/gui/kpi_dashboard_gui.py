...
class KPIDashboardFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text=t("kpi_dashboard.management"),
    ...
    def _on_add(self):
        ...
        try:
            ...
            messagebox.showinfo(t("common.success"), t("kpi_dashboard.target_created", default="Target created."))
            self._load_items()
        except Exception as exc:
    ...
    def _on_edit(self):
        ...
        if not item:
            messagebox.showerror(t("common.error"), t("kpi_dashboard.target_not_found", default="Target not found."))
            return
        ...
        try:
            ...
            messagebox.showinfo(t("common.success"), t("kpi_dashboard.target_updated", default="Target updated."))
            self._load_items()
        except Exception as exc:
            messagebox.showerror(t("common.error"), str(exc))
    ...
    def _export_csv(self):
        ...
        export_treeview_to_csv(self._tree, "kpi_dashboard.csv")

    def _on_delete(self):
        pk = self._selected_pk()
        if pk is None:
            return
        if not messagebox.askyesno(t("common.confirm"), t("kpi_dashboard.delete_target_confirm", default="Delete this target?")):
            return
        try:
            self._svc.delete_target(pk)
            messagebox.showinfo(t("common.success"), t("kpi_dashboard.target_deleted", default="Target deleted."))
            self._load_items()
        except Exception as exc:
            messagebox.showerror(t("common.error"), str(exc))
