...
class _AnnouncementDialog(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        tk.Label(container, text="Published", anchor="w",
        ...
        tk.Label(container, text="Expires", anchor="w",
...
class AnnouncementFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="Announcements",
        ...
        self._tree.heading("is_pinned", text="Pinned")
    ...
    def _on_delete(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Announcement deleted.")
            self._load_items()
        except Exception as exc:
            messagebox.showerror("Error", str(exc))
