...
class MobileDashboardFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="Mobile Dashboard",
    ...
    def _on_add(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Widget created.")
            self._load_items()
        except Exception as exc:
    ...
    def _on_edit(self):
        ...
        if not item:
            messagebox.showerror("Error", "Widget not found.")
            return
        ...
        try:
            ...
            messagebox.showinfo("Success", "Widget updated.")
            self._load_items()
        except Exception as exc:
            messagebox.showerror("Error", str(exc))
    ...
    def _on_delete(self):
        ...
        if pk is None:
            return
        if not messagebox.askyesno("Confirm", "Delete this widget?"):
            return
        try:
            self._svc.delete_widget(pk)
            messagebox.showinfo("Success", "Widget deleted.")
            self._load_items()
        except Exception as exc:
            messagebox.showerror("Error", str(exc))
