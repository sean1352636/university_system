...
class AcademicYearFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="Academic Year",
        ...
        self._tree.heading("is_current", text="Current")
    ...
    def _on_add(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Year created.")
            self._load_items()
        except Exception as exc:
    ...
    def _on_edit(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Year updated.")
            self._load_items()
        except Exception as exc:
            messagebox.showerror("Error", str(exc))
    ...
    def _on_delete(self):
        ...
        if pk is None:
            return
        if not messagebox.askyesno("Confirm", "Delete this year?"):
            return
        try:
            self._svc.delete_year(pk)
            messagebox.showinfo("Success", "Year deleted.")
            self._load_items()
        except Exception as exc:
            messagebox.showerror("Error", str(exc))
