...
class _AccountDialog(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        tk.Label(container, text="Balance", anchor="w",
        ...
        tk.Label(container, text="Reset Date", anchor="w",
...
class PrintCreditFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="Print Credits",
        ...
        self._tree.heading("quota_remaining", text="Quota")
        self._tree.column("quota_remaining", width=60, anchor="center")
        self._tree.heading("quota_reset_date", text="Reset Date")
    ...
    def _on_add(self):
        dlg = _AccountDialog(self, title="Add Account")
    ...
    def _on_edit(self):
        ...
        if not item:
            ...
            return
        dlg = _AccountDialog(self, title="Edit Account", item=item)
        self.wait_window(dlg)
        if dlg.result is None:
            return
        try:
