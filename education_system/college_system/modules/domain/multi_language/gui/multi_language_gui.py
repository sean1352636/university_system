"""GUI for multi-language management."""
...
class _OverrideDialog(tk.Toplevel):
    """Modal dialog for adding or editing a override."""

    def __init__(self, parent, title="Override", item=None):
...
class MultiLanguageFrame(tk.Frame):
    """Multi-Language management screen."""

    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        super().__init__(parent, **kwargs)
        self._db_path = db_path
        self._auth = auth
        self._svc = MultiLanguageService(db_path)
        self._build_ui()
    ...
    def _load_items(self):
        ...
        try:
            items = self._svc.list_overrides()
            for item in items:
    ...
    def _on_add(self):
        dlg = _OverrideDialog(self, title="Add Override")
