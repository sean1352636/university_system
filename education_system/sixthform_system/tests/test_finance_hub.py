...
_DATA_MODULES = (
    ...
    "education_system.sixthform_system.modules.domain.finance.fees.fees",
    "education_system.sixthform_system.modules.domain.finance.bursaries.bursaries",
    "education_system.sixthform_system.modules.domain.finance.trips.trips",
    "education_system.sixthform_system.modules.domain.finance.receipts.receipts",
    "education_system.sixthform_system.modules.domain.finance.expense_claims.expense_claims",
    "education_system.sixthform_system.modules.domain.finance.funding.funding",
    "education_system.sixthform_system.modules.domain.finance.census_ilr.census_ilr",
)
...
def test_sections_have_builders_for_every_module():
    from education_system.sixthform_system.modules.domain.finance.finance_hub import (
