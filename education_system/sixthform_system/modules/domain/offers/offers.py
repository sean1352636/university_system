...
def init_db() -> None:
    ...
    from education_system.sixthform_system.modules.domain.ucas import ucas as _ucas
    _ucas.init_db()
...
def list_offer_rows(
    *,
    ...
    from education_system.sixthform_system.modules.domain.students import students as _ucas
