...
from education_system.sixthform_system.modules.domain.governance.policies import policies as data
from education_system.sixthform_system.modules.domain.governance.policies.policies import (
    CATEGORIES,
    DEFAULT_CATEGORY,
