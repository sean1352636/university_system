...
def init_db() -> None:
    ...
    # both are in place.
    from education_system.sixthform_system.modules.domain.exam_entries import exam_entries as _entries
    _entries.init_db()
...
def bulk_view(
    ...
    from education_system.sixthform_system.modules.domain.students import students as _entries
    from education_system.sixthform_system.modules.domain.students import students as _students
