...
from education_system.sixthform_system.modules.domain.academics.lesson_plans import (
    lesson_plans as data,
)
from education_system.sixthform_system.modules.domain.academics.lesson_plans.lesson_plans import (
    DEFAULT_STATUS,
    LEVELS,
    LessonPlan,
    STATUSES,
