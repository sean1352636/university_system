...
from education_system.sixthform_system.modules.domain.academics.timetable import timetable as data
from education_system.sixthform_system.modules.domain.academics.timetable.timetable import (
    DAYS,
    DAY_NUMBERS,
