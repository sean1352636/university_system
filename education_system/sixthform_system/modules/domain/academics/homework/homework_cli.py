...
from education_system.sixthform_system.modules.domain.academics.homework import homework as data
from education_system.sixthform_system.modules.domain.students.students import students as student_data
from education_system.sixthform_system.modules.domain.academics.homework.homework import (
    ASSIGNMENT_TYPES,
    Assignment,
...
def mark_sheet() -> None:
    ...
    print(f"  Statuses: 1=Not Submitted  2=Submitted  3=Late  4=Excused  S=Skip")
