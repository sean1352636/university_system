...
from education_system.sixthform_system.modules.domain.academics.assignments import (
    assignments as data,
)
from education_system.sixthform_system.modules.domain.students.students import (
    students as student_data,
)
from education_system.sixthform_system.modules.domain.academics.assignments.assignments import (
    ASSIGNMENT_STATUSES,
    ASSIGNMENT_TYPES,
    Assignment,
