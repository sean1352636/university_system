...
from education_system.sixthform_system.modules.domain.progression.apprenticeships import apprenticeships as data
from education_system.sixthform_system.modules.domain.students.students import students as student_data
from education_system.sixthform_system.modules.domain.progression.apprenticeships.apprenticeships import (
    Application,
    DEFAULT_STATUS,
    LEVELS,
    SECTORS,
