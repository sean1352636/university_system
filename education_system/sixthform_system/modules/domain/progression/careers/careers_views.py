...
from education_system.sixthform_system.modules.domain.progression.careers import careers as data
from education_system.sixthform_system.modules.domain.students.students import students as student_data
from education_system.sixthform_system.modules.domain.progression.careers.careers import (
    CareerAspiration,
    CareerSession,
    CareersSummary,
    DEFAULT_PATHWAY,
