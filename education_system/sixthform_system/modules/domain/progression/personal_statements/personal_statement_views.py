...
from education_system.sixthform_system.modules.domain.progression.personal_statements import personal_statements as data
from education_system.sixthform_system.modules.domain.students.students import students as student_data
from education_system.sixthform_system.modules.domain.progression.ucas import ucas as ucas_data
from education_system.sixthform_system.modules.domain.progression.personal_statements.personal_statements import (
    DEFAULT_STATUS,
    MAX_CHARS,
    MAX_LINES,
    PersonalStatement,
