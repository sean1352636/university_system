...
def bulk_recalc_grade_reports(
    ...
    *,
    ...
    targets = _validate_targets(student_ids)
    from education_system.sixthform_system.modules.domain.reports.grades_report import (
...
def bulk_exam_entries(
    ...
    *,
    ...
    targets = _validate_targets(student_ids)
    from education_system.sixthform_system.modules.domain.assessment.exam_entries import (
        exam_entries as _ee,
    )
