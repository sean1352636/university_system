...
from education_system.sixthform_system.modules.domain.timetable import timetable as tt_data
from education_system.sixthform_system.modules.domain.attendance.attendance import (
    DEFAULT_STATUS,
    STATUSES,
    AttendanceRecord,
    AttendanceSummary,
...
from education_system.sixthform_system.modules.domain.timetable.timetable import day_name
