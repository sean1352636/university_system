...
from education_system.sixthform_system.modules.domain.tutor_groups import tutor_groups as student_data
from education_system.sixthform_system.modules.domain.tutor_groups import tutor_groups as data
from education_system.sixthform_system.modules.domain.tutor_groups.tutor_groups import (
    TutorGroup,
    ValidationError,
    YEAR_GROUPS,
)
