...
def init_db() -> None:
    ...
    from education_system.sixthform_system.modules.domain.students import students as _pc
        ...
        cur = conn.execute(
            """INSERT INTO messages
                 (thread_id, direction, channel, category, priority,
                  ...
                  parent_contact_id, sent_at, received_at,
    ...
    with _connect() as conn:
        conn.execute(
            """UPDATE messages SET
                  ...
                  staff_id=?, parent_contact_id=?, sent_at=?, received_at=?,
                  attachments_note=?, tags=?, notes=?,
            ...
            (p["direction"], p["channel"], p["category"], p["priority"],
             ...
             p["parent_contact_id"], p["sent_at"], p["received_at"],
