...
from education_system.sixthform_system.modules.domain.finance.census_ilr import (
    census_ilr as data,
)
from education_system.sixthform_system.modules.domain.finance.census_ilr.census_ilr import (
    AIM_TYPES,
    CensusReturn,
    DEFAULT_AIM_TYPE,
