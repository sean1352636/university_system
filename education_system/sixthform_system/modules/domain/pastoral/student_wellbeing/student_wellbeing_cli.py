...
from education_system.sixthform_system.modules.domain.pastoral.student_wellbeing import (
    student_wellbeing as data,
)
from education_system.sixthform_system.modules.domain.pastoral.student_wellbeing.student_wellbeing import (
