...
from education_system.sixthform_system.modules.domain.pastoral.disciplinary import (
    disciplinary as data,
)
from education_system.sixthform_system.modules.domain.pastoral.disciplinary.disciplinary import (
    CASE_TYPES,
    DEFAULT_CASE_TYPE,
    DEFAULT_STATUS,
    DisciplinaryCase,
