...
from education_system.sixthform_system.modules.domain.pastoral.student_council import (
    student_council as data,
)
from education_system.sixthform_system.modules.domain.pastoral.student_council.student_council import (
