...
from education_system.sixthform_system.modules.domain.pastoral.transport import (
    transport as data,
)
from education_system.sixthform_system.modules.domain.pastoral.transport.transport import (
