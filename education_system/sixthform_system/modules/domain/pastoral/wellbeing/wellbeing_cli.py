...
from education_system.sixthform_system.modules.domain.pastoral.wellbeing import wellbeing as data
from education_system.sixthform_system.modules.domain.pastoral.wellbeing.wellbeing import (
    CheckIn,
