...
from education_system.sixthform_system.modules.domain.gradebook.gradebook import LETTER_GRADES, pct_to_letter
...
def _results_sheet_for(mid: int) -> None:
    ...
    print(f"  Boundaries: A*≥90%  A≥80%  B≥70%  C≥60%  D≥50%  E≥40%")
