...
from education_system.sixthform_system.modules.domain.mock_exams.mock_exams import (
    MockExam,
    ResultView,
    StudentMockSummary,
    ValidationError,
    ...
    def load() -> None:
        ...
        for v in view:
            ...
            def _refresh_derived(*_a, mv=marks_var,
                ...
                from education_system.sixthform_system.modules.domain.gradebook.gradebook import pct_to_letter
