...
from education_system.sixthform_system.modules.domain.trips import trips as staff_data
from education_system.sixthform_system.modules.domain.students import students as student_data
from education_system.sixthform_system.modules.domain.trips import trips as data
from education_system.sixthform_system.modules.domain.trips.trips import (
    BOOKING_STATUSES,
    Booking,
    CURRENCY_SYMBOL,
...
def open_trips_window(parent=None) -> None:
    ...
    win.title("Trips & Payments — Sixth Form System")
