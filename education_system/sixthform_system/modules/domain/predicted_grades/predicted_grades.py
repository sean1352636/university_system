...
def _validate_payload(data: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        from education_system.sixthform_system.modules.domain.subjects import subjects as _subjects
...
def _subject_for_group(group_id: int) -> str | None:
    ...
    from education_system.sixthform_system.modules.domain.courses import courses as _cg
    from education_system.sixthform_system.modules.domain.courses import courses as _crs
