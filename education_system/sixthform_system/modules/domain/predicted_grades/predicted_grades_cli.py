...
from education_system.sixthform_system.modules.domain.subjects import subjects as cg_data
from education_system.sixthform_system.modules.domain.courses import courses as course_data
from education_system.sixthform_system.modules.domain.predicted_grades import predicted_grades as data
...
from education_system.sixthform_system.modules.domain.predicted_grades.predicted_grades import (
    CONFIDENCE_LEVELS,
    DEFAULT_CONFIDENCE,
    Prediction,
    ValidationError,
