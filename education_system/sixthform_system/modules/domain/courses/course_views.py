...
from education_system.sixthform_system.modules.domain.courses import courses as data
from education_system.sixthform_system.modules.domain.courses.courses import (
    Course,
