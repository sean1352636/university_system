...
def _build_registry() -> dict[str, DatasetSpec]:
    from education_system.sixthform_system.modules.domain.apprenticeships import apprenticeships
    from education_system.sixthform_system.modules.domain.attendance import attendance
    from education_system.sixthform_system.modules.domain.attendance_concerns import attendance_concerns
    from education_system.sixthform_system.modules.domain.behaviour import behaviour
    from education_system.sixthform_system.modules.domain.bursaries import bursaries
    from education_system.sixthform_system.modules.domain.careers import careers
    ...
    from education_system.sixthform_system.modules.domain.enrolments import enrolments
    from education_system.sixthform_system.modules.domain.exam_entries import exam_entries
    from education_system.sixthform_system.modules.domain.exam_results import exam_results
    from education_system.sixthform_system.modules.domain.fees import fees
    ...
    from education_system.sixthform_system.modules.domain.parents_evenings import parents_evenings
    from education_system.sixthform_system.modules.domain.personal_statements import personal_statements
    from education_system.sixthform_system.modules.domain.predicted_grades import predicted_grades
    from education_system.sixthform_system.modules.domain.progress import progress
    from education_system.sixthform_system.modules.domain.receipts import receipts
    from education_system.sixthform_system.modules.domain.references import references
    from education_system.sixthform_system.modules.domain.safeguarding import safeguarding
    ...
    from education_system.sixthform_system.modules.domain.subjects import subjects
    from education_system.sixthform_system.modules.domain.timetable import timetable
    from education_system.sixthform_system.modules.domain.trips import trips
    from education_system.sixthform_system.modules.domain.tutor_groups import tutor_groups
    from education_system.sixthform_system.modules.domain.ucas import ucas
    from education_system.sixthform_system.modules.domain.wellbeing import wellbeing as _appr
    from education_system.sixthform_system.modules.domain.attendance import attendance as _att
    from education_system.sixthform_system.modules.domain.attendance_concerns import attendance_concerns as _atc
    from education_system.sixthform_system.modules.domain.behaviour import behaviour as _beh
    from education_system.sixthform_system.modules.domain.bursaries import bursaries as _bur
    from education_system.sixthform_system.modules.domain.careers import careers as _car
    from education_system.sixthform_system.modules.domain.class_groups import class_groups as _cg
    from education_system.sixthform_system.modules.domain.courses import courses as _co
    from education_system.sixthform_system.modules.domain.enrolments import enrolments as _en
    from education_system.sixthform_system.modules.domain.exam_entries import exam_entries as _eent
    from education_system.sixthform_system.modules.domain.exam_results import exam_results as _er
    from education_system.sixthform_system.modules.domain.fees import fees as _fees
    ...
    from education_system.sixthform_system.modules.domain.notices import notices as _no
    from education_system.sixthform_system.modules.domain.offers import offers as _of
    from education_system.sixthform_system.modules.domain.parent_contacts import parent_contacts as _pc
    from education_system.sixthform_system.modules.domain.parents_evenings import parents_evenings as _pe
    from education_system.sixthform_system.modules.domain.personal_statements import personal_statements as _ps
    from education_system.sixthform_system.modules.domain.predicted_grades import predicted_grades as _pg
    from education_system.sixthform_system.modules.domain.progress import progress as _pr
    from education_system.sixthform_system.modules.domain.receipts import receipts as _rc
    from education_system.sixthform_system.modules.domain.references import references as _refs
    from education_system.sixthform_system.modules.domain.safeguarding import safeguarding as _sg
    ...
    from education_system.sixthform_system.modules.domain.subjects import subjects as _sub
    from education_system.sixthform_system.modules.domain.timetable import timetable as _tt
    from education_system.sixthform_system.modules.domain.trips import trips as _tr
    from education_system.sixthform_system.modules.domain.tutor_groups import tutor_groups as _tg
    from education_system.sixthform_system.modules.domain.ucas import ucas as _uc
    from education_system.sixthform_system.modules.domain.wellbeing import wellbeing as _wb
