...
from education_system.sixthform_system.modules.domain.assessment.sef_builder import (
    sef_builder as data,
)
from education_system.sixthform_system.modules.domain.assessment.sef_builder.sef_builder import (
    AREAS,
    DEFAULT_AREA,
    DEFAULT_STATUS,
    JUDGEMENTS,
