...
from education_system.sixthform_system.modules.domain.assessment.ilp import (
    ilp as data,
)
from education_system.sixthform_system.modules.domain.students.students import (
    students as student_data,
)
from education_system.sixthform_system.modules.domain.assessment.ilp.ilp import (
