...
from education_system.sixthform_system.modules.domain.wellbeing import wellbeing as student_data
from education_system.sixthform_system.modules.domain.wellbeing import wellbeing as data
from education_system.sixthform_system.modules.domain.wellbeing.wellbeing import (
    CheckIn,
...
def open_wellbeing_window(parent=None) -> None:
    ...
    win.title("Wellbeing — Sixth Form System")
