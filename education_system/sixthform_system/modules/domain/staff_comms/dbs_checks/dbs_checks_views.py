...
from education_system.sixthform_system.modules.domain.staff_comms.dbs_checks import (
    dbs_checks as data,
)
from education_system.sixthform_system.modules.domain.staff_comms.dbs_checks.dbs_checks import (
    CERTIFICATE_TYPES,
    DBSCheck,
