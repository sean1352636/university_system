...
from education_system.sixthform_system.modules.domain.staff_comms.attachments import (
    attachments as data,
)
from education_system.sixthform_system.modules.domain.staff_comms.attachments.attachments import (
    Attachment,
    CATEGORIES,
    DEFAULT_CATEGORY,
    DEFAULT_ENTITY_TYPE,
