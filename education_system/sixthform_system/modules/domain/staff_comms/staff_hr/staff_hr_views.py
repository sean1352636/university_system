...
from education_system.sixthform_system.modules.domain.staff_comms.staff_hr import (
    staff_hr as data,
)
from education_system.sixthform_system.modules.domain.staff_comms.staff_hr.staff_hr import (
    CONTRACT_TYPES,
