"""Tkinter views for Sixth Form Visitors."""
...
from education_system.sixthform_system.modules.domain.staff_comms.visitors import (
    visitors as data,
)
from education_system.sixthform_system.modules.domain.staff_comms.visitors.visitors import (
    DEFAULT_ID_TYPE,
    DEFAULT_STATUS,
