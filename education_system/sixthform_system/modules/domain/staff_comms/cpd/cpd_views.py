...
from education_system.sixthform_system.modules.domain.staff_comms.cpd import (
    cpd as data,
)
from education_system.sixthform_system.modules.domain.staff_comms.cpd.cpd import (
    ACTIVITY_STATUSES,
    ACTIVITY_TYPES,
    Activity,
