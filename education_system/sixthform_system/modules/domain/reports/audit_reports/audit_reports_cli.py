...
from education_system.sixthform_system.modules.domain.reports.audit_reports import (
    audit_reports as data,
)
from education_system.sixthform_system.modules.domain.reports.audit_reports.audit_reports import (
