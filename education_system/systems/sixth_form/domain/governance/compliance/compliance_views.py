...
from education_system.systems.sixth_form.domain.governance.compliance import compliance as data
from education_system.systems.sixth_form.domain.governance.compliance.compliance import (
    CATEGORIES,
    DEFAULT_FREQUENCY,
    DEFAULT_STATUS,
    DERIVED_STATUSES,
