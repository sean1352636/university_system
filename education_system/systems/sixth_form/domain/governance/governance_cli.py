...
from education_system.systems.sixth_form.domain.governance import governance as data
from education_system.systems.sixth_form.domain.governance.governance import (
