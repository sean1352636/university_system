...
from education_system.systems.sixth_form.domain.progression.apprenticeships import apprenticeships as data
from education_system.systems.sixth_form.domain.learners.students import students as student_data
from education_system.systems.sixth_form.domain.progression.apprenticeships.apprenticeships import (
    Application,
    DEFAULT_STATUS,
    LEVELS,
    SECTORS,
