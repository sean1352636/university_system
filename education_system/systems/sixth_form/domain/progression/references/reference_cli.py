...
from education_system.systems.sixth_form.domain.progression.references import references as data
from education_system.systems.sixth_form.domain.learners.students import students as student_data
from education_system.systems.sixth_form.domain.progression.references.references import (
    DEFAULT_STATUS,
    Reference,
    SOFT_CHAR_LIMIT,
    STATUSES,
