...
from education_system.systems.sixth_form.domain.operations.attachments import (
    attachments as data,
)
from education_system.systems.sixth_form.domain.operations.attachments.attachments import (
    Attachment,
    CATEGORIES,
    DEFAULT_CATEGORY,
    DEFAULT_ENTITY_TYPE,
