...
from education_system.systems.sixth_form.domain.pastoral.emergency import (
    emergency as data,
)
from education_system.systems.sixth_form.domain.pastoral.emergency.emergency import (
