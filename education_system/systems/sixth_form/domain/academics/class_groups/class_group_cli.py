...
from education_system.systems.sixth_form.domain.academics.class_groups import class_groups as data
...
from education_system.systems.sixth_form.domain.academics.class_groups.class_groups import (
    ClassGroup,
    ValidationError,
)
