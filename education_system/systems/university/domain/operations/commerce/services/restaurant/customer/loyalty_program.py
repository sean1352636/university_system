...
def manage_customer_feedback():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.operations.commerce.services.restaurant.menu.menu_management import feedback_analytics
            feedback_analytics()
        elif choice == '4':
...
def manage_loyalty_program():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.operations.commerce.services.restaurant.menu.menu_management import loyalty_analytics
            loyalty_analytics()
        elif choice == '5':
            award_bonus_points()
        elif choice == '6':
