...
def manage_green_initiatives():
    ...
    from education_system.systems.university.domain.pastoral.student_life.student_union.events.event_management import manage_sustainable_events
    from education_system.systems.university.domain.pastoral.student_life.student_union.administration.admin_management import generate_environmental_reports
