...
from education_system.systems.university.domain.pastoral.student_life.student_union.services.communications import send_confirmation_email
...
def manage_enhanced_voting():
    ...
    from education_system.systems.university.domain.pastoral.student_life.student_union.elections.election_management import (
...
def test_email_notifications(cursor, conn):
    ...
    try:
        ...
        try:
            ...
            from education_system.systems.university.infrastructure.email import queue_email
