...
def display_health_portal_menu(auth):
    ...
    try:
        ...
        from education_system.systems.university.domain.pastoral.health.portal.health_portal_core import display_health_portal_menu
...
def restore_from_backup(auth):
    ...
    try:
        ...
        print("⚠  This will replace the current database!")
