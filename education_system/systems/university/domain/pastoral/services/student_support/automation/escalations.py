    ...
    try:
        ...
        if 'created_at' not in columns:
            ...
            if condition_type == 'time_based':
                logger.warning(f"Skipping time-based escalation rule {rule_id}: created_at column missing")
                return
        ...
        if condition_type == 'time_based':
            ...
            # Use created_at if available, otherwise fall back to registration_datetime
