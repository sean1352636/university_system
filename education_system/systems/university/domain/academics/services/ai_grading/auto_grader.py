...
def _resolve_file_path(stored_path: str) -> Optional[str]:
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.assignment_system._file_viewer import (
...
def _extract_submission_text(path: str) -> Optional[str]:
    ...
    try:
        from education_system.systems.university.domain.academics.services.plagiarism.checker import (
            PlagiarismChecker,
        )
