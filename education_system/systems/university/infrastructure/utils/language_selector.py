...
wraps the cross-system ``education_system.platform.features.i18n`` selector and adds
...
from education_system.platform.features.i18n.core import get_current_language
