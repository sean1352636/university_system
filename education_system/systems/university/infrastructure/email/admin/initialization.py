...
from education_system.systems.university.infrastructure.logs import get_log_manager
...
def integrate_communication_dashboard_with_main():
    ...
    try:
        ...
        if not config.get('database_only_mode', True):
            from education_system.systems.university.infrastructure.email.admin._imports import ensure_scheduler_running
