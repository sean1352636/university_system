...
from education_system.systems.university.infrastructure.security.rate_limiter import (
    RateLimiter,
    RateLimitExceeded,
    RateLimitConfig,
    rate_limit,
...
from education_system.systems.university.infrastructure.security.audit_trail import (
    AuditLogger,
    AuditEntry,
    AuditAction,
    audit_data_access,
...
from education_system.systems.university.infrastructure.security.password_generator import (
...
_LAZY_ATTRS = {
    "AuditLogViewerGUI": "education_system.systems.university.interfaces.gui.shell.security.audit_log_viewer_gui",
    "AnomalyDetector": "education_system.systems.university.interfaces.gui.shell.security.audit_log_viewer_gui",
    "show_audit_log_viewer": "education_system.systems.university.interfaces.gui.shell.security.audit_log_viewer_gui",
}
...
from education_system.systems.university.infrastructure.security.flask_security_headers import (
...
try:
    from education_system.systems.university.infrastructure.security.file_upload_validator import (
        FileUploadValidator,
...
try:
    from education_system.systems.university.infrastructure.security.security_integration import (
        SecurityManager,
