...
def _build_student_records(self, host, close_action):
    ...
    *close_action* is a no-arg callable that closes the host —
    ...
    try:
        from education_system.systems.university.interfaces.gui.learners.students._cross_links import (
...
def show_student_details(self, student_id):
    ...
    try:
        ...
        try:
            from education_system.systems.university.interfaces.gui.academics.library.cross_module_api import (
                LibrarySummaryFrame,
            )
