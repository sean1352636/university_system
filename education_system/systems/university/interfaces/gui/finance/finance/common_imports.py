...
from education_system.systems.university.domain.finance.core import financial_core as finance_core
...
try:
    from education_system.systems.university.domain.finance.scholarships.scholarship_programs import (
    ...
    def manage_financial_aid():
        ...
        try:
            from education_system.systems.university.interfaces.gui.finance.financial_aid.admin_portal import FinancialAidAdminPortal
...
# ==================== PAYMENT PLANS ====================
try:
    from education_system.systems.university.domain.finance.billing.payment_plans import (
...
# ==================== STUDENT CREDITS ====================
try:
    from education_system.systems.university.domain.finance.core.account_management import (
