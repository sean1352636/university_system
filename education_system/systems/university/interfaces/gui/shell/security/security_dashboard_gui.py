...
# Import MFA GUIs
try:
    from education_system.systems.university.infrastructure.auth.mfa_admin_gui import MFAAdminPanel
...
try:
    from education_system.systems.university.infrastructure.auth.mfa_gui import MFASetupWizard
