...
Example usage::
    ...
    from education_system.systems.university.interfaces.gui.shell.logic import StudentFormLogic
    valid, errors = StudentFormLogic().validate_student_data({'name': 'John'})
"""

from education_system.systems.university.interfaces.gui.shell.logic.student_form_logic import StudentFormLogic
