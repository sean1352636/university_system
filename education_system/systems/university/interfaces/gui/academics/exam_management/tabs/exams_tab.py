...
class ExamsTabMixin:
    ...
    def add_exam(self):
        ...
        overflow_room = None
        try:
            from education_system.systems.university.domain.academics.services.exam_management.seating import (
    ...
    def __init__(self, parent, data_manager, exam_id: int):
        ...
        try:
            ...
            if exam_obj is not None:
                from education_system.systems.university.domain.academics.services.course_management.examiner_assignments import (
