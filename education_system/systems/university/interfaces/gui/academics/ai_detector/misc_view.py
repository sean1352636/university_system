...
def patch_gui_with_missing_functions():
    ...
    from education_system.systems.university.interfaces.gui.academics.ai_detector.main import AIDetectorGUI
...
def main_gui():
    ...
    try:
        import sys
        from education_system.systems.university.interfaces.gui.academics.ai_detector.main import GUILauncher
        args = sys.argv[1:]
