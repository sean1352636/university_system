...
from education_system.systems.university.interfaces.cli.shell.database_manager import cleanup_database_on_startup, init_all_databases, init_auth_for_modules, cleanup_database_connections

# Import menu functions
from education_system.systems.university.interfaces.cli.shell.student_operations import display_student_records_menu, set_auth as set_student_ops_auth
from education_system.systems.university.interfaces.cli.shell.integration_manager import display_integrated_academic_menu, set_auth as set_integration_auth
from education_system.systems.university.domain.academics.services.lms.lms_core import display_lms_menu
from education_system.systems.university.domain.academics.services.evaluation.course_evaluation_core import display_course_evaluation_menu
from education_system.systems.university.domain.pastoral.health.services.health_portal import display_health_portal_menu
from education_system.systems.university.domain.pastoral.services.career_services.career_services_core import display_career_services_menu
from education_system.systems.university.domain.pastoral.services.early_warning.early_warning_core import display_early_warning_menu
from education_system.systems.university.domain.pastoral.services.student_support.features.dashboard import display_support_menu
from education_system.systems.university.domain.pastoral.services.student_support.auth import set_auth as set_support_auth
from education_system.systems.university.domain.academics.services.library.menu import display_library_menu
from education_system.systems.university.domain.operations.campus.facilities.services.facilities_management_core import display_facilities_management_menu
from education_system.systems.university.domain.admissions.services.admissions_crm_core import display_admissions_crm_menu
from education_system.systems.university.domain.admissions.ucas.ucas_cli import run as display_ucas_management_menu
from education_system.systems.university.domain.academics.research.services.research_grants_core import display_research_grants_menu
from education_system.systems.university.domain.operations.campus.services.campus_events_core import display_campus_events_menu
from education_system.systems.university.interfaces.gui.finance.finance_reporting.misc import display_finance_menu, set_auth as set_finance_auth

# Import menu functions that may not exist - with fallbacks
try:
    from education_system.systems.university.interfaces.gui.academics.grade_tracking_management_gui import display_enhanced_grade_menu, predictive_analytics_menu
except ImportError:
    display_enhanced_grade_menu = None
    predictive_analytics_menu = None

try:
    from education_system.systems.university.interfaces.gui.pastoral.student_union_management_gui import display_student_union_menu
except ImportError:
    display_student_union_menu = None

# Import fully-implemented menu functions for previously-stubbed features
from education_system.systems.university.domain.academics.services.attendance import display_advanced_attendance_menu
from education_system.systems.university.domain.academics.services.timetable import display_timetable_optimizer_menu
from education_system.systems.university.domain.learners.alumni import display_alumni_menu as display_alumni_relations_menu

# Import utility functions
from education_system.systems.university.interfaces.cli.shell.utils import safe_auth_check
...
from education_system.systems.university.infrastructure.auth import set_auth_instance

# Import permission setup functions
from education_system.systems.university.domain.learners.alumni import setup_alumni_permissions
from education_system.systems.university.domain.pastoral.services.internship_management import setup_internship_permissions
from education_system.systems.university.domain.pastoral.student_life.student_union.administration.student_union_core import setup_student_union_permissions
from education_system.systems.university.infrastructure.auth import add_finance_permissions
from education_system.systems.university.domain.operations.commerce.services.shop_management import setup_shop_permissions
from education_system.systems.university.domain.operations.campus.mobility.services.trip_management import setup_trip_permissions
from education_system.systems.university.interfaces.cli.shell.services.charity_shop_cli import setup_charity_shop_permissions
from education_system.systems.university.interfaces.cli.shell.services.cafe_system_cli import setup_cafe_permissions
from education_system.systems.university.domain.operations.commerce.services.takeaway.takeaway_service import setup_takeaway_permissions
from education_system.systems.university.domain.operations.commerce.services.grocery.grocery_service import setup_grocery_permissions
from education_system.systems.university.interfaces.cli.staff.staff_hr.staff_hr_cli import setup_staff_hr_permissions
from education_system.systems.university.domain.academics.services.office_hours.office_hours_permissions import setup_office_hours_permissions
from education_system.systems.university.domain.academics.services.assignments.admin_tools.ta_permissions_setup import setup_ta_permissions

# Import Office Hours and TA Management CLI menus
try:
    from education_system.systems.university.interfaces.cli.academics.office_hours_cli import display_office_hours_menu
...
try:
    from education_system.systems.university.domain.academics.services.assignments.admin_tools.ta_management_cli import display_ta_management_menu
...
from education_system.systems.university.interfaces.gui.academics.plagiarism_main_gui import integrate_plagiarism_checker_with_main

# Import auth linking
from education_system.systems.university.interfaces.cli.shell.auth_manager import _link_auth_to_student_union

# Import admin tools menus
from education_system.systems.university.interfaces.cli.shell.admin_tools import display_analytics_menu, display_batch_menu, display_admin_tools_menu

# Import export menu
from education_system.systems.university.interfaces.cli.shell.export_manager import display_export_menu, display_pdf_export_menu

# Import system monitoring
from education_system.systems.university.interfaces.cli.shell.system_monitoring import display_system_monitoring_menu

# Import service menus
from education_system.systems.university.services.analytics.analytics_dashboard_core import display_predictive_analytics_menu
from education_system.systems.university.services.business_intelligence.bi_reports_core import display_business_intelligence_menu
from education_system.systems.university.services.analytics.advanced_search import display_enhanced_menu
from education_system.systems.university.services.ai_features.ai_features_core import display_ai_features_menu
from education_system.systems.university.services.integrations.integration_marketplace_core import display_integration_marketplace_menu

# Import domain-specific menus
from education_system.systems.university.domain.finance.blockchain.services.blockchain_credentials_core import display_blockchain_credentials_menu
from education_system.systems.university.domain.operations.campus.mobility.services.mobile_app_pwa_core import display_mobile_app_pwa_menu
from education_system.systems.university.domain.academics.services.virtual_classroom.classroom_manager import VirtualClassroomManager
from education_system.systems.university.domain.academics.services.virtual_classroom.session_manager import SessionManager
from education_system.systems.university.domain.academics.services.virtual_classroom.participant_manager import ParticipantManager
from education_system.systems.university.domain.academics.services.virtual_classroom.recording_manager import RecordingManager
from education_system.systems.university.domain.academics.services.virtual_classroom.poll_manager import PollManager
from education_system.systems.university.domain.academics.services.virtual_classroom.breakout_room_manager import BreakoutRoomManager
from education_system.systems.university.domain.academics.services.virtual_classroom.chat_manager import ChatManager
from education_system.systems.university.domain.finance.services.financial_aid.aid_manager import FinancialAidManager

auth = None


_CROSS_SYSTEM_MODULES = {
    "cross_analytics": ("education_system.platform.features.analytics.analytics_cli", "Analytics Dashboard"),
    "cross_outcomes": ("education_system.platform.outcomes.outcomes_cli", "Outcome Tracking"),
    "cross_predictive": ("education_system.platform.predictive.predictive_cli", "Predictive Alerts"),
    "cross_bulk_transfer": ("education_system.platform.bulk_transfer.bulk_transfer_cli", "Bulk Transfer"),
    "cross_transfer_docs": ("education_system.platform.transfer_docs.transfer_docs_cli", "Transfer Documents"),
    "cross_reverse_lookup": ("education_system.platform.reverse_lookup.reverse_lookup_cli", "Reverse Lookup"),
    "cross_parent_continuity": ("education_system.platform.parent_continuity.parent_cli", "Parent Continuity"),
    "cross_calendar": ("education_system.platform.features.calendar.calendar_cli", "Cross-System Calendar"),
    "cross_messaging": ("education_system.platform.features.messaging.cross_system_cli", "Inter-System Messaging"),
    "cross_admin_portal": ("education_system.platform.delivery.portals.admin.admin_cli", "Central Admin Portal"),
    "cross_gdpr": ("education_system.platform.governance.gdpr.gdpr_cli", "GDPR Compliance"),
    "cross_documents": ("education_system.platform.features.documents.document_cli", "Shared Documents"),
    "cross_student_portal": ("education_system.platform.delivery.portals.student.portal_cli", "Student Self-Service"),
    "cross_transcript": ("education_system.platform.features.transcript.transcript_cli", "Digital Transcript"),
}
...
def display_menu():
    ...
    if not hasattr(display_menu, '_permissions_setup'):
        try:
            ...
            try:
                from education_system.systems.university.infrastructure.auth import add_plagiarism_permissions
    ...
    while True:
        ...
        if choice in option_map:
            ...
            if option == "student_records":
                ...
                try:
                    from education_system.systems.university.interfaces.cli.academics.exam_management_cli import display_exam_portal_menu
                ...
                if display_student_union_menu:
                    try:
                        from education_system.systems.university.domain.pastoral.student_life.student_union import set_auth as _su_set_auth
                        _su_set_auth(auth)
                    except ImportError:
                        pass
                ...
                try:
                    from education_system.systems.university.interfaces.cli.safeguarding import run_safeguarding_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.governance.compliance.international_compliance import run_visa_compliance_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.pastoral.equality_diversity import run_equality_diversity_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.governance.legal.disciplinary import run_disciplinary_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.governance.legal.disciplinary.fitness_to_practise import run_ftp_menu
                    run_ftp_menu(auth)
                except Exception as e:
                ...
                try:
                    from education_system.systems.university.interfaces.cli.governance.legal.risk_management import run_risk_management_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.governance.compliance.hesa_export.hesa_export_cli import display_hesa_export_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.assessment.external_examiners.external_examiner_cli import display_external_examiner_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.academics.research.external_quality_assurance.eqa_cli import display_external_qa_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.academics.curriculum_specification.curriculum_specification_cli import display_curriculum_specification_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.pastoral.student_app.student_app_cli import display_student_app_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.pastoral.student_app.documentation.documentation_cli import display_documentation_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.pastoral.achievement_badges.achievement_badge_cli import display_achievement_badge_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.academics.study_recommendations.study_recommendation_cli import display_study_recommendation_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.admissions.clearing_adjustment.clearing_adjustment_cli import display_clearing_adjustment_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.admissions.prior_learning_recognition.prior_learning_cli import display_prior_learning_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.academics.course_planning.planning_cli import main as course_planning_main
                ...
                try:
                    from education_system.systems.university.interfaces.cli.academics.course_planning import run_lesson_planner_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.progression.apprenticeships import run_apprenticeships_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.progression.placements import run_placements_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.operations.commerce.bakery_shop import run_bakery_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.finance.bank_rec import run_bank_rec_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.finance.ledger import run_ledger_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.finance.statements import run_statements_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.pastoral.health.first_aid import run_first_aid_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.governance.health_safety import run_health_safety_menu
                ...
                try:
                    from education_system.systems.university.interfaces.cli.pastoral.advising.advising_cli import main as advising_main
                    advising_main()
                except ImportError as e:
                ...
                try:
                    from education_system.systems.university.interfaces.cli.pastoral.wellbeing.student_wellbeing.student_wellbeing_cli import main as wellbeing_main
                    wellbeing_main()
                except ImportError as e:
                ...
                try:
                    from education_system.systems.university.interfaces.cli.learners.student_id.student_id_cli import main as student_id_main
                    student_id_main()
                except ImportError as e:
                ...
                try:
                    from education_system.systems.university.interfaces.cli.operations.campus.printing.printing_cli import main as printing_main
                    printing_main()
                except ImportError as e:
                ...
                try:
                    from education_system.systems.university.interfaces.cli.operations.campus.study_rooms.study_rooms_cli import main as study_rooms_main
                    study_rooms_main()
                except ImportError as e:
                ...
                try:
                    from education_system.systems.university.interfaces.cli.operations.commerce.textbooks.textbooks_cli import main as textbooks_main
                    textbooks_main()
                except ImportError as e:
...
_NEW_FEATURE_CLI_DISPATCH = {
    "nf_employer_portal": (
        "education_system.systems.university.domain.pastoral."
    ...
    "nf_kpi_dashboard": (
        "education_system.systems.university.domain.operations.reporting."
    ...
    "nf_bursary": (
        "education_system.systems.university.domain.finance."
    ...
    "nf_room_booking": (
        "education_system.systems.university.domain.operations.campus."
...
def _finaid_manage_scholarships(auth):
    ...
    from education_system.systems.university.domain.finance.services.financial_aid.scholarship_manager import ScholarshipManager
    print("\n--- Manage Scholarships ---")
...
def display_communication_hub_menu(auth):
    ...
    from education_system.systems.university.infrastructure.email.admin import CommunicationDashboard
    from education_system.systems.university.services.communication.communication_manager import CommunicationManager
    from education_system.systems.university.infrastructure.logs import LOG_MANAGEMENT_AVAILABLE
    ...
    while True:
        try:
            ...
            if choice == '1':
                ...
                # Messages Management
                from education_system.systems.university.infrastructure.email.admin import display_messages_menu
                ...
                from education_system.systems.university.infrastructure.email.admin import display_announcements_menu
                display_announcements_menu(dashboard)
            elif choice == '7':
                # Send Batch Announcement
                from education_system.systems.university.infrastructure.email.email_service import send_batch_email_form
                send_batch_email_form()
            elif choice == '8':
                # Chat Rooms
                from education_system.systems.university.infrastructure.email.admin import display_chat_rooms_menu
                display_chat_rooms_menu(dashboard)
            elif choice == '9':
                # Notification Preferences
                from education_system.systems.university.infrastructure.email.admin import display_preferences_menu
                display_preferences_menu(dashboard)
            elif choice == '10':
                # Configure Email Settings
                from education_system.systems.university.infrastructure.email.config import configure_email_settings
                ...
                from education_system.systems.university.infrastructure.email.templates import template_management_menu
                template_management_menu()
            elif choice == '13':
                # Schedule Emails
                from education_system.systems.university.infrastructure.email.email_service import schedule_email_form
                schedule_email_form()
            elif choice == '14':
                # View Email Queue Status
                from education_system.systems.university.infrastructure.email.email_service import email_queue, get_stored_emails
                ...
                # View Stored Emails
                from education_system.systems.university.infrastructure.email.email_service import display_stored_emails_menu
                display_stored_emails_menu()
            elif choice == '16':
                # Generate Email Reports
                from education_system.systems.university.infrastructure.email.reports import generate_report_form
                generate_report_form()
            elif choice == '17':
                if LOG_MANAGEMENT_AVAILABLE:
                    # Communication Activity Logs
                    from education_system.systems.university.infrastructure.logs import display_communication_logs_menu
                ...
                if is_admin and LOG_MANAGEMENT_AVAILABLE:
                    ...
                    from education_system.systems.university.infrastructure.logs import display_communication_analytics_menu
                ...
                if is_admin and not LOG_MANAGEMENT_AVAILABLE:
                    ...
                    from education_system.systems.university.infrastructure.email.admin import display_admin_message_management_menu
                ...
                from education_system.platform.features.messaging import cross_system_cli
...
def display_administrative_tools_menu(auth):
    ...
    while True:
        ...
        if choice == '1':
            ...
            # Enhanced Reporting
            from education_system.systems.university.services.analytics.enhanced_reporting import display_enhanced_reporting_menu
...
def display_data_document_management_menu(auth):
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.infrastructure.database.data_backup import display_backup_menu
            display_backup_menu()
        elif choice == '4':
            # Return to main menu
            break
...
def switch_to_gui(auth_instance):
    ...
    try:
        ...
        import importlib
        gui_module = importlib.import_module('education_system.systems.university.interfaces.gui.shell.main')
