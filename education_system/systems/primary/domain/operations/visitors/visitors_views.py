...
from education_system.systems.primary.domain.operations.visitors import (
    visitors as data,
)
from education_system.systems.primary.domain.operations.visitors.visitors import (
    DEFAULT_ID_TYPE,
    DEFAULT_STATUS,
