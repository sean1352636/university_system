...
from education_system.systems.primary.domain.pastoral.health.first_aid import (
    first_aid as data,
)
from education_system.systems.primary.domain.pastoral.health.first_aid.first_aid import (
