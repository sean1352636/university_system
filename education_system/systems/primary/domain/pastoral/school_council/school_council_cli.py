"""CLI flows for Primary School Council."""
...
from education_system.systems.primary.domain.pastoral.school_council import (
    school_council as data,
)
from education_system.systems.primary.domain.pastoral.school_council.school_council import (
...
def run() -> None:
    while True:
        ...
        try:
            ...
            logger.exception("School Council CLI crashed")
            print(f"\n  ✗ Unexpected error: {e}")
            _pause()


def dispatch(label: str) -> bool:
    if label != "School Council":
        return False
    try:
        run()
    except Exception as e:
        logger.exception("School Council CLI submenu crashed")
        print(f"\n  ✗ Unexpected error: {e}")
        _pause()
    return True
