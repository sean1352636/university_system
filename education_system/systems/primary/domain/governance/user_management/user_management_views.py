...
from education_system.systems.primary.domain.governance.user_management import user_management as data
from education_system.systems.primary.interfaces import user_accounts as ua_data
