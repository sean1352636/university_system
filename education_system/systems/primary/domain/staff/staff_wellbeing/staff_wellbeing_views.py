"""Tkinter views for Primary School Staff Wellbeing."""
...
from education_system.systems.primary.domain.staff.staff_wellbeing import (
    staff_wellbeing as data,
)
from education_system.systems.primary.domain.staff.staff_wellbeing.staff_wellbeing import (
    ACTION_TYPES,
    CONCERN_FLAGS,
    DEFAULT_ENTRY_TYPE,
    DEFAULT_STATUS,
