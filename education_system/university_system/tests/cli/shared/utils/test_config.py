...
class TestConfigValidation:
    ...
    def test_validate_email_config_valid(self, sample_config):
        ...
        from education_system.university_system.modules.shared.utils.config import validate_email_config
...
class TestConfigLoading:
    ...
    def test_load_config_success(self, mock_file, mock_paths, sample_config):
        ...
        from education_system.university_system.modules.shared.utils.config import load_config, config
...
class TestConfigSaving:
    ...
    def test_save_config_success(self, mock_file, mock_paths, sample_config):
        ...
        from education_system.university_system.modules.shared.utils.config import save_config, config
    ...
    def test_save_config_write_error(self, mock_file, mock_paths):
        ...
        from education_system.university_system.modules.shared.utils.config import save_config
...
class TestConfigValidation:
    ...
    def test_validate_config_from_file(self, mock_validate, mock_file, sample_config):
        ...
        from education_system.university_system.modules.shared.utils.config import validate_config
...
class TestEnsureDatabaseMode:
    ...
    def test_ensure_database_mode_sets_defaults(self):
        ...
        from education_system.university_system.modules.shared.utils.config import ensure_email_config_for_database_mode, config
...
class TestConfigConstants:
    ...
    def test_default_config_has_required_fields(self):
        ...
        from education_system.university_system.modules.shared.utils.config import DEFAULT_CONFIG
    ...
    def test_config_schema_defines_required_fields(self):
        ...
        from education_system.university_system.modules.shared.utils.config import CONFIG_SCHEMA
