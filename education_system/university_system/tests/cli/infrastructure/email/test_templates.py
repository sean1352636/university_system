...
from education_system.university_system.infrastructure.email import templates
...
class TestBackwardCompatibility:
    ...
    def test_module_level_access(self):
        ...
        import education_system.university_system.infrastructure.email.templates as tpl
