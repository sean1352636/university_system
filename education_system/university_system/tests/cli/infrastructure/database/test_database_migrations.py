...
class TestSpecificMigrations:
    ...
    def test_add_mfa_system_migration(self):
        ...
        try:
            from education_system.university_system.infrastructure.database.migrations import add_mfa_system
    ...
    def test_add_security_features_migration(self):
        ...
        try:
            from education_system.university_system.infrastructure.database.migrations import add_security_features
    ...
    def test_add_student_modules_columns_migration(self):
        ...
        try:
            from education_system.university_system.infrastructure.database.migrations import add_student_modules_columns
    ...
    def test_fix_campus_events_tables_migration(self):
        ...
        try:
            from education_system.university_system.infrastructure.database.migrations import fix_campus_events_tables
    ...
    def test_fix_facilities_schema_migration(self):
        ...
        try:
            from education_system.university_system.infrastructure.database.migrations import fix_facilities_schema
