...
class TestSchemasModule:
    ...
    def test_schemas_module_imports(self):
        ...
        try:
            from education_system.university_system.infrastructure.database import schemas
...
class TestSchemaConstants:
    ...
    def test_remaining_features_schema_imports(self):
        ...
        try:
            from education_system.university_system.infrastructure.database import remaining_features_schema
