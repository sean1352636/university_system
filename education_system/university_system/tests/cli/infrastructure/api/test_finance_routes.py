...
from education_system.university_system.api.routes.finance_routes import finance_bp, _row_to_dict
...
class TestFees:
    ...
    @patch("university_system.api.routes.finance_routes.log_activity")
    @patch("university_system.api.routes.finance_routes.get_connection")
...
class TestCreatePayment:
    ...
    @patch("university_system.api.routes.finance_routes.log_activity")
    @patch("university_system.api.routes.finance_routes.transaction")
    @patch("university_system.api.routes.finance_routes.get_connection")
