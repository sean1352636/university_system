...
def reset_singleton():
    ...
    from education_system.university_system.infrastructure.security import audit_trail
...
class TestAuditAction:
    def test_access_value(self):
        from education_system.university_system.infrastructure.security.audit_trail import AuditAction
...
class TestAuditEntry:
    def test_creation(self):
        from education_system.university_system.infrastructure.security.audit_trail import AuditEntry
        now = datetime.now()
        entry = AuditEntry(
            timestamp=now,
            action="read",
