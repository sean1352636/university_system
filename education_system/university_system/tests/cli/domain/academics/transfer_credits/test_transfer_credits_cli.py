...
MODULE_PATH = (
    "education_system.university_system.modules.domain.academics.cli.transfer_credits_cli"
)
...
def reset_table_flag():
    ...
    import education_system.university_system.modules.domain.academics.cli.transfer_credits_cli as mod
...
class TestEnsureTable:
    ...
    def test_ensure_table_creates_table(self, mock_get_conn):
        ...
        from education_system.university_system.modules.domain.academics.cli.transfer_credits_cli import (
            _ensure_table,
        )
