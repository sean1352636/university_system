...
from education_system.university_system.modules.domain.academics.services.assignments.plagiarism_main import (
    PlagiarismChecker,
...
class TestModuleImports:
    ...
    def test_all_exports_available(self):
        ...
        from education_system.university_system.modules.domain.academics.services.assignments import plagiarism_main
