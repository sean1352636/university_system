...
class TestStudentPortalCLIInit:
    ...
    @patch('education_system.university_system.modules.shared.cli.student_portal_cli.get_auth')
    def test_init_creates_auth_and_gets_student_id(self, mock_get_auth, mock_auth):
        ...
        from education_system.university_system.modules.shared.cli.student_portal_cli import StudentPortalCLI
...
class TestStudentPortalCLIMainMenu:
    ...
    @patch('education_system.university_system.modules.shared.cli.student_portal_cli.get_auth')
    @patch('education_system.university_system.modules.shared.cli.student_portal_cli.get_connection')
