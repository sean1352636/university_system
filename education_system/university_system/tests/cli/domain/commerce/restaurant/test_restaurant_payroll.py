...
class TestPayrollModule(unittest.TestCase):
    ...
    def test_calculate_weekly_payroll(self, mock_input, mock_get_conn):
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.staff.payroll import calculate_weekly_payroll
    ...
    def test_calculate_monthly_payroll(self, mock_input, mock_get_conn):
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.staff.payroll import calculate_monthly_payroll
    ...
    def test_calculate_individual_payroll(self, mock_input, mock_get_conn):
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.staff.payroll import calculate_individual_payroll
    ...
    def test_payroll_calculations_menu_export(self, mock_input, mock_export):
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.staff.payroll import payroll_calculations
