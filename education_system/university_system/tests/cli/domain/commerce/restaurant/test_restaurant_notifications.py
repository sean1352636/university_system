...
class TestNotificationsModule(unittest.TestCase):
    ...
    def test_view_notifications_all(self, mock_input, mock_get_conn):
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.operations.notifications import view_notifications
    ...
    def test_create_notification_system_wide(self, mock_input, mock_datetime, mock_log_audit,
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.operations.notifications import create_notification
    ...
    def test_mark_notification_read(self, mock_input, mock_datetime, mock_log_audit,
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.operations.notifications import mark_notification_read
    ...
    def test_manage_notifications_return(self, mock_print, mock_input):
        ...
        from education_system.university_system.modules.domain.commerce.services.restaurant.operations.notifications import manage_notifications
