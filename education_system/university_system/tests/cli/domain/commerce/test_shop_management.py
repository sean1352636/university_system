...
from education_system.university_system.modules.domain.commerce.services import shop_management
from education_system.university_system.modules.domain.commerce.services.shop_management import config as shop_config

# Patch paths for sub-modules that import get_connection directly
DB_PATCH = 'education_system.university_system.modules.domain.commerce.services.shop_management.database.get_connection'
SHOPPING_PATCH = 'education_system.university_system.modules.domain.commerce.services.shop_management.shopping.get_connection'
SHOPPING_FINANCE_PATCH = 'education_system.university_system.modules.domain.commerce.services.shop_management.shopping.record_payment_to_finance'
...
class TestDisplayShopMenu:
    ...
    @patch('education_system.university_system.modules.domain.commerce.services.shop_management.menus.get_connection')
