...
MODULE = "education_system.university_system.modules.setup_unified_database"
...
def test_create_unified_database_returns_path(patched_paths):
    from education_system.university_system.modules.setup_unified_database import create_unified_database
...
def test_test_unified_database_returns_true(patched_paths):
    from education_system.university_system.modules.setup_unified_database import (
        create_unified_database,
...
def test_test_unified_database_returns_false_when_missing(temp_dir):
    ...
    with patch(f"{MODULE}.DEFAULT_DB_PATH", missing), \
         patch(f"{MODULE}.DB_DIR", temp_dir):
        from education_system.university_system.modules.setup_unified_database import test_unified_database
        result = test_unified_database()
        assert result is False


def test_backup_existing_database_no_file(patched_paths):
    from education_system.university_system.modules.setup_unified_database import backup_existing_database
