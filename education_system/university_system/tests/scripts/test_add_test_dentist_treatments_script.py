...
from education_system.university_system.scripts import add_test_dentist_treatments as script
...
class TestAddTestTreatments:
    ...
    def test_inserts_treatments_when_patient_exists(self):
        ...
        with patch.object(script, "get_connection", return_value=read_cm), \
             ...
             patch.dict(
                 "sys.modules",
                 {"education_system.university_system.modules.domain.health.dentist.services.dentist_core":
