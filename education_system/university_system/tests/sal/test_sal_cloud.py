...
from education_system.university_system.modules.shared.utils.simple_activity_logger import cloud
from education_system.university_system.modules.shared.utils.simple_activity_logger.cloud import (
    CloudIntegration,
)
