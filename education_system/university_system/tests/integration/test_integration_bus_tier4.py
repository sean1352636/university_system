...
def test_attendance_record_auto_flags_low_pct(tmp_db):
    from education_system.university_system.modules.domain.academics.services.attendance import records as att_records
...
def test_enrolment_invokes_match_suggestions(tmp_db):
    ...
    with patch(
        "education_system.university_system.modules.domain."
