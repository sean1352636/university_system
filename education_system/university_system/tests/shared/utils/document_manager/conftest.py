...
from education_system.university_system.modules.shared.utils import document_manager as _dm_pkg
...
@pytest.fixture
def doc_manager(patched_connection, tmp_path, monkeypatch):
