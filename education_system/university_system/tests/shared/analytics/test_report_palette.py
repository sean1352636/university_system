...
from education_system.university_system.modules.shared.utils import report_palette
from education_system.university_system.modules.shared.utils.report_palette import (
    DEFAULT_PALETTE,
    get_report_palette,
    color_at,
)
