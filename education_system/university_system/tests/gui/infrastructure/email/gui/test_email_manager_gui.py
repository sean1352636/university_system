...
# Mock GUI-related modules before importing the module
# This prevents matplotlib/tkinter from trying to initialize in headless environments
...
# NOTE: Do NOT mock tkinter — it poisons sys.modules globally for
# the entire pytest session, causing InvalidSpecError elsewhere.
