...
_GUI_MOD = 'education_system.university_system.modules.domain.academics.gui.degree_audit_gui'

from education_system.university_system.modules.domain.academics.gui.degree_audit_gui import (
