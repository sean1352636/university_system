...
class TestHelperFunctions:
    ...
    def test_percentage_to_letter(self):
        ...
        from education_system.university_system.modules.domain.academics.gui.grade_tracking.student_manager import percentage_to_letter
    ...
    def test_letter_to_gpa(self):
        ...
        from education_system.university_system.modules.domain.academics.gui.grade_tracking.student_manager import letter_to_gpa
