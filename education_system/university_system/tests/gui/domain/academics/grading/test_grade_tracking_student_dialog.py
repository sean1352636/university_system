...
from education_system.university_system.modules.domain.academics.gui.grade_tracking.dialogs.student_dialog import (
    StudentDialog,
    safe_grab_set,
    safe_combo_update,
...
class TestGradeConversionFunctions(unittest.TestCase):
    ...
    def test_letter_to_percentage_conversion(self):
        ...
        self.assertEqual(letter_to_percentage('F'), 17.5)
