...
BASE = 'education_system.university_system.modules.domain.academics.gui.library.base'
...
def _create_gui(mock_root, mock_auth):
    ...
    import education_system.university_system.modules.domain.academics.gui.library.base as base_mod
...
class TestLibraryGUIInitialization:
    ...
    def test_window_maximization_zoomed(self, mock_root, mock_auth):
    ...
    def test_window_maximization_fallback(self, mock_root, mock_auth):
