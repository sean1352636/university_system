...
class TestPhoneShopImports:
    def test_gui_class_importable(self):
        from education_system.university_system.modules.domain.phoneshop.gui.phoneshop_gui import PhoneShopGUI
    ...
    def test_init_phoneshop_db_callable(self):
        from education_system.university_system.modules.domain.phoneshop.services.phoneshop_core import init_phoneshop_db
