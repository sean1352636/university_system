...
from education_system.university_system.modules.domain.student_affairs.gui.internship_management_gui import InternshipGUI

# Base patch paths for the actual modules where symbols are used
_GUI_MOD = 'education_system.university_system.modules.domain.student_affairs.gui.internship_management.internship_gui'
_PLACEMENTS_MOD = 'education_system.university_system.modules.domain.student_affairs.gui.internship_management.placements'
_IMPORTS_MOD = 'education_system.university_system.modules.domain.student_affairs.gui.internship_management._imports'
