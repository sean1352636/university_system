...
MODULE = "education_system.university_system.modules.domain.academics.cli.accreditation_cli"
...
class TestEnsureTables:
    ...
    def test_ensure_tables_creates_all_three_tables(self, mock_get_conn):
        ...
        from education_system.university_system.modules.domain.academics.cli.accreditation_cli import (
            _ensure_tables,
        )
