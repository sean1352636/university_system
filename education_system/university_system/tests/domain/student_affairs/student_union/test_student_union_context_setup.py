...
from education_system.university_system.modules.domain.student_affairs.student_union.services import context_setup
...
class TestSetAuth:
    ...
    @patch('education_system.university_system.modules.domain.student_affairs.student_union.services.union_context')
    ...
    @patch('education_system.university_system.modules.domain.student_affairs.student_union.services.context_setup.HAS_AUTH', True)
    @patch('education_system.university_system.modules.domain.student_affairs.student_union.services.context_setup.set_auth_instance')
    @patch('education_system.university_system.modules.domain.student_affairs.student_union.services.union_context')
    ...
    @patch('education_system.university_system.modules.domain.student_affairs.student_union.services.context_setup.HAS_AUTH', False)
    @patch('education_system.university_system.modules.domain.student_affairs.student_union.services.union_context')
...
class TestDocumentation:
    ...
    def test_module_has_future_annotations(self):
        ...
        if 'university_system.modules.core.services.student_union_misc.context_setup' in sys.modules:
            module = sys.modules['university_system.modules.core.services.student_union_misc.context_setup']
