...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.database import (
...
from education_system.university_system.modules.domain.commerce.cinema.services.cinema_service import (
    CinemaService,
