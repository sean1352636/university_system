...
from education_system.university_system.modules.domain.operations.staff_hr.services.managers.contract_manager import ContractManager
...
class TestContractCreation:
    ...
    @patch('education_system.university_system.modules.domain.operations.staff_hr.services.managers.contract_manager.get_connection')
    @patch('education_system.university_system.modules.domain.operations.staff_hr.services.managers.contract_manager.transaction')
    @patch('education_system.university_system.modules.domain.operations.staff_hr.services.managers.contract_manager.log_activity')
