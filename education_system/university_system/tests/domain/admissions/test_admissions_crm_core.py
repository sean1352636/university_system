...
from education_system.university_system.infrastructure.database.schemas.admissions_schemas import (
...
class TestApplicationManager:
    ...
    def test_make_decision_persists_decision_and_status(self, admissions_db, monkeypatch):
        ...
        import education_system.university_system.modules.domain.admissions.services.admissions_crm_core as mod
