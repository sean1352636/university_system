...
MODULE = "education_system.university_system.modules.services.cli.cafe_system_cli"
...
class TestSupplierManagement:
    ...
    def test_add_supplier_returns_id(self, _patch_db_and_logger):
        from education_system.university_system.modules.services.cli.cafe_system_cli import add_supplier
...
class TestReservations:
    ...
    def test_create_reservation_returns_id(self, _patch_db_and_logger):
        from education_system.university_system.modules.services.cli.cafe_system_cli import create_reservation
...
class TestLoyaltyPoints:
    ...
    def test_get_or_create_loyalty_account_creates_new(self, _patch_db_and_logger):
        from education_system.university_system.modules.services.cli.cafe_system_cli import get_or_create_loyalty_account
...
class TestStaffScheduling:
    ...
    def test_add_staff_schedule(self, _patch_db_and_logger):
        from education_system.university_system.modules.services.cli.cafe_system_cli import add_staff_schedule
