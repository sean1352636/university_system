...
class TestListGrades:
    ...
    @patch("education_system.shared.api.university.routes.grade_routes.log_activity")
    @patch("education_system.shared.api.university.routes.grade_routes.get_connection")
...
class TestRecordGrade:
    ...
    @patch("education_system.shared.api.university.routes.grade_routes.log_activity")
    @patch("education_system.shared.api.university.routes.grade_routes.get_connection")
    @patch("education_system.shared.api.university.routes.grade_routes.transaction")
