...
from education_system.university_system.infrastructure.email import template_utils
...
class TestEnsureTemplatesDirectory:
    ...
    def test_ensure_templates_directory_exists(self, mock_log):
        ...
        with patch('education_system.university_system.infrastructure.email.template_utils.paths') as mock_paths:
...
class TestLoadTemplate:
    ...
    @patch('education_system.university_system.infrastructure.email.template_utils._load_mapping')
    @patch('education_system.university_system.infrastructure.email.template_utils.ensure_templates_directory')
    @patch('education_system.university_system.infrastructure.email.template_utils.log_event')
