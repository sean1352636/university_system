...
class TestConnectionSettingsDefaults:
    ...
    def test_default_db_timeout_value(self):
        ...
        from education_system.university_system.infrastructure.database.constants import DEFAULT_DB_TIMEOUT
    ...
    def test_sqlite_busy_timeout_value(self):
        ...
        from education_system.university_system.infrastructure.database.constants import SQLITE_BUSY_TIMEOUT
        assert SQLITE_BUSY_TIMEOUT == 30000

    def test_max_retry_attempts_value(self):
        """Test MAX_RETRY_ATTEMPTS has expected default of 3."""
        from education_system.university_system.infrastructure.database.constants import MAX_RETRY_ATTEMPTS
        assert MAX_RETRY_ATTEMPTS == 3

    def test_retry_delay_value(self):
        """Test RETRY_DELAY has expected default of 0.5."""
        from education_system.university_system.infrastructure.database.constants import RETRY_DELAY
...
class TestConnectionSettingsEnvOverrides:
    ...
    def test_db_timeout_env_override(self):
        ...
        with patch.dict(os.environ, {'DB_TIMEOUT': '60.0'}):
            ...
            import importlib
            import education_system.university_system.infrastructure.database.constants as mod
...
class TestPragmaSettingsDefaults:
    ...
    def test_pragma_foreign_keys_default(self):
        ...
        from education_system.university_system.infrastructure.database.constants import PRAGMA_FOREIGN_KEYS
        assert PRAGMA_FOREIGN_KEYS == 'ON'

    def test_pragma_journal_mode_default(self):
        """Test PRAGMA_JOURNAL_MODE defaults to WAL."""
        from education_system.university_system.infrastructure.database.constants import PRAGMA_JOURNAL_MODE
        assert PRAGMA_JOURNAL_MODE == 'WAL'

    def test_pragma_synchronous_default(self):
        """Test PRAGMA_SYNCHRONOUS defaults to NORMAL."""
        from education_system.university_system.infrastructure.database.constants import PRAGMA_SYNCHRONOUS
...
class TestConnectionPoolDefaults:
    ...
    def test_max_pool_connections_default(self):
        ...
        from education_system.university_system.infrastructure.database.constants import MAX_POOL_CONNECTIONS
        assert MAX_POOL_CONNECTIONS == 10

    def test_min_pool_connections_default(self):
        """Test MIN_POOL_CONNECTIONS defaults to 2."""
        from education_system.university_system.infrastructure.database.constants import MIN_POOL_CONNECTIONS
        assert MIN_POOL_CONNECTIONS == 2

    def test_pool_timeout_default(self):
        """Test POOL_TIMEOUT defaults to 30.0."""
        from education_system.university_system.infrastructure.database.constants import POOL_TIMEOUT
        assert POOL_TIMEOUT == 30.0

    def test_max_connection_age_default(self):
        """Test MAX_CONNECTION_AGE defaults to 3600 (1 hour)."""
        from education_system.university_system.infrastructure.database.constants import MAX_CONNECTION_AGE
    ...
    def test_pool_cleanup_interval_default(self):
        ...
        from education_system.university_system.infrastructure.database.constants import POOL_CLEANUP_INTERVAL
...
class TestQueryPerformanceDefaults:
    ...
    def test_default_page_size(self):
        ...
        from education_system.university_system.infrastructure.database.constants import DEFAULT_PAGE_SIZE
        assert DEFAULT_PAGE_SIZE == 50

    def test_max_page_size(self):
        """Test MAX_PAGE_SIZE is 1000."""
        from education_system.university_system.infrastructure.database.constants import MAX_PAGE_SIZE
        assert MAX_PAGE_SIZE == 1000

    def test_query_timeout(self):
        """Test QUERY_TIMEOUT is 60.0."""
        from education_system.university_system.infrastructure.database.constants import QUERY_TIMEOUT
...
class TestBackupSettingsDefaults:
    ...
    def test_max_backups(self):
        ...
        from education_system.university_system.infrastructure.database.constants import MAX_BACKUPS
        assert MAX_BACKUPS == 10

    def test_default_backup_interval(self):
        """Test DEFAULT_BACKUP_INTERVAL is 86400 (24 hours)."""
        from education_system.university_system.infrastructure.database.constants import DEFAULT_BACKUP_INTERVAL
    ...
    def test_backup_compression_level(self):
        ...
        from education_system.university_system.infrastructure.database.constants import BACKUP_COMPRESSION_LEVEL
...
class TestEmailConstants:
    ...
    def test_min_email_send_delay(self):
        ...
        from education_system.university_system.infrastructure.database.constants import MIN_EMAIL_SEND_DELAY
        assert MIN_EMAIL_SEND_DELAY == 2.0

    def test_default_email_send_delay(self):
        """Test DEFAULT_EMAIL_SEND_DELAY is 2.0."""
        from education_system.university_system.infrastructure.database.constants import DEFAULT_EMAIL_SEND_DELAY
        assert DEFAULT_EMAIL_SEND_DELAY == 2.0

    def test_max_email_threads(self):
        """Test MAX_EMAIL_THREADS is 1."""
        from education_system.university_system.infrastructure.database.constants import MAX_EMAIL_THREADS
        assert MAX_EMAIL_THREADS == 1

    def test_email_queue_size(self):
        """Test EMAIL_QUEUE_SIZE is 1000."""
        from education_system.university_system.infrastructure.database.constants import EMAIL_QUEUE_SIZE
        assert EMAIL_QUEUE_SIZE == 1000

    def test_email_max_retries(self):
        """Test EMAIL_MAX_RETRIES is 3."""
        from education_system.university_system.infrastructure.database.constants import EMAIL_MAX_RETRIES
...
class TestCacheConstants:
    ...
    def test_cache_ttl(self):
        ...
        from education_system.university_system.infrastructure.database.constants import CACHE_TTL
        assert CACHE_TTL == 300

    def test_max_cache_size(self):
        """Test MAX_CACHE_SIZE is 1000."""
        from education_system.university_system.infrastructure.database.constants import MAX_CACHE_SIZE
...
class TestValidationLimitsDefaults:
    ...
    def test_max_student_id_length(self):
        ...
        from education_system.university_system.infrastructure.database.constants import MAX_STUDENT_ID_LENGTH
        assert MAX_STUDENT_ID_LENGTH == 20

    def test_max_email_length(self):
        """Test MAX_EMAIL_LENGTH is 255."""
        from education_system.university_system.infrastructure.database.constants import MAX_EMAIL_LENGTH
        assert MAX_EMAIL_LENGTH == 255

    def test_max_name_length(self):
        """Test MAX_NAME_LENGTH is 100."""
        from education_system.university_system.infrastructure.database.constants import MAX_NAME_LENGTH
        assert MAX_NAME_LENGTH == 100

    def test_max_text_length(self):
        """Test MAX_TEXT_LENGTH is 5000."""
        from education_system.university_system.infrastructure.database.constants import MAX_TEXT_LENGTH
        assert MAX_TEXT_LENGTH == 5000

    def test_max_file_size(self):
        """Test MAX_FILE_SIZE is 10485760 (10 MB)."""
        from education_system.university_system.infrastructure.database.constants import MAX_FILE_SIZE
...
class TestGradeSystemDefaults:
    ...
    def test_min_grade(self):
        ...
        from education_system.university_system.infrastructure.database.constants import MIN_GRADE
        assert MIN_GRADE == 0.0

    def test_max_grade(self):
        """Test MAX_GRADE is 100.0."""
        from education_system.university_system.infrastructure.database.constants import MAX_GRADE
        assert MAX_GRADE == 100.0

    def test_passing_grade(self):
        """Test PASSING_GRADE is 50.0."""
        from education_system.university_system.infrastructure.database.constants import PASSING_GRADE
        assert PASSING_GRADE == 50.0

    def test_gpa_range(self):
        """Test GPA range is 0.0 to 4.0."""
        from education_system.university_system.infrastructure.database.constants import MIN_GPA, MAX_GPA
        assert MIN_GPA == 0.0
        assert MAX_GPA == 4.0
...
class TestSessionAndSecurityConstants:
    ...
    def test_session_timeout(self):
        ...
        from education_system.university_system.infrastructure.database.constants import SESSION_TIMEOUT
        assert SESSION_TIMEOUT == 3600

    def test_remember_me_duration(self):
        """Test REMEMBER_ME_DURATION is 2592000 (30 days)."""
        from education_system.university_system.infrastructure.database.constants import REMEMBER_ME_DURATION
        assert REMEMBER_ME_DURATION == 2592000

    def test_max_sessions_per_user(self):
        """Test MAX_SESSIONS_PER_USER is 5."""
        from education_system.university_system.infrastructure.database.constants import MAX_SESSIONS_PER_USER
        assert MAX_SESSIONS_PER_USER == 5

    def test_max_login_attempts(self):
        """Test MAX_LOGIN_ATTEMPTS is 5."""
        from education_system.university_system.infrastructure.database.constants import MAX_LOGIN_ATTEMPTS
        assert MAX_LOGIN_ATTEMPTS == 5

    def test_lockout_duration(self):
        """Test LOCKOUT_DURATION is 900 (15 minutes)."""
        from education_system.university_system.infrastructure.database.constants import LOCKOUT_DURATION
        assert LOCKOUT_DURATION == 900

    def test_api_rate_limit(self):
        """Test API_RATE_LIMIT is 60."""
        from education_system.university_system.infrastructure.database.constants import API_RATE_LIMIT
        assert API_RATE_LIMIT == 60

    def test_password_hash_iterations(self):
        """Test PASSWORD_HASH_ITERATIONS is 1000000."""
        from education_system.university_system.infrastructure.database.constants import PASSWORD_HASH_ITERATIONS
        assert PASSWORD_HASH_ITERATIONS == 1_000_000

    def test_salt_length(self):
        """Test SALT_LENGTH is 32."""
        from education_system.university_system.infrastructure.database.constants import SALT_LENGTH
        assert SALT_LENGTH == 32

    def test_key_derivation_length(self):
        """Test KEY_DERIVATION_LENGTH is 64."""
        from education_system.university_system.infrastructure.database.constants import KEY_DERIVATION_LENGTH
        assert KEY_DERIVATION_LENGTH == 64

    def test_password_reset_token_expiry(self):
        """Test PASSWORD_RESET_TOKEN_EXPIRY is 3600."""
        from education_system.university_system.infrastructure.database.constants import PASSWORD_RESET_TOKEN_EXPIRY
...
class TestStorageAndMonitoringConstants:
    ...
    def test_user_storage_quota(self):
        ...
        from education_system.university_system.infrastructure.database.constants import USER_STORAGE_QUOTA
        assert USER_STORAGE_QUOTA == 1073741824

    def test_max_database_size(self):
        """Test MAX_DATABASE_SIZE is 10 GB."""
        from education_system.university_system.infrastructure.database.constants import MAX_DATABASE_SIZE
        assert MAX_DATABASE_SIZE == 10737418240

    def test_stats_log_interval(self):
        """Test STATS_LOG_INTERVAL is 3600."""
        from education_system.university_system.infrastructure.database.constants import STATS_LOG_INTERVAL
        assert STATS_LOG_INTERVAL == 3600

    def test_max_log_file_size(self):
        """Test MAX_LOG_FILE_SIZE is 10 MB."""
        from education_system.university_system.infrastructure.database.constants import MAX_LOG_FILE_SIZE
        assert MAX_LOG_FILE_SIZE == 10485760

    def test_log_file_backup_count(self):
        """Test LOG_FILE_BACKUP_COUNT is 5."""
        from education_system.university_system.infrastructure.database.constants import LOG_FILE_BACKUP_COUNT
        assert LOG_FILE_BACKUP_COUNT == 5

    def test_health_check_interval(self):
        """Test HEALTH_CHECK_INTERVAL is 60."""
        from education_system.university_system.infrastructure.database.constants import HEALTH_CHECK_INTERVAL
        assert HEALTH_CHECK_INTERVAL == 60

    def test_health_check_query_timeout(self):
        """Test HEALTH_CHECK_QUERY_TIMEOUT is 1.0."""
        from education_system.university_system.infrastructure.database.constants import HEALTH_CHECK_QUERY_TIMEOUT
...
class TestAllExports:
    ...
    def test_all_is_list(self):
        ...
        from education_system.university_system.infrastructure.database import constants
    ...
    def test_all_contains_connection_constants(self):
        ...
        from education_system.university_system.infrastructure.database.constants import __all__
