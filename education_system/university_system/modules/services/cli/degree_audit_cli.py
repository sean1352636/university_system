...
class DegreeAuditCLI:
    ...
    def view_degree_requirements(self):
        ...
        print(f"\n📚 CORE REQUIREMENTS")
        print(f"  • Total Credits: 120")
        print(f"  • Minimum GPA: 2.0")
        print(f"  • Residency: 30 credits minimum\n")

        print(f"📖 MAJOR REQUIREMENTS ({course_code})")
        if course_code == 'CS':
            print(f"  • Programming Fundamentals: 12 credits")
            print(f"  • Data Structures & Algorithms: 12 credits")
            print(f"  • Systems & Architecture: 9 credits")
            print(f"  • Software Engineering: 9 credits")
            print(f"  • Electives: 18 credits")
        else:  # DS
            print(f"  • Statistics & Probability: 12 credits")
            print(f"  • Machine Learning: 12 credits")
            print(f"  • Data Mining: 9 credits")
            print(f"  • Big Data Systems: 9 credits")
            print(f"  • Electives: 18 credits")

        print(f"\n🌍 GENERAL EDUCATION")
        print(f"  • English Composition: 6 credits")
        print(f"  • Mathematics: 12 credits")
        print(f"  • Natural Sciences: 12 credits")
        print(f"  • Social Sciences: 9 credits")
        print(f"  • Humanities: 9 credits")

        print(f"\n📝 CAPSTONE")
        print(f"  • Senior Project or Thesis: 6 credits")
