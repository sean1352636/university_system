...
def _launch_grades_breakdown(parent, auth):
    ...
    from education_system.university_system.modules.domain.academics.gui.grades_breakdown.grades_breakdown_gui import GradesBreakdownGUI
    GradesBreakdownGUI(parent, auth=auth)


def _launch_degree_progress(parent, auth):
    """Launch Degree Progress Tracker."""
    from education_system.university_system.modules.domain.academics.gui.degree_progress.degree_progress_gui import DegreeProgressGUI
...
def _launch_gpa_calculator(parent, auth):
    ...
    from education_system.university_system.modules.domain.academics.gui.gpa_calculator.gpa_calculator_gui import GPACalculatorGUI
