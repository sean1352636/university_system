...
def _launch_roster(parent, auth):
    ...
    from education_system.university_system.modules.domain.academics.gui.roster_viewer.roster_gui import ClassRosterGUI
    ClassRosterGUI(parent, auth=auth)


def _launch_bulk_grade(parent, auth):
    """Launch Bulk Grade Import."""
    from education_system.university_system.modules.domain.academics.gui.bulk_grade_import.bulk_grade_gui import BulkGradeImportGUI
    BulkGradeImportGUI(parent, auth=auth)


def _launch_messaging(parent, auth):
    """Launch Course Messaging."""
    from education_system.university_system.modules.domain.academics.gui.course_messaging.messaging_gui import CourseMessagingGUI
    CourseMessagingGUI(parent, auth=auth)


def _launch_attendance_grade(parent, auth):
    """Launch Attendance-Grade Config."""
    from education_system.university_system.modules.domain.academics.gui.attendance_grade.attendance_grade_gui import AttendanceGradeConfigGUI
...
def _launch_semester_analytics(parent, auth):
    ...
    from education_system.university_system.modules.domain.academics.gui.semester_analytics.semester_analytics_gui import SemesterAnalyticsGUI
