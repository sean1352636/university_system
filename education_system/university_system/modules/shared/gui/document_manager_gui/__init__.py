...
Recommended imports (direct submodule paths):
    ...
    from education_system.university_system.modules.shared.gui.document_manager_gui.console import start_document_manager_gui
    from education_system.university_system.modules.shared.gui.document_manager_gui.console import display_document_management_menu

Backward-compatible imports (re-exported here):
    from education_system.university_system.modules.shared.gui.document_manager_gui import DocumentManagerGUI
    from education_system.university_system.modules.shared.gui.document_manager_gui import start_document_manager_gui
    from education_system.university_system.modules.shared.gui.document_manager_gui import display_document_management_menu
"""
