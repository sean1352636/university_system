...
from education_system.university_system.modules.shared.gui.database.scheduling.scheduler import stop_scheduler
...
from education_system.university_system.modules.shared.gui.database.operations.restore_ops import restore_from_backup
...
def display_enhanced_backup_menu_gui():
    ...
    try:
        from education_system.university_system.infrastructure.database.data_backup import display_enhanced_backup_menu
    except ImportError:
        from education_system.university_system.infrastructure.database.data_backup import display_enhanced_backup_menu
...
if __name__ != "__main__":
    ...
    try:
        from education_system.university_system.infrastructure.database.data_backup import (
