...
from education_system.university_system.modules.shared.gui.database.metadata import metadata_manager
...
from education_system.university_system.modules.shared.gui.database.scheduling.cron import parse_cron_schedule
import education_system.university_system.modules.shared.gui.database.config as cfg
...
from education_system.university_system.modules.shared.gui.database.operations.backup_ops import (
    create_enhanced_backup, create_selective_backup, create_schema_only_backup,
    create_incremental_backup, create_differential_backup,
    calculate_file_hash, compress_file, encrypt_file,
    upload_to_aws_s3, upload_to_ftp, upload_to_sftp,
    cleanup_old_backups, notify_backup_result,
    get_database_tables, get_database_tables_from_connection,
    has_database_changed, ensure_backup_directory,
    list_available_backups, validate_backup,
    deduplicate_backups, check_storage_quota,
                ...
                if len(backup_group) > 1:
                    ...
                    for duplicate in backup_group[1:]:  # Skip the first (newest)
                        try:
                            ...
                            try:
                                from education_system.university_system.infrastructure.database.data_backup import delete_backup as delete_backup_func
