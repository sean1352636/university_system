...
from education_system.university_system.modules.shared.gui.email.email_gui.chat_dialogs import CreateChatRoomDialog, ChatInvitationsDialog, ChatRoomWindow
