...
try:
    from education_system.university_system.modules.shared.utils.batch_operations import BatchOperationManager as OriginalBatchOperationManager
    from education_system.university_system.modules.shared.utils.batch_operations import ImportResult, ProgressTracker
except ImportError:
    ...
    class OriginalBatchOperationManager:
        ...
        def display_batch_menu(self):
            ...
            try:
                ...
                print("  from education_system.university_system.modules.shared.gui.batch_operations_gui import BatchOperationsGUI")
                print("\n" + "="*60)
