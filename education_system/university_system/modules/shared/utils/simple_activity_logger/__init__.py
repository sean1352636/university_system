...
from education_system.university_system.modules.shared.utils.simple_activity_logger.decorators import enhanced_log_activity as _decorator_enhanced_log_activity
