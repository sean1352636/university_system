...
Usage:
    ...
    from education_system.university_system.modules.shared.cli import main
    main()

    # Or use individual functions (backward compatible)
    from education_system.university_system.modules.shared.cli import create_student_record
"""
