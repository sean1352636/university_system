...
def display_module_management_menu():
    ...
    while True:
        ...
        if can_manage:
            print(f"\n📚 MODULE CRUD:")
            print(f"  1. Create new module")
            print(f"  2. Edit module")
            print(f"  3. Delete module")
            options.extend(['create_module', 'edit_module', 'delete_module'])

            print(f"\n🔍 SEARCH:")
            print(f"  4. Search module by name")
            print(f"  5. Search module by code")
            options.extend(['search_name', 'search_code'])

            print(f"\n📅 SCHEDULING:")
            print(f"  6. Schedule module")
            print(f"  7. View timetable")
            options.extend(['schedule', 'timetable'])

            print(f"\n📊 REPORTS & EMAIL:")
            print(f"  8. Generate module report")
            print(f"  9. Email students on module")
            options.extend(['report', 'email_students'])

            print(f"\n💾 BULK OPERATIONS:")
            print(f"  10. Import modules from CSV")
            print(f"  11. Export modules to CSV")
            options.extend(['import_csv', 'export_csv'])

            print(f"\n🔧 MAINTENANCE:")
            print(f"  12. Validate module data")
            print(f"  13. Backup module data")
            options.extend(['validate', 'backup'])

            max_option = 13
        else:
            print(f"\n🔍 SEARCH:")
            print(f"  1. Search module by name")
            print(f"  2. Search module by code")
            print(f"  3. View timetable")
            print(f"  4. Generate module report")
