...
try:
    from education_system.university_system.modules.domain.academics.gui.grade_tracking_management_gui import display_enhanced_grade_menu, predictive_analytics_menu
except ImportError:
...
from education_system.university_system.modules.domain.student_affairs.services.alumni_management import setup_alumni_permissions
from education_system.university_system.modules.domain.student_affairs.services.internship_management import setup_internship_permissions
...
from education_system.university_system.modules.shared.services.business_intelligence.bi_reports_core import display_business_intelligence_menu
from education_system.university_system.modules.shared.services.analytics.advanced_search import display_enhanced_menu
from education_system.university_system.modules.shared.services.ai_features.ai_features_core import display_ai_features_menu
...
def display_menu():
    ...
    if not hasattr(display_menu, '_permissions_setup'):
        try:
            ...
            try:
                from education_system.university_system.infrastructure.auth import add_plagiarism_permissions
    ...
    while True:
        try:
            ...
            if choice == '1':
                ...
                # Messages Management
                from education_system.university_system.infrastructure.email.admin import display_messages_menu
                ...
                from education_system.university_system.infrastructure.email.admin import display_announcements_menu
                display_announcements_menu(dashboard)
            elif choice == '7':
                # Send Batch Announcement
                from education_system.university_system.infrastructure.email.email_service import send_batch_email_form
                send_batch_email_form()
            elif choice == '8':
                # Chat Rooms
                from education_system.university_system.infrastructure.email.admin import display_chat_rooms_menu
                display_chat_rooms_menu(dashboard)
            elif choice == '9':
                # Notification Preferences
                from education_system.university_system.infrastructure.email.admin import display_preferences_menu
                display_preferences_menu(dashboard)
            elif choice == '10':
                # Configure Email Settings
                from education_system.university_system.infrastructure.email.config import configure_email_settings
                ...
                from education_system.university_system.infrastructure.email.templates import template_management_menu
                template_management_menu()
            elif choice == '13':
                # Schedule Emails
                from education_system.university_system.infrastructure.email.email_service import schedule_email_form
                schedule_email_form()
            elif choice == '14':
                # View Email Queue Status
                from education_system.university_system.infrastructure.email.email_service import email_queue, get_stored_emails
                ...
                # View Stored Emails
                from education_system.university_system.infrastructure.email.email_service import display_stored_emails_menu
                display_stored_emails_menu()
            elif choice == '16':
                # Generate Email Reports
                from education_system.university_system.infrastructure.email.reports import generate_report_form
                ...
                if is_admin and not LOG_MANAGEMENT_AVAILABLE:
                    ...
                    from education_system.university_system.infrastructure.email.admin import display_admin_message_management_menu
...
def switch_to_gui(auth_instance):
    ...
    try:
        ...
        import importlib
        gui_module = importlib.import_module('education_system.university_system.modules.shared.gui.main')
