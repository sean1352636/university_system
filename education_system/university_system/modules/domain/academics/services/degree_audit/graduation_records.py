...
class PrintQueueManager:
    ...
    def enqueue(ceremony_id: int, student_id: str,
        ...
        from education_system.shared.certificates.certificate_service import (
            CertificateService,
        )
...
class TranscriptFreezeManager:
    ...
    def freeze(student_id: str,
        ...
        from education_system.shared.certificates.transcript_service import (
            TranscriptService,
        )
...
class AlumniProvisioner:
    ...
    def provision(student_id: str,
                  ...
                  degree_earned: str = "") -> Dict[str, Any]:
        """Upsert an ``alumni`` row from the student record. Returns the
        resulting row."""
        with transaction() as conn:
