...
class MultiStageMixin:
    ...
    def create_multi_stage_assignment(self):
        ...
        try:
            ...
            for i in range(1, num_stages + 1):
                ...
                name = input(f"Stage name: ").strip()
                if not name:
                    print("Stage name cannot be empty.")
                    conn.close()
                    return

                description = input(f"Stage description: ").strip()
                ...
                while True:
                    deadline_str = input(f"Deadline (YYYY-MM-DD HH:MM): ").strip()
                    try:
                ...
                feedback_input = input(f"Feedback required before next stage? (y/n): ").lower()
    ...
    def review_stage(self):
        ...
        try:
            ...
            print(f"Feedback provided to student.")
