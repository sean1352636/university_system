...
from education_system.university_system.modules.domain.academics.services.admissions_selection.tariff import (
    ALEVEL_POINTS,
    GRADE_CHOICES,
    compute_tariff,
...
from education_system.university_system.modules.domain.academics.services.admissions_selection.course_catalogue import (
    get_course,
    list_active_courses,
)
from education_system.university_system.modules.domain.academics.services.admissions_selection.eligibility import (
    eligible_courses,
    is_eligible,
)
from education_system.university_system.modules.domain.academics.services.admissions_selection.curriculum import (
    TOTAL_MODULES,
    enrol_student_in_curriculum,
    get_or_create_curriculum,
)
from education_system.university_system.modules.domain.academics.services.admissions_selection.module_chat import (
