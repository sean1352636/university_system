...
class GeofenceService:
    ...
    def _get_system(cls):
        if cls._shared_instance is None:
            from education_system.university_system.modules.domain.academics.services.attendance.geofencing import (  # noqa: E501
                GeofencingSystem,
            )
...
class FaceCheckinService:
    ...
    def _get_system(cls):
        if cls._shared_instance is None:
            from education_system.university_system.modules.domain.academics.services.attendance.face_recognition_system import (  # noqa: E501
...
class LmsSyncService:
    ...
    def grant_for_absence(self, student_id: str, module_code: str,
        ...
        try:
            ...
            return
        try:
            from education_system.university_system.modules.domain.academics.services.lms import (  # type: ignore  # noqa: E501
                lms_core as _lms,
            )
