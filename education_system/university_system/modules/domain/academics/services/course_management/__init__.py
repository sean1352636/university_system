...
from education_system.university_system.modules.domain.academics.services.course_management.validation import (
...
from education_system.university_system.modules.domain.academics.services.course_management.courses import (
...
from education_system.university_system.modules.domain.academics.services.course_management.prerequisites import (
    add_prerequisite,
    view_prerequisites,
    remove_prerequisite,
)
...
from education_system.university_system.modules.domain.academics.services.course_management.scheduling import (
...
from education_system.university_system.modules.domain.academics.services.course_management.import_export import (
    import_courses_from_csv,
    export_courses_to_csv,
    bulk_update_courses,
)
from education_system.university_system.modules.domain.academics.services.course_management.analytics import (
    generate_course_analytics,
    generate_enrollment_report,
    department_statistics,
)
from education_system.university_system.modules.domain.academics.services.course_management.waitlist import (
    add_to_waitlist,
    view_waitlists,
    process_waitlist,
)
from education_system.university_system.modules.domain.academics.services.course_management.recommendations import (
    recommend_courses,
...
from education_system.university_system.modules.domain.academics.services.course_management.menu import (
