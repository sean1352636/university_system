        ...
        if not self.lessons and not self.courses:
            ...
            self.courses = [
                {"code": "CS101", "name": "Introduction to Computer Science",
                 "dept": "Computer Science", "credits": "4",
                 "semester": "Fall 2026", "description": "Foundational CS course."},
                {"code": "MATH201", "name": "Calculus II",
                 "dept": "Mathematics", "credits": "3",
                 "semester": "Fall 2026", "description": "Integral calculus."},
            ]
            self.lessons = [
                {"course": "CS101 - Introduction to Computer Science",
                 "title": "Algorithms Lecture", "instructor": "Dr. Smith",
                 "type": "Lecture", "day": "Monday",
                 "start": "09:00", "end": "11:00", "room": "A101",
                 "notes": "Bring textbook."},
                {"course": "MATH201 - Calculus II",
                 "title": "Integration Techniques", "instructor": "Prof. Jones",
                 "type": "Tutorial", "day": "Wednesday",
