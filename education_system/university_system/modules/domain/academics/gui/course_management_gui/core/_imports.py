...
from education_system.university_system.modules.domain.academics.gui.course_management_gui.courses.course_crud import (
    CourseCreateDialog, CourseEditDialog
)
from education_system.university_system.modules.domain.academics.gui.course_management_gui.courses.course_status import (
...
from education_system.university_system.modules.domain.academics.gui.course_management_gui.bulk.bulk_operations import (
    BulkUpdateDialog
)
...
from education_system.university_system.modules.domain.academics.gui.course_management_gui.core.validation import (
