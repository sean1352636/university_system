# Backwards-compatibility shim – import from the split modules
from education_system.university_system.modules.domain.academics.gui.course_management_gui.waitlists.actions import (
    show_add_waitlist,
    show_view_waitlists,
