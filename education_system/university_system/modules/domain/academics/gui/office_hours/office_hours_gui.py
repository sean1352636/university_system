...
class OfficeHoursGUI:
    ...
    def _setup_ui(self):
        ...
        from education_system.university_system.modules.domain.academics.gui.office_hours.booking_manager import (
            BookingManager,
        )

        if role in ('admin', 'instructor', 'staff'):
            from education_system.university_system.modules.domain.academics.gui.office_hours.instructor_manager import (
                InstructorManager,
            )
