...
class TAManagementGUI:
    ...
    def _setup_ui(self):
        ...
        from education_system.university_system.modules.domain.academics.gui.ta_management.assignment_manager import (
            AssignmentManager,
        )
        from education_system.university_system.modules.domain.academics.gui.ta_management.permissions_manager import (
            PermissionsManager,
        )
        ...
        if role in ('admin', 'instructor'):
            ...
            from education_system.university_system.modules.domain.academics.gui.ta_management.evaluation_manager import (
                EvaluationManager,
            )
