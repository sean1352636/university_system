...
try:
    from education_system.university_system.modules.domain.academics.grading.learning_outcomes import (
...
try:
    from education_system.university_system.modules.domain.academics.grading.performance_analytics import (
        _table_exists,
        _cols,
