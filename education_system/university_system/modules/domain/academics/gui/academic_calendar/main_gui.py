...
from education_system.university_system.modules.domain.academics.gui.academic_calendar.dialogs_search import (
...
def launch_calendar_gui(auth_manager=None):
    ...
    try:
        ...
        from education_system.university_system.modules.domain.academics.services.academic_calendar.cli import ensure_calendar_permissions
