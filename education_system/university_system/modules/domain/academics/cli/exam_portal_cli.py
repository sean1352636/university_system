"""Exam Portal CLI — command-line interface for exam management and taking.

Provides menus for:
- Students: browse exams, take exams, view results
- Instructors: create/edit exams, manage questions, grade, analytics
...
def display_exam_portal_menu(auth):
    ...
    while True:
        ...
        if role in ("admin", "staff", "instructor"):
            ...
            print("8. Exam Analytics")
            print("9. Export Results (CSV)")
        print("0. Back")
