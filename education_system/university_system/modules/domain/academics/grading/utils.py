...
import numpy as np
from education_system.university_system.modules.domain.academics.grading.grade_web_context import GRADE_SYSTEMS

def _get_calculate_course_statistics():
    try:
        from education_system.university_system.modules.domain.academics.grading.performance_analytics import calculate_course_statistics
