...
def deferred_assessments_for_student(student_id: str) -> List[Dict]:
    ...
    try:
        with __import__(
            'education_system.university_system.infrastructure.database.db',
...
def open_mc_gui_for_student(parent, student_id: str = None) -> bool:
    ...
    try:
        from education_system.university_system.modules.domain.academics.mitigating_circumstances.gui.mitigating_circumstances_gui import (
