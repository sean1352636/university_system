...
def display_customer_menu():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import create_customer
            create_customer()
        elif choice == '2':
            from education_system.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import view_customers
            view_customers()
        elif choice == '3':
            from education_system.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import update_customer
            update_customer()
        elif choice == '4':
            from education_system.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import manage_customer_feedback
            manage_customer_feedback()
        elif choice == '5':
            from education_system.university_system.modules.domain.commerce.services.restaurant.customer.loyalty_program import manage_loyalty_program
