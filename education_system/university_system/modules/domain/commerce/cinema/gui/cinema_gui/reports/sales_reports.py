...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.reports_page import show_reports_page

from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.generators import (
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.charts import (
    create_bar_chart,
    create_line_chart,
    create_pie_chart,
)

from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.exports import (
    export_report_csv,
    save_report_txt,
