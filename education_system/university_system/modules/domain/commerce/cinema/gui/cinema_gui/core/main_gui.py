...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.database import DB_FILE, init_database
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.constants import (
...
try:
    from education_system.university_system.infrastructure.auth import hash_password
    HASH_AVAILABLE = True
except ImportError:
...
# --- Helpers ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.helpers import (
...
# --- Reports: Dashboard ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.dashboard import show_dashboard
CinemaApp.show_dashboard = show_dashboard

# --- Booking: Movie Browser ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.booking.movie_browser import (
    show_movies_page,
    create_movie_card,
    show_screenings,
)
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.booking.seat_selection import (
    show_seat_selection,
    toggle_seat,
)
...
# --- Booking: Snacks ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.booking.snacks import (
    show_snacks_page,
    update_snacks_total,
...
# --- Booking: Payment ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.booking.payment import (
    show_payment_page,
    print_ticket,
)
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.management.screening_management import (
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.management.movie_management import (
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.management.ticket_management import (
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.management.promo_management import (
...
# --- Management: Bookings ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.management.bookings import show_bookings_page
CinemaApp.show_bookings_page = show_bookings_page

# --- Loyalty: Members ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.loyalty.members import (
    show_members_page,
...
# --- Loyalty: Gift Cards ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.loyalty.gift_cards import (
...
# --- Loyalty: Profiles ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.loyalty.profiles import (
    show_profiles_page,
    create_profile,
    edit_profile,
...
# --- Loyalty: Referrals ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.loyalty.referrals import (
    show_referrals_page,
    create_referral,
    use_referral,
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.loyalty.season_passes import (
...
# --- Community: Waitlist ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.community.waitlist import (
    show_waitlist_page,
...
# --- Community: Reviews ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.community.reviews import (
    show_reviews_page,
    add_review,
    view_full_review,
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.community.coming_soon import (
...
# --- Community: Series ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.community.series import (
    show_series_page,
    on_series_select,
    create_series,
...
# --- Community: Polls ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.community.polls import (
    show_polls_page,
    create_poll,
    view_results,
    cast_vote,
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.staff_management import (
    show_staff_page,
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.inventory import (
    show_inventory_page,
    add_inv_item,
    restock_inv,
)
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.maintenance import (
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.equipment import (
    show_equipment_page,
    add_equipment,
...
# --- Operations: Rentals ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.rentals import (
    show_rentals_page,
    create_rental,
    confirm_rental,
    cancel_rental,
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.shift_scheduling import (
...
# --- Operations: Events ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.events import (
    show_events_page,
    create_event,
)
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.corporate import (
    show_corporate_page,
    add_corporate,
)
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.operations.lost_found import (
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.sales_reports import (
    show_reports_page,
...
# --- Reports: Analytics ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.analytics import show_analytics_page
CinemaApp.show_analytics_page = show_analytics_page

# --- Reports: Audit Log ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.audit_log import (
...
# --- Reports: Incidents ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.incidents import (
    show_incidents_page,
    set_incident_filter,
    report_incident,
...
# --- Reports: Refunds ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.reports.refunds import (
    show_refunds_page,
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.special_features.accessibility import (
...
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.special_features.heatmap import show_heatmap_page
CinemaApp.show_heatmap_page = show_heatmap_page

# --- Special Features: Theatre Layout ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.special_features.theatre_layout import show_theatre_layout_page
CinemaApp.show_theatre_layout_page = show_theatre_layout_page

# --- Special Features: Occupancy ---
from education_system.university_system.modules.domain.commerce.cinema.gui.cinema_gui.special_features.occupancy import (
