...
class FinanceMixin:
    ...
    def track_cash_drawer(self):
        ...
        # Current balance
        try:
            from education_system.university_system.modules.domain.commerce.barber.services.barber_core import CashDrawerManager
    ...
    def create_gift_card(self):
        ...
        def create():
            try:
                from education_system.university_system.modules.domain.commerce.barber.services.barber_core import GiftCardManager
