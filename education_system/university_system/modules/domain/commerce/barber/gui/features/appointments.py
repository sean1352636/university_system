...
class AppointmentsMixin:
    ...
    def book_appointment(self):
        ...
        try:
            ...
            from education_system.university_system.modules.domain.commerce.barber.services.barber_core import AppointmentManager
    ...
    def process_payment(self):
        ...
        from education_system.university_system.modules.domain.commerce.barber.services.barber_core import AppointmentManager, TransactionManager
        appt = AppointmentManager.get_appointment_by_number(appt_number)
    ...
    def send_receipt_email(self, appointment: dict, transaction_id: int, tip: float = 0):
        ...
        try:
            ...
            from education_system.university_system.modules.domain.commerce.barber.services.barber_core import TransactionManager
    ...
    def generate_admin_report(self):
        ...
        try:
            from education_system.university_system.modules.domain.commerce.barber.services.barber_core import ReportManager
    ...
    def view_waitlist(self):
        ...
        def load_waitlist():
            for item in tree.get_children():
                tree.delete(item)
            try:
                from education_system.university_system.modules.domain.commerce.barber.services.barber_core import WaitlistManager
    ...
    def block_time_slot(self):
        ...
        def block_slot():
            try:
                ...
                from education_system.university_system.modules.domain.commerce.barber.services.barber_core import BlockedSlotManager
    ...
    def recurring_appointment(self):
        ...
        def create_recurring():
            try:
                ...
                from education_system.university_system.modules.domain.commerce.barber.services.barber_core import RecurringAppointmentManager
