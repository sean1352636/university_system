...
class StaffMixin:
    ...
    def add_staff(self):
        ...
        try:
            from education_system.university_system.modules.domain.commerce.barber.services.barber_core import StaffManager
    ...
    def set_staff_schedule(self):
        ...
        def save_schedule():
            try:
                ...
                from education_system.university_system.modules.domain.commerce.barber.services.barber_core import StaffScheduleManager
    ...
    def view_staff_performance(self):
        ...
        try:
            from education_system.university_system.modules.domain.commerce.barber.services.barber_core import AnalyticsManager
    ...
    def set_staff_commission(self):
        ...
        def save_commission():
            try:
                ...
                from education_system.university_system.modules.domain.commerce.barber.services.barber_core import CommissionManager
