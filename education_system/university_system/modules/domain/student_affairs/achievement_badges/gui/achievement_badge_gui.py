...
class AchievementBadgeGUI:
    def __init__(self, parent=None, auth=None):
        ...
        try:
            from education_system.university_system.modules.domain.student_affairs.achievement_badges.services.achievement_badge_service import AchievementBadgeService
