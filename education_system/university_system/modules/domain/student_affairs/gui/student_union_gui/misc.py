...
def _get_student_union_gui():
    from education_system.university_system.modules.domain.student_affairs.gui.student_union_gui.core.main_gui import StudentUnionGUI
    return StudentUnionGUI

def _get_event_attendance_dialog():
    from education_system.university_system.modules.domain.student_affairs.gui.student_union_gui.events.event_dialogs import EventAttendanceDialog
