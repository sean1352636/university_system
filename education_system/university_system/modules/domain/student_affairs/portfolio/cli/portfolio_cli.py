...
from education_system.university_system.modules.domain.student_affairs.portfolio.services.portfolio_service import PortfolioService
...
class PortfolioCLI:
    ...
    def main_menu(self):
        ...
        while True:
            ...
            print("4.  Manage Skills")
            print("5.  View My Badges")
            print("6.  View Endorsements")
            print("7.  Request Endorsement")
            print("8.  Resume Builder")
            print("9.  Public Profile Settings")
            print("10. Share Portfolio")
            print("11. Portfolio Statistics")
