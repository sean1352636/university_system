    ...
    while True:
        try:
            ...
            if choice in ['1', '2', '3', '4', '5', '6', '7']:
                ...
                print("Use: from education_system.university_system.modules.domain.student_affairs.services.career_services import JobManager")
            elif choice == '8':
                display_language_menu_option()
            elif choice == '9':
...
def __getattr__(name):
    if name == "launch_career_services_gui":
        from education_system.university_system.modules.domain.student_affairs.gui.career_services.career_services_gui import (
