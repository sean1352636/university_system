...
from education_system.university_system.modules.domain.student_affairs.student_union.services import union_context as context

# Export context_setup for auth initialization
from education_system.university_system.modules.domain.student_affairs.student_union.services.context_setup import set_auth
...
def __getattr__(name):
    ...
    if name in ('view_active_competitions', 'view_competition_results', 'view_my_competition_history',
        ...
        from education_system.university_system.modules.domain.student_affairs.student_union.services import competitions
    ...
    if name in ('manage_peer_support_system', 'browse_support_groups', 'join_support_group',
        ...
        from education_system.university_system.modules.domain.student_affairs.student_union.services import support
    ...
    if name in ('manage_green_initiatives', 'track_carbon_footprint', 'waste_reduction_tracking',
        ...
        from education_system.university_system.modules.domain.student_affairs.student_union.services import sustainability
    ...
    if name in ('browse_volunteer_opportunities', 'signup_for_volunteer_opportunity',
        ...
        from education_system.university_system.modules.domain.student_affairs.student_union.services import volunteering
    ...
    if name in ('manage_live_streaming', 'interactive_virtual_features',
        ...
        from education_system.university_system.modules.domain.student_affairs.student_union.services import events
