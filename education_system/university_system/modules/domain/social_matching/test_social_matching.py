...
def test_basic_functionality():
    ...
    print("\nTo use the module:")
    print("  - CLI: python -m university_system.modules.domain.social_matching.cli.social_matching_cli")
    print("  - GUI: python -m university_system.modules.domain.social_matching.gui.social_matching_gui")
    print("\nOr import in your code:")
    print("  from education_system.university_system.modules.domain.social_matching import SocialMatchingService")
