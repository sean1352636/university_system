...
from education_system.university_system.modules.domain.health.gui.health_portal.medical_accommodation._common import tk, ttk, messagebox, CLI_AVAILABLE

if CLI_AVAILABLE:
    from education_system.university_system.modules.domain.health.gui.health_portal.medical_accommodation._common import get_accommodation_types
