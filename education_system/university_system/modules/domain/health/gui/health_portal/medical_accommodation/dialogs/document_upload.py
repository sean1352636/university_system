...
from education_system.university_system.modules.domain.health.gui.health_portal.medical_accommodation.utils import resolve_user_identifier
...
class DocumentUploadDialog:
    ...
    def upload(self):
        ...
        try:
            self.do_upload()
            if CLI_AVAILABLE:
                from education_system.university_system.modules.domain.health.gui.health_portal.medical_accommodation._common import log_action
    ...
    def _notify_student_of_upload(self):
        ...
        try:
            ...
            if CLI_AVAILABLE:
                from education_system.university_system.modules.domain.health.gui.health_portal.medical_accommodation._common import cli_notify_student
                cli_notify_student(
                    row['student_id'],
