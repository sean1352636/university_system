...
class ButcherGUI:
    ...
    def _init_database(self):
        ...
        from education_system.university_system.modules.domain.butcher.services.butcher_core import init_butcher_db
        try:
            init_butcher_db()
        except Exception as e:
...
"""
    ...
    def _get_categories(self) -> dict:
        ...
        from education_system.university_system.modules.domain.butcher.services.butcher_core import MEAT_CATEGORIES
    ...
    def add_product(self):
        ...
        try:
            ...
            from education_system.university_system.modules.domain.butcher.services.butcher_core import ProductManager
    ...
    def submit_order(self):
        ...
        try:
            from education_system.university_system.modules.domain.butcher.services.butcher_core import OrderManager
...
"""
    ...
    def process_order_payment(self):
        ...
        from education_system.university_system.modules.domain.butcher.services.butcher_core import OrderManager, TransactionManager
        order = OrderManager.get_order_by_number(order_number)
...
University Butcher Shop"""
    ...
    def send_receipt_email(self, order: dict, transaction_id: int):
        ...
        try:
            ...
            from education_system.university_system.modules.domain.butcher.services.butcher_core import TransactionManager
    ...
    def generate_admin_report(self):
        ...
        try:
            from education_system.university_system.modules.domain.butcher.services.butcher_core import ReportManager
