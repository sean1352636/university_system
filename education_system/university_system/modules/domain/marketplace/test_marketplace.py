...
def test_marketplace_service():
    ...
    try:
        from education_system.university_system.modules.domain.marketplace.services.marketplace_service import (
            MarketplaceService
        )
...
def test_marketplace_cli():
    ...
    try:
        from education_system.university_system.modules.domain.marketplace.cli.marketplace_cli import (
            MarketplaceCLI
        )
...
def test_marketplace_gui():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location(
            "marketplace_gui",
            project_root / "university_system/modules/domain/marketplace/gui/marketplace_gui.py"
        )
...
def main():
    ...
    if passed == total:
        ...
        print("\nUsage:")
        print("  CLI: python -m university_system.modules.domain.marketplace.cli.marketplace_cli")
        print("  GUI: python -m university_system.modules.domain.marketplace.gui.marketplace_gui")
    else:
