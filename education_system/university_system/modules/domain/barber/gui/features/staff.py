    ...
    def set_staff_schedule(self):
        ...
        def save_schedule():
            try:
                ...
                from education_system.university_system.modules.domain.barber.services.barber_core import StaffScheduleManager
    ...
    def set_staff_commission(self):
        ...
        def save_commission():
            try:
                ...
                from education_system.university_system.modules.domain.barber.services.barber_core import CommissionManager
