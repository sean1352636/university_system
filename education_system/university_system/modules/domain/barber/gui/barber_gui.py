...
from education_system.university_system.modules.domain.barber.gui.helpers import HelpersMixin

from education_system.university_system.modules.domain.barber.gui.tabs import (
...
from education_system.university_system.modules.domain.barber.gui.features import (
    AppointmentsMixin,
    ServicesMixin,
    StaffMixin,
    CustomersMixin,
