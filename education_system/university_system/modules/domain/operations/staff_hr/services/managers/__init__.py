...
from education_system.university_system.modules.domain.operations.staff_hr.services.managers.contract_manager import (
    ContractManager,
)
from education_system.university_system.modules.domain.operations.staff_hr.services.managers.expense_manager import (
    ExpenseManager,
)
from education_system.university_system.modules.domain.operations.staff_hr.services.managers.grievance_manager import (
    GrievanceManager,
)
from education_system.university_system.modules.domain.operations.staff_hr.services.managers.exit_manager import (
    ExitManager,
)
