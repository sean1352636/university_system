...
from education_system.university_system.modules.domain.staff_comms.staff_hr.services.managers.peer_review_manager import PeerReviewManager
...
class PeerReviewGUI:
    ...
    def _admin_activate_cycle(self):
        ...
        if not messagebox.askyesno("Confirm",
                                    f"Activate the selected review cycle?"):
            return
