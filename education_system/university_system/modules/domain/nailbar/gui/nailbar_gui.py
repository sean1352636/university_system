...
class NailBarGUI:
    ...
    def _init_database(self):
        ...
        from education_system.university_system.modules.domain.nailbar.services.nailbar_core import init_nailbar_db
        try:
            init_nailbar_db()
    ...
    def _get_time_slots(self) -> list:
        ...
        from education_system.university_system.modules.domain.nailbar.services.nailbar_core import TIME_SLOTS
        return TIME_SLOTS

    def _get_categories(self) -> dict:
        """Get treatment categories - Function 11"""
        from education_system.university_system.modules.domain.nailbar.services.nailbar_core import TREATMENT_CATEGORIES
    ...
    def process_payment(self):
        ...
        from education_system.university_system.modules.domain.nailbar.services.nailbar_core import AppointmentManager, TransactionManager
        appt = AppointmentManager.get_appointment_by_reference(booking_ref)
