...
def _post_refund_journal(deposit_held, total_deductions, refund_amount,
    ...
    try:
        from education_system.university_system.modules.domain.finance.ledger import posting
        from education_system.university_system.modules.domain.finance.ledger.hooks import get_connection as gl_conn
...
def process_deposit_refund():
    ...
    try:
        ...
        try:
            from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation import deposit_state as _ds
        ...
        try:
            from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation import interest as _interest
        ...
        if accrued_interest > 0:
            ...
            if tenant_interest > 0:
                ...
                print(f"    → retained by landlord (no payout)")
            elif interest_policy == 'Scheme':
                print(f"    → handled by scheme (no payout)")
