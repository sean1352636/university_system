...
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.database import init_housing_db
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.buildings import create_building, create_rooms_for_building, view_building, update_building, delete_building
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.applications import create_application, view_application, process_application
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.assignments import view_assignment, update_assignment_status
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.maintenance import create_maintenance_request, view_maintenance_requests, update_maintenance_request
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.payments import record_payment, view_payment_history
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.deposits import (
    process_deposit_refund, view_deposit_ledger,
    student_review_deductions, resolve_deduction_disputes,
)
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.tdp import (
    record_deposit_protection, tdp_compliance_report,
)
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.interest import (
    accrue_deposit_interest, view_interest_accruals,
)
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.deposit_state import (
    view_deposit_state,
)
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.inventory import manage_inventory
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.inspections import create_inspection, view_inspections
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.reports import display_reports_menu
from education_system.university_system.modules.domain.campus.housing.services.housing_accommodation.extended_cli import display_extended_housing_menu
...
def display_housing_accommodation_menu(auth_instance=None):
    ...
    while True:
        ...
        if auth.check_permission('manage_accommodations'):
            ...
            print(f"9. Advanced Operations")
            print(f"   - Move-out · Waitlist · Vacancy board · Bulk ops · "
                  f"Broadcasts · Resident search · Keys · Contracts · "
                  f"Checklists · Guests · Damages · Audit log · Roommate finder")
            print(f"10. {get_text('housing.menu.language', default='Language')}")
            print(f"11. {get_text('housing.menu.return_main', default='Return to Main Menu')}")

            choice = input(f"\n{get_text('housing.prompt.choice', default='Enter your choice (1-11)')}: ")
            ...
            print(f"4. My Deposit Deductions (review / dispute)")
            print(f"5. {get_text('housing.menu.language', default='Language')}")
            print(f"6. {get_text('housing.menu.return_main', default='Return to Main Menu')}")
...
def display_payment_menu():
    ...
    while True:
        ...
        print("3. View Deposit Ledger")
        print("4. Process Deposit Refund (Move-out)")
        print("5. Resolve Deduction Disputes")
        print("6. Record Deposit Protection (TDP)")
        print("7. TDP Compliance Report")
        print("8. Accrue Deposit Interest")
        print("9. View Interest Accruals")
        print("10. View Deposit State")
        print("11. Back to Housing Menu")
        ...
        if choice == '1':
            ...
            record_deposit_protection()
        elif choice == '7':
            tdp_compliance_report()
        elif choice == '8':
            accrue_deposit_interest()
        elif choice == '9':
            view_interest_accruals()
        elif choice == '10':
            view_deposit_state()
        elif choice == '11':
            return
