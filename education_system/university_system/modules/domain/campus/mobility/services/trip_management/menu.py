...
from education_system.university_system.modules.domain.campus.mobility.services.trip_management._common import get_text, logging, CALENDAR_AVAILABLE, log_menu_navigation
from education_system.university_system.modules.domain.campus.mobility.services.trip_management.database import init_trip_db
...
from education_system.university_system.modules.domain.campus.mobility.services.trip_management.trips import view_trips, view_trips_with_calendar, create_trip, update_trip, delete_trip
...
from education_system.university_system.modules.domain.campus.mobility.services.trip_management.reports import generate_trip_report
from education_system.university_system.modules.domain.campus.mobility.services.trip_management.calendar_integration import create_trip_calendar_event, view_trip_events_in_calendar

# Conditional calendar imports
if CALENDAR_AVAILABLE:
    from education_system.university_system.modules.domain.campus.mobility.services.trip_management._common import AcademicCalendarManager, CalendarConfig
...
def test_report_generation():
    ...
    from education_system.university_system.modules.domain.campus.mobility.services.trip_management._common import PDF_AVAILABLE
