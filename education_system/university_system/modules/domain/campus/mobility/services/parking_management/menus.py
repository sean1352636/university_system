...
from education_system.university_system.core.i18n import get_text, get_current_language
...
from education_system.university_system.modules.domain.campus.mobility.services.parking_management.permits import create_parking_permit, view_parking_permit, update_parking_permit, delete_parking_permit
from education_system.university_system.modules.domain.campus.mobility.services.parking_management.vehicles import register_vehicle, view_vehicle, update_vehicle, delete_vehicle
from education_system.university_system.modules.domain.campus.mobility.services.parking_management.violations import record_violation, view_violations, update_violation, delete_violation
from education_system.university_system.modules.domain.campus.mobility.services.parking_management.lots import view_parking_lots, add_parking_lot, update_parking_lot, delete_parking_lot, update_available_spaces
from education_system.university_system.modules.domain.campus.mobility.services.parking_management.reports import (generate_permit_report, generate_violation_report, generate_compliance_report,
                      generate_analytics_dashboard, generate_revenue_report, generate_user_activity_report)
from education_system.university_system.modules.domain.campus.mobility.services.parking_management.exports import export_data
from education_system.university_system.modules.domain.campus.mobility.services.parking_management.core import init_db
