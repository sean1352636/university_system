...
from education_system.university_system.modules.domain.campus.mobility.gui.parking_management import get_connection, _t, TEMPLATE_AVAILABLE, render_template
