...
from education_system.university_system.modules.domain.admissions.ucas.ucas import (
    APP_STATUSES,
    Applicant,
    DECIDABLE,
    DECISION_STATUSES,
...
from education_system.university_system.modules.domain.admissions.ucas.ucas_links import (
    LINK_STATUSES,
    UcasLinkError,
)
