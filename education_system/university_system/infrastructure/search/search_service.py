...
from education_system.university_system.infrastructure.search.elasticsearch_service import (
    get_elasticsearch_service,
    ELASTICSEARCH_AVAILABLE
)
from education_system.university_system.infrastructure.search.fallback_search import FallbackSearchService
