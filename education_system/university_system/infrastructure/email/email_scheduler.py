...
Usage:
    ...
    from education_system.university_system.infrastructure.email.email_scheduler import start_scheduler, stop_scheduler
...
from education_system.university_system.infrastructure.email.email_manager import send_sla_alert
