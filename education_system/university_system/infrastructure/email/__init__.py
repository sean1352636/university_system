...
from education_system.university_system.infrastructure.email.smtp import (
    SMTPClient,
    SMTPConfig,
    EmailService,
)
...
try:
    from education_system.university_system.infrastructure.email.email_fallback import (
        EmailServiceWithFallback,
        EmailServiceUnavailable,
        Email,
        SendResult,
