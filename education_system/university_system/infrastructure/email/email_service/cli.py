...
from education_system.university_system.core.logs import handle_exception
from education_system.university_system.infrastructure.email.templates import list_templates


@handle_exception
def send_batch_email_form():
    """Interactive form for sending batch emails"""
    from education_system.university_system.infrastructure.email.email_service.queue import wait_for_email_queue
...
def schedule_email_form():
    ...
    from education_system.university_system.infrastructure.email.email_service.scheduling import schedule_send
