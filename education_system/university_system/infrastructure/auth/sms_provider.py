...
from education_system.university_system.infrastructure.validation.validators import Validators
...
def load_sms_config() -> Dict:
    ...
    if os.path.exists(config_file):
        try:
            ...
            from education_system.university_system.infrastructure.validation.config_validators import validate_sms_config
