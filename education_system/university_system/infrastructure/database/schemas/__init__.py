...
from education_system.university_system.infrastructure.database.schemas.health_wellness_schemas import init_health_system_db, init_mental_health_system_db, init_health_tables, init_wellness_tables
from education_system.university_system.infrastructure.database.schemas.lms_schemas import init_lms_system_db
from education_system.university_system.infrastructure.database.schemas.attendance_warning_schemas import init_attendance_system_db, init_early_warning_system_db, init_peer_support_tables
...
from education_system.university_system.infrastructure.database.schemas.career_alumni_schemas import init_career_services_system_db, init_alumni_relations_system_db, init_career_tables, init_alumni_tables
...
from education_system.university_system.infrastructure.database.schemas.analytics_bi_schemas import init_analytics_dashboard_system_db, init_business_intelligence_system_db, init_analytics_tables
...
from education_system.university_system.infrastructure.database.schemas.facilities_housing_schemas import init_facilities_management_system_db, init_housing_tables, init_parking_tables, init_travel_tables
from education_system.university_system.infrastructure.database.schemas.research_integration_schemas import init_research_grants_system_db, init_integration_marketplace_system_db, init_integration_tables
...
from education_system.university_system.infrastructure.database.schemas.admin_support_schemas import init_course_evaluation_system_db, init_auth_tables, init_audit_tables, init_documents_tables, init_support_tables, init_parent_tables, init_library_tables, init_commerce_tables, init_other_tables, init_certificate_tables
from education_system.university_system.infrastructure.database.schemas.aggregators import init_additional_missing_tables, init_all_missing_tables
from education_system.university_system.infrastructure.database.schemas.misc_schemas import create_performance_indexes, initialize_all_schemas, init_academic_transfer_history
