...
from education_system.university_system.core.paths import DEFAULT_DB_PATH, DATA_DIR
...
# ── Metadata ──────────────────────────────────────────────────────────────────
from education_system.university_system.infrastructure.database.data_backup.metadata import (
    BackupMetadata,
    metadata_manager,
)
...
# ── Compression ───────────────────────────────────────────────────────────────
from education_system.university_system.infrastructure.database.data_backup.compression import (
    compress_file,
    decompress_file,
)

# ── Storage ───────────────────────────────────────────────────────────────────
from education_system.university_system.infrastructure.database.data_backup.storage import (
...
# ── Notifications ─────────────────────────────────────────────────────────────
from education_system.university_system.infrastructure.database.data_backup.notifications import (
...
# ── CLI menus ─────────────────────────────────────────────────────────────────
from education_system.university_system.infrastructure.database.data_backup.cli_menu import (
    configure_backups,
