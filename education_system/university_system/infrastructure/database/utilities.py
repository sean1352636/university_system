...
try:
    from education_system.university_system.infrastructure.database.schemas.core_schemas import init_grade_system_db
    ...
    from education_system.university_system.infrastructure.database.schemas.communication_schemas import init_email_system_db
