...
try:
    from education_system.university_system.infrastructure.auth.enhanced_auth import (
        EnhancedAuth,
...
try:
    from education_system.university_system.infrastructure.security.remember_me import (
        remember_me_manager,
        RememberMeManager
    )
...
class SecurityManager:
    ...
    Usage:
        from education_system.university_system.infrastructure.security.security_integration import SecurityManager
