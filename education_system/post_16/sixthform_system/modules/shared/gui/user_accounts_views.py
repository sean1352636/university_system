"""Tkinter views for Sixth Form User Accounts admin."""
...
class UsersTab:
    ...
    def _build(self) -> None:
        ...
        ttk.Checkbutton(bar, text="Sixth-form only",
...
class SummaryTab:
    ...
    def refresh(self) -> None:
        ...
        L.append(f"  In sixth-form        : {s.sixth_form_users}")
        L.append(f"  Logins in last 7 days: {s.recent_logins_7d}")
        L.append("")
        L.append("Sixth-form roles")
        L.append("----------------")
        for r in ROLES:
