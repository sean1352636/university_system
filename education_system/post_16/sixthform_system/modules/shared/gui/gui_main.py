...
NAV_CATEGORIES: list[tuple[str, list[tuple[str, str]]]] = [
    ("Student Management", [
        ...
        ("Alumni", "open_alumni"),
        ("Parent Portal", "open_parent_portal"),
    ]),
    ("Academic Management", [
        ...
        ("Timetable Optimiser", "open_timetable_optimiser"),
    ...
    ("Assessment & Grades", [
        ...
        ("Risk Analytics", "open_risk_analytics"),
    ...
    ("UCAS & Careers", [
        ...
        ("UCAS Workflow", "open_ucas_workflow"),
    ...
    ("System", [
        ...
        ("Automation Rules", "open_automation_rules"),
...
class SixthFormMainGUI:
    def __init__(self, auth):
        ...
        try:
            from education_system.post_16.sixthform_system.modules.shared.gui.idle_timeout import (
                IdleTimeoutWatcher,
            )
    ...
    def _gather_kpis(self) -> list[tuple[str, str, str]]:
        ...
        staff_count = self._safe_count(
            "education_system.post_16.sixthform_system.modules.domain.staff_comms.staff.staff",
            "list_staff",
        )
        course_count = self._safe_count(
            "education_system.post_16.sixthform_system.modules.domain.academics.courses.courses",
            "list_courses",
        )
    ...
    def _today_attendance_pct(self, today: str) -> tuple[str, str]:
        try:
            from education_system.post_16.sixthform_system.modules.domain.academics.attendance import (
                attendance as att,
            )
    ...
    def _build_recent_behaviour_panel(self, parent: ttk.Frame) -> None:
        ...
        try:
            from education_system.post_16.sixthform_system.modules.domain.pastoral.behaviour import (
                behaviour as bdata,
            )
    ...
    def open_student_directory(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.students import student_views
    ...
    def open_enrolment(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.enrolments import enrolment_views
        enrolment_views.open_directory(self)

    def open_courses(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.courses import course_views
        course_views.open_directory(self)

    def open_subjects(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.subjects import subject_views
        subject_views.open_directory(self)

    def open_class_groups(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.class_groups import class_group_views
        class_group_views.open_directory(self)

    def open_timetable(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.timetable import timetable_views
        timetable_views.open_directory(self)

    def open_timetable_optimiser(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.timetable_optimiser import timetable_optimiser_views
        timetable_optimiser_views.open_directory(self)

    def open_attendance(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.attendance import attendance_views
        attendance_views.open_directory(self)

    def open_homework(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.homework import homework_views
        homework_views.open_directory(self)

    def open_gradebook(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.gradebook import gradebook_views
        gradebook_views.open_directory(self)

    def open_predicted_grades(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.predicted_grades import predicted_grades_views
        predicted_grades_views.open_directory(self)

    def open_mock_exams(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.mock_exams import mock_exam_views
        mock_exam_views.open_directory(self)

    def open_exam_entries(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.exam_entries import exam_entry_views
        exam_entry_views.open_directory(self)

    def open_results_day(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.exam_results import exam_result_views
        exam_result_views.open_directory(self)

    def open_ucas(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.ucas import ucas_views
        ucas_views.open_directory(self)

    def open_ucas_workflow(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.ucas_workflow import ucas_workflow_views
        ucas_workflow_views.open_directory(self)

    def open_personal_statements(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.personal_statements import personal_statement_views
        personal_statement_views.open_directory(self)

    def open_references(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.references import reference_views
        reference_views.open_directory(self)

    def open_offers(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.offers import offer_views
        offer_views.open_directory(self)

    def open_apprenticeships(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.apprenticeships import apprenticeship_views
        apprenticeship_views.open_directory(self)

    def open_university_visits(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.university_visits import university_visits_views
        university_visits_views.open_directory(self)

    def open_careers(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.careers import careers_views
        careers_views.open_directory(self)

    def open_destinations(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.destinations import destinations_views
        destinations_views.open_directory(self)

    def open_epq(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.epq import epq_views
        epq_views.open_directory(self)

    def open_work_experience(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.work_experience import work_experience_views
        work_experience_views.open_directory(self)

    def open_room_booking(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.room_booking import room_booking_views
        room_booking_views.open_directory(self)

    def open_medical_records(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.medical_records import medical_records_views
        medical_records_views.open_directory(self)

    def open_tutor_groups(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.tutor_groups import tutor_group_views
        tutor_group_views.open_directory(self)

    def open_behaviour(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.behaviour import behaviour_views
        behaviour_views.open_directory(self)

    def open_safeguarding(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.safeguarding import safeguarding_views
        safeguarding_views.open_directory(self)

    def open_wellbeing(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.wellbeing import wellbeing_views
        wellbeing_views.open_wellbeing_window(self)

    def open_student_wellbeing(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.student_wellbeing import student_wellbeing_views
        student_wellbeing_views.open_student_wellbeing_window(self)

    def open_prevent_duty(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.prevent_duty import prevent_duty_views
        prevent_duty_views.open_prevent_duty_window(self)

    def open_attendance_concerns(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.attendance_concerns import attendance_concerns_views
        attendance_concerns_views.open_attendance_concerns_window(self)

    def open_staff(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff import staff_views
        staff_views.open_directory(self)

    def open_parents(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.parent_contacts import parent_contacts_views
        parent_contacts_views.open_directory(self)

    def open_parents_evenings(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.parents_evenings import parents_evenings_views
        parents_evenings_views.open_parents_evenings_window(self)

    def open_notices(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.notices import notices_views
        notices_views.open_notices_window(self)

    def open_messaging(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.messages import messages_views
        messages_views.open_messages_window(self)

    def open_finance_hub(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.finance_hub import finance_hub_views
        finance_hub_views.open_finance_hub(self)

    def open_fees(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.fees import fees_views
        fees_views.open_fees_window(self)

    def open_bursaries(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.bursaries import bursaries_views
        bursaries_views.open_bursaries_window(self)

    def open_trips_payments(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.trips import trips_views
        trips_views.open_trips_window(self)

    def open_receipts(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.receipts import receipts_views
        receipts_views.open_receipts_window(self)

    def open_report_attendance(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.attendance_report import attendance_report_views
        attendance_report_views.open_attendance_report_window(self)

    def open_report_grades(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.grades_report import grades_report_views
        grades_report_views.open_grades_report_window(self)

    def open_progress(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.progress import progress_views
        progress_views.open_progress_window(self)

    def open_kpi_dashboard(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.kpi_dashboard import kpi_dashboard_views
        kpi_dashboard_views.open_kpi_dashboard_window(self)

    def open_data_dashboard(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.data_dashboard import data_dashboard_views
        data_dashboard_views.open_data_dashboard_window(self)

    def open_progress_dashboard(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.progress_dashboard import progress_dashboard_views
        progress_dashboard_views.open_progress_dashboard_window(self)

    def open_mobile_dashboard(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.mobile_dashboard import mobile_dashboard_views
        mobile_dashboard_views.open_mobile_dashboard_window(self)

    def open_export(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.custom_export import custom_export_views
        custom_export_views.open_custom_export_window(self)

    def open_audit_reports(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.audit_reports import audit_reports_views
        audit_reports_views.open_audit_reports_window(self)

    def open_data_export(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.reports.data_export import data_export_views
        data_export_views.open_data_export_window(self)

    def open_gdpr(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.gdpr import gdpr_views
        gdpr_views.open_gdpr_window(self)

    def open_risk_management(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.risk_management import risk_management_views
        risk_management_views.open_risk_management_window(self)

    def open_automation_rules(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.automation_rules import automation_rules_views
        automation_rules_views.open_directory(self)

    def open_change_password(self) -> None:
        from education_system.post_16.sixthform_system.modules.shared.gui import change_password_views
        change_password_views.open_change_password_dialog(
            self, auth=self.auth)

    def open_mfa(self) -> None:
        from education_system.post_16.sixthform_system.modules.shared.gui import mfa_views
        mfa_views.open_mfa_dialog(self, auth=self.auth)

    def open_user_accounts(self) -> None:
        from education_system.post_16.sixthform_system.modules.shared.gui import user_accounts_views
        user_accounts_views.open_user_accounts_window(
            self, auth=self.auth)

    def open_settings(self) -> None:
        from education_system.post_16.sixthform_system.modules.shared.gui import settings_views
        settings_views.open_settings_window(self, auth=self.auth)

    def open_user_management(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.user_management import user_management_views
        user_management_views.open_user_management_window(self)

    def open_compliance(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.compliance import compliance_views
        compliance_views.open_compliance_window(self)

    def open_governance(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.governance import governance_views
        governance_views.open_governance_window(self)

    def open_policies(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.policies import policies_views
        policies_views.open_policies_window(self)

    def open_absence_requests(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.absence_requests import absence_requests_views
        absence_requests_views.open_absence_requests_window(self)

    def open_academic_year(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.academic_year import academic_year_views
        academic_year_views.open_academic_year_window(self)

    def open_accessibility(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.accessibility import accessibility_views
        accessibility_views.open_accessibility_window(self)

    def open_activity_feed(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.activity_feed import activity_feed_views
        activity_feed_views.open_activity_feed_window(self)

    def open_advanced_search(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.advanced_search import advanced_search_views
        advanced_search_views.open_advanced_search_window(self)

    def open_admissions(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.admissions import admissions_views
        admissions_views.open_admissions_window(self)

    def open_onboarding(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.onboarding import onboarding_views
        onboarding_views.open_onboarding_window(self)

    def open_bulk_operations(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.bulk_operations import bulk_operations_views
        bulk_operations_views.open_bulk_operations_window(self)

    def open_alumni(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.alumni import alumni_views
        alumni_views.open_alumni_window(self)

    def open_parent_portal(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.students.parent_portal import parent_portal_views
        parent_portal_views.open_directory(self)

    def open_calendar(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.calendar import calendar_views
        calendar_views.open_calendar_window(self)

    def open_lesson_plans(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.lesson_plans import lesson_plans_views
        lesson_plans_views.open_lesson_plans_window(self)

    def open_cover(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.cover import cover_views
        cover_views.open_cover_window(self)

    def open_cover_agency(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.cover_agency import cover_agency_views
        cover_agency_views.open_cover_agency_window(self)

    def open_assignments(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.assignments import assignments_views
        assignments_views.open_assignments_window(self)

    def open_enrichment(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.enrichment import enrichment_views
        enrichment_views.open_enrichment_window(self)

    def open_library(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.library import library_views
        library_views.open_library_window(self)

    def open_study_planner(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.academics.study_planner import study_planner_views
        study_planner_views.open_study_planner_window(self)

    def open_baseline_assessment(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.baseline_assessment import baseline_assessment_views
        baseline_assessment_views.open_baseline_assessment_window(self)

    def open_target_setting(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.target_setting import target_setting_views
        target_setting_views.open_target_setting_window(self)

    def open_ilp(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.ilp import ilp_views
        ilp_views.open_ilp_window(self)

    def open_intervention_tracking(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.intervention_tracking import intervention_tracking_views
        intervention_tracking_views.open_intervention_tracking_window(self)

    def open_value_added(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.value_added import value_added_views
        value_added_views.open_value_added_window(self)

    def open_early_warning(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.early_warning import early_warning_views
        early_warning_views.open_early_warning_window(self)

    def open_risk_analytics(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.risk_analytics import risk_analytics_views
        risk_analytics_views.open_directory(self)

    def open_observations(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.observations import observations_views
        observations_views.open_observations_window(self)

    def open_self_assessment(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.self_assessment import self_assessment_views
        self_assessment_views.open_self_assessment_window(self)

    def open_quality_assurance(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.quality_assurance import quality_assurance_views
        quality_assurance_views.open_quality_assurance_window(self)

    def open_sef_builder(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.assessment.sef_builder import sef_builder_views
        sef_builder_views.open_sef_builder_window(self)

    def open_send(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.send import send_views
        send_views.open_send_window(self)

    def open_disciplinary(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.disciplinary import disciplinary_views
        disciplinary_views.open_disciplinary_window(self)

    def open_student_support(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.student_support import student_support_views
        student_support_views.open_student_support_window(self)

    def open_peer_mentoring(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.peer_mentoring import peer_mentoring_views
        peer_mentoring_views.open_peer_mentoring_window(self)

    def open_first_aid(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.first_aid import first_aid_views
        first_aid_views.open_first_aid_window(self)

    def open_emergency(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.emergency import emergency_views
        emergency_views.open_emergency_window(self)

    def open_health_safety(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.health_safety import health_safety_views
        health_safety_views.open_health_safety_window(self)

    def open_assets(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.assets import assets_views
        assets_views.open_assets_window(self)

    def open_equality_diversity(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.equality_diversity import equality_diversity_views
        equality_diversity_views.open_equality_diversity_window(self)

    def open_complaints(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.complaints import complaints_views
        complaints_views.open_complaints_window(self)

    def open_feedback(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.feedback import feedback_views
        feedback_views.open_feedback_window(self)

    def open_surveys(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.surveys import surveys_views
        surveys_views.open_surveys_window(self)

    def open_student_council(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.student_council import student_council_views
        student_council_views.open_student_council_window(self)

    def open_transport(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.pastoral.transport import transport_views
        transport_views.open_transport_window(self)

    def open_staff_hr(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff_hr import staff_hr_views
        staff_hr_views.open_staff_hr_window(self)

    def open_departments(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.departments import departments_views
        departments_views.open_departments_window(self)

    def open_staff_absence(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff_absence import staff_absence_views
        staff_absence_views.open_staff_absence_window(self)

    def open_staff_wellbeing(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff_wellbeing import staff_wellbeing_views
        staff_wellbeing_views.open_staff_wellbeing_window(self)

    def open_recruitment(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.recruitment import recruitment_views
        recruitment_views.open_recruitment_window(self)

    def open_appraisals(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.appraisals import appraisals_views
        appraisals_views.open_appraisals_window(self)

    def open_cpd(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.cpd import cpd_views
        cpd_views.open_cpd_window(self)

    def open_dbs_checks(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.dbs_checks import dbs_checks_views
        dbs_checks_views.open_dbs_checks_window(self)

    def open_visitors(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.visitors import visitors_views
        visitors_views.open_visitors_window(self)

    def open_announcements(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.announcements import announcements_views
        announcements_views.open_announcements_window(self)

    def open_notifications(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.notifications import notifications_views
        notifications_views.open_notifications_window(self)

    def open_letter_templates(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.letter_templates import letter_templates_views
        letter_templates_views.open_letter_templates_window(self)

    def open_document_hub(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.document_hub import document_hub_views
        document_hub_views.open_document_hub_window(self)

    def open_attachments(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.staff_comms.attachments import attachments_views
        attachments_views.open_attachments_window(self)

    def open_census_ilr(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.census_ilr import census_ilr_views
        census_ilr_views.open_census_ilr_window(self)

    def open_expense_claims(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.expense_claims import expense_claims_views
        expense_claims_views.open_expense_claims_window(self)

    def open_funding(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.finance.funding import funding_views
        funding_views.open_funding_window(self)

    def open_about(self) -> None:
        from education_system.post_16.sixthform_system.modules.shared.gui import about_views
    ...
    def open_university_visits_crm(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.progression.university_visits import (
    ...
    def open_todo(self) -> None:
        from education_system.post_16.sixthform_system.modules.domain.governance.todo import todo_views
