"""CLI flows for Sixth Form User Accounts admin."""
...
from education_system.post_16.sixthform_system.modules.shared import user_accounts as data
...
def filter_users(auth: Any) -> None:
    ...
    try:
        ...
        sixth = _yes_no("Sixth-form only?", default=True)
...
def new_user(auth: Any) -> None:
    ...
    try:
        ...
        role = _pick_from("Sixth-form role", list(ROLES),
...
_MENU: list[tuple[str, Callable[[Any], None]]] = [
    ("Sixth-Form Users",      list_sixthform),
    ("All Users",             list_all),
