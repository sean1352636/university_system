...
from education_system.post_16.sixthform_system.modules.domain.pastoral.first_aid import (
    first_aid as data,
)
from education_system.post_16.sixthform_system.modules.domain.pastoral.first_aid.first_aid import (
    DEFAULT_NATURE,
    DEFAULT_STATUS,
    Incident,
    NATURES,
