...
from education_system.post_16.sixthform_system.modules.domain.pastoral.complaints import (
    complaints as data,
)
from education_system.post_16.sixthform_system.modules.domain.pastoral.complaints.complaints import (
    CATEGORIES,
    COMPLAINANT_ROLES,
    Complaint,
    DEFAULT_CATEGORY,
