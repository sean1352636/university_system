...
from education_system.post_16.sixthform_system.modules.domain.pastoral.medical_records import (
    medical_records as data,
)
from education_system.post_16.sixthform_system.modules.domain.pastoral.medical_records.medical_records import (
    ALLERGY_SEVERITIES,
    Allergy,
    BLOOD_GROUPS,
