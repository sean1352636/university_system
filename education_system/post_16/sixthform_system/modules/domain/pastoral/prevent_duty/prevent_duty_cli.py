...
from education_system.post_16.sixthform_system.modules.domain.pastoral.prevent_duty import (
    prevent_duty as data,
)
from education_system.post_16.sixthform_system.modules.domain.pastoral.prevent_duty.prevent_duty import (
    CONCERN_STATUSES,
    CONCERN_TYPES,
