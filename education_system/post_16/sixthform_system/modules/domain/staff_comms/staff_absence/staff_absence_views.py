"""Tkinter views for Sixth Form Staff Absence."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff_absence import (
    staff_absence as data,
)
from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff_absence.staff_absence import (
    ABSENCE_TYPES,
    Absence,
    CERTIFICATE_TYPES,
    COVER_SOURCES,
