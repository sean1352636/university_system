"""Tkinter views for Sixth Form Notifications."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.notifications.notifications import (
    CHANNELS,
    DEFAULT_CHANNEL,
