"""CLI flows for Sixth Form Staff Wellbeing."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff_wellbeing import (
    staff_wellbeing as data,
)
from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff_wellbeing.staff_wellbeing import (
    ACTION_TYPES,
    CONCERN_FLAGS,
    DEFAULT_ENTRY_TYPE,
    DEFAULT_STATUS,
