"""Tkinter views for Sixth Form Attachments."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.attachments import (
    attachments as data,
)
from education_system.post_16.sixthform_system.modules.domain.staff_comms.attachments.attachments import (
    Attachment,
    CATEGORIES,
    DEFAULT_CATEGORY,
    DEFAULT_ENTITY_TYPE,
