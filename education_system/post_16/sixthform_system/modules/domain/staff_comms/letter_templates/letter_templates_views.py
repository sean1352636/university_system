"""Tkinter views for Sixth Form Letter Templates."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.letter_templates.letter_templates import (
    CATEGORIES,
    DEFAULT_CATEGORY,
    DEFAULT_FORMAT,
