"""Tkinter views for Sixth Form Recruitment."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.recruitment import (
    recruitment as data,
)
from education_system.post_16.sixthform_system.modules.domain.staff_comms.recruitment.recruitment import (
    APPLICANT_SOURCES,
    APPLICANT_STATUSES,
    Applicant,
    CONTRACT_TYPES,
