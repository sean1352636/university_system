"""Tkinter views for Sixth Form Departments."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.departments import (
    departments as data,
)
from education_system.post_16.sixthform_system.modules.domain.staff_comms.departments.departments import (
    DEFAULT_DEPT_ROLE,
    DEFAULT_FACULTY,
    DEFAULT_STATUS,
    DEPT_ROLES,
