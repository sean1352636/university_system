...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.activity_feed import (
    activity_feed as data,
)
from education_system.post_16.sixthform_system.modules.domain.staff_comms.activity_feed.activity_feed import (
    ACTIONS,
    DEFAULT_SEVERITY,
    Event,
    KNOWN_ENTITY_TYPES,
