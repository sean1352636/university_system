...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.notices import notices as data
from education_system.post_16.sixthform_system.modules.domain.staff_comms.staff import staff as staff_data
from education_system.post_16.sixthform_system.modules.domain.staff_comms.notices.notices import (
    AUDIENCES,
    CATEGORIES,
    DEFAULT_AUDIENCE,
    DEFAULT_CATEGORY,
