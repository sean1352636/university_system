"""Tkinter views for Sixth Form Announcements."""
...
from education_system.post_16.sixthform_system.modules.domain.staff_comms.announcements.announcements import (
    AUDIENCES,
    Announcement,
    CATEGORIES,
    DEFAULT_AUDIENCES,
