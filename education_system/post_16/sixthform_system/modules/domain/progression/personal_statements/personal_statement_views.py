...
from education_system.post_16.sixthform_system.modules.domain.progression.personal_statements import personal_statements as data
...
from education_system.post_16.sixthform_system.modules.domain.progression.personal_statements.personal_statements import (
    DEFAULT_STATUS,
    MAX_CHARS,
    MAX_LINES,
    PersonalStatement,
