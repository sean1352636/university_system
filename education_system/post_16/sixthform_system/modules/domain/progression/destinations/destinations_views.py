...
from education_system.post_16.sixthform_system.modules.domain.progression.destinations import (
    destinations as data,
)
from education_system.post_16.sixthform_system.modules.domain.progression.destinations.destinations import (
    CHECKPOINTS,
    CHECKPOINT_LABELS,
    CONFIRMED_VIA,
    DEFAULT_CHECKPOINT,
...
class RecordDialog(tk.Toplevel):
    def __init__(self, master: tk.Misc, *,
        ...
        self._preset_checkpoint = preset_checkpoint
    ...
    def _build(self) -> None:
        record = self.record
        preset_student = self._preset_student
        preset_checkpoint = self._preset_checkpoint
