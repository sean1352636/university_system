...
def init_db() -> None:
    ...
    from education_system.post_16.sixthform_system.modules.domain.progression.ucas import ucas as _ucas
    _ucas.init_db()
...
def list_offer_rows(
    *,
    ...
    from education_system.post_16.sixthform_system.modules.domain.students.students import students as _ucas
