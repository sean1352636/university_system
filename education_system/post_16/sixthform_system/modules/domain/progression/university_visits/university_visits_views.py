...
from education_system.post_16.sixthform_system.modules.domain.progression.university_visits.university_visits import (
    DEFAULT_TRANSPORT,
...
def _render_editor(gui, parent: ttk.Frame, visit_id: int | None,
    ...
    if existing is not None:
        def _push() -> None:
            from education_system.post_16.sixthform_system.modules.domain.progression.university_visits import crm_link
            try:
