...
def _messages_module():
    ...
    from education_system.post_16.sixthform_system.modules.domain.staff_comms.messages \
...
def _ucas_destination_for(student_id: str
    ...
    um = _safe_import(
        "education_system.post_16.sixthform_system.modules.domain.progression.ucas.ucas")
    if um is None:
        return (None, None)
    try:
...
def _career_aspiration_for(student_id: str) -> str | None:
    cm = _safe_import(
        "education_system.post_16.sixthform_system.modules.domain.progression.careers.careers")
    if cm is None:
        return None
    try:
...
def _student_context(student_id: str) -> dict[str, Any]:
    ...
    try:
        from education_system.post_16.sixthform_system.modules.domain.students.students \
