...
from education_system.post_16.sixthform_system.modules.domain.students.bulk_operations import (
...
def _install_logging() -> None:
    ...
    if _LOG_HANDLER is not None:
        return
    try:
        from education_system.shared.core.structured_logging import (
...
def bulk_enrol(
    ...
    *,
    ...
    targets = _validate_targets(student_ids)
    from education_system.post_16.sixthform_system.modules.domain.students.enrolments import (
        enrolments as _en,
    )
...
def bulk_recalc_grade_reports(
    ...
    *,
    ...
    targets = _validate_targets(student_ids)
    from education_system.post_16.sixthform_system.modules.domain.reports.grades_report import (
...
def bulk_send_letters(
    ...
    *,
    ...
    targets = _validate_targets(student_ids)
    from education_system.post_16.sixthform_system.modules.domain.staff_comms.letter_templates import (
...
def bulk_exam_entries(
    ...
    *,
    ...
    targets = _validate_targets(student_ids)
    from education_system.post_16.sixthform_system.modules.domain.assessment.exam_entries import (
        exam_entries as _ee,
    )
