...
from education_system.post_16.sixthform_system.modules.domain.students.bulk_operations.bulk_operations import (
    BulkResult,
    Job,
    OPERATIONS,
    SAFE_STUDENT_FIELDS,
...
def bulk_bursary_flow() -> None:
    print("\n═══ Bulk Bursary Award ═══")
    from education_system.post_16.sixthform_system.modules.domain.finance.bursaries.bursaries import (
...
def bulk_invoices_flow() -> None:
    print("\n═══ Bulk Raise Invoices ═══")
    from education_system.post_16.sixthform_system.modules.domain.finance.fees.fees import (
...
def bulk_ucas_status_flow() -> None:
    ...
    from education_system.post_16.sixthform_system.modules.domain.progression.ucas.ucas import (
        APP_STATUSES,
    )
    try:
        sids = _pick_students()
