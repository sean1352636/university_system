...
from education_system.post_16.sixthform_system.modules.domain.students.advanced_search.advanced_search import (
    ALL_SCOPES,
...
def bulk_status_flow() -> None:
    ...
    if res is None:
        return
    from education_system.post_16.sixthform_system.modules.domain.students.\
