"""Tkinter views for Sixth Form Receipts."""
...
from education_system.post_16.sixthform_system.modules.domain.finance.receipts import receipts as data
from education_system.post_16.sixthform_system.modules.domain.students.students import students as student_data
from education_system.shared import branding
from education_system.post_16.sixthform_system.modules.domain.finance.receipts.receipts import (
    CURRENCY_SYMBOL,
    DEFAULT_LINE_KIND,
    DEFAULT_METHOD,
    DEFAULT_STATUS,
...
def open_receipts_window(parent=None) -> None:
    ...
    build_receipts_notebook(win)


def build_receipts_notebook(parent: tk.Misc) -> ttk.Notebook:
    """Build the Receipts notebook into *parent* (a Toplevel or Frame)."""
    data.init_db()
