"""Tkinter views for Sixth Form Expense Claims."""
...
from education_system.post_16.sixthform_system.modules.domain.finance.expense_claims import (
    expense_claims as data,
)
from education_system.post_16.sixthform_system.modules.domain.finance.expense_claims.expense_claims import (
    CATEGORIES,
    CLAIM_STATUSES,
    CLAIMANT_TYPES,
    Claim,
