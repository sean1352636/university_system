...
from education_system.post_16.sixthform_system.modules.domain.assessment.self_assessment import (
    self_assessment as data,
)
from education_system.post_16.sixthform_system.modules.domain.assessment.self_assessment.self_assessment import (
    ASSESSMENT_TYPES,
