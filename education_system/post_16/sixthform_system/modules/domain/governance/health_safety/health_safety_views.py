"""Tkinter views for Sixth Form Health & Safety register."""
...
from education_system.post_16.sixthform_system.modules.domain.governance.health_safety import (
    health_safety as data,
)
from education_system.post_16.sixthform_system.modules.domain.governance.health_safety.health_safety import (
    ACTION_PRIORITIES,
    ACTION_STATUSES,
    AFFECTED_PARTIES,
    CATEGORIES,
