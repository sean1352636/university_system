"""CLI flows for Sixth Form Assets."""
...
from education_system.post_16.sixthform_system.modules.domain.governance.assets import assets as data
from education_system.post_16.sixthform_system.modules.domain.governance.assets.assets import (
    Asset,
    CATEGORIES,
    CONDITIONS,
    CURRENCY_SYMBOL,
