"""GUI panels for the Sixth Form Compliance register.
...
from education_system.post_16.sixthform_system.modules.domain.governance.compliance import compliance as data
from education_system.post_16.sixthform_system.modules.domain.governance.compliance.compliance import (
    CATEGORIES,
    DEFAULT_FREQUENCY,
    DEFAULT_STATUS,
    DERIVED_STATUSES,
