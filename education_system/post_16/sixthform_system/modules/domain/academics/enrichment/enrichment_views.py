...
from education_system.post_16.sixthform_system.modules.domain.academics.enrichment import (
    enrichment as data,
)
from education_system.post_16.sixthform_system.modules.domain.students.students import (
    students as student_data,
)
from education_system.post_16.sixthform_system.modules.domain.academics.enrichment.enrichment import (
    ACTIVITY_STATUSES,
    Activity,
    CATEGORIES,
    DAYS,
