...
from education_system.post_16.sixthform_system.modules.domain.academics.courses import courses as data
from education_system.post_16.sixthform_system.modules.domain.academics.courses.courses import (
    Course,
