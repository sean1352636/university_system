...
from education_system.post_16.sixthform_system.modules.domain.academics.work_experience import (
    work_experience as data,
)
from education_system.post_16.sixthform_system.modules.domain.academics.work_experience.work_experience import (
