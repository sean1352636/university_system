...
def populate_from_data(
    ...
    *,
    ...
    out: dict[str, Any] = {}
    from education_system.post_16.sixthform_system.modules.domain.reports.attendance_report import attendance_report as _ar
    try:
    ...
    try:
        from education_system.post_16.sixthform_system.modules.domain.reports.grades_report import grades_report as _gr
