...
from education_system.post_16.sixthform_system.modules.domain.reports.attendance_report import attendance_report
from education_system.post_16.sixthform_system.modules.domain.academics.class_groups import class_groups
from education_system.post_16.sixthform_system.modules.domain.reports.attendance_report import attendance_report as data
...
from education_system.post_16.sixthform_system.modules.domain.reports.attendance_report.attendance_report import (
    DOW_NAMES,
    StatusBreakdown,
    ValidationError,
)
...
def open_attendance_report_window(parent=None) -> None:
    ...
    win.title(f"Attendance Report — {branding.SYSTEM_NAME}")
