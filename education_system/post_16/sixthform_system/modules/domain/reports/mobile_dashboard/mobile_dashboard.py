...
def _high_risk_feed(limit: int = 10) -> list[FeedItem]:
    def _():
        from education_system.post_16.sixthform_system.modules.domain.reports.progress_dashboard import (
            progress_dashboard,
        )
...
def _open_alerts_feed(limit: int = 10) -> list[FeedItem]:
    def _():
        from education_system.post_16.sixthform_system.modules.domain.assessment.early_warning import (
            early_warning,
        )
