"""Tkinter views for the Sixth Form Mobile Dashboard.
...
from education_system.post_16.sixthform_system.modules.domain.reports.mobile_dashboard import (
    mobile_dashboard as data,
)
from education_system.post_16.sixthform_system.modules.domain.reports.mobile_dashboard.mobile_dashboard import (
    FeedItem,
    Tile,
)
