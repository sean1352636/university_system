...
from education_system.post_16.sixthform_system.modules.domain.reports.kpi_dashboard import kpi_dashboard as data
from education_system.post_16.sixthform_system.modules.domain.reports.kpi_dashboard.kpi_dashboard import (
    DEFAULT_THRESHOLD,
    DEFAULT_WINDOW_DAYS,
    Snapshot,
)
