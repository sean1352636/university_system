...
_FEATURE_MODULES = (
    ...
    "education_system.post_16.sixthform_system.modules.domain.academics.class_groups.class_groups",
    "education_system.post_16.sixthform_system.modules.domain.academics.timetable_optimiser.timetable_optimiser",
    "education_system.post_16.sixthform_system.modules.domain.assessment.risk_analytics.risk_analytics",
    "education_system.post_16.sixthform_system.modules.domain.progression.ucas_workflow.ucas_workflow",
    "education_system.post_16.sixthform_system.modules.domain.governance.automation_rules.automation_rules",
    "education_system.post_16.sixthform_system.modules.domain.students.parent_portal.parent_portal",
)
