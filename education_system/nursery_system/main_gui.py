...
from education_system.nursery_system import SYSTEM_NAME, SYSTEM_SLUG
...
class NurseryMainGUI:
    ...
    def _show_welcome(self) -> None:
        ...
        try:
            from education_system.nursery_system.modules.domain import dashboard
    ...
    def _dispatch_feature(self, label: str) -> bool:
        ...
        if label == "Student Journey":
            ...
            return True
        try:
            from education_system.nursery_system.modules.domain.children import (
                children_views,
            )
            child_views = {
    ...
    def _dispatch_local_view(self, label: str) -> bool:
        ...
        mod = importlib.import_module(
            f"education_system.nursery_system.modules.domain.{module_path}")
    ...
    def _dispatch_system_view(self, label: str) -> bool:
        ...
        try:
            if label == "Change Password":
                from education_system.nursery_system.modules.shared.gui import (
                ...
                from education_system.nursery_system.modules.domain.mfa import (
                    mfa_views,
                )
                mfa_views.open_mfa(self)
            elif label == "User Management":
                from education_system.nursery_system.modules.domain.user_management import (
...
def run(user_info=None, role=None, shared_auth=None) -> int:
    ...
    from education_system.nursery_system.core.database import init_db
    init_db()
