"""CLI flows for Primary School Recruitment."""
...
from education_system.nursery_system.modules.domain.recruitment import (
    recruitment as data,
)
from education_system.nursery_system.modules.domain.recruitment.recruitment import (
    APPLICANT_SOURCES,
    APPLICANT_STATUSES,
    Applicant,
    CONTRACT_TYPES,
