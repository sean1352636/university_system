...
def income_summary() -> dict[str, float]:
    ...
    try:
        from education_system.nursery_system.modules.domain.invoices import invoices
    ...
    try:
        from education_system.nursery_system.modules.domain.payments import payments
