...
from education_system.nursery_system.modules.domain.registration_forms import (
    registration_forms as data,
)
from education_system.nursery_system.modules.domain.registration_forms.registration_forms import (
    FORM_TYPES,
    SOURCES,
    ValidationError,
)
