...
from education_system.nursery_system.modules.domain.cohort_tracking import (
    cohort_tracking as data,
)
from education_system.nursery_system.modules.domain.cohort_tracking.cohort_tracking import (
    AREAS,
    ROOMS,
    ValidationError,
)
