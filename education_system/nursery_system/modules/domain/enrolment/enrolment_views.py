...
from education_system.nursery_system.modules.domain.enrolment import enrolment as data
from education_system.nursery_system.modules.domain.enrolment.enrolment import (
    CONSENT_FIELDS,
    STATUSES,
    ValidationError,
)
...
def open_enrol_from_application(host, application_id: str) -> None:
    ...
    from education_system.nursery_system.modules.domain.admissions import admissions
