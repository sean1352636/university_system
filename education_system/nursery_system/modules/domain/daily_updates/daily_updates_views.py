...
from education_system.nursery_system.modules.domain.daily_updates import (
    daily_updates as data,
)
from education_system.nursery_system.modules.domain.daily_updates.daily_updates import (
    MOODS,
    ValidationError,
)
