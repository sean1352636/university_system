...
from education_system.nursery_system.modules.domain.transitions import (
    transitions as data,
)
from education_system.nursery_system.modules.domain.transitions.transitions import (
    STATUSES,
    ValidationError,
)
