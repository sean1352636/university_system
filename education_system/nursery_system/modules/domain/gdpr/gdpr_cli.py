"""CLI flows for Primary School GDPR."""
...
from education_system.nursery_system.modules.domain.gdpr import gdpr as data
from education_system.nursery_system.modules.domain.gdpr.gdpr import (
    BREACH_SEVERITIES,
    BREACH_STATUSES,
    CONSENT_PURPOSES,
