...
from education_system.nursery_system.modules.domain.curriculum_planning import (
    curriculum_planning as data,
)
from education_system.nursery_system.modules.domain.curriculum_planning.curriculum_planning import (
    AREAS,
    ROOMS,
    STATUSES,
    ValidationError,
