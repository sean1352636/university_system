"""GUI panels for the Primary School User Management module.
...
from education_system.nursery_system.modules.domain.user_management import user_management as data
from education_system.nursery_system.modules.shared import user_accounts as ua_data
from education_system.nursery_system.modules.shared.user_accounts import (
    DEFAULT_ROLE,
    SYSTEM_KEY,
    UserAccountError,
    UserRow,
