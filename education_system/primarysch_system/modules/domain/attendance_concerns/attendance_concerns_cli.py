...
from education_system.primarysch_system.modules.domain.attendance_concerns import (
    attendance_concerns as data,
)
from education_system.primarysch_system.modules.domain.attendance_concerns.attendance_concerns import (
