"""Tkinter views for the Primary School Mobile Dashboard.
...
from education_system.primarysch_system.modules.domain.mobile_dashboard import (
    mobile_dashboard as data,
)
from education_system.primarysch_system.modules.domain.mobile_dashboard.mobile_dashboard import (
    FeedItem,
    Tile,
)
