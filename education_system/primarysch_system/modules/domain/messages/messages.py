...
def init_db() -> None:
    ...
    from education_system.primarysch_system.modules.domain.parent_contacts import parent_contacts as _pc
    ...
    try:
        from education_system.primarysch_system.modules.domain.alumni \
