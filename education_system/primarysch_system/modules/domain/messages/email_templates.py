"""JSON email templates for the Primary School System.
...
package. Each file describes one outbound message and looks like::

    {
      ...
      "body":    "Hi {{first_name}}, ...",
      "from_name": "Primary School Admissions",
      "from_address": "admissions@primary.sch.uk",
...
from education_system.primarysch_system.modules.domain.messages import (
