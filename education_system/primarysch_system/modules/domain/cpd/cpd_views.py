"""Tkinter views for Primary School CPD."""
...
from education_system.primarysch_system.modules.domain.cpd import (
    cpd as data,
)
from education_system.primarysch_system.modules.domain.cpd.cpd import (
    ACTIVITY_STATUSES,
    ACTIVITY_TYPES,
    Activity,
