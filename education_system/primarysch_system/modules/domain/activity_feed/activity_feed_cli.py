"""CLI flows for Primary School Activity Feed."""
...
from education_system.primarysch_system.modules.domain.activity_feed import (
    activity_feed as data,
)
from education_system.primarysch_system.modules.domain.activity_feed.activity_feed import (
    ACTIONS,
    DEFAULT_SEVERITY,
    DEFAULT_SOURCE,
    Event,
