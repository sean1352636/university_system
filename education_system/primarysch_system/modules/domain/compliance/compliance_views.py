"""GUI panels for the Primary School Compliance register.
...
from education_system.primarysch_system.modules.domain.compliance import compliance as data
from education_system.primarysch_system.modules.domain.compliance.compliance import (
    CATEGORIES,
    DEFAULT_FREQUENCY,
    DEFAULT_STATUS,
    DERIVED_STATUSES,
