...
from education_system.primarysch_system.modules.domain.appraisals import (
    appraisals as data,
)
from education_system.primarysch_system.modules.domain.appraisals.appraisals import (
    Appraisal,
