"""Tkinter views for Primary School Document Hub."""
...
from education_system.primarysch_system.modules.domain.document_hub import (
    document_hub as data,
)
from education_system.primarysch_system.modules.domain.document_hub.document_hub import (
    ACCESS_LEVELS,
    AUDIENCES,
    CATEGORIES,
    DEFAULT_ACCESS,
