...
def kpi_course_count() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.courses import courses
...
def kpi_class_groups() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.class_groups import class_groups
...
def kpi_today_attendance() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.attendance import attendance
...
def kpi_recent_behaviour(window_days: int) -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.behaviour import behaviour
        df, dt_ = _date_window(window_days)
...
def kpi_outstanding_fees() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.fees import fees
...
def kpi_bursaries_submitted() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.bursaries import bursaries
...
def kpi_ucas_submitted() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.ucas import ucas
...
def kpi_apprenticeships_active() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.apprenticeships import apprenticeships
...
def kpi_exam_entries() -> Tile:
    def _go():
        from education_system.primarysch_system.modules.domain.exam_entries import exam_entries
