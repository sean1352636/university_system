...
from education_system.primarysch_system.modules.domain.kpi_dashboard import kpi_dashboard as data
from education_system.primarysch_system.modules.domain.kpi_dashboard.kpi_dashboard import (
    DEFAULT_THRESHOLD,
    DEFAULT_WINDOW_DAYS,
    Snapshot,
)
