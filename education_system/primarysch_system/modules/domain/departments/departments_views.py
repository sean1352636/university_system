"""Tkinter views for Primary School Departments."""
...
from education_system.primarysch_system.modules.domain.departments import (
    departments as data,
)
from education_system.primarysch_system.modules.domain.departments.departments import (
    DEFAULT_DEPT_ROLE,
    DEFAULT_FACULTY,
    DEFAULT_STATUS,
    DEPT_ROLES,
