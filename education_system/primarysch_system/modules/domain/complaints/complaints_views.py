...
from education_system.primarysch_system.modules.domain.complaints import (
    complaints as data,
)
from education_system.primarysch_system.modules.domain.complaints.complaints import (
    CATEGORIES,
    COMPLAINANT_ROLES,
    Complaint,
    DEFAULT_CATEGORY,
