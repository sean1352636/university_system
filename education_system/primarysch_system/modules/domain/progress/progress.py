...
def populate_from_data(
    ...
    *,
    ...
    out: dict[str, Any] = {}
    from education_system.primarysch_system.modules.domain.attendance_report import attendance_report as _ar
    try:
    ...
    try:
        from education_system.primarysch_system.modules.domain.grades_report import grades_report as _gr
