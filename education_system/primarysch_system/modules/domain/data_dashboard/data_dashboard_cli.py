...
from education_system.primarysch_system.modules.domain.data_dashboard import data_dashboard as data
from education_system.primarysch_system.modules.domain.data_dashboard.data_dashboard import (
    DEFAULT_WINDOW_DAYS,
    Panel,
)
