...
from education_system.primarysch_system.modules.domain.assets import assets as data
from education_system.primarysch_system.modules.domain.assets.assets import (
    Asset,
    CATEGORIES,
    CONDITIONS,
    CURRENCY_SYMBOL,
