...
from education_system.primarysch_system.modules.domain.policies import policies as data
from education_system.primarysch_system.modules.domain.policies.policies import (
    CATEGORIES,
    DEFAULT_CATEGORY,
