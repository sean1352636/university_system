...
def test_package_and_cli_import():
    import education_system.primarysch_system  # noqa: F401
    import education_system.primarysch_system.cli_main  # noqa: F401
...
def test_api_blueprints_register():
    from education_system.shared.api.primary.routes import ALL_BLUEPRINTS
