"""Academic year management service for the Secondary School."""
...
class AcademicYearService:
    ...
    def update_year(self, year_id, **kwargs):
        ...
        try:
            ...
            values = list(updates.values()) + [year_id]
            conn.execute(f"UPDATE academic_years SET {set_clause} WHERE id = ?", values)
            conn.commit()
