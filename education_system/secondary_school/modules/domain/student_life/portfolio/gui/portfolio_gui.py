"""PortfolioFrame GUI for the Secondary School."""
...
class PortfolioFrame(tk.Frame):
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._my_portfolio_tab = tk.Frame(self._notebook)
        self._notebook.add(self._my_portfolio_tab, text="My Portfolio")
        self._add_item_tab = tk.Frame(self._notebook)
        self._notebook.add(self._add_item_tab, text="Add Item")
