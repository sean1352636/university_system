"""SkillsPassportFrame GUI for the Secondary School."""
...
class SkillsPassportFrame(tk.Frame):
    """GUI for managing skills passport."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = SkillsPassportService(db_path)
        ...
        self._my_skills_tab = tk.Frame(self._notebook)
        self._notebook.add(self._my_skills_tab, text="My Skills")
        self._add_skill_tab = tk.Frame(self._notebook)
        self._notebook.add(self._add_skill_tab, text="Add Skill")
        self._endorsements_tab = tk.Frame(self._notebook)
        self._notebook.add(self._endorsements_tab, text="Endorsements")
