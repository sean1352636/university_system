"""StudentCouncilFrame GUI for the Secondary School."""
...
class StudentCouncilFrame(tk.Frame):
    """GUI for managing student council."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = StudentCouncilService(db_path)
        ...
        self._members_tab = tk.Frame(self._notebook)
        self._notebook.add(self._members_tab, text="Members")
        self._meetings_tab = tk.Frame(self._notebook)
        self._notebook.add(self._meetings_tab, text="Meetings")
        self._proposals_tab = tk.Frame(self._notebook)
        self._notebook.add(self._proposals_tab, text="Proposals")
