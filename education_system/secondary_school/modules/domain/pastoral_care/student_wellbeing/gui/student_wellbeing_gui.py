"""StudentWellbeingFrame GUI for the Secondary School."""
...
class StudentWellbeingFrame(tk.Frame):
    """GUI for managing student wellbeing."""
    ...
    def __init__(self, parent, db_path=None, auth=None, **kwargs):
        ...
        self._auth = auth
        self._service = StudentWellbeingService(db_path)

        # Header
        header = tk.Frame(self, bg=self.HEADER_BG, height=40)
        header.pack(fill="x")
        header.pack_propagate(False)
        tk.Label(header, text="Student Wellbeing",
        ...
        self._checkins_tab = tk.Frame(self._notebook)
        self._notebook.add(self._checkins_tab, text="Check-ins")
