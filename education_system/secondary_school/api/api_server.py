...
from education_system.secondary_school.api.errors import register_error_handlers
from education_system.secondary_school.api.routes import ALL_BLUEPRINTS, ALL_INIT_FUNCS
...
def create_app(db_path: str | None = None, auth_db_path: str | None = None) -> Flask:
    ...
    from education_system.secondary_school.api.routes.auth_routes import init_auth_routes
...
def run_server(db_path: str | None = None, host: str = "127.0.0.1", port: int = 5001):
    ...
    from education_system.secondary_school.api.config import API_DEBUG
