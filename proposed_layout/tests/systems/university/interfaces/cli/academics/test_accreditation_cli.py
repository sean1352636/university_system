...
MODULE = "education_system.systems.university.interfaces.cli.academics.accreditation_cli"
...
class TestEnsureTables:
    ...
    def test_ensure_tables_creates_all_three_tables(self, mock_get_conn):
        ...
        from education_system.systems.university.interfaces.cli.academics.accreditation_cli import (
            _ensure_tables,
        )
