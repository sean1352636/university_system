...
class TestLogin:
    ...
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.log_login")
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.get_auth")
    ...
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.MFAService")
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.create_mfa_token", return_value="mfa-test-token")
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.get_auth")
...
class TestLogout:
    ...
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.log_activity")
...
class TestRefresh:
    ...
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.create_access_token")
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.decode_token")
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.is_token_blacklisted", return_value=False)
    ...
    @patch("education_system.platform.delivery.api.university.routes.auth_routes.is_token_blacklisted", return_value=True)
