...
from education_system.platform.delivery.api.university.routes.student_routes import student_bp, _student_to_dict
...
class TestListStudents:
    ...
    @patch("education_system.platform.delivery.api.university.routes.student_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.student_routes.get_student_repository")
...
class TestCreateStudent:
    ...
    @patch("education_system.platform.delivery.api.university.routes.student_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.student_routes.get_student_repository")
    def test_create_missing_student_id(self, mock_repo_fn, mock_log, client):
        """Route auto-generates student_id, so omitting it is valid."""
        repo = MagicMock()
        repo.exists.return_value = False
        repo.save.return_value = _FakeStudent(first_name="John", last_name="Smith")
        mock_repo_fn.return_value = repo
