...
from education_system.platform.delivery.api.university.routes.finance_routes import finance_bp, _row_to_dict
...
class TestFees:
    ...
    @patch("education_system.platform.delivery.api.university.routes.finance_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.finance_routes.get_connection")
...
class TestCreatePayment:
    ...
    @patch("education_system.platform.delivery.api.university.routes.finance_routes.log_activity")
    @patch("education_system.platform.delivery.api.university.routes.finance_routes.transaction")
    @patch("education_system.platform.delivery.api.university.routes.finance_routes.get_connection")
