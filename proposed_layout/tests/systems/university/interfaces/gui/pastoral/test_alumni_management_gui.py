...
from education_system.systems.university.interfaces.gui.learners.alumni.main_gui import AlumniGUIApp
...
class TestAlumniGUIApp:
    ...
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.init_alumni_db')
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.setup_alumni_permissions')
    ...
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.init_alumni_db')
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.setup_alumni_permissions')
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.get_connection')
    def test_show_dashboard(self, mock_conn, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch.object(gui, 'clear_content'), \
             ...
             patch('education_system.systems.university.interfaces.gui.learners.alumni.dashboard.ttk'), \
             patch('education_system.systems.university.interfaces.gui.learners.alumni.dashboard.tk'), \
             patch('education_system.systems.university.interfaces.gui.learners.alumni.dashboard.db_get_connection') as mock_db_conn:
            mock_db = Mock()
            mock_cursor = Mock()
    ...
    def test_show_register_alumni(self, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch.object(gui, 'clear_content'), \
             patch.object(gui, 'update_status'), \
             patch('education_system.systems.university.interfaces.gui.learners.alumni.alumni_crud.ttk'), \
             patch('education_system.systems.university.interfaces.gui.learners.alumni.alumni_crud.tk') as mock_tk:
    ...
    def test_create_sidebar(self, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.ttk') as mock_ttk:
    ...
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.init_alumni_db')
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.setup_alumni_permissions')
    @patch('education_system.systems.university.interfaces.gui.learners.alumni.main_gui.messagebox')
