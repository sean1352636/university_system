...
from education_system.systems.university.interfaces.gui.pastoral.internship_management.internship_gui import InternshipGUI

# Base patch paths for the actual modules where symbols are used
_GUI_MOD = 'education_system.systems.university.interfaces.gui.pastoral.internship_management.internship_gui'
_PLACEMENTS_MOD = 'education_system.systems.university.interfaces.gui.pastoral.internship_management.placements'
_IMPORTS_MOD = 'education_system.systems.university.interfaces.gui.pastoral.internship_management._imports'
