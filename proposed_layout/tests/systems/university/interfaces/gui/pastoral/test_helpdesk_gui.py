...
class TestHelpdeskGUI:
    ...
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.init_helpdesk_db')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.setup_enhanced_helpdesk_permissions')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.get_auth')
    ...
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.setup_enhanced_helpdesk_permissions')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.get_auth')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.get_global_auth')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.messagebox')
    ...
    def test_ensure_subject_column(self, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch('education_system.systems.university.infrastructure.database.db.get_connection') as mock_conn:
            mock_db = Mock()
            mock_cursor = Mock()
    ...
    def test_setup_styles(self, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch.object(HelpdeskGUI, 'ensure_subject_column'), \
            ...
            with patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.ttk.Style') as mock_style:
                gui = HelpdeskGUI(mock_root, mock_auth)
    ...
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.init_helpdesk_db')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.setup_enhanced_helpdesk_permissions')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base._t', side_effect=lambda key, **kw: kw.get('default', key))
    def test_setup_main_window(self, mock_t, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch.object(HelpdeskGUI, 'ensure_subject_column'), \
             ...
             patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.ttk.Frame'):
    ...
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.init_helpdesk_db')
    @patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.setup_enhanced_helpdesk_permissions')
    @patch('education_system.systems.university.infrastructure.database.db.get_connection')
    ...
    def test_activity_logging_integration(self, mock_permissions, mock_init_db, mock_root, mock_auth):
        ...
        with patch('education_system.systems.university.interfaces.gui.pastoral.helpdesk.base.log_activity') as mock_log:
            with patch.object(HelpdeskGUI, 'ensure_subject_column'), \
                 patch.object(HelpdeskGUI, 'setup_current_user'), \
                 patch.object(HelpdeskGUI, 'setup_styles'), \
                 patch.object(HelpdeskGUI, 'setup_main_window'), \
