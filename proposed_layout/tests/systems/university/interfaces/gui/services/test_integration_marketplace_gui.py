...
class TestIntegrationMarketplaceGUIInitialization:
    ...
    def test_gui_requires_parent(self, root_window, mock_auth, temp_db):
        ...
        with patch('education_system.systems.university.infrastructure.database.db.DEFAULT_DB_PATH', temp_db):
            with patch('education_system.systems.university.infrastructure.database.schemas.init_integration_marketplace_system_db'):
                try:
    ...
    def test_gui_initializes_database(self, root_window, mock_auth, temp_db):
        ...
        with patch('education_system.systems.university.infrastructure.database.db.DEFAULT_DB_PATH', temp_db):
            with patch('education_system.systems.university.interfaces.gui.shell.services.integration_marketplace_gui.main.init_integration_marketplace_system_db') as mock_init:
                try:
                    gui = integration_marketplace_gui.IntegrationMarketplaceGUI(root_window, mock_auth)
