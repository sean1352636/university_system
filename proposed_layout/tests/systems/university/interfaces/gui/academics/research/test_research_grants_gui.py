...
class TestResearchGrantsImports:
    def test_gui_class_importable(self):
        from education_system.systems.university.interfaces.gui.academics.research.research_grants_gui import ResearchGrantsGUI
    ...
    def test_milestone_manager_importable(self):
        from education_system.systems.university.domain.academics.research.services.research_grants_core import MilestoneManager
    ...
    def test_ethics_review_manager_importable(self):
        from education_system.systems.university.domain.academics.research.services.research_grants_core import EthicsReviewManager
