...
from education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui import (
...
class TestFinancialAidGUIInit:
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui.get_auth')
    @patch('education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui.check_permission')
    @patch('education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui.get_current_user')
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui.get_auth')
    @patch('education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui.show_error')
...
class TestLaunchFunction:
    ...
    @patch('education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui.FinancialAidGUI')
