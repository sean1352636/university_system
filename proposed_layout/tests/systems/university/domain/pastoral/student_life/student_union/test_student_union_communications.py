...
_MOD = 'education_system.systems.university.domain.pastoral.student_life.student_union.services.communications'
_EMAIL = 'education_system.systems.university.infrastructure.email'
