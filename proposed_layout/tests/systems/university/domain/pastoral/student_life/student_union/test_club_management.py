...
from education_system.systems.university.domain.pastoral.student_life.student_union.clubs import club_management
...
class TestCreateClub:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.get_connection')
...
class TestJoinClub:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.get_connection')
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.view_clubs')
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.send_confirmation_email')
...
class TestEdgeCases:
    ...
    def test_no_student_record(self, mock_auth):
        ...
        with patch('education_system.systems.university.domain.pastoral.student_life.student_union.clubs.club_management.get_connection') as mock_get_conn:
            mock_conn = Mock()
            mock_cursor = Mock()
