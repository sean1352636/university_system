...
from education_system.systems.university.domain.pastoral.student_life.student_union.events import event_management

GET_CONN = 'education_system.systems.university.domain.pastoral.student_life.student_union.events.event_management.get_connection'
...
class TestRegisterForEvent:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.events.event_management.send_confirmation_email')
...
class TestEventMenu:
    ...
    @patch('education_system.systems.university.domain.pastoral.student_life.student_union.events.event_management.get_connection')
