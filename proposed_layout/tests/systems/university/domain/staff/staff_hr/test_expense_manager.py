...
from education_system.systems.university.domain.staff.staff_hr.services.managers.expense_manager import ExpenseManager
...
class TestExpenseClaimCreation:
    ...
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.expense_manager.get_connection')
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.expense_manager.transaction')
    @patch('education_system.systems.university.domain.staff.staff_hr.services.managers.expense_manager.log_activity')
