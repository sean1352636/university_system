...
class TestExitInterviews:
    ...
    def mock_db(self):
        ...
        with patch('education_system.systems.university.domain.staff.staff_hr.services.managers.exit_manager.get_connection') as mock_get, \
             patch('education_system.systems.university.domain.staff.staff_hr.services.managers.exit_manager.transaction') as mock_trans, \
             patch('education_system.systems.university.domain.staff.staff_hr.services.managers.exit_manager.log_activity'):
    ...
    def test_create_exit_interview(self, mock_db):
        ...
        from education_system.systems.university.domain.staff.staff_hr.services.managers.exit_manager import ExitManager
