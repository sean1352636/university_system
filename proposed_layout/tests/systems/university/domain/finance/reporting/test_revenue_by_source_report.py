...
from education_system.systems.university.domain.finance.reporting import revenue_by_source_report
...
class TestRevenueBySource:
    ...
    def test_get_revenue_by_source_all_time(self, temp_db):
        ...
        with patch('education_system.systems.university.domain.finance.reporting.revenue_by_source_report.paths') as mock_paths:
