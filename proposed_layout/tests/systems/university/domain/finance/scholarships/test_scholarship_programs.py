...
from education_system.systems.university.domain.finance.scholarships import scholarship_programs
...
class TestScholarshipManagement:
    ...
    def test_view_available_scholarships(self, temp_db, capsys):
        ...
        with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_connection') as mock_conn:
...
class TestScholarshipAward:
    ...
    def test_award_scholarship_to_student(self, temp_db, capsys, monkeypatch):
        ...
        with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_connection') as mock_conn:
            ...
            with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.student_exists', return_value=True, create=True):
                with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_student_name', return_value='Bob Johnson', create=True):
                    try:
    ...
    def test_award_scholarship_invalid_student(self, temp_db, capsys, monkeypatch):
        ...
        with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_connection') as mock_conn:
            ...
            with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.student_exists', return_value=False, create=True):
                try:
                    scholarship_programs.award_scholarship_to_student()
                    captured = capsys.readouterr()
    ...
    def test_view_student_scholarships(self, temp_db, capsys, monkeypatch):
        ...
        with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_connection') as mock_conn:
            ...
            with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.student_exists', return_value=True, create=True):
                with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_student_name', return_value='John Doe', create=True):
                    try:
...
class TestFinancialAidManagement:
    ...
    def test_create_financial_aid_application(self, temp_db, capsys, monkeypatch):
        ...
        with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_connection') as mock_conn:
            ...
            with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.student_exists', return_value=True, create=True):
                with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_student_name', return_value='Bob Johnson', create=True):
                    with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.log_audit_action', create=True):
                        try:
    ...
    def test_disburse_financial_aid(self, temp_db, capsys, monkeypatch):
        ...
        with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.get_connection') as mock_conn:
            ...
            with patch.object(scholarship_programs, 'auth') as mock_auth:
                ...
                with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.apply_aid_to_fees', create=True):
                    with patch('education_system.systems.university.domain.finance.scholarships.scholarship_programs.log_audit_action', create=True):
                        try:
