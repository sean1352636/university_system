...
class TestMobileAppPWACore(unittest.TestCase):
    ...
    @patch('education_system.systems.university.domain.operations.campus.mobility.services.mobile_app_pwa_core.transaction')
    def test_init_mobile_app_database(self, mock_transaction):
        """Test database initialization"""
        from education_system.systems.university.domain.operations.campus.mobility.services import mobile_app_pwa_core
    ...
    @patch('education_system.systems.university.domain.operations.campus.mobility.services.mobile_app_pwa_core.transaction')
    @patch('education_system.systems.university.domain.operations.campus.mobility.services.mobile_app_pwa_core.log_activity')
    ...
    @patch('education_system.systems.university.domain.operations.campus.mobility.services.mobile_app_pwa_core.get_connection')
