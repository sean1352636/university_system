...
from education_system.systems.university.domain.operations.commerce.services.restaurant.customer import loyalty_program
...
class TestCustomerCreation:
    ...
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.customer.loyalty_program.get_db_connection')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.customer.loyalty_program.backup_before_operation')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.customer.loyalty_program.log_audit_action')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.customer.loyalty_program.send_confirmation_email')
    @patch('education_system.systems.university.domain.operations.commerce.services.restaurant.customer.loyalty_program.render_template')
...
class TestFeedbackManagement:
    ...
    def test_export_feedback_report_csv(self, mock_db_connection, tmp_path):
        ...
        # Setup
        with patch('education_system.systems.university.domain.operations.commerce.services.restaurant.customer.loyalty_program.get_db_connection') as mock_get_conn:
            mock_get_conn.return_value = mock_db_connection
            cursor = mock_db_connection.cursor()
