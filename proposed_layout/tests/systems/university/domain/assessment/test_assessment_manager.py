...
from education_system.systems.university.interfaces.gui.academics.grade_tracking.assessment_manager import (
...
class TestAssessmentManager:
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.assessment_manager.get_connection')
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.assessment_manager.sqlite3')
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.assessment_manager.AssessmentAssignmentService')
    @patch('tkinter.messagebox.showinfo')
