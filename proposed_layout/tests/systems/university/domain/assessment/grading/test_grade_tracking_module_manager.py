...
class TestModuleManager(unittest.TestCase):
    ...
    def test_refresh_modules(self):
        ...
        with patch(
            'education_system.systems.university.interfaces.gui.academics.grade_tracking.module_manager.get_connection',
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.module_manager.get_connection')
