...
from education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.enrollment_dialog import (
...
class TestModuleEnrollmentDialog:
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.enrollment_dialog.messagebox')
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.enrollment_dialog.safe_grab_set')
