...
def student_manager(mock_app):
    ...
    with patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager.get_connection', return_value=mock_app.conn):
...
class TestDatabaseOperations:
    ...
    def test_get_cursor_creates_new_connection(self, mock_app):
        ...
        with patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager.get_connection') as mock_get_conn:
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager.get_connection')
...
class TestImportExport:
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager.filedialog')
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager.messagebox')
...
class TestHelperFunctions:
    ...
    def test_init_basic_database(self, mock_get_conn, mock_conn):
        ...
        from education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager import init_basic_database
    ...
    def test_init_enhanced_grades_db(self, mock_get_conn, mock_conn):
        ...
        from education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager import init_enhanced_grades_db
    ...
    def test_percentage_to_letter(self):
        ...
        from education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager import percentage_to_letter
    ...
    def test_letter_to_gpa(self):
        ...
        from education_system.systems.university.interfaces.gui.academics.grade_tracking.student_manager import letter_to_gpa
