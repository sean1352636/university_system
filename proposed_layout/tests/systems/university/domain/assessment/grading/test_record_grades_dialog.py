...
from education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.record_grades_dialog import (
    RecordGradesDialog
)
...
class TestRecordGradesDialog:
    ...
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.record_grades_dialog.get_connection')
    @patch('education_system.systems.university.interfaces.gui.academics.grade_tracking.dialogs.record_grades_dialog.messagebox')
