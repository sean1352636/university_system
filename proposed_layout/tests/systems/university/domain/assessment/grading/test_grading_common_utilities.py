...
from education_system.systems.university.domain.assessment.grading.common_utilities import (
    _table_exists,
    _cols,
    _first_table,
    _first_col,
...
class TestFirstTable:
    ...
    @patch('education_system.systems.university.domain.assessment.grading.common_utilities._table_exists')
...
class TestFirstCol:
    ...
    @patch('education_system.systems.university.domain.assessment.grading.common_utilities._cols')
...
class TestSelectAssessment:
    ...
    @patch('education_system.systems.university.domain.assessment.grading.common_utilities._first_table')
    @patch('education_system.systems.university.domain.assessment.grading.common_utilities._first_col')
    ...
    @patch('education_system.systems.university.domain.assessment.grading.common_utilities.get_connection')
    @patch('education_system.systems.university.domain.assessment.grading.common_utilities._first_table')
    @patch('education_system.systems.university.domain.assessment.grading.common_utilities._first_col')
    @patch('builtins.input', return_value='1')
