...
class TestSessionInfo:
    def test_creation(self):
        from education_system.systems.university.infrastructure.security.session_management import SessionInfo
        now = datetime.now()
        s = SessionInfo(
            session_id="sid",
            user_id=1,
...
class TestSessionManagerInit:
    @patch("education_system.systems.university.infrastructure.security.session_management.DEFAULT_DB_PATH", "/tmp/test.db")
...
class TestGetLocationFromIp:
    ...
    @patch("education_system.systems.university.infrastructure.security.session_management.requests")
...
class TestCreateSession:
    @patch("education_system.systems.university.infrastructure.security.session_management.get_connection")
