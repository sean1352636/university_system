...
def reset_globals():
    ...
    import education_system.systems.university.infrastructure.security.immutable_audit_log as mod
...
def in_memory_audit_log():
    ...
    from education_system.systems.university.infrastructure.security.immutable_audit_log import ImmutableAuditLog

    with patch("education_system.systems.university.infrastructure.security.immutable_audit_log.transaction") as mock_tx, \
         patch("education_system.systems.university.infrastructure.security.immutable_audit_log.get_connection") as mock_gc:
...
class TestImmutableAuditLogInit:
    @patch("education_system.systems.university.infrastructure.security.immutable_audit_log.transaction")
...
class TestConvenienceFunctions:
    def test_log_security_event(self, in_memory_audit_log):
        ...
        with patch(
            ...
            from education_system.systems.university.infrastructure.security.immutable_audit_log import log_security_event
    ...
    def test_verify_audit_log_integrity(self, in_memory_audit_log):
        ...
        with patch(
            ...
            from education_system.systems.university.infrastructure.security.immutable_audit_log import verify_audit_log_integrity
