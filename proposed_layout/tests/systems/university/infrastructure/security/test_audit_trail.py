...
def reset_singleton():
    ...
    from education_system.systems.university.infrastructure.security import audit_trail
...
class TestAuditAction:
    def test_access_value(self):
        from education_system.systems.university.infrastructure.security.audit_trail import AuditAction
...
class TestAuditEntry:
    def test_creation(self):
        from education_system.systems.university.infrastructure.security.audit_trail import AuditEntry
        now = datetime.now()
        entry = AuditEntry(
            timestamp=now,
            action="read",
...
class TestAuditLoggerSingleton:
    @patch("education_system.systems.university.infrastructure.security.audit_trail.get_connection")
    def test_same_instance(self, mock_conn):
        from education_system.systems.university.infrastructure.security.audit_trail import AuditLogger
...
class TestLogMethod:
    ...
    def test_log_returns_entry_id(self, mock_conn):
        from education_system.systems.university.infrastructure.security.audit_trail import AuditLogger, AuditAction
        mock_cm = MagicMock()
...
class TestConvenienceFunctions:
    ...
    def test_log_activity_function(self, mock_conn):
        from education_system.systems.university.infrastructure.security.audit_trail import log_activity
        mock_cm = MagicMock()
        mock_cursor = MagicMock()
