...
_SD_MOD = 'education_system.systems.university.interfaces.gui.shell.security.security_dashboard_gui'
# Also the backward-compat shim location
_SD_INFRA = 'education_system.systems.university.infrastructure.security.security_dashboard_gui'
...
class TestMFAIntegration:
    ...
    def test_mfa_admin_panel_availability(self):
        ...
        from education_system.systems.university.interfaces.gui.shell.security.security_dashboard_gui import MFA_ADMIN_AVAILABLE
    ...
    def test_mfa_setup_wizard_availability(self):
        ...
        from education_system.systems.university.interfaces.gui.shell.security.security_dashboard_gui import MFA_SETUP_AVAILABLE
...
class TestGUIModuleImports:
    ...
    def test_all_security_modules_imported(self):
        ...
        from education_system.systems.university.interfaces.gui.shell.security import security_dashboard_gui
