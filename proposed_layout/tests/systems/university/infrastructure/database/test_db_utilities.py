...
class TestCoreReExports:
    ...
    def test_sqlite3_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import sqlite3
    ...
    def test_database_manager_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import DatabaseManager
        from education_system.systems.university.infrastructure.database.db import DatabaseManager as OrigDM
        assert DatabaseManager is OrigDM

    def test_get_connection_re_exported(self):
        """Test get_connection is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import get_connection
        from education_system.systems.university.infrastructure.database.db import get_connection as orig
        assert get_connection is orig

    def test_get_db_connection_re_exported(self):
        """Test get_db_connection is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import get_db_connection
        from education_system.systems.university.infrastructure.database.db import get_db_connection as orig
        assert get_db_connection is orig

    def test_default_db_path_re_exported(self):
        """Test DEFAULT_DB_PATH is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import DEFAULT_DB_PATH
    ...
    def test_db_dir_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import DB_DIR
    ...
    def test_exports_dir_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import EXPORTS_DIR
...
class TestEmailDbUtilitiesReExports:
    ...
    def test_get_unified_connection_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import get_unified_connection
        assert callable(get_unified_connection)

    def test_simple_db_manager_re_exported(self):
        """Test SimpleDBManager is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import SimpleDBManager
        assert SimpleDBManager is not None

    def test_get_db_manager_re_exported(self):
        """Test get_db_manager is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import get_db_manager
        assert callable(get_db_manager)

    def test_execute_db_operation_re_exported(self):
        """Test execute_db_operation is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import execute_db_operation
        assert callable(execute_db_operation)

    def test_safe_db_operation_re_exported(self):
        """Test safe_db_operation is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import safe_db_operation
        assert callable(safe_db_operation)

    def test_initialize_email_db_re_exported(self):
        """Test initialize_email_db is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import initialize_email_db
    ...
    def test_migrate_email_log_table_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import migrate_email_log_table
    ...
    def test_schedule_database_maintenance_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import schedule_database_maintenance
    ...
    def test_optimize_database_re_exported(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import optimize_database
        assert callable(optimize_database)

    def test_ensure_db_directory_re_exported(self):
        """Test ensure_db_directory is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import ensure_db_directory
        assert callable(ensure_db_directory)

    def test_ensure_parent_dir_re_exported(self):
        """Test ensure_parent_dir is re-exported."""
        from education_system.systems.university.infrastructure.database.utilities import ensure_parent_dir
...
class TestHealthDbBackupReExports:
    ...
    def test_create_sqlite_backup_available_or_none(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import create_sqlite_backup
    ...
    def test_ensure_templates_schema_available_or_none(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import ensure_templates_schema
...
class TestSchemaInitReExports:
    ...
    def test_init_grade_system_db_available_or_none(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import init_grade_system_db
    ...
    def test_init_finance_system_db_available_or_none(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import init_finance_system_db
    ...
    def test_init_student_union_db_available_or_none(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import init_student_union_db
    ...
    def test_init_email_system_db_available_or_none(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import init_email_system_db
    ...
    def test_initialize_all_schemas_available_or_none(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import initialize_all_schemas
...
class TestUtilitiesAllExports:
    ...
    def test_all_is_list(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import __all__
        assert isinstance(__all__, list)

    def test_all_names_exist(self):
        """Test every name in __all__ is a real attribute."""
        import education_system.systems.university.infrastructure.database.utilities as mod
...
class TestConsistency:
    ...
    def test_default_db_path_matches_db_module(self):
        ...
        from education_system.systems.university.infrastructure.database.utilities import DEFAULT_DB_PATH as u_path
        from education_system.systems.university.infrastructure.database.db import DEFAULT_DB_PATH as d_path
        assert u_path == d_path

    def test_db_dir_matches_db_module(self):
        """Test DB_DIR in utilities matches db module."""
        from education_system.systems.university.infrastructure.database.utilities import DB_DIR as u_dir
        from education_system.systems.university.infrastructure.database.db import DB_DIR as d_dir
        assert u_dir == d_dir

    def test_exports_dir_matches_db_module(self):
        """Test EXPORTS_DIR in utilities matches db module."""
        from education_system.systems.university.infrastructure.database.utilities import EXPORTS_DIR as u_dir
        from education_system.systems.university.infrastructure.database.db import EXPORTS_DIR as d_dir
        assert u_dir == d_dir
