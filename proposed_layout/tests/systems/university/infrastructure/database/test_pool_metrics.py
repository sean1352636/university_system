...
def collector():
    ...
    from education_system.systems.university.infrastructure.database.pool_metrics import PoolMetricsCollector
...
class TestPoolMetrics:
    ...
    def test_default_values(self):
        ...
        from education_system.systems.university.infrastructure.database.pool_metrics import PoolMetrics
        pm = PoolMetrics()
...
class TestConnectionEvent:
    ...
    def test_creation(self):
        ...
        from education_system.systems.university.infrastructure.database.pool_metrics import ConnectionEvent
        now = datetime.now()
...
class TestGetPoolMetrics:
    ...
    def test_returns_collector(self):
        ...
        import education_system.systems.university.infrastructure.database.pool_metrics as mod
...
class TestModuleExports:
    ...
    def test_all_is_list(self):
        ...
        from education_system.systems.university.infrastructure.database.pool_metrics import __all__
