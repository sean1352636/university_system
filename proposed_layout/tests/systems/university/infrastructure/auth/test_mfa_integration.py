...
from education_system.systems.university.infrastructure.auth.mfa_integration import (
    MFAIntegration,
    integrate_mfa_check,
...
class TestMFAIntegration:
    ...
    def test_init(self):
        ...
        with patch('education_system.systems.university.infrastructure.auth.mfa_integration.MFAService'):
            integration = MFAIntegration()

            assert integration.mfa_service is not None

    @patch('education_system.systems.university.infrastructure.auth.mfa_integration.MFAService')
...
class TestIntegrateMFACheck:
    ...
    @patch('education_system.systems.university.infrastructure.auth.mfa_integration.MFAIntegration')
...
class TestCreateMFAPatch:
    ...
    @patch('education_system.systems.university.infrastructure.auth.mfa_integration.integrate_mfa_check')
...
class TestGUIIntegrationHelpers:
    ...
    @patch('education_system.systems.university.infrastructure.auth.mfa_integration.MFAIntegration')
    @patch('education_system.systems.university.infrastructure.auth.mfa_gui.show_mfa_verification')
    ...
    @patch('education_system.systems.university.infrastructure.auth.mfa_gui.show_mfa_setup')
