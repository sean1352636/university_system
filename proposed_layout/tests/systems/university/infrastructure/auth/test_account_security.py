...
from education_system.systems.university.infrastructure.auth.managers.account_security import (
...
class TestIncrementLoginAttempts:
    ...
    @patch(
        "education_system.systems.university.infrastructure.auth.managers.account_security.SECURITY_ALERTS_AVAILABLE",
        True,
    )
    @patch(
        "education_system.systems.university.infrastructure.auth.managers.account_security.alert_account_lockout",
    )
