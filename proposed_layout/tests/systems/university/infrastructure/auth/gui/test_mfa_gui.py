...
_MFA_MOD = 'education_system.systems.university.interfaces.gui.shell.auth.mfa_gui'
...
class TestMFASetupWizard:
    ...
    @patch('education_system.systems.university.interfaces.gui.shell.auth.mfa_gui.MFAService')
    @patch('education_system.systems.university.interfaces.gui.shell.auth.mfa_gui.tk.Toplevel')
    def test_wizard_initialization(self, mock_toplevel, mock_service_class, mock_mfa_service):
        ...
        from education_system.systems.university.interfaces.gui.shell.auth.mfa_gui import MFASetupWizard
...
class TestMFAVerificationDialog:
    ...
    def test_dialog_initialization(self, mock_toplevel, mock_service_class, mock_mfa_service):
        ...
        from education_system.systems.university.interfaces.gui.shell.auth.mfa_gui import MFAVerificationDialog
...
class TestConvenienceFunctions:
    ...
    @patch('education_system.systems.university.interfaces.gui.shell.auth.mfa_gui.MFASetupWizard')
    def test_show_mfa_setup(self, mock_wizard_class):
        ...
        from education_system.systems.university.interfaces.gui.shell.auth.mfa_gui import show_mfa_setup
    ...
    @patch('education_system.systems.university.interfaces.gui.shell.auth.mfa_gui.MFAVerificationDialog')
    def test_show_mfa_verification(self, mock_dialog_class):
        ...
        from education_system.systems.university.interfaces.gui.shell.auth.mfa_gui import show_mfa_verification
...
class TestGUIValidation:
    ...
    @patch('education_system.systems.university.interfaces.gui.shell.auth.mfa_gui.MFAService')
    @patch('education_system.systems.university.interfaces.gui.shell.auth.mfa_gui.tk.Toplevel')
    @patch('education_system.systems.university.interfaces.gui.shell.auth.mfa_gui.messagebox.showerror')
