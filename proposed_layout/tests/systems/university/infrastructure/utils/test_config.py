...
def mock_paths():
    """Mock paths module"""
    with patch('education_system.systems.university.infrastructure.utils.config.paths') as mock:
...
class TestEmailConfigValidation:
    ...
    def test_validate_email_config_valid(self, sample_config):
        ...
        from education_system.systems.university.infrastructure.utils.config import validate_email_config
...
class TestConfigLoading:
    ...
    def test_load_config_success(self, mock_file, mock_paths, sample_config):
        ...
        from education_system.systems.university.infrastructure.utils.config import load_config, config
    ...
    @patch('education_system.systems.university.infrastructure.utils.config.save_config')
    def test_load_config_file_not_found(self, mock_save, mock_paths):
        """Test loading config when file doesn't exist"""
        from education_system.systems.university.infrastructure.utils.config import load_config
...
class TestConfigSaving:
    ...
    def test_save_config_success(self, mock_file, mock_paths, sample_config):
        ...
        from education_system.systems.university.infrastructure.utils.config import save_config, config
    ...
    def test_save_config_write_error(self, mock_file, mock_paths):
        ...
        from education_system.systems.university.infrastructure.utils.config import save_config
...
class TestConfigValidation:
    ...
    def test_validate_config_success(self, mock_validate, sample_config):
        ...
        from education_system.systems.university.infrastructure.utils.config import validate_config, config
    ...
    def test_validate_config_from_file(self, mock_validate, mock_file, sample_config):
        ...
        from education_system.systems.university.infrastructure.utils.config import validate_config
...
class TestInteractiveConfiguration:
    ...
    def test_configure_email_settings_database_mode(self, mock_save, mock_input, sample_config):
        ...
        from education_system.systems.university.infrastructure.utils.config import configure_email_settings, config
    ...
    @patch('builtins.input')
    @patch('education_system.systems.university.infrastructure.utils.config.save_config')
    @patch('education_system.systems.university.infrastructure.utils.config.validate_config')
    @patch('education_system.systems.university.infrastructure.utils.config.test_email_configuration')
...
class TestEmailConfiguration:
    ...
    @patch('education_system.systems.university.infrastructure.utils.email_service.send_email')
    ...
    def test_test_email_configuration_success(self, mock_render, mock_send, sample_config):
        ...
        from education_system.systems.university.infrastructure.utils.config import test_email_configuration, config
...
class TestEnsureDatabaseMode:
    ...
    def test_ensure_database_mode_sets_defaults(self):
        ...
        from education_system.systems.university.infrastructure.utils.config import ensure_email_config_for_database_mode, config
...
class TestConfigConstants:
    ...
    def test_default_config_has_required_fields(self):
        ...
        from education_system.systems.university.infrastructure.utils.config import DEFAULT_CONFIG
    ...
    def test_config_schema_defines_required_fields(self):
        ...
        from education_system.systems.university.infrastructure.utils.config import CONFIG_SCHEMA
