...
class TestEnsureDirectories:
    ...
    def test_ensure_directories_creates_all_directories(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('education_system.systems.university.infrastructure.paths.DATA_DIR', temp_path / 'data'), \
                 patch('education_system.systems.university.infrastructure.paths.DB_DIR', temp_path / 'data' / 'db_files'), \
                 patch('education_system.systems.university.infrastructure.paths._ensure') as mock_ensure:
    ...
    def test_ensure_helper_creates_directory(self):
        ...
        from education_system.systems.university.infrastructure.paths import _ensure
