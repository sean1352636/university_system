...
def doc_manager(temp_db, mock_auth):
    ...
    with patch('education_system.systems.university.infrastructure.utils.document_manager.get_connection') as mock_conn, \
         patch('education_system.systems.university.infrastructure.utils.document_manager.get_current_user') as mock_user, \
         patch('education_system.systems.university.infrastructure.utils.document_manager.set_auth_instance'):
