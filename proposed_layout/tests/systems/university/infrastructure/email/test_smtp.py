...
class TestSendEmailViaSMTP:
    ...
    @patch('education_system.systems.university.infrastructure.email.smtp.smtplib.SMTP')
    @patch('education_system.systems.university.infrastructure.email.smtp.execute_db_operation')
    @patch('education_system.systems.university.infrastructure.email.smtp.config')
    ...
    @patch('education_system.systems.university.infrastructure.email.smtp.os.path.exists', return_value=True)
    @patch('education_system.systems.university.infrastructure.email.smtp.open', new_callable=mock_open, read_data=b'file content')
    @patch('education_system.systems.university.infrastructure.email.smtp.os.path.basename')
    @patch('education_system.systems.university.infrastructure.email.smtp.smtplib.SMTP')
    @patch('education_system.systems.university.infrastructure.email.smtp.execute_db_operation')
    @patch('education_system.systems.university.infrastructure.email.smtp.config')
    ...
    @patch('education_system.systems.university.infrastructure.email.smtp.ssl.create_default_context')
    @patch('education_system.systems.university.infrastructure.email.smtp.smtplib.SMTP')
    @patch('education_system.systems.university.infrastructure.email.smtp.execute_db_operation')
    @patch('education_system.systems.university.infrastructure.email.smtp.config')
