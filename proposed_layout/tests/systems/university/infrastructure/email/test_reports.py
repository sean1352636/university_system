...
from education_system.systems.university.infrastructure.email import reports
...
class TestLogEmailMetrics:
    ...
    def test_log_email_metrics_sent_new_record(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.reports.execute_db_operation', side_effect=mock_operation):
    ...
    def test_log_email_metrics_database_error(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.reports.execute_db_operation') as mock_db:
    ...
    def test_log_email_metrics_creates_correct_date(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.reports.execute_db_operation', side_effect=mock_operation), \
             patch('education_system.systems.university.infrastructure.email.reports.datetime') as mock_datetime:
...
class TestGenerateReportForm:
    ...
    def test_generate_report_form_last_7_days_json(self):
        ...
        with patch('builtins.input', side_effect=['1', '1']), \
             ...
             patch('education_system.systems.university.infrastructure.email.reports.execute_db_operation', side_effect=mock_operation):
...
class TestGetSystemHealthInfo:
    ...
    def test_get_system_health_info_all_operational(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.email_service.email_queue', mock_email_queue), \
             patch('education_system.systems.university.infrastructure.email.email_service.worker_threads', mock_worker_threads), \
             patch('education_system.systems.university.infrastructure.email.reports.config') as mock_config, \
             patch('education_system.systems.university.infrastructure.email.reports.execute_db_operation', side_effect=mock_operation):
    ...
    def test_get_system_health_info_database_only_mode(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.reports.config') as mock_config, \
             patch('education_system.systems.university.infrastructure.email.reports.execute_db_operation', side_effect=mock_operation):
    ...
    def test_get_system_health_info_database_error(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.reports.config') as mock_config, \
             patch('education_system.systems.university.infrastructure.email.reports.execute_db_operation') as mock_db:
