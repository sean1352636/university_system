...
def cleanup_scheduler():
    ...
    try:
        from education_system.systems.university.infrastructure.email import email_scheduler
...
class TestCheckBookReturnReminders:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.send_book_return_reminder')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.get_connection')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.log_event')
    def test_check_book_return_reminders_no_books(self, mock_log_event, mock_get_conn, mock_send_reminder):
        ...
        from education_system.systems.university.infrastructure.email.email_scheduler import check_book_return_reminders
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.send_book_return_reminder')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.get_connection')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.logger')
...
class TestCheckOverdueBooks:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.send_overdue_notification')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.get_connection')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.log_event')
    def test_check_overdue_books_no_overdue(self, mock_log_event, mock_get_conn, mock_send_notification):
        ...
        from education_system.systems.university.infrastructure.email.email_scheduler import check_overdue_books
...
class TestCheckSlaBreaches:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.send_sla_alert')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.get_connection')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.log_event')
    def test_check_sla_breaches_no_breaches(self, mock_log_event, mock_get_conn, mock_send_alert):
        ...
        from education_system.systems.university.infrastructure.email.email_scheduler import check_sla_breaches
...
class TestSendDailySatisfactionSurveys:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.send_bulk_satisfaction_surveys')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.log_event')
    def test_send_daily_satisfaction_surveys_success(self, mock_log_event, mock_send_bulk):
        ...
        from education_system.systems.university.infrastructure.email.email_scheduler import send_daily_satisfaction_surveys
...
class TestSetupSchedules:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.schedule')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.logger')
    def test_setup_schedules_configures_all_jobs(self, mock_logger, mock_schedule):
        """Test that all scheduled jobs are configured"""
        from education_system.systems.university.infrastructure.email.email_scheduler import setup_schedules
...
class TestStartScheduler:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.threading.Thread')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.setup_schedules')
    def test_start_scheduler_success(self, mock_setup, mock_thread, cleanup_scheduler):
        """Test starting scheduler successfully"""
        from education_system.systems.university.infrastructure.email.email_scheduler import start_scheduler, scheduler_running
...
class TestGetScheduledJobs:
    ...
    def test_get_scheduled_jobs_empty(self, mock_schedule):
        ...
        from education_system.systems.university.infrastructure.email.email_scheduler import get_scheduled_jobs
...
class TestRunScheduler:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.schedule')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.setup_schedules')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.time.sleep')
...
class TestIntegration:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.send_book_return_reminder')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.get_connection')
    @patch('education_system.systems.university.infrastructure.email.email_scheduler.time.sleep', side_effect=lambda s: None)
    def test_scheduler_lifecycle(self, mock_sleep, mock_get_conn, mock_book_reminder, mock_surveys, cleanup_scheduler):
        ...
        # Start scheduler
        with patch('education_system.systems.university.infrastructure.email.email_scheduler.setup_schedules'):
            result = start_scheduler()
            assert result is True
            assert is_scheduler_running() is True
...
class TestErrorRecovery:
    ...
    def test_book_reminders_continues_after_error(self, mock_logger, mock_get_conn):
        ...
        with patch('education_system.systems.university.infrastructure.email.email_scheduler.send_book_return_reminder') as mock_send:
