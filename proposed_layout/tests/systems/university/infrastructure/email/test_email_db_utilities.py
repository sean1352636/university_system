...
from education_system.systems.university.infrastructure.email import email_db_utilities
...
class TestEnsureDbDirectory:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.paths')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.os.path.exists')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.os.makedirs')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.log_event')
...
class TestGetUnifiedConnection:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.get_connection')
...
class TestSimpleDBManager:
    ...
    def test_simple_db_manager_init_default_path(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.email_db_utilities.ensure_parent_dir'):
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.ensure_parent_dir')
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.get_unified_connection')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.ensure_parent_dir')
...
class TestGetDbManager:
    ...
    def test_get_db_manager_returns_singleton(self):
        ...
        with patch('education_system.systems.university.infrastructure.email.email_db_utilities._db_manager', None):
            with patch('education_system.systems.university.infrastructure.email.email_db_utilities.ensure_parent_dir'):
...
class TestExecuteDbOperation:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.DatabaseManager')
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.DatabaseManager')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.time.sleep')
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.DatabaseManager')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.time.sleep')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.logger')
    ...
    def test_execute_db_operation_logs_info_on_lock(self, mock_logger, mock_db_cls):
        ...
        with patch('education_system.systems.university.infrastructure.email.email_db_utilities.time.sleep'):
...
class TestSafeDbOperation:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.execute_db_operation')
...
class TestDbReadyInitialization:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities.initialize_email_db')
    @patch('education_system.systems.university.infrastructure.email.email_db_utilities._sync_inbox_messages')
