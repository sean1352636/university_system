...
from education_system.systems.university.infrastructure.email import admin
from education_system.systems.university.infrastructure.auth import UserAuth

# The DB_PATH used by execute_db_operation (the actual path that matters for search/list)
_EMAIL_DB_PATH = 'education_system.systems.university.infrastructure.database.db.DEFAULT_DB_PATH'
...
class TestCommunicationDashboard:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_service.send_email_as_user')
...
class TestEmailSystem:
    ...
    @patch('education_system.systems.university.infrastructure.email.email_service.send_email')
