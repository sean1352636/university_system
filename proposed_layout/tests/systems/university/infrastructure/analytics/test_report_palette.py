...
from education_system.systems.university.infrastructure.utils import report_palette
from education_system.systems.university.infrastructure.utils.report_palette import (
    DEFAULT_PALETTE,
    get_report_palette,
    color_at,
)
