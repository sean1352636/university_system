...
from education_system.systems.university.services.analytics.predictive_analytics_gui import (
...
_PA_MOD = 'education_system.systems.university.services.analytics.predictive_analytics_gui'
...
class TestPredictiveAnalyticsGUI:
    ...
    def test_init_database(self, root_window, mock_auth):
        ...
        with patch('education_system.systems.university.infrastructure.database.schemas.analytics_bi_schemas.init_analytics_dashboard_system_db') as mock_init:
            with patch.object(PredictiveAnalyticsGUI, '_create_widgets'):
                with patch(f'{_PA_MOD}.log_activity'):
                    gui = PredictiveAnalyticsGUI(root_window, mock_auth)
