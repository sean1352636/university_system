...
def test_package_and_cli_import():
    import education_system.systems.secondary  # noqa: F401
    import education_system.systems.secondary.cli_main  # noqa: F401
...
def test_api_blueprints_register():
    from education_system.platform.delivery.api.school.routes import ALL_BLUEPRINTS
