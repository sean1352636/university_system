...
def test_package_and_cli_import():
    import education_system.systems.nursery  # noqa: F401
    import education_system.systems.nursery.cli_main  # noqa: F401
...
def test_api_blueprints_register():
    from education_system.platform.delivery.api.nursery.routes import ALL_BLUEPRINTS
