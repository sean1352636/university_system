...
@pytest.fixture
def gui_inner():
    from education_system.systems.sixth_form.interfaces.gui import gui_main
    return gui_main
...
def test_shim_reexports_run():
    from education_system.systems.sixth_form import gui_main as shim
    from education_system.systems.sixth_form.interfaces.gui import (
        gui_main as inner,
    )
...
def test_run_main_module_guard():
    ...
    with pytest.raises(SystemExit) as exc:
        runpy.run_module(
            "education_system.systems.sixth_form.interfaces.gui.gui_main",
            run_name="__main__",
        )
