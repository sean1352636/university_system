...
def test_shim_reexports_run_and_run_authenticated():
    from education_system.systems.sixth_form import cli_main as shim
...
def test_categories_catalogue_shape():
    from education_system.systems.sixth_form.interfaces.cli.cli_main import (
        CATEGORIES,
    )
...
def test_run_raises_without_shared_auth():
    from education_system.systems.sixth_form.interfaces.cli import cli_main
...
def test_prompt_returns_zero_on_eof(monkeypatch):
    from education_system.systems.sixth_form.interfaces.cli import cli_main
    from education_system.systems.sixth_form.interfaces.cli import idle_timeout
...
def test_main_menu_main_module_guard(monkeypatch):
    ...
    with pytest.raises(SystemExit) as exc:
        runpy.run_module(
            "education_system.systems.sixth_form.interfaces.cli.cli_main",
            run_name="__main__",
        )
