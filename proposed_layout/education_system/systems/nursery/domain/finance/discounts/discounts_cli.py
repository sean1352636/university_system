...
from education_system.systems.nursery.domain.finance.discounts import discounts as data
from education_system.systems.nursery.domain.finance.discounts.discounts import (
    DISCOUNT_TYPES,
    STATUSES,
    ValidationError,
)
