"""Tkinter views for Primary School Visitors."""
...
from education_system.systems.nursery.domain.operations.visitors import (
    visitors as data,
)
from education_system.systems.nursery.domain.operations.visitors.visitors import (
    DEFAULT_ID_TYPE,
    DEFAULT_STATUS,
...
from education_system.systems.nursery.domain.staff import (
    staff as staff_data,
)
