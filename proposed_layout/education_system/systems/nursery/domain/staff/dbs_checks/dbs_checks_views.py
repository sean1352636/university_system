"""Tkinter views for Primary School DBS Checks."""
...
from education_system.systems.nursery.domain.staff.dbs_checks import (
    dbs_checks as data,
)
from education_system.systems.nursery.domain.staff.dbs_checks.dbs_checks import (
    CERTIFICATE_TYPES,
    DBSCheck,
