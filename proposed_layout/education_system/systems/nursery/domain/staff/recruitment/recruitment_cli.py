...
from education_system.systems.nursery.domain.staff.recruitment import (
    recruitment as data,
)
from education_system.systems.nursery.domain.staff.recruitment.recruitment import (
    APPLICANT_SOURCES,
    APPLICANT_STATUSES,
    Applicant,
    CONTRACT_TYPES,
