"""Tkinter views for Primary School Audit Reports."""
...
from education_system.systems.nursery.domain.governance.audit.audit_reports import (
    audit_reports as data,
)
from education_system.systems.nursery.domain.governance.audit.audit_reports.audit_reports import (
