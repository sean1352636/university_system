"""Tkinter views for Secondary School Notifications."""
...
from education_system.systems.secondary.domain.operations.communications.notifications.notifications import (
    CHANNELS,
    DEFAULT_CHANNEL,
