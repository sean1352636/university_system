...
from education_system.systems.secondary.domain.operations.reporting.custom_export import custom_export as data
...
def _build_registry() -> dict[str, DatasetSpec]:
    ...
    attendance = _load("education_system.systems.secondary.domain.academics.attendance", "attendance")
    attendance_concerns = _load("education_system.systems.secondary.domain.pastoral.attendance_concerns", "attendance_concerns")
    behaviour = _load("education_system.systems.secondary.domain.pastoral.behaviour", "behaviour")
    bursaries = _load("education_system.systems.secondary.domain.finance.bursaries", "bursaries")
    class_groups = _load("education_system.systems.secondary.domain.academics.class_groups", "class_groups")
    courses = _load("education_system.systems.secondary.domain.academics.courses", "courses")
    enrolments = _load("education_system.systems.secondary.domain.admissions.enrolment", "enrolment")
    exam_entries = _load("education_system.systems.secondary.domain.assessment.exam_entries", "exam_entries")
    exam_results = _load("education_system.systems.secondary.domain.assessment.exam_results", "exam_results")
    fees = _load("education_system.systems.secondary.domain.finance.fees", "fees")
    gradebook = _load("education_system.systems.secondary.domain.assessment.gradebook", "gradebook")
    homework = _load("education_system.systems.secondary.domain.academics.homework", "homework")
    mock_exams = _load("education_system.systems.secondary.domain.assessment.mock_exams", "mock_exams")
    notices = _load("education_system.systems.secondary.domain.operations.communications.notices", "notices")
    parent_contacts = _load("education_system.systems.secondary.domain.operations.communications.parent_contacts", "parent_contacts")
    parents_evenings = _load("education_system.systems.secondary.domain.operations.communications.parents_evenings", "parents_evenings")
    predicted_grades = _load("education_system.systems.secondary.domain.assessment.predicted_grades", "predicted_grades")
    progress = _load("education_system.systems.secondary.domain.operations.reporting.progress", "progress")
    receipts = _load("education_system.systems.secondary.domain.finance.receipts", "receipts")
    safeguarding = _load("education_system.systems.secondary.domain.safeguarding", "safeguarding")
    staff = _load("education_system.systems.secondary.domain.staff", "staff")
    students = _load("education_system.systems.secondary.domain.pastoral", "_pupils_bridge")
    subjects = _load("education_system.systems.secondary.domain.academics.subjects", "subjects")
    timetable = _load("education_system.systems.secondary.domain.academics.timetable", "timetable")
    trips = _load("education_system.systems.secondary.domain.finance.trips", "trips")
    tutor_groups = _load("education_system.systems.secondary.domain.pastoral.tutor_groups", "tutor_groups")
    _att = _load("education_system.systems.secondary.domain.academics.attendance", "attendance")
    _atc = _load("education_system.systems.secondary.domain.pastoral.attendance_concerns", "attendance_concerns")
    _beh = _load("education_system.systems.secondary.domain.pastoral.behaviour", "behaviour")
    _bur = _load("education_system.systems.secondary.domain.finance.bursaries", "bursaries")
    _cg = _load("education_system.systems.secondary.domain.academics.class_groups", "class_groups")
    _co = _load("education_system.systems.secondary.domain.academics.courses", "courses")
    _en = _load("education_system.systems.secondary.domain.admissions.enrolment", "enrolment")
    _eent = _load("education_system.systems.secondary.domain.assessment.exam_entries", "exam_entries")
    _er = _load("education_system.systems.secondary.domain.assessment.exam_results", "exam_results")
    _fees = _load("education_system.systems.secondary.domain.finance.fees", "fees")
    _gb = _load("education_system.systems.secondary.domain.assessment.gradebook", "gradebook")
    _hw = _load("education_system.systems.secondary.domain.academics.homework", "homework")
    _me = _load("education_system.systems.secondary.domain.assessment.mock_exams", "mock_exams")
    _no = _load("education_system.systems.secondary.domain.operations.communications.notices", "notices")
    _pc = _load("education_system.systems.secondary.domain.operations.communications.parent_contacts", "parent_contacts")
    _pe = _load("education_system.systems.secondary.domain.operations.communications.parents_evenings", "parents_evenings")
    _pg = _load("education_system.systems.secondary.domain.assessment.predicted_grades", "predicted_grades")
    _pr = _load("education_system.systems.secondary.domain.operations.reporting.progress", "progress")
    _rc = _load("education_system.systems.secondary.domain.finance.receipts", "receipts")
    _sg = _load("education_system.systems.secondary.domain.safeguarding", "safeguarding")
    _staff = _load("education_system.systems.secondary.domain.staff", "staff")
    _students = _load("education_system.systems.secondary.domain.pastoral", "_pupils_bridge")
    _sub = _load("education_system.systems.secondary.domain.academics.subjects", "subjects")
    _tt = _load("education_system.systems.secondary.domain.academics.timetable", "timetable")
    _tr = _load("education_system.systems.secondary.domain.finance.trips", "trips")
    _tg = _load("education_system.systems.secondary.domain.pastoral.tutor_groups", "tutor_groups")
    _wb = _load("education_system.systems.secondary.domain.pastoral.wellbeing", "wellbeing")


    _appr = _load("education_system.systems.secondary.domain.progression.apprenticeships", "apprenticeships")
    _car = _load("education_system.systems.secondary.domain.progression.careers", "careers")
    _of = _load("education_system.systems.secondary.domain.progression.offers", "offers")
    _ps = _load("education_system.systems.secondary.domain.progression.personal_statements", "personal_statements")
    _refs = _load("education_system.systems.secondary.domain.progression.references", "references")
    _uc = _load("education_system.systems.secondary.domain.progression.ucas", "ucas")
