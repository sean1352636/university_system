"""Progress Tracking data layer for the Secondary School System.
...
def populate_from_data(
    ...
    *,
    ...
    out: dict[str, Any] = {}
    from education_system.systems.secondary.domain.operations.reporting.attendance_report import attendance_report as _ar
    try:
    ...
    try:
        from education_system.systems.secondary.domain.operations.reporting.grades_report import grades_report as _gr
