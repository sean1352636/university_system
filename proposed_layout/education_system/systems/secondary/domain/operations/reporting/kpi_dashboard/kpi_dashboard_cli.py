"""CLI flow for the Secondary School KPI Dashboard.
...
from education_system.systems.secondary.domain.operations.reporting.kpi_dashboard import kpi_dashboard as data
from education_system.systems.secondary.domain.operations.reporting.kpi_dashboard.kpi_dashboard import (
    DEFAULT_THRESHOLD,
    DEFAULT_WINDOW_DAYS,
    Snapshot,
)
