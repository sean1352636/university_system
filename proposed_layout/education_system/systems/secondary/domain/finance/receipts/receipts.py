"""Receipts data layer for the Secondary School System.
...
def receipt_from_fee_payment(payment_id: int,
    ...
    from education_system.systems.secondary.domain.finance.fees import fees as _fees
...
def receipt_from_trip_payment(payment_id: int,
    ...
    from education_system.systems.secondary.domain.finance.trips import trips as _trips
