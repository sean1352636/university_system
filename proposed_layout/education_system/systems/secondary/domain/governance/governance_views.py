...
from education_system.systems.secondary.domain.governance import governance as data
from education_system.systems.secondary.domain.governance.governance import (
