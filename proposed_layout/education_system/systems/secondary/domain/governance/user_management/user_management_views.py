...
from education_system.systems.secondary.domain.governance.user_management import user_management as data
from education_system.systems.secondary.interfaces import user_accounts as ua_data
