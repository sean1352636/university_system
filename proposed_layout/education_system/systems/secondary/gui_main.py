...
def _count_pupils() -> int:
    from education_system.systems.secondary.domain.learners.pupils import pupils
...
def _count_form_groups() -> int:
    from education_system.systems.secondary.domain.academics.form_groups import form_groups
...
class SecondarySchoolMainGUI:
    ...
    def open_change_password(self) -> None:
        from education_system.systems.secondary.interfaces.gui import (
    ...
    def open_cross_analytics(self) -> None:
        from education_system.platform.features.analytics.analytics_gui import (
    ...
    def open_cross_calendar(self) -> None:
        from education_system.platform.features.calendar.calendar_gui import (
