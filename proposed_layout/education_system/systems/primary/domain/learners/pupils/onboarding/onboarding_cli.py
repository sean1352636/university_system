"""CLI handlers for onboarding in the Primary School System."""
...
from education_system.systems.primary.domain.learners.pupils.onboarding.onboarding import (
    STEPS, STEP_KEYS,
)
...
def _edit_checklist() -> None:
    ...
    while True:
        ...
        print(f"\n   Toggle step (1-{len(STEPS)}), A) all done, R) reset, 0) back")
