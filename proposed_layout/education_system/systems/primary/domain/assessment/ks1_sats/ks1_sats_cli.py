"""CLI handlers for KS1 SATs results."""
...
@_safe
def open_ks1_sats() -> None:
    logger.debug("CLI: open_ks1_sats")
    while True:
        print("\n  -- KS1 SATs --")
...
_DISPATCH = {"KS1 SATs": open_ks1_sats}
...
def dispatch(label: str) -> bool:
    ...
    if handler is None:
        return False
    logger.debug("Dispatching ks1_sats CLI label: %s", label)
    handler()
    return True
