...
from education_system.systems.primary.domain.staff.departments import (
    departments as data,
)
from education_system.systems.primary.domain.staff.departments.departments import (
    DEFAULT_DEPT_ROLE,
    DEFAULT_FACULTY,
    DEFAULT_STATUS,
    DEPT_ROLES,
