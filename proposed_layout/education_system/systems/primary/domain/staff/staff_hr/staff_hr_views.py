"""Tkinter views for Primary School Staff HR."""
...
from education_system.systems.primary.domain.staff.staff_hr import (
    staff_hr as data,
)
from education_system.systems.primary.domain.staff.staff_hr.staff_hr import (
    CONTRACT_TYPES,
