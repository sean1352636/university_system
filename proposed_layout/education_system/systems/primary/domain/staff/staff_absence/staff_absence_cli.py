"""CLI flows for Primary School Staff Absence."""
...
from education_system.systems.primary.domain.staff.staff_absence import (
    staff_absence as data,
)
from education_system.systems.primary.domain.staff.staff_absence.staff_absence import (
    ABSENCE_TYPES,
    Absence,
    CERTIFICATE_TYPES,
    COVER_SOURCES,
