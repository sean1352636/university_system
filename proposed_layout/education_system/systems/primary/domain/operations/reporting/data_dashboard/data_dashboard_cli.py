"""CLI flow for the Primary School Data Dashboard.
...
from education_system.systems.primary.domain.operations.reporting.data_dashboard import data_dashboard as data
from education_system.systems.primary.domain.operations.reporting.data_dashboard.data_dashboard import (
    DEFAULT_WINDOW_DAYS,
    Panel,
)
