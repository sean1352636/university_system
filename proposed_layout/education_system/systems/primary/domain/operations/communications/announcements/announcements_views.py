"""Tkinter views for Primary School Announcements."""
...
from education_system.systems.primary.domain.operations.communications.announcements.announcements import (
    AUDIENCES,
    Announcement,
    CATEGORIES,
    DEFAULT_AUDIENCES,
