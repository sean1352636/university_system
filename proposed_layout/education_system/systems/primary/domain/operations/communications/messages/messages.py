"""Email / Messaging log for the Primary School System.
...
def init_db() -> None:
    ...
    from education_system.systems.primary.domain.operations.communications.parent_contacts import parent_contacts as _pc
    from education_system.systems.primary.domain.staff import staff as _staff
    from education_system.systems.primary.domain import _pupils_bridge as _students
    _students.init_db()
    _staff.init_db()
    _pc.init_db()
    # Ensure the alumni table exists so the FK target is present.
    try:
        from education_system.systems.primary.domain.alumni \
