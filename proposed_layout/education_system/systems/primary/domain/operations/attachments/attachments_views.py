"""Tkinter views for Primary School Attachments."""
...
from education_system.systems.primary.domain.operations.attachments import (
    attachments as data,
)
from education_system.systems.primary.domain.operations.attachments.attachments import (
    Attachment,
    CATEGORIES,
    DEFAULT_CATEGORY,
    DEFAULT_ENTITY_TYPE,
