"""Tkinter views for Primary School Risk Management."""
...
from education_system.systems.primary.domain.governance.risk_management import (
    risk_management as data,
)
from education_system.systems.primary.domain.governance.risk_management.risk_management import (
    ACTION_STATUSES,
    CATEGORIES,
