...
from education_system.systems.primary.domain.pastoral.equality_diversity import (
    equality_diversity as data,
)
from education_system.systems.primary.domain.pastoral.equality_diversity.equality_diversity import (
