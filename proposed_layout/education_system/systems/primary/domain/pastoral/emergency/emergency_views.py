...
from education_system.systems.primary.domain.pastoral.emergency import (
    emergency as data,
)
from education_system.systems.primary.domain.pastoral.emergency.emergency import (
