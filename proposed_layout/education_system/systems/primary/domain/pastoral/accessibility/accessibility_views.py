...
from education_system.systems.primary.domain.pastoral.accessibility import (
    accessibility as data,
)
from education_system.systems.primary.domain.pastoral.accessibility.accessibility import (
