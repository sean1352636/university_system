"""CLI flows for Primary School Receipts."""
...
from education_system.systems.primary.domain.finance.receipts import receipts
...
from education_system.systems.primary.domain.finance.receipts.receipts import (
    CURRENCY_SYMBOL,
    DEFAULT_LINE_KIND,
    DEFAULT_METHOD,
    DEFAULT_STATUS,
