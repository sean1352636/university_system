...
from education_system.systems.primary.domain.finance.pupil_premium import (
    pupil_premium as data,
)
from education_system.systems.primary.domain.finance.pupil_premium.pupil_premium import (
