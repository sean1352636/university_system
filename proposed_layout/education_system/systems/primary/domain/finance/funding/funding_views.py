"""Tkinter views for Primary School Funding."""
...
from education_system.systems.primary.domain.finance.funding import (
    funding as data,
)
from education_system.systems.primary.domain.finance.funding.funding import (
    ALLOCATION_STATUSES,
