...
from education_system.systems.university.infrastructure.utils.activity_logger.models import LogLevel, SecurityLevel
...
def enhanced_log_activity(action=None, module=None, description=None,
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            from education_system.systems.university.infrastructure.utils.activity_logger.module_api import logger
