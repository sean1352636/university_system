...
from education_system.systems.university.infrastructure.database.data_backup.config import config
import education_system.systems.university.infrastructure.database.data_backup.config as _cfg
from education_system.systems.university.infrastructure.database.data_backup.operations import create_enhanced_backup
from education_system.systems.university.infrastructure.database.data_backup.notifications import notify_backup_result
...
def scheduled_backup_job():
    ...
    try:
        ...
        if config["auto_validate"] and backup_path:
            from education_system.systems.university.infrastructure.database.data_backup.analysis import validate_backup
