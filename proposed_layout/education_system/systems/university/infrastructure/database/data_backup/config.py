...
from education_system.systems.university.infrastructure.paths import DATA_DIR, BACKUP_DATABASE_DIR
...
def _active_config() -> dict:
    ...
    package = sys.modules.get("education_system.systems.university.infrastructure.database.data_backup")
