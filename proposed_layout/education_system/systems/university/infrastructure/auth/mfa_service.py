...
try:
    from education_system.systems.university.infrastructure.auth.sms_provider import send_otp as send_sms_otp
...
try:
    from education_system.systems.university.infrastructure.auth.email_otp_service import send_otp as send_email_otp
