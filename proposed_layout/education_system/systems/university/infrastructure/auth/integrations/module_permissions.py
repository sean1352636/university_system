...
try:
    from education_system.systems.university.infrastructure.auth.optional_dependencies import is_chatbot_available
except ImportError:
...
def initialize_complete_system():
    ...
    try:
        ...
        from education_system.systems.university.infrastructure.auth.integrations.chatbot_integration import setup_chatbot_permissions
        setup_chatbot_permissions(auth)

        # Initialize chatbot integration
        print("3. Initializing chatbot integration...")
        from education_system.systems.university.infrastructure.auth.integrations.chatbot_integration import initialize_chatbot_integration
