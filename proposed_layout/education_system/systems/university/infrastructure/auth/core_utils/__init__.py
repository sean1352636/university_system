...
# Constants
from education_system.systems.university.infrastructure.auth.core_utils.constants import (
    ROLES,
    PERMISSIONS,
...
from education_system.systems.university.infrastructure.auth.core_utils.global_auth import (
    get_current_user,
    set_auth_instance,
    get_auth_instance,
    clear_auth_instance,
