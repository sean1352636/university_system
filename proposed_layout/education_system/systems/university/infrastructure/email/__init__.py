...
from education_system.systems.university.infrastructure.email import email_service as _email_service_module
...
try:
    from education_system.systems.university.infrastructure.email.email_fallback import (
        EmailServiceWithFallback,
        EmailServiceUnavailable,
        Email,
        SendResult,
...
from education_system.systems.university.infrastructure.email import email_manager as _email_manager  # noqa: E402  (import after __all__ setup)
