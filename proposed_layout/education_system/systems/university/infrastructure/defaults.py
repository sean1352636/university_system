...
DEFAULT_ADMIN_FIRST_NAME = _get_env("DEFAULT_ADMIN_FIRST_NAME", "University")
...
DEFAULT_STAFF_USERNAME = _get_env("DEFAULT_STAFF_USERNAME", "staff")
DEFAULT_STAFF_EMAIL = _get_env("DEFAULT_STAFF_EMAIL", "staff@university.edu")
DEFAULT_STAFF_FIRST_NAME = _get_env("DEFAULT_STAFF_FIRST_NAME", "University")
DEFAULT_STAFF_LAST_NAME = _get_env("DEFAULT_STAFF_LAST_NAME", "Staff")
...
__all__ = [
    ...
    "DEFAULT_STAFF_EMAIL",
    "DEFAULT_STAFF_FIRST_NAME",
    "DEFAULT_STAFF_LAST_NAME",
