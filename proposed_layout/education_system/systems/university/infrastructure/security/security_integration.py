...
try:
    from education_system.systems.university.infrastructure.auth.enhanced_auth import (
        EnhancedAuth,
...
try:
    from education_system.systems.university.infrastructure.utils.input_validation import (
        InputValidator,
        ValidationError,
        validate_email,
        validate_phone,
...
class SecurityManager:
    ...
    Usage:
        from education_system.systems.university.infrastructure.security.security_integration import SecurityManager
