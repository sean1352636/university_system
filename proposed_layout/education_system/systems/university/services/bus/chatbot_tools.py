...
def tool_schedule_exam(*, module_code: str, date: str,
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.exam_management.models import (
            Exam,
        )
        from education_system.systems.university.interfaces.gui.academics.exam_management.data_manager import (
            ExamDataManager,
        )
        exam = Exam(
            id=0,
...
def tool_my_engagements(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.systems.university.services.bus.careers_bus import (
            list_engagements,
        )
...
def tool_my_trips(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.systems.university.services.bus.trip_bus import (
...
def tool_my_parking(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.systems.university.services.bus.parking_bus import (
...
def tool_todays_menu() -> dict[str, Any]:
    ...
    try:
        from education_system.systems.university.services.bus.restaurant_bus import (
            menu_for,
        )
...
def tool_email_prefs(user_id: str | int) -> dict[str, Any]:
    ...
    try:
        from education_system.systems.university.services.bus.email_bus import (
            get_prefs,
        )
