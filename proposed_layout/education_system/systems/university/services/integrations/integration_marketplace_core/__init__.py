...
from education_system.systems.university.services.integrations.integration_marketplace_core._imports import get_connection

# Core manager classes
from education_system.systems.university.services.integrations.integration_marketplace_core.catalog import IntegrationCatalogManager
from education_system.systems.university.services.integrations.integration_marketplace_core.installation import InstallationManager
from education_system.systems.university.services.integrations.integration_marketplace_core.credentials import CredentialManager
from education_system.systems.university.services.integrations.integration_marketplace_core.sync import SyncManager
from education_system.systems.university.services.integrations.integration_marketplace_core.data_mapping import DataMappingManager
from education_system.systems.university.services.integrations.integration_marketplace_core.webhooks import WebhookManager

# Feature manager classes
from education_system.systems.university.services.integrations.integration_marketplace_core.search_discovery import SearchDiscoveryManager
from education_system.systems.university.services.integrations.integration_marketplace_core.bulk_operations import BulkOperationsManager
from education_system.systems.university.services.integrations.integration_marketplace_core.import_export import ImportExportManager
from education_system.systems.university.services.integrations.integration_marketplace_core.reports import ReportsDashboardManager
from education_system.systems.university.services.integrations.integration_marketplace_core.security import SecurityCredentialsManager
from education_system.systems.university.services.integrations.integration_marketplace_core.scheduling import SchedulingManager
from education_system.systems.university.services.integrations.integration_marketplace_core.validation import ValidationTestingManager
from education_system.systems.university.services.integrations.integration_marketplace_core.mapping_tools import DataMappingToolsManager
from education_system.systems.university.services.integrations.integration_marketplace_core.notifications import NotificationsAlertManager
...
# Menu & GUI
from education_system.systems.university.services.integrations.integration_marketplace_core.menu import display_integration_marketplace_menu, launch_integration_marketplace_gui
