...
try:
    from education_system.systems.university.interfaces.gui.pastoral.student_union_gui import StudentUnionGUI
...
# Import CLI fallback
try:
    from education_system.systems.university.domain.pastoral.student_life.student_union import display_student_union_menu
except ImportError:
...
try:
    from education_system.systems.university.infrastructure.paths import PROJECT_ROOT, DEFAULT_DB_PATH
except ImportError:
