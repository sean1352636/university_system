...
from education_system.systems.university.domain.pastoral.health.records.clinical.lab_results import (
    recent_lab_results_dashboard,
)
from education_system.systems.university.domain.pastoral.health.records.vaccinations.tracking import (
...
from education_system.systems.university.domain.pastoral.health.records.screening.results import (
    record_screening_results,
)
from education_system.systems.university.domain.pastoral.health.records.screening.reminders import (
    screening_reminders,
    population_screening_reports,
)
from education_system.systems.university.domain.pastoral.health.records.screening.guidelines import (
