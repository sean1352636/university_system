...
def main_menu():
    ...
    from education_system.systems.university.interfaces.gui.pastoral.student_union_gui.misc import launch_student_union_gui
    try:
...
def launch_cli():
    ...
    if CLI_AVAILABLE:
        try:
            from education_system.systems.university.domain.pastoral.student_life.student_union.administration.student_union_core import main as cli_main
            cli_main()
        except ImportError:
            print("Error: Cannot import CLI system")
    else:
...
if __name__ == "__main__":
    from education_system.systems.university.interfaces.gui.pastoral.student_union_gui.misc import main
    main()
