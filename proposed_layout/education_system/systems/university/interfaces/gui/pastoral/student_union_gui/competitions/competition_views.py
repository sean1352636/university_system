...
class CompetitionsDialog:
    ...
    def register_competition(self):
        ...
        from education_system.systems.university.interfaces.gui.pastoral.student_union_gui.competitions.competition_registration import CompetitionRegistrationDialog
