...
from tkinter import Toplevel, Label, Entry, Button, Frame, StringVar, ttk
...
try:
    from education_system.systems.university.infrastructure.i18n import get_text as _t_real
except Exception:
    def _t_real(key, **kw):
