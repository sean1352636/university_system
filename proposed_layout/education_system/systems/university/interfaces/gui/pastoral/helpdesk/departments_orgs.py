...
def _show_template_form(self, tree):
    ...
    def save():
        ...
        try:
            ...
            cursor = conn.cursor()
            cursor.execute("""
                INSERT INTO ticket_templates (name, category, subject_template, message_template,
...
def load_templates_list(self, tree):
    ...
    try:
        ...
        cursor.execute('''
            SELECT template_id, name, category, priority, default_impact,
        ...
        try:
            ...
            cursor.execute('''
                ...
                (name, description, category, subject_template, message_template,
                 priority, default_impact, default_urgency, created_by, created_at)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', (
                name,
            ...
            try:
                ...
                cursor.execute('''
                    ...
                    SET name = ?, description = ?, category = ?, subject_template = ?,
                        message_template = ?, priority = ?, default_impact = ?,
                        default_urgency = ?
                    WHERE template_id = ?
                ''', (
                    name,
