...
try:
    from education_system.systems.university.infrastructure.email.email_service import send_email as _send_email
except Exception:
...
class PaymentRecordingMixin:
    ...
    def view_payment_details(self):
        ...
        from education_system.systems.university.interfaces.gui.finance.finance.invoice_manager import PaymentDetailsDialog
