...
Usage:
    from education_system.systems.university.interfaces.gui.finance.financial_aid import FinancialAidGUI
...
from education_system.systems.university.interfaces.gui.finance.financial_aid.financial_aid_gui import FinancialAidGUI
