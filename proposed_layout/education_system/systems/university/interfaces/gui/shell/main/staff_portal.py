...
class StaffPortalGUI:
    ...
    def _build_sidebar(self):
        ...
        self._add_button("Course Catalog", self._open_course_catalog)
        self._add_button("TA Management", self._open_ta_management)
        ...
        self._add_button("UCAS Management", self._launch('show_ucas_management_gui'))
    ...
    def _open_grade_tracking_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.academics.grade_tracking.grade_tracking_app import (
                GradeTrackingApp,
            )
    ...
    def _open_assignments_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.academics.assignment_system.assignment_gui import (
    ...
    def _open_auto_grading_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.academics.assignment_system.auto_grading_portal import (
    ...
    def _open_course_catalog(self):
        try:
            from education_system.systems.university.interfaces.gui.academics.course_catalog.course_catalog_gui import (
                CourseCatalogGUI,
            )
            CourseCatalogGUI(self.root, auth=self.auth)
        except Exception as e:
            logger.error(f"Error opening course catalog: {e}")
            messagebox.showerror("Error", f"Failed to open Course Catalog: {e}")

    def _open_ta_management(self):
        try:
            ...
            gui = AssignmentGUI(AssignmentSubmission(), self.auth,
                                parent=tk.Toplevel(self.root))
            gui.show_ta_management()
        except Exception as e:
            logger.error(f"Error opening TA management: {e}")
            messagebox.showerror("Error", f"Failed to open TA Management: {e}")

    def _open_library_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.academics.library.base import (
                LibraryGUI,
            )
    ...
    def _open_health_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.pastoral.health.health_portal.main import (
                HealthPortalGUI,
            )
    ...
    def _open_student_union_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.pastoral.student_union_gui import (
                StudentUnionGUI,
            )
    ...
    def _open_campus_events_portal(self):
        # Delegate to the main launcher so the workspace embed path
        # (8.117.54) is used; falls back to Toplevel internally.
        try:
    ...
    def _open_cafe_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.operations.commerce.cafe_system_gui import (
                CafeSystemGUI,
            )
    ...
    def _open_bar_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.operations.commerce.bar_gui import (
                BarGUI,
            )
    ...
    def _open_takeaway_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.operations.commerce.takeaway_gui import (
                TakeawayGUI,
            )
    ...
    def _open_cinema_portal(self):
        try:
            from education_system.systems.university.interfaces.gui.operations.commerce.cinema.cinema_gui import (
                CinemaApp,
            )
    ...
    def _open_alumni(self):
        try:
            from education_system.systems.university.interfaces.gui.learners.alumni.main_gui import (
                AlumniGUIApp,
            )
    ...
    def _get_backend_gui(self):
        ...
        if not hasattr(self, '_backend_gui'):
            from education_system.systems.university.interfaces.gui.shell.main.main_gui import UnifiedManagementGUI
            ...
            try:
                from education_system.systems.university.interfaces.gui.shell.main import main_gui as _mg
    ...
    def _show_dashboard(self):
        ...
        try:
            ...
            # Announcements posted via the Communications (Email) GUI.
            try:
                ...
                create_announcements_panel(self.content_frame, self.auth,
                                           limit=5, padx=30)
            except Exception as e:
