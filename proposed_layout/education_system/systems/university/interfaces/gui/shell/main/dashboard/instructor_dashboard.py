...
def _launch_roster(parent, auth):
    ...
    from education_system.systems.university.interfaces.gui.academics.roster_viewer.roster_gui import ClassRosterGUI
    ClassRosterGUI(parent, auth=auth)


def _launch_bulk_grade(parent, auth):
    """Launch Bulk Grade Import."""
    from education_system.systems.university.interfaces.gui.academics.bulk_grade_import.bulk_grade_gui import BulkGradeImportGUI
    BulkGradeImportGUI(parent, auth=auth)


def _launch_messaging(parent, auth):
    """Launch Course Messaging."""
    from education_system.systems.university.interfaces.gui.academics.course_messaging.messaging_gui import CourseMessagingGUI
    CourseMessagingGUI(parent, auth=auth)


def _launch_attendance_grade(parent, auth):
    """Launch Attendance-Grade Config."""
    from education_system.systems.university.interfaces.gui.academics.attendance_grade.attendance_grade_gui import AttendanceGradeConfigGUI
...
def _launch_semester_analytics(parent, auth):
    ...
    from education_system.systems.university.interfaces.gui.academics.semester_analytics.semester_analytics_gui import SemesterAnalyticsGUI
