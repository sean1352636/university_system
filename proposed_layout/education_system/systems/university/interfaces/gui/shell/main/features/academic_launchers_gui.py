...
try:
    from education_system.systems.university.interfaces.gui.shell.pdf_export_gui import show_pdf_export_gui as _pdf_export_gui_func
    ...
    try:
        if MODULE_SCHEDULING_GUI_AVAILABLE and ModuleSchedulingGUI:
            ...
            try:
                ...
                from education_system.systems.university.domain.academics.services.module_scheduling import display_enhanced_scheduling_menu
...
def show_plagiarism_checker(self):
    ...
    try:
        ...
        from education_system.systems.university.interfaces.gui.academics.plagiarism_main_gui import launch_gui_from_main_system
...
def open_absence_tracker_gui(self):
    ...
    try:
        python = sys.executable
        cmd = [python, "-m",
               "education_system.systems.university.domain.academics.services.attendance.absence_tracking.absence_tracker"]
...
def show_virtual_classroom_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.virtual_classroom_gui import VirtualClassroomGUI
...
def show_exam_scheduler_gui(self):
    ...
    try:
        ...
        if role == 'student':
            ...
            from education_system.systems.university.interfaces.gui.academics.exam_management import StudentExamViewer
...
def show_exam_portal(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.exam_management import ExamPortalGUI
        window = tk.Toplevel(self.root)
        _install_clean_close(window)
...
def show_hesa_export_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.governance.compliance.hesa_export.hesa_export_gui import HESAExportGUI
    except ImportError as e:
...
def show_clearing_adjustment_gui(self):
    ...
    Toplevel otherwise — same pattern as Student Records (8.117.38)."""
    try:
        from education_system.systems.university.interfaces.gui.admissions.clearing_adjustment.clearing_adjustment_gui import ClearingAdjustmentGUI
    except ImportError as e:
...
def show_prior_learning_gui(self):
    ...
    tab accordingly."""
    try:
        from education_system.systems.university.interfaces.gui.admissions.prior_learning_recognition.prior_learning_gui import PriorLearningGUI
        from education_system.systems.university.interfaces.gui.shell.main.features.academic_link_bar import (
            consume_context as _consume,
        )
    except ImportError as e:
...
def show_mitigating_circumstances_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.assessment.mitigating_circumstances.mitigating_circumstances_gui import MitigatingCircumstancesGUI
    except ImportError as e:
