...
def show_ai_study_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.ai_study.ai_study_gui import AIStudyGUI
    except ImportError as e:
...
def show_budget_tracker_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.finance.budget.budget_gui import BudgetTrackerGUI
...
def show_student_jobs_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.pastoral.student_jobs.jobs_gui import StudentJobsGUI
        from education_system.systems.university.infrastructure.shared_context import get_auth
        auth = get_auth()
...
def show_study_matching_gui(self):
    ...
    (8.117.38)."""
    try:
        from education_system.systems.university.interfaces.gui.academics.study_matching.study_matching_gui import StudyMatchingGUI
...
def show_lost_found_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.operations.campus.lost_found.lost_found_gui import LostFoundGUI
...
def show_marketplace_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.operations.commerce.marketplace.marketplace_gui import MarketplaceGUI
...
def show_events_discovery_gui(self):
    ...
    try:
        import tkinter as tk
        from education_system.systems.university.interfaces.gui.pastoral.student_life.events.events_gui import EventsGUI
        # Create a new Toplevel window
        window = tk.Toplevel(self.root)
        _install_clean_close(window)
...
def show_social_matching_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.pastoral.social_matching.social_matching_gui import SocialMatchingGUI
...
def show_feedback_system_gui(self):
    ...
    otherwise — same pattern as Student Records (8.117.38)."""
    try:
        from education_system.systems.university.interfaces.gui.operations.communications.feedback.feedback_gui import FeedbackGUI
    except ImportError as e:
...
def show_visa_compliance_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.governance.compliance.international_compliance.visa_compliance_gui import VisaComplianceGUI
...
def show_qa_dashboard_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.research.external_quality_assurance.qa_dashboard_gui import QADashboardGUI
...
def show_todo_app_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.shell.tools.todo_app_gui import TodoApp
        window = tk.Toplevel(self.root)
        _install_clean_close(window)
...
def show_student_app_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.pastoral.student_app.student_app_gui import StudentAppGUI
...
def show_achievement_badge_gui(self):
    ...
    try:
        from education_system.systems.university.interfaces.gui.pastoral.achievement_badges.achievement_badge_gui import AchievementBadgeGUI
...
def show_study_recommendations_gui(self):
    ...
    otherwise — same pattern as Student Records (8.117.38)."""
    try:
        from education_system.systems.university.interfaces.gui.academics.study_recommendations.study_recommendation_gui import StudyRecommendationGUI
    except ImportError as e:
