...
try:
    from education_system.systems.university.infrastructure.database.db import DatabaseManager as InfraDBManager, get_connection
...
class DocumentDatabaseManager:
    ...
    def insert_default_data(self, cursor):
        ...
        if cursor.fetchone()[0] == 0:
            ...
            from education_system.systems.university.infrastructure.defaults import DEFAULT_ADMIN_PASSWORD
