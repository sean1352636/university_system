...
# Email-sending helpers (guarded: set to None if the service is unavailable).
# The dialog handlers below check `if <func> is not None:` before calling.
try:
...
try:
    ...
    send_schedule_change_notification = None
