...
try:
    from education_system.systems.university.interfaces.gui.shell.email.email_gui.email_manager_main import (
...
# Import config
try:
    from education_system.systems.university.interfaces.gui.shell.email.email_gui.email_manager_main import config
except ImportError:
    config = {}
