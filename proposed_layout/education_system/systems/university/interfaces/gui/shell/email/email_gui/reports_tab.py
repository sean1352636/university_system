...
from education_system.systems.university.interfaces.gui.shell.email.email_gui.email_manager_main import EmailManagerGUI, get_stored_emails
...
try:
    from education_system.systems.university.infrastructure.email.reports import get_user_communication_stats
except ImportError:
