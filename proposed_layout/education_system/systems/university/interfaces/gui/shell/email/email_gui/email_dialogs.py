...
from education_system.systems.university.infrastructure.utils.config import config, save_config, test_email_configuration
from education_system.systems.university.infrastructure.email.email_db_utilities import execute_db_operation
from education_system.systems.university.infrastructure.email.template_utils import create_template
...
try:
    from education_system.systems.university.infrastructure.email.template_utils import list_templates, load_template
except ImportError:
    pass
...
class TemplateManagerDialog:
    ...
    def delete_selected_template(self):
        ...
        if messagebox.askyesno("Confirm Delete", f"Are you sure you want to delete the template '{template_name}'?"):
            try:
                from education_system.systems.university.infrastructure.email.template_utils import delete_template
...
class TemplateEditDialog:
    ...
    def load_template_data(self):
        ...
        try:
            from education_system.systems.university.infrastructure.email.template_utils import load_template
    ...
    def save_template(self):
        ...
        try:
            if self.template_name:
                ...
                from education_system.systems.university.infrastructure.email.template_utils import update_template
