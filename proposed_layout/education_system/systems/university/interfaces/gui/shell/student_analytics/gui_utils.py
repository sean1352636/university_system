...
class GUIUtilsMixin:
    ...
    def show_filters_dialog(self):
        ...
        from education_system.systems.university.interfaces.gui.shell.student_analytics.dialogs import FilterDialog
    ...
    def show_custom_report_dialog(self):
        ...
        from education_system.systems.university.interfaces.gui.shell.student_analytics.dialogs import CustomReportDialog
        dialog = CustomReportDialog(self.root, self.analytics)
        self.root.wait_window(dialog.dialog)

    def show_config_dialog(self):
        """Show configuration dialog"""
        from education_system.systems.university.interfaces.gui.shell.student_analytics.dialogs import ConfigDialog
