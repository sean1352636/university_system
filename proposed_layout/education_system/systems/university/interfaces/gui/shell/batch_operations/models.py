...
try:
    from education_system.systems.university.infrastructure.utils.batch_operations import BatchOperationManager as OriginalBatchOperationManager
    from education_system.systems.university.infrastructure.utils.batch_operations import ImportResult, ProgressTracker
except ImportError:
    ...
    class OriginalBatchOperationManager:
        ...
        def display_batch_menu(self):
            ...
            try:
                ...
                from education_system.systems.university.infrastructure.utils.batch_operations import (
                ...
                print("  from education_system.systems.university.interfaces.gui.shell.batch_operations_gui import BatchOperationsGUI")
                print("\n" + "="*60)
