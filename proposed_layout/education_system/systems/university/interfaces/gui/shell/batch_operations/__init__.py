...
from education_system.systems.university.interfaces.gui.shell.batch_operations.main_gui import (
    BatchOperationsGUI,
)
from education_system.systems.university.interfaces.gui.shell.batch_operations.backend import (
    EnhancedBatchOperationManager,
    main,
)
from education_system.systems.university.interfaces.gui.shell.batch_operations.models import (
    ImportResult,
    ProgressTracker,
    OriginalBatchOperationManager,
)
from education_system.systems.university.interfaces.gui.shell.batch_operations.progress_dialog import (
    GUIProgressDialog,
)
