...
try:
    ...
    raise ImportError(
        ...
        "education_system.systems.university.infrastructure.paths"
    ) from exc

try:
    from education_system.systems.university.infrastructure.database.db import get_db_connection, sqlite3
