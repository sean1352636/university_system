...
try:
    ...
    from education_system.systems.university.infrastructure.utils.gui_context import get_gui_context
...
def load_active_assignments_for_payment(gui_instance):
    ...
    from education_system.systems.university.interfaces.gui.operations.campus.housing.housing_accommodation_gui.assignment_manager import load_active_assignments
