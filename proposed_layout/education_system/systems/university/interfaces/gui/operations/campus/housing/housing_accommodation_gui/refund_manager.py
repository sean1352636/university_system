...
try:
    from education_system.systems.university.infrastructure.activity_logger import log_dynamic_activity
except ImportError:
...
def _notify_finance_for_housing_refund(self, student_id: str, amount: float, method: str, refund_ref: str):
        ...
        try:
            from education_system.systems.university.infrastructure.database.db import transaction as db_transaction
            from datetime import datetime
