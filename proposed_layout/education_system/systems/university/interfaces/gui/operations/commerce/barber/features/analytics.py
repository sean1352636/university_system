...
class AnalyticsMixin:
    ...
    def schedule_automated_reports(self):
        ...
        try:
            from education_system.systems.university.domain.operations.commerce.barber.services.barber_core import ScheduledReportManager
    ...
    def view_audit_log(self):
        ...
        def load_log():
            for item in tree.get_children():
                tree.delete(item)
            try:
                from education_system.systems.university.domain.operations.commerce.barber.services.barber_core import AuditLogManager
