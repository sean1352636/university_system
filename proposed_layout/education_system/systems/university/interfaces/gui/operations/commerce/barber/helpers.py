...
class HelpersMixin:
    ...
    def _get_time_slots(self) -> list:
        ...
        from education_system.systems.university.domain.operations.commerce.barber.services.barber_core import TIME_SLOTS
        return TIME_SLOTS

    def _get_service_types(self) -> dict:
        """Get service types."""
        from education_system.systems.university.domain.operations.commerce.barber.services.barber_core import SERVICE_TYPES
    ...
    def _load_staff(self):
        ...
        try:
            from education_system.systems.university.domain.operations.commerce.barber.services.barber_core import StaffManager
    ...
    def _load_customers(self):
        ...
        try:
            from education_system.systems.university.domain.operations.commerce.barber.services.barber_core import CustomerManager
