...
``integrate_gui_with_main``) so the canonical import is:
    ...
    from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui \\
...
from education_system.systems.university.interfaces.gui.operations.commerce.shop_management_gui.main_gui import (
    UniversityShopGUI,
