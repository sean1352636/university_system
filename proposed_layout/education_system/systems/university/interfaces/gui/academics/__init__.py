...
_LAZY = {
    'launch_blockchain_credentials_gui': (
        'education_system.systems.university.interfaces.gui.academics.blockchain_credentials_gui',
        'launch_blockchain_credentials_gui',
    ),
    'GradeTrackingManagementGUI': (
        'education_system.systems.university.interfaces.gui.academics.grade_tracking_management_gui',
        'GradeTrackingManagementGUI',
    ),
    'CalendarGUI': (
        'education_system.systems.university.interfaces.gui.academics.academic_calendar.main_gui',
        'CalendarGUI',
    ),
    'ai_detector_gui': (
