...
from education_system.systems.university.interfaces.gui.academics.attendance_tracker import dashboard_tab
from education_system.systems.university.interfaces.gui.academics.attendance_tracker import attendance_tab
from education_system.systems.university.interfaces.gui.academics.attendance_tracker import students_tab
from education_system.systems.university.interfaces.gui.academics.attendance_tracker import reports_tab
from education_system.systems.university.interfaces.gui.academics.attendance_tracker import analytics_tab
from education_system.systems.university.interfaces.gui.academics.attendance_tracker import settings_admin_tabs
from education_system.systems.university.interfaces.gui.academics.attendance_tracker import misc_tab

# Import window classes
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.attendance_windows import (
    ManualAttendanceWindow, BatchAttendanceWindow, EditAttendanceWindow, StudentAddWindow
)
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.qr_windows import QRAttendanceWindow, QRGeneratorWindow
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.face_recognition_windows import (
    FaceRecognitionAttendanceWindow, FaceRecognitionWindow
)
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.admin_windows import APIManagementWindow, AuditLogsViewer, SystemDiagnosticsWindow
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.backup_database_windows import (
    BackupRecoveryWindow, BackupSettingsDialog, DatabaseMaintenanceWindow
)
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.alerts_predictive_windows import (
    AlertsWindow, CreateAlertDialog, AlertDetailsWindow,
    PredictiveAnalyticsWindow, SinglePredictionDialog
)
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.notifications_windows import (
    ParentNotificationWindow, ParentContactDialog, NotificationSettingsWindow
)
from education_system.systems.university.interfaces.gui.academics.attendance_tracker.misc_windows import (
