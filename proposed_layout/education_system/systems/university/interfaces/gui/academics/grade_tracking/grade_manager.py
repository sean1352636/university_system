...
class GradeManager:
    ...
    def add_grade_dialog(self, prefill_student_id=None,
        ...
        def on_student_selected(event=None):
            ...
            try:
                ...
                if not all_items:
                    status_var.set("No submissions or assessments found for this student")
                    return
    ...
    def calculate_all_gpas(self):
        ...
        try:
            ...
            from education_system.systems.university.interfaces.gui.academics.grade_tracking.integrations import (
                push_grade_kpi,
                notify_aid_of_gpa,
            )
    ...
    def _open_exam_results_for_grade(self, student_grades_id: int):
        ...
        try:
            from education_system.systems.university.interfaces.gui.academics.exam_management.models import Exam
            from education_system.systems.university.interfaces.gui.academics.exam_management.data_manager import DataManager
            from education_system.systems.university.interfaces.gui.academics.exam_management.tabs.results_tab import ResultsEntryDialog
