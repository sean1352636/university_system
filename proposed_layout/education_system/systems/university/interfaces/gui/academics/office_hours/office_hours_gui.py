...
class OfficeHoursGUI:
    ...
    def _setup_ui(self):
        ...
        from education_system.systems.university.interfaces.gui.academics.office_hours.booking_manager import (
            BookingManager,
        )

        if role in ('admin', 'instructor', 'staff'):
            from education_system.systems.university.interfaces.gui.academics.office_hours.instructor_manager import (
                InstructorManager,
            )
