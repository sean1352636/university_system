...
from education_system.systems.university.interfaces.gui.academics.academic_calendar.utils import safe_show_warning

gui_logger = logging.getLogger(__name__)

# Lazy imports to avoid circular dependency
def _get_edit_event_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_event import EditEventDialog
    return EditEventDialog

def _get_event_details_dialog():
    from education_system.systems.university.interfaces.gui.academics.academic_calendar.dialogs_event import EventDetailsDialog
...
class EventsViewMixin:
    ...
    def _create_events_context_menu(self):
        ...
        def show_context_menu(event):
            try:
                ...
                # row-aware portion.
                try:
                    from education_system.systems.university.interfaces.gui.academics.academic_calendar._cross_links import (
    ...
    def _launch_email_reminder_dialog(self, event_name, event_date, event_type, description):
        ...
        try:
            ...
            from education_system.systems.university.interfaces.gui.shell.email.email_manager_gui import EmailManagerGUI
...
Academic Calendar System"""
    ...
    def _open_event_chat(self):
        ...
        try:
            ...
            from education_system.systems.university.interfaces.gui.shell.email.email_gui.chat_launchers import (
                open_chat_for_event,
            )
        except Exception as e:
            from tkinter import messagebox
