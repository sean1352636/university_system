...
def _get_degree_audit_cls():
    ...
    if _degree_audit_cls is None:
        from education_system.systems.university.interfaces.gui.academics.course_management_gui.degree_audit_gui import DegreeAuditGUI
...
def _get_course_eval_cls():
    ...
    if _course_eval_cls is None:
        from education_system.systems.university.interfaces.gui.academics.course_management_gui.course_evaluation_gui import CourseEvaluationGUI
