...
from education_system.systems.university.domain.academics.services.evaluation.course_evaluation_core import (
    EvaluationTemplateManager,
    CourseEvaluationManager,
    ResponseManager,
    ResultsAnalyticsManager
)
from education_system.systems.university.domain.academics.services.evaluation.db_schema import initialize_evaluation_database
...
class CourseEvaluationGUI:
    ...
    def open_operations(self):
        ...
        try:
            from education_system.systems.university.interfaces.gui.academics.course_management_gui.course_evaluation_operations import (
    ...
    def open_survey_designer(self):
        ...
        try:
            from education_system.systems.university.interfaces.gui.academics.course_management_gui.course_evaluation_designer import (
