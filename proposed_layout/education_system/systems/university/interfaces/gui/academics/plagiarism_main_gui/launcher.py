...
def launch_gui_from_main_system(auth=None):
    ...
    try:
        from education_system.systems.university.interfaces.gui.academics.plagiarism_main_gui.main_gui import PlagiarismCheckerGUI
...
def run_gui_tests():
    ...
    try:
        ...
        from education_system.systems.university.interfaces.gui.academics.plagiarism_main_gui.common import StatusBar, ScrollableFrame
        test_root = tk.Tk()
        test_root.withdraw()
