...
from education_system.systems.university.interfaces.gui.academics.plagiarism_main_gui.common import get_authenticated_user_auth, PlagiarismCheckerError, logger
