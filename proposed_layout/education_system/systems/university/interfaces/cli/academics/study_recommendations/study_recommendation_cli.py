...
def display_study_recommendation_menu(auth):
    from education_system.systems.university.domain.academics.study_recommendations.services.study_recommendation_service import StudyRecommendationService
