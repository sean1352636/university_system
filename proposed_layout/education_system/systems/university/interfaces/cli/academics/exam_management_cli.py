...
from education_system.systems.university.domain.academics.services.exam_management import ExamPortalService
from education_system.systems.university.interfaces.cli.academics.exam_seating_cli import (
