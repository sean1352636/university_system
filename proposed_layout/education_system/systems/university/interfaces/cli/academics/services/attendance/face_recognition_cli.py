...
from education_system.systems.university.domain.academics.services.attendance.records import get_modules
from education_system.systems.university.domain.academics.services.attendance.face_recognition_system import FACE_RECOGNITION_SUPPORT
