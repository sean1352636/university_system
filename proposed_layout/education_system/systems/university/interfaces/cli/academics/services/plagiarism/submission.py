import os
from education_system.systems.university.domain.academics.services.plagiarism.exceptions import PlagiarismCheckerError, FileProcessingError
        ...
        try:
            ...
            if auth.check_permission('check_plagiarism'):
                ...
                if check_now == 'y':
                    ...
                    try:
                        from education_system.systems.university.interfaces.cli.academics.services.plagiarism.reporting import display_check_result
        ...
        if view_choice:
            try:
                ...
                if 1 <= view_num <= len(documents):
                    from education_system.systems.university.interfaces.cli.academics.services.plagiarism.reporting import display_document_details
