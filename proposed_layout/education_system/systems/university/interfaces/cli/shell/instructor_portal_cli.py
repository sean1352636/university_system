...
class InstructorPortalCLI:
    ...
    def _handle_module_management(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_module_management_menu
    ...
    def _handle_assignments(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_assignments_menu
    ...
    def _handle_virtual_classroom(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_virtual_classroom_menu
    ...
    def _handle_student_analytics(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_student_analytics_menu
    ...
    def _handle_learning_outcomes(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_learning_outcomes_menu
    ...
    def _handle_early_warning(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_early_warning_menu
    ...
    def _handle_attendance(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_attendance_menu
    ...
    def _handle_exam_scheduler(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_exam_scheduler_menu
    ...
    def _handle_analytics_reports(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_analytics_reports_menu
    ...
    def _handle_export_data(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_export_data_menu
