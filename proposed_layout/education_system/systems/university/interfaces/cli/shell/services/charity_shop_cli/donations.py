...
def generate_donation_receipt(donation_id: int) -> Optional[Dict]:
    ...
    return {
        ...
        'organization': os.getenv('CHARITY_ORG_NAME', 'University Charity Shop'),
        # Sourced from config/env; empty when unconfigured rather than a fake ID.
        'tax_id': os.getenv('CHARITY_TAX_ID', ''),
