...
Usage:
    from education_system.systems.university.interfaces.cli.shell.services import health_portal
    from education_system.systems.university.interfaces.cli.shell.services import library
    from education_system.systems.university.interfaces.cli.shell.services import betting_shop_cli
"""

# Import all CLI services
try:
    from education_system.systems.university.interfaces.cli.shell.services.health_portal import (
...
try:
    from education_system.systems.university.interfaces.cli.shell.services import betting_shop_cli
    from education_system.systems.university.interfaces.cli.shell.services import butcher_cli
    ...
    from education_system.systems.university.interfaces.cli.shell.services import cinema_cli
