...
from education_system.systems.university.infrastructure import defaults
...
# Database utilities
from education_system.systems.university.infrastructure.database.database_utils import cleanup_database_connections
...
# Assignment system
from education_system.systems.university.domain.academics.services.assignments.assignment_submission import (
...
# Security Desk CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.security_desk_cli import security_desk_menu
...
# To-Do List CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.todo_cli import todo_menu
    TODO_AVAILABLE = True
except ImportError as e:
    todo_menu = None
...
try:
    from education_system.systems.university.interfaces.cli.shell.services.church_cli import church_menu
...
# Police Station CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.police_station_cli import police_station_menu
...
# Taxi Booking CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.taxi_booking_cli import taxi_booking_menu
...
# Train Station CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.train_station_cli import train_station_menu
...
# Legal Services CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.legal_services_cli import legal_services_menu
...
try:
    from education_system.systems.university.interfaces.cli.governance.legal.information_rights.information_rights_cli import (  # noqa: E501
...
# Car Rental CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.carrental_cli import carrental_menu
...
try:
    from education_system.systems.university.interfaces.cli.shell.services.equipment_rental_cli import equipment_rental_menu
...
# Phone Shop CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.phone_shop_cli import phone_shop_menu
...
# Music Shop CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.music_shop_cli import music_shop_menu
...
# Bar CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.bar_cli import bar_menu
    BAR_AVAILABLE = True
except ImportError as e:
    bar_menu = None
    BAR_AVAILABLE = False
...
# Betting Shop CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.betting_shop_cli import launch_betting_shop_cli
...
# Butcher Shop CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.butcher_cli import launch_butcher_cli
...
# Barber Shop CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.barber_cli import launch_barber_cli
...
# Nail Bar CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.nailbar_cli import launch_nailbar_cli
...
# Cinema CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.cinema_cli import launch_cinema_cli
...
try:
    from education_system.systems.university.interfaces.cli.shell.services.medical_accommodation_cli import launch_medical_accommodation_cli
...
# Degree Audit CLI
try:
    from education_system.systems.university.interfaces.gui.academics.course_management_gui.cli.degree_audit_cli import launch_degree_audit_cli
...
# Graduation Ceremony CLI
try:
    from education_system.systems.university.interfaces.cli.academics.graduation_ceremony_cli import launch_graduation_ceremony_cli
    GRADUATION_CEREMONY_CLI_AVAILABLE = True
except ImportError as e:
    launch_graduation_ceremony_cli = None
    GRADUATION_CEREMONY_CLI_AVAILABLE = False
    logger.warning(f"Graduation Ceremony CLI not available: {e}")

# Mail/Post CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.mail_post_cli import mail_post_menu
...
# Gym CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.gym_cli import gym_menu
    GYM_AVAILABLE = True
except ImportError as e:
    gym_menu = None
    GYM_AVAILABLE = False
...
from education_system.systems.university.infrastructure.shared_context import get_auth, set_auth
...
try:
    from education_system.systems.university.infrastructure.security.security_dashboard_cli import display_security_dashboard_menu
...
from education_system.systems.university.domain.pastoral.student_life.student_union.clubs import club_management as su_club
from education_system.systems.university.domain.pastoral.student_life.student_union.events import event_management as su_event
from education_system.systems.university.domain.pastoral.student_life.student_union.facilities import facility_management as su_fac
from education_system.systems.university.domain.pastoral.student_life.student_union.administration import (
    admin_management as su_admin,
    finance_oversight as su_fin,
    student_union_core,
)
from education_system.systems.university.domain.pastoral.student_life.student_union.elections import election_management as su_elec
...
# Course Management
from education_system.systems.university.domain.academics.services.course_management import display_course_management_menu

# Log Management
from education_system.systems.university.infrastructure.logging.log_management import display_log_management_menu

# Parent Portal
from education_system.systems.university.domain.academics.services.parent_portal import (
    ParentPortal,
...
# Charity Shop CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.charity_shop_cli import (
...
# Cafe System CLI
try:
    from education_system.systems.university.interfaces.cli.shell.services.cafe_system_cli import (
        init_cafe_db,
...
# Takeaway System
try:
    from education_system.systems.university.domain.operations.commerce.services.takeaway import (
        init_takeaway_db,
...
# Grocery Shop
try:
    from education_system.systems.university.domain.operations.commerce.services.grocery import (
        init_grocery_db,
...
def get_predictive_analytics():
    ...
    try:
        from education_system.systems.university.services.analytics.predictive_analytics_gui import PredictiveAnalyticsGUI
...
def get_business_intelligence():
    ...
    try:
        from education_system.systems.university.services.business_intelligence import display_business_intelligence_menu
...
def get_enhanced_menu():
    ...
    try:
        from education_system.systems.university.interfaces.gui.shell.advanced_search import display_enhanced_menu
