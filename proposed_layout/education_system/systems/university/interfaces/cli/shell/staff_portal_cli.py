...
class StaffPortalCLI:
    ...
    def _handle_student_records(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.student_operations import display_student_records_menu
    ...
    def _handle_create_student(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.student_operations import create_student_record
    ...
    def _handle_search_students(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.student_search import search_student_by_first_name
    ...
    def _handle_course_management(self):
        try:
            from education_system.systems.university.domain.academics.services.course_management.menu import display_course_management_menu
    ...
    def _handle_module_management(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.module_operations import display_module_management_menu
    ...
    def _handle_grade_tracking(self):
        try:
            from education_system.systems.university.interfaces.gui.academics.grade_tracking_management_gui import display_enhanced_grade_menu
    ...
    def _handle_academic_progress(self):
        try:
            from education_system.systems.university.interfaces.cli.assessment.academic_progress.progress_cli import AcademicProgressCLI
    ...
    def _handle_scheduling(self):
        try:
            from education_system.systems.university.domain.academics.services.module_scheduling.menus import display_module_scheduling_menu
    ...
    def _handle_staff_hr(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.imports import STAFF_HR_CLI_AVAILABLE, display_staff_hr_menu
    ...
    def _handle_finance_management(self):
        try:
            from education_system.systems.university.interfaces.gui.finance.finance_reporting.misc import display_finance_menu
    ...
    def _handle_financial_aid(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_financial_aid_menu
    ...
    def _handle_communication_hub(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.menu_router import display_communication_hub_menu
    ...
    def _handle_analytics(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.admin_tools import display_analytics_menu
    ...
    def _handle_export_data(self):
        try:
            from education_system.systems.university.interfaces.cli.shell.export_manager import display_export_menu
            display_export_menu()
        except ImportError as e:
    ...
    def _handle_university_shop(self):
        try:
            from education_system.systems.university.domain.operations.commerce.services.shop_management.menus import display_shop_menu
            display_shop_menu()
        except ImportError as e:
    ...
    def _handle_alumni_management(self):
        try:
            from education_system.systems.university.domain.learners.alumni import display_alumni_menu
            display_alumni_menu()
        except ImportError as e:
    ...
    def _handle_transfer_credits(self):
        try:
            from education_system.systems.university.interfaces.cli.academics.transfer_credits_cli import display_transfer_credits_menu
    ...
    def _handle_accreditation(self):
        try:
            from education_system.systems.university.interfaces.cli.academics.accreditation_cli import display_accreditation_menu
    ...
    def _handle_course_catalog(self):
        try:
            from education_system.systems.university.interfaces.cli.academics.course_catalog_cli import display_course_catalog_menu
    ...
    def main_menu(self):
        ...
        while True:
            ...
            print("    26. Accreditation")
            print("    27. Course Catalog")
