...
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.buildings import create_building, create_rooms_for_building, view_building, update_building, delete_building
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.applications import create_application, view_application, process_application
...
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.maintenance import create_maintenance_request, view_maintenance_requests, update_maintenance_request
...
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.deposits import (
    process_deposit_refund, view_deposit_ledger,
    student_review_deductions, resolve_deduction_disputes,
)
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.tdp import (
    record_deposit_protection, tdp_compliance_report,
)
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.interest import (
    accrue_deposit_interest, view_interest_accruals,
)
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.deposit_state import (
    view_deposit_state,
)
...
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.reports import display_reports_menu
from education_system.systems.university.domain.operations.campus.housing.services.housing_accommodation.extended_cli import display_extended_housing_menu
