...
def display_staff_management():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.operations.commerce.services.restaurant.menu.menu_management import staff_analytics
            staff_analytics()
        elif choice == '9':
            return
        else:
...
def staff_performance():
    ...
    try:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.operations.commerce.services.restaurant.menu.menu_management import performance_analytics
