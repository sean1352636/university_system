...
#
#     from education_system.systems.university.domain.operations.commerce.services.shop_management \
...
from education_system.systems.university.domain.operations.commerce.services.shop_management.config import (
    auth,
    set_auth,
    format_currency,
    calculate_tax,
...
from education_system.systems.university.domain.operations.commerce.services.shop_management.database import (
    init_shop_db,
...
from education_system.systems.university.domain.operations.commerce.services.shop_management.shopping import (
    browse_products,
...
from education_system.systems.university.domain.operations.commerce.services.shop_management.products import (
    add_new_product,
    edit_product,
...
from education_system.systems.university.domain.operations.commerce.services.shop_management.inventory import (
    update_stock_levels,
    restock_products,
...
from education_system.systems.university.domain.operations.commerce.services.shop_management.discounts import (
    create_discount,
    edit_discount,
...
from education_system.systems.university.domain.operations.commerce.services.shop_management.analytics import (
    get_customer_analytics,
    display_customer_analytics,
)

from education_system.systems.university.domain.operations.commerce.services.shop_management.receipts import (
    generate_pdf_receipt,
    generate_barcode,
    print_product_labels,
)

from education_system.systems.university.domain.operations.commerce.services.shop_management.utils import (
    log_shop_activity,
