...
def display_main_menu(auth=None):
    ...
    try:
        ...
        from education_system.systems.university.domain.operations.commerce.services.restaurant.operations.restaurant_core import display_main_menu as display_restaurant_menu
