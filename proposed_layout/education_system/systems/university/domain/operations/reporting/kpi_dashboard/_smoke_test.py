...
Not part of the pytest suite — run directly:
    python -m \
      education_system.systems.university.domain.operations.reporting.kpi_dashboard._smoke_test
"""
...
from education_system.systems.university.domain.operations.reporting.kpi_dashboard.services.kpi_dashboard_service import (  # noqa: E402
    KpiDashboardError,
    KpiDashboardService,
)
