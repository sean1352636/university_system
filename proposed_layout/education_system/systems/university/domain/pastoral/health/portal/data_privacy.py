...
from education_system.systems.university.domain.pastoral.health.services import get_connection

from education_system.systems.university.domain.pastoral.health.services import (
...
from education_system.systems.university.domain.pastoral.health.records.referrals.referrals import manage_referrals
from education_system.systems.university.domain.pastoral.health.records.records.templates import enhanced_health_record_templates
from education_system.systems.university.domain.pastoral.health.records.student.dashboard import student_health_dashboard
...
def population_risk_analysis(auth):
    ...
    for vaccine in critical_vaccines:
        ...
        if coverage < 70:
            print("  🔴 Low coverage - Priority intervention needed")
        elif coverage < 85:
            print("  🟡 Suboptimal - Targeted outreach recommended")
        else:
            print("  ✅ Good coverage")
