...
from education_system.systems.university.domain.pastoral.health.services import generate_disease_surveillance_report
from education_system.systems.university.domain.pastoral.health.records.analytics.population import generate_population_health_report, generate_student_health_summary_report
from education_system.systems.university.domain.pastoral.health.records.vaccinations.reports import generate_vaccination_analysis_report
...
def generate_health_report(auth):
    ...
    if selected_report == 'Population Health Statistics':
        ...
        from education_system.systems.university.domain.pastoral.health.appointments.appointment_booking import generate_provider_utilization_report
        generate_provider_utilization_report(auth, start_date, end_date)
    elif selected_report == 'Quality Metrics Dashboard':
        from education_system.systems.university.domain.pastoral.health.records.quality_assurance import generate_quality_metrics_report
