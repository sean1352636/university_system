...
from education_system.systems.university.domain.pastoral.student_life.student_union.services.union_context import auto_award_points

logger = logging.getLogger(__name__)

def manage_peer_support_system():
    """Main peer support system interface"""
    from education_system.systems.university.domain.pastoral.student_life.student_union.administration.admin_management import (
