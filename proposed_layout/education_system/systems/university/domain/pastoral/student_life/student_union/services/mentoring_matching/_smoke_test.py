...
Run directly:
    /home/seancatchpole989/venv/bin/python -m education_system.systems.university.domain.pastoral.student_life.student_union.services.mentoring_matching._smoke_test
"""
import os
import sys
import tempfile

from education_system.systems.university.domain.pastoral.student_life.student_union.services.mentoring_matching import (
