...
from education_system.systems.university.infrastructure.exceptions import DatabaseError, ValidationError
    ...
    while True:
        try:
            ...
            if choice in ['1', '2', '3', '4', '5', '6', '7']:
                ...
                print("Use: from education_system.systems.university.domain.pastoral.services.career_services import JobManager")
            elif choice == '8':
                display_language_menu_option()
            elif choice == '9':
...
def __getattr__(name):
    if name == "launch_career_services_gui":
        from education_system.systems.university.interfaces.gui.pastoral.career_services.career_services_gui import (
