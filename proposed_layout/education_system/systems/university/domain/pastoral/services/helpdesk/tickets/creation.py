...
def create_ticket_with_details(auth, subject, message, category, priority, impact, urgency, subcategory=None):
    ...
    try:
        ...
        (user_id, assigned_to, subject, description, category, subcategory, status, priority,
        ...
        from education_system.systems.university.domain.pastoral.services.helpdesk.tickets.attachments import handle_file_attachments, suggest_knowledge_base_articles
