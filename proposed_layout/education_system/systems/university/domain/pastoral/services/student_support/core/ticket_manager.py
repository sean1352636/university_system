...
from education_system.systems.university.domain.pastoral.services.student_support.core.attachment_manager import _get_attachment_count, _get_last_response_info, _process_attachments
from education_system.systems.university.domain.pastoral.services.student_support.automation.sentiment_analysis import _analyze_sentiment, _suggest_category, _get_auto_assignment, _estimate_resolution_time
from education_system.systems.university.domain.pastoral.services.student_support.features.templates import _create_auto_response
from education_system.systems.university.domain.pastoral.services.student_support.features.notifications import _create_ticket_notifications
