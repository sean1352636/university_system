...
from education_system.systems.university.domain.pastoral.services.student_support.features.notifications import _get_recent_notifications
...
def display_support_menu():
    ...
    from education_system.systems.university.domain.pastoral.services.student_support import EnhancedStudentSupport
    from education_system.systems.university.domain.pastoral.services.student_support.features.search import perform_advanced_search
    from education_system.systems.university.domain.pastoral.services.student_support.utils.helpers import (
        display_enhanced_faqs,
        display_enhanced_resources,
        create_enhanced_ticket,
        manage_preferences,
    )
    from education_system.systems.university.domain.pastoral.services.student_support.features.knowledge_base import browse_knowledge_base, manage_knowledge_base_menu
    from education_system.systems.university.domain.pastoral.services.student_support.core.ticket_manager import view_my_tickets_enhanced, use_ticket_template, view_all_tickets_enhanced
    from education_system.systems.university.domain.pastoral.services.student_support.features.reports import generate_reports_menu
    from education_system.systems.university.domain.pastoral.services.student_support.features.templates import manage_templates_menu
    from education_system.systems.university.domain.pastoral.services.student_support.operations.bulk_operations import bulk_operations_menu
    from education_system.systems.university.domain.pastoral.services.student_support.operations.export import export_data_menu
    from education_system.systems.university.domain.pastoral.services.student_support.features.notifications import view_notifications
