...
def generate_student_outcome_report(cursor, student_id):
    ...
    try:
        ...
        elements.append(Paragraph("Learning Outcome Achievement Report", title_style))
        ...
        if assessed_outcomes:
            ...
            if low_achievement > 0:
                elements.append(Paragraph(
                    "• Focus on improving outcomes with low achievement levels (<2.5), especially those with high importance ratings.",
                    styles['Normal']))

            if high_achievement < assessed_count * 0.5:  # Less than 50% are high achievement
                elements.append(Paragraph(
                    "• Work towards moving medium achievement outcomes (2.5-3.9) into the high achievement range (≥4.0).",
                    styles['Normal']))
            ...
            elements.append(Paragraph(
                "• Continue to gather evidence for achievement of learning outcomes, especially for those that currently lack detailed evidence.",
                styles['Normal']))

            if weighted_avg < 3.5:
                elements.append(Paragraph(
                    "• Prioritize improvement in high-importance outcomes to raise the weighted average achievement level.",
                    styles['Normal']))
        else:
...
def generate_course_outcome_report(cursor, course):
    ...
    try:
        ...
        elements.append(Paragraph("Course Learning Outcome Report", title_style))
        ...
        if outcomes_with_achievements:
            ...
            if low_achievement_outcomes:
                elements.append(Paragraph(
                    "• Focus on improving student achievement in the following outcomes with low average levels:",
                    styles['Normal']))
            ...
            if low_coverage_outcomes:
                elements.append(Paragraph(
                    "• Increase assessment coverage for these outcomes with less than 50% student coverage:",
                    styles['Normal']))
            ...
            if no_data_outcomes:
                elements.append(Paragraph(
                    "• Begin assessing the following outcomes that currently have no achievement data:",
                    styles['Normal']))
            ...
            elements.append(Paragraph(
                "• Document best practices from outcomes with high achievement levels to apply to other areas.",
                styles['Normal']))
        else:
...
def generate_all_courses_outcome_report(cursor):
    ...
    try:
        ...
        elements.append(Paragraph("Cross-Course Learning Outcome Report", title_style))
        elements.append(Paragraph(f"Generated on {datetime.now().strftime('%B %d, %Y')}", styles['Normal']))
        elements.append(Spacer(1, 12))
        ...
        if low_achievement_courses:
            elements.append(Paragraph(
                "• Focus on improving learning outcome achievement in the following courses with below-average levels:",
                styles['Normal']))
        ...
        if low_coverage_courses:
            elements.append(Paragraph(
                "• Increase assessment coverage in these courses with less than 50% coverage:",
                styles['Normal']))
        ...
        if shared_outcomes:
            ...
            if high_variation_outcomes:
                elements.append(Paragraph(
                    "• Address inconsistencies in the following shared outcomes that have high variation across courses:",
                    styles['Normal']))
        ...
        elements.append(Paragraph(
            "• Share best practices from high-performing courses to improve outcomes in lower-performing areas.",
            styles['Normal']))

        elements.append(Paragraph(
            "• Standardize outcome assessment methods across courses to ensure consistent evaluation.",
            styles['Normal']))

        elements.append(Paragraph(
            "• Regularly review and update learning outcomes based on achievement data and curriculum changes.",
            styles['Normal']))
...
def generate_module_outcome_report(cursor, module_code):
    ...
    try:
        ...
        elements.append(Paragraph("Module Learning Outcome Report", title_style))
        ...
        if outcomes_with_achievements:
            ...
            if low_achievement_outcomes:
                elements.append(Paragraph(
                    "• Focus on improving achievement in these outcomes with low average levels:",
                    styles['Normal']))
            ...
            if low_coverage_outcomes:
                elements.append(Paragraph(
                    "• Increase assessment coverage for these outcomes:",
                    styles['Normal']))
            ...
            if no_data_outcomes:
                elements.append(Paragraph(
                    "• Begin assessing these outcomes that currently have no achievement data:",
                    styles['Normal']))
            ...
            if unmapped_assessments:
                elements.append(Paragraph(
                    "• Map learning outcomes to these assessments that currently have no outcome mappings:",
                    styles['Normal']))
            ...
            elements.append(Paragraph(
                "• Ensure that assessment tasks are aligned with learning outcomes and appropriately weighted.",
                styles['Normal']))

            elements.append(Paragraph(
                "• Consider direct assessment methods for outcomes that are currently only measured indirectly through assessments.",
                styles['Normal']))
        else:
