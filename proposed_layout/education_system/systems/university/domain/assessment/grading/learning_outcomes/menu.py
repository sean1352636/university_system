from education_system.systems.university.domain.assessment.grading.learning_outcomes.management import manage_learning_outcomes
...
from education_system.systems.university.domain.assessment.grading.grade_calculation import map_assessments_to_outcomes
