...
from education_system.systems.university.domain.assessment.grading.utils import calculate_trend_slope, select_student
from education_system.systems.university.domain.assessment.grading.forecasting import forecast_success_rates
...
def trend_forecasting():
    ...
    try:
        ...
        if choice == '1':
            try:
                from education_system.systems.university.domain.assessment.grading.performance_analytics import forecast_overall_performance
            ...
            try:
                from education_system.systems.university.domain.assessment.grading.performance_analytics import forecast_course_performance
            ...
            try:
                from education_system.systems.university.domain.assessment.grading.forecasting import forecast_module_difficulty
            ...
            try:
                from education_system.systems.university.domain.assessment.grading.grade_calculation import forecast_assessment_performance
