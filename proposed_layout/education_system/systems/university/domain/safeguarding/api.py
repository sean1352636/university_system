...
from education_system.systems.university.domain.safeguarding.i18n import (
    _LANG_NAMES,
    _I18N_READY,
    _ensure_i18n_loaded,
    tr,
...
from education_system.systems.university.domain.safeguarding.services.integrations import (
...
from education_system.systems.university.domain.safeguarding.services.training import (
    DEFAULT_TRAINING_VALIDITY_DAYS,
    record_training,
    training_status,
    training_compliance_summary,
)
from education_system.systems.university.domain.safeguarding.services.drafts import (
    _draft_path,
    save_draft,
    load_draft,
    clear_draft,
)
from education_system.systems.university.domain.safeguarding.services.media import (
    _QUICK_EXIT_URL,
    quick_exit,
    maybe_transcribe,
)
