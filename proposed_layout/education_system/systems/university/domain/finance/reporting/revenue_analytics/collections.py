...
from education_system.systems.university.domain.finance.reporting.revenue_analytics.app import auth
from education_system.systems.university.domain.finance.core.aid import create_payment_arrangement
from education_system.systems.university.domain.finance.core.students import student_exists, get_student_name
from education_system.systems.university.domain.finance.core.security_automation import log_audit_action, send_email_notification


def manage_collections():
    """Collection management system for overdue accounts"""
    from education_system.systems.university.domain.finance.core.analytics import view_overdue_accounts
    global auth
    ...
    while True:
        ...
        if choice == '1':
            ...
            from education_system.systems.university.domain.finance.reporting.revenue_analytics.collection_reports import generate_collection_reports
            generate_collection_reports()
        elif choice == '7':
            from education_system.systems.university.domain.finance.reporting.revenue_analytics.agencies import manage_collection_agencies
            manage_collection_agencies()
        elif choice == '8':
            from education_system.systems.university.domain.finance.reporting.revenue_analytics.agencies import setup_collection_workflows
...
def create_collection_case():
    ...
    from education_system.systems.university.domain.finance.core.analytics import assign_case_to_agency
    try:
        conn = get_connection()
        cursor = conn.cursor()
