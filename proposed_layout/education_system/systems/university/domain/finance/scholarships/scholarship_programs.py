...
from education_system.systems.university.domain.finance.core.aid import review_pending_aid_applications, approve_reject_aid_application, track_loan_repayments, manage_aid_types, apply_aid_to_fees
from education_system.systems.university.domain.finance.core.security_automation import log_audit_action
...
def manage_scholarships():
    ...
    from education_system.systems.university.domain.finance.reporting.revenue_analytics.scholarships import scholarship_reports
    global auth
...
def manage_financial_aid():
    ...
    from education_system.systems.university.domain.finance.reporting.revenue_analytics.scholarships import generate_aid_reports
    global auth
