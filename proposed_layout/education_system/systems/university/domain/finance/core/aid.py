...
from education_system.systems.university.domain.finance.core.finance_context import get_connection, get_current_user
from education_system.systems.university.domain.finance.core.security_automation import (
    log_audit_action,
    send_email_notification,
)
from education_system.systems.university.domain.finance.core.communications import send_arrangement_confirmation
...
def view_aid_application_detail(aid_id):
    ...
    try:
        ...
        if requires_repayment:
            print("Requires Repayment: Yes")
            if repayment_start:
                print(f"Repayment Start: {repayment_start}")
        else:
            print("Requires Repayment: No")
