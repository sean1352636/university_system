...
from education_system.systems.university.domain.finance.core.finance_context import get_auth
from education_system.systems.university.domain.finance.core.finance_db_operations import initialize_finance
    ...
    while True:
        ...
        try:
            ...
            if choice == '1' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.account_management import assign_fees_to_student
                assign_fees_to_student()
            elif choice == '2' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.account_management import record_payment
                record_payment()
            elif choice == '3' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.account_management import generate_invoice
                generate_invoice()
            elif choice == '4' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.account_management import process_refund
                process_refund()
            elif choice == '5' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.account_management import manage_student_credits
                manage_student_credits()
            elif choice == '6':
                from education_system.systems.university.domain.finance.core.account_management import view_student_financial_statement
                view_student_financial_statement()

            # Payment Plans
            elif choice == '7' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.billing.payment_plans import manage_payment_plans
                manage_payment_plans()
            elif choice == '8' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.billing.payment_plans import process_payment_plan_payment
                process_payment_plan_payment()

            # Late Fees
            elif choice == '9' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.billing.fee_structure import calculate_late_fees
                calculate_late_fees()
            elif choice == '10' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.billing.fee_structure import waive_late_fee
                waive_late_fee()

            # Multi-Currency
            elif choice == '11' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.billing.fee_structure import update_exchange_rates
                update_exchange_rates()
            elif choice == '12' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.billing.fee_structure import currency_conversion_tool
                currency_conversion_tool()

            # Analytics
            elif choice == '13' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.reporting.revenue_analytics import generate_financial_dashboard
                generate_financial_dashboard()
            elif choice == '14' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.reporting.revenue_analytics import generate_predictive_analytics
                generate_predictive_analytics()
            elif choice == '15' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.reporting.revenue_analytics import generate_financial_reports
                generate_financial_reports()
            elif choice == '16' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.reporting.revenue_analytics import generate_outstanding_fees_report
                generate_outstanding_fees_report()
            elif choice == '17' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.reporting.revenue_analytics import generate_payment_collection_report
                generate_payment_collection_report()

            # Scholarships
            elif choice == '18' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.scholarships.scholarship_programs import manage_scholarships
                manage_scholarships()
            elif choice == '19' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.scholarships.scholarship_programs import manage_financial_aid
                manage_financial_aid()

            # Security
            elif choice == '20' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.security_automation import detect_payment_fraud
                detect_payment_fraud()
            elif choice == '21' and auth.check_permission('view_audit_logs'):
                from education_system.systems.university.domain.finance.reporting.revenue_analytics import generate_audit_report
                ...
                from education_system.systems.university.domain.finance.core.security_automation import create_approval_workflow
                create_approval_workflow()

            # Automation
            elif choice == '23' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.security_automation import setup_automated_notifications
                setup_automated_notifications()
            elif choice == '24' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.core.security_automation import send_automated_notifications
            ...
            # Budgeting
                ...
                from education_system.systems.university.domain.finance.reporting.budget_analysis import manage_budgets
                manage_budgets()
            elif choice == '26' and auth.check_permission('manage_finances'):
                from education_system.systems.university.domain.finance.reporting.revenue_analytics import generate_revenue_forecast
