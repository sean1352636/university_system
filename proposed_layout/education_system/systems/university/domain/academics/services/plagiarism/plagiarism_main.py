...
from education_system.systems.university.domain.academics.services.plagiarism.exceptions import (
    PlagiarismCheckerError,
    DatabaseError,
    FileProcessingError,
    IntegrationError,
)
from education_system.systems.university.domain.academics.services.plagiarism.nlp import download_nltk_data, NLTK_AVAILABLE, TEXTRACT_AVAILABLE
from education_system.systems.university.domain.academics.services.plagiarism.db import get_safe_db_connection
from education_system.systems.university.domain.academics.services.plagiarism.checker import PlagiarismChecker

# --- CLI functions ---
from education_system.systems.university.interfaces.cli.academics.services.plagiarism import (
    safe_input,
...
# --- Setup & testing ---
from education_system.systems.university.domain.academics.services.plagiarism.setup import (
    check_requirements,
    check_database,
    create_directories,
    setup_plagiarism_system,
)
from education_system.systems.university.domain.academics.services.plagiarism.sample_data import (
    create_sample_documents,
    create_ai_education_content,
    create_similar_ai_content,
    create_different_content,
)
from education_system.systems.university.domain.academics.services.plagiarism.tests import (
