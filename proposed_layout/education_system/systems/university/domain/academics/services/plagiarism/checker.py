...
from education_system.systems.university.domain.academics.services.plagiarism.exceptions import PlagiarismCheckerError, DatabaseError, FileProcessingError
from education_system.systems.university.domain.academics.services.plagiarism.nlp import (
    ...
    def check_plagiarism(self, document_id, checker_id=None, threshold=0.3):
        ...
        try:
            with self.get_db_connection() as conn:
                ...
                try:
                    from education_system.systems.university.domain.academics.services.course_management.integrity_settings import (
