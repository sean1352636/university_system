...
from education_system.systems.university.domain.academics.services.plagiarism.nlp import download_nltk_data
from education_system.systems.university.domain.academics.services.plagiarism.sample_data import create_sample_documents
