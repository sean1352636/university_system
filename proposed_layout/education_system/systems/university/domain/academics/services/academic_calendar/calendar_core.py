...
from education_system.systems.university.domain.academics.services.academic_calendar.config import CalendarConfig, ValidationUtils
from education_system.systems.university.domain.academics.services.academic_calendar.database import DatabaseManager
from education_system.systems.university.domain.academics.services.academic_calendar.auth import AuthenticationManager
from education_system.systems.university.domain.academics.services.academic_calendar.audit import AuditManager
from education_system.systems.university.domain.academics.services.academic_calendar.recurring_events import RecurringEventManager
from education_system.systems.university.domain.academics.services.academic_calendar.categories import EventCategoryManager, CourseManager
from education_system.systems.university.domain.academics.services.academic_calendar.resources import ResourceManager
from education_system.systems.university.domain.academics.services.academic_calendar.notifications import NotificationManager, SMSNotificationManager
from education_system.systems.university.domain.academics.services.academic_calendar.search import AdvancedSearchManager
from education_system.systems.university.domain.academics.services.academic_calendar.holidays import HolidayManager
from education_system.systems.university.domain.academics.services.academic_calendar.visualization import DataVisualizationManager, EnhancedCalendarVisualizationManager
from education_system.systems.university.domain.academics.services.academic_calendar.dependencies import EventDependencyManager
from education_system.systems.university.domain.academics.services.academic_calendar.reporting import AdvancedReportingManager
from education_system.systems.university.domain.academics.services.academic_calendar.deadlines import AcademicDeadlineManager
from education_system.systems.university.domain.academics.services.academic_calendar.batch import BatchOperationsManager
from education_system.systems.university.domain.academics.services.academic_calendar.timezone import EnhancedTimeZoneManager
...
class AcademicCalendarManager:
    ...
    def __init__(self, config: CalendarConfig = None, auth_manager: AuthenticationManager = None):
        ...
        try:
            ...
            if FLASK_AVAILABLE:
                try:
                    from education_system.systems.university.domain.academics.services.academic_calendar.mobile_api import MobileAPIManager
    ...
    def _create_enhanced_tables(self):
        ...
        try:
            enhanced_tables = [
                ...
                # holiday_calendars folded into academic_calendar_events
                # (event_type='holiday_calendar').
            ...
            for table_sql in enhanced_tables:
                try:
                    self.db_manager.execute_update(table_sql)
                    logger.debug("Created enhanced table successfully")
                except Exception as e:
    ...
    def get_trips_for_calendar_integration(self):
        ...
        try:
            # sqlite3 is imported globally from education_system.systems.university.infrastructure.database.db
            conn = get_connection()
            cursor = conn.cursor()
    ...
    def remove_trip_calendar_link(self, trip_id, event_id):
        ...
        try:
            ...
            cursor.execute('''
                UPDATE academic_calendar_events SET trip_id = NULL
