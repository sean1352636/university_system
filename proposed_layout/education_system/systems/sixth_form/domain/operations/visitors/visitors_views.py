...
from education_system.systems.sixth_form.domain.operations.visitors import (
    visitors as data,
)
from education_system.systems.sixth_form.domain.operations.visitors.visitors import (
    DEFAULT_ID_TYPE,
    DEFAULT_STATUS,
