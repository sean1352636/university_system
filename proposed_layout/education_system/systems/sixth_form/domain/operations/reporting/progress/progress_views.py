...
from education_system.systems.sixth_form.domain.operations.reporting.progress import progress as data
...
from education_system.systems.sixth_form.domain.operations.reporting.progress.progress import (
    DEFAULT_PERIOD,
    DEFAULT_RATING,
    DEFAULT_RISK,
