...
from education_system.systems.sixth_form.domain.operations.communications.notices import notices as data
...
from education_system.systems.sixth_form.domain.operations.communications.notices.notices import (
    AUDIENCES,
    CATEGORIES,
    DEFAULT_AUDIENCE,
    DEFAULT_CATEGORY,
