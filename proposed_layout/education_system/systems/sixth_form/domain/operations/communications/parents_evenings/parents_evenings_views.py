...
from education_system.systems.sixth_form.domain.operations.communications.parents_evenings import parents_evenings as data
...
from education_system.systems.sixth_form.domain.operations.communications.parents_evenings.parents_evenings import (
    BOOKING_STATUSES,
    Booking,
