"""Tkinter views for Sixth Form Activity Feed.
...
from education_system.systems.sixth_form.domain.operations.communications.activity_feed import (
    activity_feed as data,
)
from education_system.systems.sixth_form.domain.operations.communications.activity_feed.activity_feed import (
    ACTIONS,
    DEFAULT_SEVERITY,
    Event,
    KNOWN_ENTITY_TYPES,
