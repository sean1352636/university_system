"""CLI flows for Sixth Form Census / ILR."""
...
from education_system.systems.sixth_form.domain.governance.compliance.census_ilr import (
    census_ilr as data,
)
from education_system.systems.sixth_form.domain.governance.compliance.census_ilr.census_ilr import (
    AIM_TYPES,
    CensusReturn,
    DEFAULT_AIM_TYPE,
