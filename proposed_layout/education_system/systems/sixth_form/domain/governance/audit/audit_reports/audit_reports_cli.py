"""CLI flows for Sixth Form Audit Reports."""
...
from education_system.systems.sixth_form.domain.governance.audit.audit_reports import (
    audit_reports as data,
)
from education_system.systems.sixth_form.domain.governance.audit.audit_reports.audit_reports import (
