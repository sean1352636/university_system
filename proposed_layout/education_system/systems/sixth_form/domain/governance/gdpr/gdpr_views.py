...
from education_system.systems.sixth_form.domain.governance.gdpr import gdpr as data
from education_system.platform import branding
from education_system.systems.sixth_form.domain.governance.gdpr.gdpr import (
    BREACH_SEVERITIES,
    BREACH_STATUSES,
    CONSENT_PURPOSES,
