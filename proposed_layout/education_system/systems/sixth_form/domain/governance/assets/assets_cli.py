...
from education_system.systems.sixth_form.domain.governance.assets import assets as data
from education_system.systems.sixth_form.domain.governance.assets.assets import (
    Asset,
    CATEGORIES,
    CONDITIONS,
    CURRENCY_SYMBOL,
