...
from education_system.systems.sixth_form.domain.governance.health_safety import (
    health_safety as data,
)
from education_system.systems.sixth_form.domain.governance.health_safety.health_safety import (
    ACTION_PRIORITIES,
    ACTION_STATUSES,
    AFFECTED_PARTIES,
    CATEGORIES,
