...
from education_system.systems.sixth_form.domain.progression.careers import careers as data
from education_system.systems.sixth_form.domain.learners.students import students as student_data
from education_system.systems.sixth_form.domain.progression.careers.careers import (
    CareerAspiration,
    CareerSession,
    DEFAULT_PATHWAY,
