...
from education_system.systems.sixth_form.domain.pastoral.tutor_groups import tutor_groups as data
from education_system.systems.sixth_form.domain.pastoral.tutor_groups.tutor_groups import (
    TutorGroup,
    ValidationError,
    YEAR_GROUPS,
)
