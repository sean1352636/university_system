...
from education_system.systems.sixth_form.domain.finance.trips import trips as data
from education_system.platform import branding
from education_system.systems.sixth_form.domain.finance.trips.trips import (
    BOOKING_STATUSES,
    Booking,
    CURRENCY_SYMBOL,
