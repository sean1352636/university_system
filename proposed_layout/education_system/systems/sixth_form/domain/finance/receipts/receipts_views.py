...
from education_system.systems.sixth_form.domain.finance.receipts import receipts as data
...
from education_system.systems.sixth_form.domain.finance.receipts.receipts import (
    CURRENCY_SYMBOL,
    DEFAULT_LINE_KIND,
    DEFAULT_METHOD,
    DEFAULT_STATUS,
