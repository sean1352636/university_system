...
from education_system.systems.sixth_form.domain.academics.timetable import timetable as data
from education_system.systems.sixth_form.domain.academics.timetable.timetable import (
    DAYS,
    DAY_NUMBERS,
