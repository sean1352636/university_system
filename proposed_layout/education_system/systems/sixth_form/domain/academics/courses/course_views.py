...
from education_system.systems.sixth_form.domain.academics.courses import courses as data
from education_system.systems.sixth_form.domain.academics.courses.courses import (
    Course,
