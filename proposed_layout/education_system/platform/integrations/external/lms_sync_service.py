...
class LMSSyncService:
    ...
    def get_provider(self, connection: dict[str, Any]):
        ...
        if provider_type == PROVIDER_CANVAS:
            from education_system.platform.integrations.external.canvas_provider import (
                CanvasProvider,
            )
        ...
        if provider_type == PROVIDER_MOODLE:
            from education_system.platform.integrations.external.moodle_provider import (
                MoodleProvider,
            )
        ...
        if provider_type == PROVIDER_GOOGLE_CLASSROOM:
            from education_system.platform.integrations.external.google_classroom_provider import (
                GoogleClassroomProvider,
            )
