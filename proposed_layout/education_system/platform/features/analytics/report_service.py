...
Usage::
    ...
    from education_system.platform.features.analytics import ReportService
...
from education_system.platform.features.analytics.models import MetricSnapshot, ReportFormat, ReportResult
