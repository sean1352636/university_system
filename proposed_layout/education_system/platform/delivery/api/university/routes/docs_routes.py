...
University-specific docs — serves the detailed, hand-curated OpenAPI spec
generated from ``openapi_spec.py``.  The unified server also provides
...
from education_system.platform.delivery.api.university.openapi_spec import get_openapi_spec
...
<body>
  ...
  <script>
    SwaggerUIBundle({{
      url: "/api/v1/university/openapi.json",
      dom_id: "#swagger-ui",
      deepLinking: true,
      presets: [
...
def openapi_json():
    """Return the University OpenAPI specification as JSON."""
