...
from education_system.platform.delivery.api.university.validators import validate_student_create, validate_student_update
...
from education_system.systems.university.infrastructure.repositories.student import (
    Student,
...
def _generate_unique_student_id(repo) -> str:
    ...
    for _ in range(10):
        sid = str(secrets.randbelow(9000000) + 1000000).zfill(7)
