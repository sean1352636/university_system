...
Usage in route handlers:
    from education_system.platform.delivery.api.async_adapter import run_in_executor, async_route
    ...
    from education_system.platform.delivery.api.async_adapter import AsyncFlaskRunner
