...
@_token_required
def list_behaviour():
    from education_system.systems.secondary.domain.pastoral.behaviour import (  # noqa: E501
        behaviour as data,
    )
    from education_system.systems.secondary.domain.learners.pupils.pupils import (  # noqa: E501
        ValidationError,
    )
    args = request.args
    try:
...
@_token_required
def list_detentions():
    from education_system.systems.secondary.domain.pastoral.detentions import (  # noqa: E501
        detentions as data,
    )
    from education_system.systems.secondary.domain.learners.pupils.pupils import (  # noqa: E501
        ValidationError,
...
def list_safeguarding():
    from education_system.systems.secondary.domain.safeguarding import (  # noqa: E501
