...
class SuperAdminDashboard(tk.Tk):
    ...
    def _get_admin_service(self):
        if self._admin_service is None:
            try:
                from education_system.platform.delivery.portals.admin.admin_service import AdminService
    ...
    def _get_analytics_service(self):
        if self._analytics_service is None:
            try:
                from education_system.platform.features.analytics.analytics_service import AnalyticsService
    ...
    def _get_notification_service(self):
        if self._notification_service is None:
            try:
                from education_system.platform.features.notifications.service import (
    ...
    def _get_journey_service(self):
        if self._journey_service is None:
            try:
                from education_system.platform.cross_system.journey_service import JourneyService
    ...
    def _build_misconduct(self):
        ...
        try:
            import sqlite3
            from education_system.platform.governance.academic_misconduct._imports import DEFAULT_DB_PATH
            from education_system.platform.governance.academic_misconduct.database import init_misconduct_tables
    ...
    def _build_backup(self):
        ...
        def _backup_auth():
            ...
            if not auth_path:
                try:
                    from education_system.platform.delivery.portals.admin.admin_service import _auth_db_path
    ...
    def _build_db_report(self):
        ...
        try:
            from education_system.platform.delivery.gui.db_report import (
    ...
    def _build_password_policy(self):
        ...
        if self.auth is None or not hasattr(self.auth, "get_password_policy_overview"):
            ...
            return
        try:
            from education_system.platform.delivery.gui.password_reset_dashboard import (
