"""
Comprehensive tests for modules.domain.academics.gui.grade_tracking.dialogs.student_dialog
...
from modules.domain.academics.gui.grade_tracking.dialogs.student_dialog import StudentDialog
from modules.domain.academics.gui.grade_tracking.dialogs.student_dialog import percentage_to_letter, letter_to_percentage, letter_to_gpa, ensure_column_exists, init_basic_database, init_enhanced_grades_db, safe_grab_set, safe_combo_update
...
class TestStudentDialog:
    ...
    def test_setup_dialog(self, instance, sample_data):
        """Test StudentDialog.setup_dialog() method"""
