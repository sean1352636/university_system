...
class TestKPIManager:
    ...
    def test_record_kpi(self):
        ...
        from university_system.modules.shared.services.analytics.analytics_dashboard_core import KPIManager
...
class TestModuleExports:
    ...
    def test_all_exports_defined(self):
        ...
        from university_system.modules.shared.services.analytics import analytics_dashboard_core
