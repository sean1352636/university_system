...
Tests all functionality in university_system/modules/shared/services/analytics/student_analytics.py
"""
...
from university_system.modules.shared.services.analytics.student_analytics import (
    StudentAnalytics,
...
def analytics():
    ...
    with patch('university_system.modules.shared.services.analytics.student_analytics.get_connection'):
