...
def chart_generator_module(mock_matplotlib):
    ...
    if 'university_system.modules.shared.utils.chart_generator' in sys.modules:
    ...
    with patch('university_system.infrastructure.database.db.get_connection') as mock_conn:
        ...
        from university_system.modules.shared.utils import chart_generator
...
class TestChartGenerator:
    ...
    def test_email_chart_with_custom_message(self, mock_send, chart_generator_module):
        ...
        assert custom_msg in call_args.kwargs['body']
...
class TestDatabaseChartGenerator:
    ...
    def test_generate_age_distribution(self, mock_get_conn, chart_generator_module):
        ...
        # Mock ChartGenerator
        with patch.object(chart_generator_module.ChartGenerator, 'generate_chart') as mock_gen:
    ...
    def test_generate_registration_timeline(self, mock_get_conn, chart_generator_module):
        ...
        with patch.object(chart_generator_module.ChartGenerator, 'generate_chart') as mock_gen:
            ...
            assert fig is not None
            # Check x-axis labels were updated
