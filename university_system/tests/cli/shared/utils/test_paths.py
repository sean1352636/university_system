"""
Tests for university_system/modules/shared/constants/paths.py
...
class TestPathConstants:
    ...
    def test_file_paths_have_correct_parents(self):
        ...
        # EMAIL_CONFIG_PATH should be in EMAIL_DATA_DIR
        assert paths.EMAIL_CONFIG_PATH.parent == paths.EMAIL_DATA_DIR
...
class TestEnsureDirectories:
    ...
    def test_ensure_helper_creates_directory(self):
        ...
        from university_system.modules.shared.constants.paths import _ensure
