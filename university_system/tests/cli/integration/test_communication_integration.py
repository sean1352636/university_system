...
class TestEmailIntegration:
    ...
    def test_send_bulk_email_unified(self, mock_bulk):
        ...
        from university_system.modules.shared.utils.communication_integration import send_bulk_email_unified
    ...
    def test_queue_email_unified(self, mock_queue):
        """Test queueing email"""
        from university_system.modules.shared.utils.communication_integration import queue_email_unified
...
class TestSMSIntegration:
    ...
    def test_send_bulk_sms_unified(self, mock_bulk):
        ...
        from university_system.modules.shared.utils.communication_integration import send_bulk_sms_unified
...
class TestCalendarReminder:
    ...
    def test_calendar_reminder_email(self, mock_email):
        ...
        from university_system.modules.shared.utils.communication_integration import send_calendar_reminder
...
class TestRestaurantNotifications:
    ...
    def test_restaurant_order_confirmation(self, mock_email):
        ...
        from university_system.modules.shared.utils.communication_integration import send_restaurant_notification
...
class TestMigrationHelpers:
    ...
    def test_migrate_standalone_email(self, mock_email):
        ...
        from university_system.modules.shared.utils.communication_integration import migrate_standalone_email
    ...
    def test_migrate_standalone_sms(self, mock_sms):
        ...
        from university_system.modules.shared.utils.communication_integration import migrate_standalone_sms
