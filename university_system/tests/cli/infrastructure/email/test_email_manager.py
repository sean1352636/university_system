...
class TestQueueEmail:
    ...
    def test_queue_email_basic(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import _queue_email, _email_queue
...
class TestDisplayChatRoomsMenu:
    ...
    def test_display_chat_rooms_menu_output(self, capsys):
        ...
        from university_system.infrastructure.email.email_manager import display_chat_rooms_menu
...
class TestSendTicketNotification:
    ...
    def test_send_ticket_notification_basic(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import send_ticket_notification, _email_queue
...
class TestSendEmail:
    ...
    def test_send_email_basic(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import send_email, _email_queue
...
class TestSendConfirmationEmail:
    ...
    def test_send_confirmation_email_basic(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import send_confirmation_email, _email_queue
...
class TestSendReplyNotification:
    ...
    def test_send_reply_notification_basic(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import send_reply_notification, _email_queue
...
class TestSendSlaAlert:
    ...
    def test_send_sla_alert_basic(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import send_sla_alert, _email_queue
...
class TestSendSatisfactionSurvey:
    ...
    def test_send_satisfaction_survey_basic(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import send_satisfaction_survey, _email_queue
...
class TestGetQueuedEmails:
    ...
    def test_get_queued_emails_empty_queue(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import get_queued_emails
...
class TestClearEmailQueue:
    ...
    def test_clear_empty_queue(self, reset_email_queue):
        ...
        from university_system.infrastructure.email.email_manager import clear_email_queue
