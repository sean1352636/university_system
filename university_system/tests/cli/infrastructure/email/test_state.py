...
class TestAuthProxy:
    ...
    def test_auth_proxy_bool_when_auth_is_none(self):
        ...
        from university_system.infrastructure.email.state import AuthProxy, auth

        # Ensure auth is None
        import university_system.infrastructure.email.state as state_module
    ...
    def test_auth_proxy_bool_when_auth_exists(self):
        ...
        from university_system.infrastructure.email.state import AuthProxy
        import university_system.infrastructure.email.state as state_module
...
class TestAuthVariable:
    ...
    def test_auth_variable_shared_across_imports(self):
        ...
        # First import
        from university_system.infrastructure.email import state as state1

        mock_auth = Mock()
        state1.auth = mock_auth

        # Second import
        from university_system.infrastructure.email import state as state2
...
class TestHasAuthFlag:
    ...
    def test_has_auth_true_when_module_available(self):
        ...
        from university_system.infrastructure.email.state import HAS_AUTH
...
class TestAuthProxyInstance:
    ...
    def test_auth_proxy_instance_exists(self):
        ...
        from university_system.infrastructure.email.state import auth_proxy, AuthProxy
