...
from university_system.modules.domain.finance.reporting.financial_reports import (
...
class TestAuthSetup:
    ...
    def test_set_auth(self):
        ...
        from university_system.modules.domain.finance.reporting.financial_reports import auth
