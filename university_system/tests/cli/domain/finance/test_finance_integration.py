...
class TestGetStudentFinancialSummary:
    ...
    def test_get_student_financial_summary_exists(self):
        """Test that function exists and is callable"""
        from university_system.modules.shared.utils.finance_integration import get_student_financial_summary
...
class TestGetFinanceReportBySource:
    ...
    def test_get_finance_report_by_source_exists(self):
        """Test that function exists and is callable"""
        from university_system.modules.shared.utils.finance_integration import get_finance_report_by_source
