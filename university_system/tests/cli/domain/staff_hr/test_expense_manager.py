...
class TestExpenseClaimCreation:
    ...
    @patch('university_system.modules.domain.staff_hr.services.managers.expense_manager.get_connection')
    @patch('university_system.modules.domain.staff_hr.services.managers.expense_manager.transaction')
    @patch('university_system.modules.domain.staff_hr.services.managers.expense_manager.log_activity')
