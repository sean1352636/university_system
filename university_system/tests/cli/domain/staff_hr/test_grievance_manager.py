...
class TestGrievanceCreation:
    ...
    @patch('university_system.modules.domain.staff_hr.services.managers.grievance_manager.get_connection')
    @patch('university_system.modules.domain.staff_hr.services.managers.grievance_manager.transaction')
    @patch('university_system.modules.domain.staff_hr.services.managers.grievance_manager.log_activity')
