...
class TestAlumniRegistration:
    ...
    def test_register_alumni_basic(self, setup_alumni_database, mock_auth):
        ...
        with patch('builtins.input', side_effect=[
            ...
            with patch('university_system.modules.domain.student_affairs.services.alumni_management.auth', mock_auth):
                try:
                    from university_system.modules.domain.student_affairs.services.alumni_management import register_alumni
                    register_alumni()
