...
class TestNotificationsModule(unittest.TestCase):
    ...
    def test_view_notifications_all(self, mock_input, mock_get_conn):
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.notifications import view_notifications
    ...
    def test_create_notification_system_wide(self, mock_input, mock_datetime, mock_log_audit,
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.notifications import create_notification
    ...
    def test_mark_notification_read(self, mock_input, mock_datetime, mock_log_audit,
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.notifications import mark_notification_read
    ...
    def test_clear_old_notifications_option1(self, mock_input, mock_log_audit, mock_backup,
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.notifications import clear_old_notifications
    ...
    def test_manage_notifications_return(self, mock_print, mock_input):
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.notifications import manage_notifications
