...
class TestSettingsModule(unittest.TestCase):
    ...
    def test_view_system_settings(self, mock_get_conn):
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.settings import view_system_settings
    ...
    def test_update_system_settings(self, mock_input, mock_log_audit, mock_backup,
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.settings import update_system_settings
    ...
    def test_display_system_settings_view_option(self, mock_input, mock_view):
        ...
        from university_system.modules.domain.commerce.services.restaurant.operations.settings import display_system_settings
