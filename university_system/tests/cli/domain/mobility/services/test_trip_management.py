...
class TestTripManagementCore(unittest.TestCase):
    ...
    def test_set_auth_function(self):
        ...
        from university_system.modules.domain.mobility.services.trip_management import set_auth
    ...
    def test_init_trip_db(self, mock_transaction):
        ...
        from university_system.modules.domain.mobility.services.trip_management import init_trip_db
...
class TestTripCreation(unittest.TestCase):
    ...
    def test_create_trip(self, mock_log, mock_conn, mock_input):
        ...
        from university_system.modules.domain.mobility.services.trip_management import create_trip
    ...
    def test_view_trips(self, mock_conn):
        """Test viewing trips"""
        from university_system.modules.domain.mobility.services.trip_management import view_trips
    ...
    def test_view_trip_details(self, mock_conn, mock_input):
        ...
        from university_system.modules.domain.mobility.services.trip_management import view_trip_details
    ...
    def test_update_trip(self, mock_log, mock_conn, mock_input):
        ...
        from university_system.modules.domain.mobility.services.trip_management import update_trip
    ...
    def test_delete_trip(self, mock_log, mock_conn, mock_input):
        ...
        from university_system.modules.domain.mobility.services.trip_management import delete_trip
...
class TestTripRegistration(unittest.TestCase):
    ...
    def test_register_for_trip(self, mock_log, mock_conn, mock_input):
        ...
        from university_system.modules.domain.mobility.services.trip_management import register_for_trip
