...
class TestParkingLauncher(unittest.TestCase):
    ...
    def test_module_can_be_imported(self):
        ...
        try:
            from university_system.modules.domain.mobility.services import parking_launcher
    ...
    def test_check_dependencies_all_present(self, mock_tk):
        ...
        from university_system.modules.domain.mobility.services.parking_launcher import check_dependencies
    ...
    def test_show_interface_selection_gui(self, mock_msgbox, mock_tk):
        ...
        from university_system.modules.domain.mobility.services.parking_launcher import (
    ...
    def test_launch_gui_success(self, mock_gui_class, mock_tk):
        ...
        from university_system.modules.domain.mobility.services.parking_launcher import launch_gui
    ...
    def test_launch_console_success(self, mock_auth_class, mock_get_auth, mock_set_auth, mock_menu):
        ...
        from university_system.modules.domain.mobility.services.parking_launcher import launch_console
