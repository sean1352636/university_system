...
class TestMFAIntegration:
    ...
    def test_mfa_admin_panel_availability(self):
        ...
        from university_system.infrastructure.security.security_dashboard_gui import MFA_ADMIN_AVAILABLE
    ...
    def test_mfa_setup_wizard_availability(self):
        ...
        from university_system.infrastructure.security.security_dashboard_gui import MFA_SETUP_AVAILABLE
...
class TestGUIModuleImports:
    ...
    def test_all_security_modules_imported(self):
        ...
        from university_system.infrastructure.security import security_dashboard_gui
