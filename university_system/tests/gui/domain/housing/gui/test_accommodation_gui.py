...
class TestHelperFunctions:
    ...
    def test_resolve_user_identifier_with_auth(self):
        ...
        from university_system.modules.domain.health.gui.medical_accommodation_gui import resolve_user_identifier
...
class TestModuleConstants:
    ...
    def test_cli_available_flag(self):
        ...
        from university_system.modules.domain.housing.gui import accommodation_gui
