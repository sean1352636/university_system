...
try:
    from university_system.modules.domain.finance.gui.finance_reporting import (
...
class TestFinanceReportingGUIComponents(unittest.TestCase):
    ...
    def test_module_level_constants(self):
        ...
        from university_system.modules.domain.finance.gui import finance_reporting as frg
