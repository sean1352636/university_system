...
class TestHelperFunctions:
    ...
    def test_safe_entry_insert_with_string(self, root_window):
        ...
        from university_system.modules.shared.gui.main import _safe_entry_insert
    ...
    def test_safe_set_combobox_with_string(self, root_window):
        ...
        from university_system.modules.shared.gui.main import _safe_set_combobox
...
class TestAuthenticationSetup:
    ...
    def test_set_auth_function_exists(self):
        ...
        from university_system.modules.shared.gui import main
