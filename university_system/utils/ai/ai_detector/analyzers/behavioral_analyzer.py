...
from university_system.utils.ai.ai_detector.core.enums import DetectionMethod, RiskLevel
from university_system.utils.ai.ai_detector.core.dataclasses import DetectionResult, SubmissionMetadata
