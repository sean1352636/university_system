...
from university_system.utils.ai.ai_detector.core.enums import (
    DetectionMethod,
    RiskLevel,
    ViolationType,
)
from university_system.utils.ai.ai_detector.core.dataclasses import (
    DetectionResult,
    SubmissionMetadata,
)
from university_system.utils.ai.ai_detector.core.exceptions import (
    AIDetectionError,
    DatabaseError,
    APIError,
    ConfigurationError,
...
# Integration
from university_system.utils.ai.ai_detector.integration import (
    APIGateway,
    ComplianceManager,
)
...
# CLI functions
from university_system.utils.ai.ai_detector.cli import (
