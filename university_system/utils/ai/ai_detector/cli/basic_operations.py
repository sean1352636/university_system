...
def _get_ai_detector():
    ...
    import university_system.utils.ai.ai_detector.cli.interface as _iface
...
def view_submission_history_safe():
    ...
    try:
        ...
        try:
            ...
            from university_system.utils.ai.ai_detector.cli.interface import fix_ai_detector_database_schema
