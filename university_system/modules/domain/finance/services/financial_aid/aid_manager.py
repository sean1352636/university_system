...
class FinancialAidManager:
    ...
    def create_application(
        ...
        try:
            ...
            print(f"Error creating financial aid application: {e}")
            return None
    ...
    def get_fafsa_data(self, student_id: int, academic_year: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Error getting FAFSA data: {e}")
            return None
    ...
    def create_aid_package(
        ...
        try:
            ...
            print(f"Error creating aid package: {e}")
            return None
    ...
    def add_aid_component(
        ...
        try:
            ...
            print(f"Error adding aid component: {e}")
            return None
    ...
    def get_aid_package(self, student_id: int, academic_year: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Error getting aid package: {e}")
            return None
    ...
    def accept_aid_package(self, package_id: int) -> bool:
        ...
        try:
            ...
            print(f"Error accepting aid package: {e}")
            return False
    ...
    def create_disbursement(
        ...
        try:
            ...
            print(f"Error creating disbursement: {e}")
            return None
    ...
    def get_pending_disbursements(self, academic_term: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Error getting pending disbursements: {e}")
            return []
