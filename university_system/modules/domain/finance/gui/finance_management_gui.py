...
try:
    ...
    from university_system.modules.domain.finance.gui.finance_reporting import FinancialManagementGUI as FinanceReportingGUI
...
# Import CLI fallback
try:
    from university_system.modules.shared.cli.cli_main import display_finance_menu as _display_finance_menu
