...
def send_internship_notification(*args, **kwargs):
    """Dummy function - email notification not implemented"""
    pass

def send_application_confirmation(*args, **kwargs):
    """Dummy function - email confirmation not implemented"""
    pass
...
class InternshipGUI:
    def __init__(self, root, auth_object=None):
        self.root = root
        self.root.title("Student Internship Portal")
    ...
    def setup_main_interface(self):
        ...
        title_label = tk.Label(title_frame, text="Student Internship Portal",
    ...
    def create_navigation_buttons(self, parent):
        ...
        if self.auth.check_permission('view_internships'):
            buttons.append(("View Internships", self.show_internships))
            
        if self.auth.check_permission('apply_for_internship'):
            buttons.append(("Apply for Internship", self.show_application_form))
            
        if self.auth.check_permission('view_own_applications'):
            buttons.append(("My Applications", self.show_my_applications))
        
        # Staff/Admin buttons
        if self.auth.check_permission('view_all_applications'):
            buttons.append(("All Applications", self.show_all_applications))
            
        if self.auth.check_permission('create_internship'):
            buttons.append(("Create Internship", self.show_create_internship))
            
        if self.auth.check_permission('edit_internship'):
            buttons.append(("Manage Internships", self.show_manage_internships))
        
        # Add placement management
        if self.auth.check_permission('view_all_applications'):
            buttons.append(("Manage Placements", self.show_placement_management))
            
        if self.auth.check_permission('view_internship_reports'):
            buttons.append(("Reports", self.show_reports))

        # Integration Services
        buttons.append(("Integration Services", self.show_integration_menu))

        # CLI Mode button (backward compatibility)
        buttons.append(("CLI Mode", self.launch_cli_mode))

        # Navigation back to homescreen
        buttons.append(("Return to Homescreen", self.return_to_main_menu))
    ...
    def load_placement_data(self):
        ...
        try:
            ...
            for placement in placements:
                ...
                self.placement_tree.insert('', 'end', values=placement, tags=tags)
    ...
    def show_welcome(self):
        ...
        • Apply for internships that match your interests
        • Track your application status
        • Access internship resources and information
        
        Use the navigation buttons above to get started.
        """
        
        tk.Label(welcome_frame, text="Welcome!", font=('Arial', 24, 'bold'), 
                bg='white', fg='#2c3e50').pack(pady=(0, 20))
        
        tk.Label(welcome_frame, text=welcome_text, font=('Arial', 12), 
    ...
    def show_internships(self):
        ...
        tk.Label(title_frame, text="Available Internships", 
                font=('Arial', 18, 'bold'), bg='white', fg='#2c3e50').pack(side='left')
        
        # Refresh button
        refresh_btn = tk.Button(title_frame, text="Refresh", command=self.show_internships,
                               bg='#27ae60', fg='white', font=('Arial', 10), 
        ...
        tk.Button(btn_frame, text="View Details", command=self.view_selected_internship,
                 bg='#3498db', fg='white', font=('Arial', 10), padx=15, pady=5, relief='flat').pack(side='left', padx=5)
        
        if self.auth.check_permission('apply_for_internship'):
            tk.Button(btn_frame, text="Apply", command=self.apply_for_selected_internship,
    ...
    def load_internships_data(self):
        ...
        try:
            ...
            for internship in internships:
                self.internship_tree.insert('', 'end', values=internship)
    ...
    def show_application_form(self, internship_id=None):
        ...
        if not self.auth.check_permission('apply_for_internship'):
            messagebox.showerror("Permission Error", "You don't have permission to apply for internships.")
            return
        ...
        tk.Label(title_frame, text="Apply for Internship", 
                font=('Arial', 18, 'bold'), bg='white', fg='#2c3e50').pack(side='left')
        ...
        tk.Label(form_frame, text="Select Internship:", font=('Arial', 12, 'bold'), 
        ...
        # CV filename
        tk.Label(form_frame, text="CV Filename:", font=('Arial', 12, 'bold'), 
                bg='white', fg='#2c3e50').pack(anchor='w', pady=(0, 5))
        ...
        # Cover letter
        tk.Label(form_frame, text="Cover Letter:", font=('Arial', 12, 'bold'), 
                bg='white', fg='#2c3e50').pack(anchor='w', pady=(0, 5))
        ...
        tk.Button(btn_frame, text="Submit Application", command=self.submit_application,
    ...
    def show_my_applications(self):
        ...
        if not self.auth.check_permission('view_own_applications'):
            messagebox.showerror("Permission Error", "You don't have permission to view applications.")
            return
        ...
        tk.Label(title_frame, text="My Applications", 
                font=('Arial', 18, 'bold'), bg='white', fg='#2c3e50').pack(side='left')
        
        # Refresh button
        refresh_btn = tk.Button(title_frame, text="Refresh", command=self.show_my_applications,
                               bg='#27ae60', fg='white', font=('Arial', 10), 
                               padx=15, pady=5, relief='flat')
        refresh_btn.pack(side='right')
    ...
    def load_my_applications_data(self):
        ...
        try:
            ...
            for app in applications:
                ...
                self.app_tree.insert('', 'end', values=app, tags=tags)
    ...
    def load_manage_internships_data(self):
        ...
        try:
            ...
            for internship in internships:
                ...
                self.manage_tree.insert('', 'end', values=internship, tags=tags)
    ...
    def show_success_rate_report(self):
        ...
        try:
            ...
            for rate in rates:
                ...
                report_tree.insert('', 'end', values=rate, tags=tags)
...
• You'll receive updates via email on your application status"""
                ...
                template_name = "internship_application_withdrawn"
    ...
    def show_integration_menu(self):
        ...
        if self.auth.current_user.get('role') == 'student':
            tk.Button(grade_btn_frame, text="Check My Eligibility",
                     command=lambda: self.show_eligibility_dialog(),
