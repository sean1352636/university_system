...
class AppointmentManager:
    ...
    def _send_appointment_confirmation(appointment_id: int) -> None:
        ...
        try:
            ...
            subject = "Mental Health Appointment Confirmation"

            if appt['is_anonymous']:
                body = f"""
                Dear Student,

                Your anonymous counseling appointment has been confirmed:
                ...
                Your anonymous code: {appt['anonymous_code']}
                ...
                Counselor: {appt['counselor_name'] if appt['counselor_name'] else 'To be assigned'}
                Type: {appt['appointment_type']}
                Date: {appt['appointment_date']}
                Time: {appt['appointment_time']}
                Duration: {appt['duration_minutes']} minutes
    ...
    while True:
        try:
            ...
            if choice in ['1', '2', '3', '4', '5', '6', '7']:
                ...
                print("Use: from university_system.modules.domain.student_affairs.services.mental_health import CounselorManager")
            elif choice == '8':
                break
            else:
