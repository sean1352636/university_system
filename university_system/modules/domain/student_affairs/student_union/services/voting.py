...
from university_system.modules.domain.student_affairs.student_union.services.communications import send_confirmation_email
...
def test_email_notifications(cursor, conn):
    ...
    try:
        ...
        try:
            ...
            from university_system.infrastructure.email import queue_email
