...
from university_system.modules.domain.student_affairs.student_union.services import union_context as context

# Export context_setup for auth initialization
from university_system.modules.domain.student_affairs.student_union.services.context_setup import set_auth
