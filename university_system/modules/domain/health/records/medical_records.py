...
from university_system.modules.core.services.health_misc import critical_values_alert
...
def template_validation(auth):
    ...
    try:
        from university_system.modules.core.services.health_misc import ensure_templates_schema
