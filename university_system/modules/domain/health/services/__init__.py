...
from university_system.modules.domain.health.services.operations import (
    block_time_slots,
    patient_queue,
    pending_tasks,
...
# Dashboard functions
from university_system.modules.domain.health.services.dashboards import (
    critical_alerts_dashboard,
    generate_custom_report,
)

# Template functions
from university_system.modules.domain.health.services.templates import (
...
# Directory functions
from university_system.modules.domain.health.services.directory import (
    specialist_directory,
    emergency_information,
)

# Contact functions
from university_system.modules.domain.health.services.contacts import (
    get_user_student_id,
...
# Audit functions
from university_system.modules.domain.health.services.audit import (
    log_audit_event,
...
from university_system.modules.domain.health.services.surveillance import (
...
from university_system.modules.domain.health.services.allergies import (
...
from university_system.modules.domain.health.services.medication import (
    track_medication_adherence,
    manage_refill_reminders,
)

# Vital signs functions
from university_system.modules.domain.health.services.vitals import (
    manage_vital_signs,
    record_vital_signs,
...
# Security functions
from university_system.modules.domain.health.services.security import (
    validate_csv_format,
)
