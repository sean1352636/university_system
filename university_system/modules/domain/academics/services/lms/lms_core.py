...
class LMSCourseManager:
    ...
    def create_lms_course(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error creating LMS course: {e}")
        finally:
            conn.close()
    ...
    def publish_course(lms_course_id: int) -> bool:
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error publishing course: {e}")
        finally:
            conn.close()
...
class LMSContentManager:
    ...
    def add_video_lecture(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error adding video lecture: {e}")
        finally:
            conn.close()
...
class LMSDiscussionManager:
    ...
    def create_forum(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error creating forum: {e}")
        finally:
            conn.close()
...
class LMSQuizManager:
    ...
    def submit_quiz(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error submitting quiz: {e}")
        finally:
            conn.close()
...
class LMSGradebookManager:
    ...
    def add_grade_entry(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error adding grade entry: {e}")
        finally:
            conn.close()
...
def display_lms_menu(auth):
    ...
    print("2. Course Content Management")
    print("3. Video Lectures")
    print("4. Discussion Forums")
    print("5. Quizzes & Assessments")
    print("6. Gradebook")
    print("7. Student Progress Tracking")
