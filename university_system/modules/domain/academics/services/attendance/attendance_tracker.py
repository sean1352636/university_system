...
class QRAttendanceSystem:
    ...
    def process_qr_checkin(self, qr_data, student_id, location_data=None):
        ...
        try:
            ...
            expiry_time = datetime.datetime.fromisoformat(session_data['expires'])
...
def display_attendance_menu():
    ...
    while True:
        ...
        print("1.  Take Attendance (Traditional)")
        print("2.  QR Code Check-in System")
        print("3.  Geofencing Attendance")
        print("4.  Face Recognition Check-in")
        print("5.  View Attendance Records")
        
        print("\n📊 ANALYTICS & REPORTING")
        print("6.  Student Attendance Report")
        print("7.  Module Attendance Report")
        print("8.  Executive Summary Report")
        print("9.  Predictive Analytics")
        print("10. Real-time Dashboard")
        
        print("\n🎮 GAMIFICATION & ENGAGEMENT")
        print("11. Student Gamification Portal")
        print("12. Attendance Achievements")
        print("13. Leaderboards")
        
        print("\n🔔 NOTIFICATIONS & ALERTS")
        print("14. Attendance Alerts Manager")
        print("15. Parent Notifications")
        print("16. SMS/Email Settings")
        
        print("\n🔧 SYSTEM MANAGEMENT")
        print("17. Enhanced Settings")
        print("18. Backup & Recovery")
        print("19. API Management")
        print("20. Audit Logs")
        
        print("\n📱 INTEGRATIONS")
        print("21. LMS Integration")
        print("22. Calendar Sync")
        print("23. Import/Export Data")
        
        print("\n🚪 EXIT")
        print("24. Return to Main Menu")
