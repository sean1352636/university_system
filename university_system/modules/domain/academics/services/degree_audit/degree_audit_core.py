...
class DegreeProgramManager:
    ...
    def create_program(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error creating degree program: {e}")
        finally:
            conn.close()
    ...
    def add_requirement(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error adding requirement: {e}")
        finally:
            conn.close()
    ...
    def add_required_course(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error adding required course: {e}")
        finally:
            conn.close()
    ...
    def add_prerequisite(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error adding prerequisite: {e}")
        finally:
            conn.close()
...
class DegreeProgressManager:
    ...
    def initialize_student_progress(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error initializing progress: {e}")
        finally:
            conn.close()
    ...
    def update_progress(student_id: str, program_id: int) -> None:
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error updating progress: {e}")
        finally:
            conn.close()
...
class WhatIfScenarioManager:
    ...
    def create_scenario(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error creating scenario: {e}")
        finally:
            conn.close()
...
class AdvisingAppointmentManager:
    ...
    def schedule_appointment(
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error scheduling appointment: {e}")
        finally:
            conn.close()
...
class GraduationAuditManager:
    ...
    def run_graduation_audit(student_id: str, program_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error running graduation audit: {e}")
        finally:
            conn.close()
    ...
    def approve_graduation(student_id: str, program_id: int, graduation_date: str) -> bool:
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"Error approving graduation: {e}")
        finally:
            conn.close()


def display_degree_audit_menu(auth):
    """Display the Degree Audit & Academic Advising CLI menu"""
    print("\n" + "="*50)
    print("  DEGREE AUDIT & ACADEMIC ADVISING")
    print("="*50)
    print("1. View Degree Progress")
    print("2. Check Prerequisites")
    print("3. What-If Scenario Analysis")
    print("4. Schedule Advising Appointment")
    print("5. Graduation Audit")
    print("6. View Degree Requirements")
    print("7. Print Degree Audit Report")
    ...
    while True:
        try:
            ...
            if choice in ['1', '2', '3', '4', '5', '6', '7']:
                print(f"\n🎓 Feature available via Degree Audit managers")
                print("Use: from university_system.modules.domain.academics.services.degree_audit import DegreeProgressManager")
            elif choice == '8':
                break
            else:
