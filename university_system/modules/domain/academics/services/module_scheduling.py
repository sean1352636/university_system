...
class ModuleScheduler:
    ...
    def create_notification(self, recipient_type, recipient_id, message, notification_type="info"):
        ...
        # Use recipient_id as user_id to satisfy NOT NULL constraint
        # If recipient_type is 'student', recipient_id is the user_id
...
def display_enhanced_scheduling_menu():
    ...
    while True:
        ...
        print("  1. Room Utilization Analytics")
        print("  2. Instructor Workload Report")
        print("  3. Scheduling Analytics Dashboard")
        print("  4. Generate Visual Timetables")
        print("  5. Generate Utilization Charts")
        
        print("\n🔄 ADVANCED SCHEDULING")
        print("  6. Smart Scheduling Assistant")
        print("  7. Batch Import from CSV")
        print("  8. Schedule Templates")
        print("  9. Advanced Search & Filtering")
        print("  10. Find Free Rooms")
        print("  11. Find Schedule Gaps")
        
        print("\n⚠️  CONFLICT MANAGEMENT")
        print("  12. Detect All Conflicts")
        print("  13. View/Resolve Conflicts")
        print("  14. Check Student Conflicts")
        
        print("\n📅 CALENDAR & EXPORTS")
        print("  15. Export to iCal")
        print("  16. Export All Schedules")
        print("  17. Generate PDF Reports")
        
        print("\n💾 DATA MANAGEMENT")
        print("  18. Create Backup")
        print("  19. Restore Backup")
        print("  20. Validate Data")
        print("  21. System Settings")
        
        print("\n📝 BASIC OPERATIONS")
        print("  22. Manage Rooms")
        print("  23. Manage Instructors")
        print("  24. Manage Schedules")
        print("  25. View Schedules")
        print("  26. Generate Timetables")
        
        print("\n🔔 NOTIFICATIONS & HOLIDAYS")
        print("  27. View Notifications")
        print("  28. Manage Holidays")
