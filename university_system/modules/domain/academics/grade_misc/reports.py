...
def _get_grading_imports():
    ...
    from university_system.modules.domain.academics.grading.grade_calculation import calculate_student_gpa, GRADE_SYSTEMS
...
def generate_statistical_report():
    ...
    try:
        ...
        # Choose report type
        print("\nReport Type:")
        print("1. Assessment Statistics")
        print("2. Module Statistics")
