        ...
        while True:
            ...
            if choice == '1':
                ...
                if add_levels == 'y':
                    ...
                    from university_system.modules.domain.academics.grading.competency_assessment import add_competency_levels as _add_levels
...
def record_student_competencies():
    ...
    try:
        ...
        if not levels:
            print(f"No levels defined for this competency. Please add levels first.")
            conn.close()
            return
