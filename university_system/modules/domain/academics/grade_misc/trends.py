...
from university_system.modules.domain.academics.grade_misc.utils import calculate_trend_slope, select_student
...
def trend_forecasting():
    ...
    try:
        ...
        if choice == '1':
            try:
                from university_system.modules.domain.academics.grading.performance_analytics import forecast_overall_performance
            ...
            try:
                from university_system.modules.domain.academics.grading.performance_analytics import forecast_course_performance
            ...
            try:
                from university_system.modules.domain.academics.grading.grade_calculation import forecast_assessment_performance
