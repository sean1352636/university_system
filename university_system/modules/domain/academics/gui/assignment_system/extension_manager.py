...
class ExtensionManager:
    ...
    def show_review_extensions(self):
        ...
        title = ttk.Label(self.gui.layout.content_area, text="Review Extension Requests", style='Title.TLabel')
        ...
        # Status filter
        ttk.Label(filter_frame, text="Status:").grid(row=0, column=0, sticky='w', padx=5)
