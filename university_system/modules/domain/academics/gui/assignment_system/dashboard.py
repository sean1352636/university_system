...
class DashboardManager:
    ...
    def show_dashboard(self):
        ...
        # Dashboard title
        title = ttk.Label(self.gui.layout.content_area, text="Dashboard", style='Title.TLabel')
    ...
    def create_dashboard_widgets(self):
        ...
        # Create stat cards
        stat_cards = [
            ("Active Assignments", stats.get('active_assignments', 0), '#3498db'),
            ("My Submissions", stats.get('my_submissions', 0), '#2ecc71'),
            ("Pending Grades", stats.get('pending_grades', 0), '#f39c12'),
            ("Upcoming Due", stats.get('upcoming_due', 0), '#e74c3c')
        ]
        ...
        activity_frame = ttk.LabelFrame(self.gui.layout.content_area, text="Recent Activity", padding=10)
