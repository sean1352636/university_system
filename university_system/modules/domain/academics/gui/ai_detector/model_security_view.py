...
def export_model_weights(self):
    ...
    try:
        file_path = filedialog.asksaveasfilename(
            ...
            initialfilename=f"ai_model_weights_{datetime.now().strftime('%Y%m%d')}.pkl"
        )
...
def _export_activity_log(self):
    ...
    try:
        file_path = filedialog.asksaveasfilename(
            ...
            initialfilename=f"activity_log_{datetime.now().strftime('%Y%m%d')}.csv"
        )
...
def export_chain_of_custody(self):
    ...
    try:
        ...
        file_path = filedialog.asksaveasfilename(
            ...
            initialfilename=f"chain_of_custody_{submission_id}.txt"
        )
...
def generate_gdpr_data_export(self):
    ...
    try:
        ...
        file_path = filedialog.asksaveasfilename(
            ...
            initialfilename=f"gdpr_export_{student_id}_{datetime.now().strftime('%Y%m%d')}.json"
        )
