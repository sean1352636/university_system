...
class GradeTrackingApp:
    ...
    def populate_initial_data(self):
        ...
        enrollments = [
            ...
            ('STU001', 'MATH101', '2024-09-01', 'Enrolled'),
            ('STU001', 'ENG101', '2024-09-01', 'Enrolled'),
            ('STU002', 'CS101', '2024-09-01', 'Enrolled'),
            ('STU002', 'PHYS101', '2024-09-01', 'Enrolled'),
            ('STU003', 'MATH101', '2024-09-01', 'Enrolled'),
            ('STU003', 'ENG101', '2024-09-01', 'Enrolled'),
            ('STU004', 'PHYS101', '2024-09-01', 'Enrolled'),
            ('STU004', 'MATH101', '2024-09-01', 'Enrolled'),
        ...
        for student_id in student_ids:
            for assessment_id in assessment_ids:
                # Skip some assessments to make it realistic
