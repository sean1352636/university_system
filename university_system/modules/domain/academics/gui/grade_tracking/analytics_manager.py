...
class AnalyticsManager:
    ...
    def generate_performance_analytics(self):
        ...
        try:
            ...
            SELECT 
                ...
                AVG(mg.grade_points) AS avg_gpa
    ...
    def predict_module_success(self):
        ...
        try:
            ...
            for module_code, module_name, student_count, avg_score, avg_gpa in modules:
                ...
                SELECT COUNT(*) * 100.0 / ?
                FROM module_grades
                WHERE module_code = ? AND grade_points >= 2.0
        ...
        try:
            ...
            for student_id, first_name, last_name, course in students:
                ...
                if gpa is not None:
                    ...
                    cursor.execute('''
                    SELECT AVG(grade_points) FROM module_grades
                    WHERE student_id = ?
                    ''', (student_id,))
    ...
    def analyze_dropout_risk(self):
        ...
        try:
            ...
            for student_id, first_name, last_name, course, enrollment_date in students:
                ...
                cursor.execute('''
                SELECT grade_points FROM module_grades
                WHERE student_id = ?
        ...
        try:
            ...
            cursor.execute("""
                SELECT
                    ...
                    AVG(g.score / a.max_points * 100) AS avg_percentage,
                    MIN(g.score / a.max_points * 100) AS min_percentage,
                    MAX(g.score / a.max_points * 100) AS max_percentage,
                    SUM(CASE WHEN g.letter_grade IN ('F', 'D-', 'D') THEN 1 ELSE 0 END) AS poor_grades,
                    SUM(CASE WHEN g.letter_grade IN ('A+', 'A', 'A-') THEN 1 ELSE 0 END) AS excellent_grades
                FROM grades g
                JOIN assessments a ON g.assessment_id = a.assessment_id
                WHERE g.student_id = ?
            """, (student_id,))
        ...
        try:
            ...
            cursor.execute("""
                SELECT
                    ...
                    COUNT(g.grade_id) AS total_grades,
                    AVG(g.score / a.max_points * 100) AS avg_percentage,
                    SUM(CASE WHEN g.letter_grade IN ('A+', 'A', 'A-') THEN 1 ELSE 0 END) AS excellent_count,
                    SUM(CASE WHEN g.letter_grade IN ('F', 'D', 'D-') THEN 1 ELSE 0 END) AS poor_count
                FROM modules m
    ...
    def analyze_performance_trends(self):
        ...
        try:
            ...
            cursor.execute("""
                SELECT
                    date(g.submission_date) AS submission_month,
                    AVG(g.score / a.max_points * 100) AS avg_percentage,
                    COUNT(g.grade_id) AS grade_count
                FROM grades g
                JOIN assessments a ON g.assessment_id = a.assessment_id
    ...
    def generate_performance_dashboard(self):
        ...
        try:
            ...
            stats = cursor.fetchone()
            total_students, total_modules, total_assessments, total_grades, overall_avg = stats
    ...
    def show_grade_trends_chart(self):
        ...
        try:
            ...
            cursor.execute("""
                SELECT submission_date, AVG(score / max_points * 100) AS avg_score
                FROM grades g
                JOIN assessments a ON g.assessment_id = a.assessment_id
            ...
            ax.plot(range(len(dates)), scores, marker='o')
    ...
    def student_progress_charts(self):
        ...
        messagebox.showinfo("Student Progress Charts",
                          "Select a student from the Students tab to view their detailed progress charts.")
    ...
    def _generate_transcript_for_student(self, student_id, export_format="display"):
        ...
        try:
            ...
            cursor.execute("""
                ...
                WHERE g.student_id = ?
                ORDER BY m.module_code, g.submission_date
            """, (student_id,))
