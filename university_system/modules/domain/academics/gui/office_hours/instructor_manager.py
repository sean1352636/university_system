...
class InstructorManager:
    ...
    def _create_hours(self):
        ...
        # Start time
        ttk.Label(frame, text="Start Time (HH:MM):").grid(
            row=1, column=0, sticky=tk.W, pady=5,
        )
        start_var = tk.StringVar()
        ttk.Entry(frame, textvariable=start_var, width=22).grid(
            row=1, column=1, sticky=tk.W, pady=5,
        )

        # End time
        ttk.Label(frame, text="End Time (HH:MM):").grid(
            row=2, column=0, sticky=tk.W, pady=5,
        )
        end_var = tk.StringVar()
        ttk.Entry(frame, textvariable=end_var, width=22).grid(
        ...
        ttk.Entry(frame, textvariable=location_var, width=22).grid(
