...
from university_system.modules.domain.academics.services.academic_calendar.exceptions import (
...
try:
    from university_system.infrastructure.auth import _current_auth_instance
...
from university_system.modules.domain.academics.gui.academic_calendar.dashboard import DashboardMixin
from university_system.modules.domain.academics.gui.academic_calendar.calendar_view import CalendarViewMixin
from university_system.modules.domain.academics.gui.academic_calendar.events_view import EventsViewMixin
from university_system.modules.domain.academics.gui.academic_calendar.academic_view import AcademicViewMixin
from university_system.modules.domain.academics.gui.academic_calendar.menu_actions import MenuActionsMixin

# Import dialog classes
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_event import (
    AddEventDialog, EditEventDialog, EventDetailsDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_academic import (
    AddAcademicYearDialog, AddSemesterDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_admin import (
    SystemMaintenanceDialog, AuditLogsDialog, SettingsDialog,
    TimezoneSettingsDialog, NotificationSettingsDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_resources import (
    ResourceManagementDialog, CourseManagementDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_categories import (
    EventCategoriesDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_recurring import (
    RecurringEventDialog, RecurringEventsDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_reports import (
    ReportsDialog, DataVisualizationDialog, ProjectMilestonesDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_search import (
    AdvancedSearchDialog
)
from university_system.modules.domain.academics.gui.academic_calendar.dialogs_misc import (
...
def launch_calendar_gui(auth_manager=None):
    ...
    try:
        ...
        from university_system.modules.domain.academics.services.academic_calendar.cli import ensure_calendar_permissions
