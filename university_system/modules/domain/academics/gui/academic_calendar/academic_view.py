...
def _get_add_academic_year_dialog():
    from university_system.modules.domain.academics.gui.academic_calendar.dialogs_academic import AddAcademicYearDialog
    return AddAcademicYearDialog

def _get_add_semester_dialog():
    from university_system.modules.domain.academics.gui.academic_calendar.dialogs_academic import AddSemesterDialog
