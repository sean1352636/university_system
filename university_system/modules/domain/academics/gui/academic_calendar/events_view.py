...
def _get_edit_event_dialog():
    from university_system.modules.domain.academics.gui.academic_calendar.dialogs_event import EditEventDialog
    return EditEventDialog

def _get_event_details_dialog():
    from university_system.modules.domain.academics.gui.academic_calendar.dialogs_event import EventDetailsDialog
...
class EventsViewMixin:
    ...
    def _launch_email_reminder_dialog(self, event_name, event_date, event_type, description):
        ...
        try:
            ...
            from university_system.modules.shared.gui.email.email_manager_gui import EmailManagerGUI
