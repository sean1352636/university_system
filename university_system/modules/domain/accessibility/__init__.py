...
from university_system.modules.domain.accessibility.services.accessibility_service import AccessibilityService
from university_system.modules.domain.accessibility.cli.accessibility_cli import AccessibilityCLI
