...
try:
    from university_system.modules.domain.housing.gui.housing_accommodation_gui.finance_integration import HousingFinanceManager
except ImportError:
    # Fallback if file doesn't exist yet
    HousingFinanceManager = None

# Import email functions
from university_system.modules.domain.housing.gui.housing_accommodation_gui.email_notifications import (
    send_housing_email,
