...
from university_system.modules.core.services.restaurant_orders_payments import (
    view_orders,
    update_order_status,
    process_payments,
)
...
def display_customer_menu():
    ...
    while True:
        ...
        if choice == '1':
            ...
            from university_system.modules.core.services.restaurant_customers_loyalty_feedback import create_customer
            create_customer()
        elif choice == '2':
            from university_system.modules.core.services.restaurant_customers_loyalty_feedback import view_customers
            view_customers()
        elif choice == '3':
            from university_system.modules.core.services.restaurant_customers_loyalty_feedback import update_customer
            update_customer()
        elif choice == '4':
            from university_system.modules.core.services.restaurant_customers_loyalty_feedback import manage_customer_feedback
            manage_customer_feedback()
        elif choice == '5':
            from university_system.modules.core.services.restaurant_customers_loyalty_feedback import manage_loyalty_program
