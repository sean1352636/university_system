...
def create_qr_code_image(table_id, capacity, location):
    ...
    try:
        # Create QR data - URL that could link to online menu
        base_url = "https://restaurant.university.edu/menu"
...
def update_qr_database_record(cursor, table_id, qr_filename):
    ...
    try:
        ...
        qr_data = f"https://restaurant.university.edu/menu?table={table_id}"
