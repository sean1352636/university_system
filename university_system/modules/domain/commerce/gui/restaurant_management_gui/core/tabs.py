...
def create_place_order_tab(self, parent=None):
    ...
    from university_system.modules.domain.commerce.gui.restaurant_management_gui.orders import place_order
    if parent is None:
...
def create_refunds_tab(self, parent=None):
    ...
    from university_system.modules.domain.commerce.gui.restaurant_management_gui.orders import refunds
    if parent is None:
