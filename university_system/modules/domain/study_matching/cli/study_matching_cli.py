...
class StudyMatchingCLI:
    ...
    def create_study_group(self):
        ...
        try:
            ...
            print(f"You are the group admin. Share the group ID with others to invite them.")
        except Exception as e:
            print(f"\n✗ Error: {e}")
    ...
    def start_pomodoro_session(self, session_type: str):
        ...
        try:
            ...
            print(f"Focus on your studies. Mark as complete when done.")
        except Exception as e:
            print(f"\n✗ Error: {e}")
