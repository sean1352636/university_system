...
from university_system.modules.domain.staff_hr.services.managers.exit_manager import ExitManager
...
class ExitGUI:
    ...
    def _complete_my_item(self):
        ...
        ExitManager.complete_checklist_item(item_id, self.current_user.get('user_id'), notes or '')
    ...
    def _view_exit_checklist(self):
        ...
        def complete_item():
            ...
            ExitManager.complete_checklist_item(item_id, self.current_user.get('user_id'))
            dialog.destroy()
    ...
    def _schedule_interview(self):
        ...
        interviewer_entry.insert(0, self.current_user.get('user_id'))
