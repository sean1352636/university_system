...
class ExpenseGUI:
    ...
    def _load_recent_claims(self):
        ...
        claims = ExpenseManager.get_user_claims(self.current_user.get('user_id'))
        for c in claims[:10]:
    ...
    def _load_my_claims(self):
        ...
        claims = ExpenseManager.get_user_claims(self.current_user.get('user_id'), status=status)
    ...
    def _load_approvals(self):
        ...
        claims = ExpenseManager.get_pending_approvals(self.current_user.get('user_id'))
    ...
    def _approve_claim(self):
        ...
        try:
            ExpenseManager.approve_claim(claim_id, self.current_user.get('user_id'), comments or '')
    ...
    def _reject_claim(self):
        ...
        try:
            ExpenseManager.reject_claim(claim_id, self.current_user.get('user_id'), comments)
