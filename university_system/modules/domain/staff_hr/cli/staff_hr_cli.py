...
def init_staff_hr_db() -> bool:
    ...
    try:
        ...
        from university_system.infrastructure.database.schemas.staff_hr_schemas_v3 import (
            init_staff_hr_v3_schemas
        )
        from university_system.infrastructure.database.schemas.staff_hr_schemas_v4 import (
...
def display_staff_hr_menu() -> None:
    ...
    from university_system.modules.domain.staff_hr.cli.menus import (
