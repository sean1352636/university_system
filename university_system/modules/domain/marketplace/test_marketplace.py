...
def test_marketplace_service():
    ...
    try:
        from university_system.modules.domain.marketplace.services.marketplace_service import (
            MarketplaceService
        )
...
def test_marketplace_cli():
    ...
    try:
        from university_system.modules.domain.marketplace.cli.marketplace_cli import (
            MarketplaceCLI
        )
