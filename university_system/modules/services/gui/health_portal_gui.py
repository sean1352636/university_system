...
try:
    from university_system.modules.domain.health.gui.health_portal_gui import HealthPortalGUI as _RealHealthPortalGUI
    ...
    class HealthPortalGUI:
        ...
        def run(self) -> None:
            ...
            print("Health Portal GUI not available. Please check installation.")
            return None
