...
from university_system.modules.shared.constants.paths import DEFAULT_DB_PATH, DB_DIR
...
def create_unified_database():
    ...
    print(f"🔧 Creating unified database at: {db_path}")
    ...
    print(f"🎉 Unified database created successfully at: {db_path}")
    return db_path
