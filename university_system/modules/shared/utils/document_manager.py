...
try:
    ...
    print("Warning: Email system not available")
...
class DocumentManager:
    ...
    def display_admin_menu(self):
        ...
        print("13. System Settings")
        print("14. Notification Center")
        
        print("\n📤 IMPORT/EXPORT:")
        print("15. Bulk Import Documents")
        print("16. Export Data")
        print("17. Backup System")
        
        print("\n🤖 ADVANCED FEATURES:")
        print("18. OCR Integration")
        print("19. API Server")
        print("20. Web Interface")
        
        print("\n🚪 EXIT:")
        print("21. Switch User")
        print("22. Exit System")
    ...
    def check_authentication(self):
        ...
        print("❌ You must be logged in to access the Document Management System.")
        print("Please run the main authentication menu first.")
        return False
    ...
    def upload_student_document(self):
        ...
        try:
            ...
            if existing_doc:
                print(f"\nExisting document found: {existing_doc[2]} (Version {existing_doc[1]})")
                print("1. Upload new version (replace existing)")
                print("2. Upload additional document")
                print("3. Cancel")
            ...
            if EMAIL_SYSTEM_AVAILABLE:
                try:
                    ...
                    if student_data:
                        ...
                        if send_email(email_address, subject, body):
                            ...
                            print("Document uploaded but email notification failed")
                    else:
                ...
                print("Document uploaded (email system not available)")
    ...
    def check_document_expiry(self):
        ...
        try:
            ...
            print(f"Documents expiring within {days_ahead} days: {len(expiring_docs)}")
            print(f"Documents already expired: {len(expired_docs)}")
            ...
            if expiring_docs:
                ...
                for doc in expiring_docs:
                    ...
                    print(f"ID: {doc_id} | {student_name} | {doc_type} | Expires: {expiry_date} ({int(days_left)} days)")
            ...
            if expired_docs:
                ...
                for doc in expired_docs:
                    ...
                    student_name = f"{first_name} {last_name}".strip()
                    print(f"ID: {doc_id} | {student_name} | {doc_type} | Expired: {expiry_date}")
            ...
            if expiring_docs or expired_docs:
                ...
                if send_notifications == 'y':
                    ...
                    conn.commit()
                    print(f"\nProcessed {notification_count} email notifications")
                    
                else:
                    print("Notifications skipped")
            else:
                print("No documents require expiry notifications")
    ...
    def update_document_status(self):
        ...
        try:
            ...
            document_id = input("Enter document ID to update: ").strip()
            ...
            print(f"\nDocument: {doc_type} for {student_name}")
            ...
            print("3. Pending")
            print("4. Expired")
            print("5. Under Review")
            
            choice = input("Choose new status (1-5): ").strip()
            ...
            print(f"\nDocument status updated to: {new_status}")
            ...
            if EMAIL_SYSTEM_AVAILABLE and email_address:
                try:
                    ...
                    if send_email(email_address, subject, body):
                        ...
                        print(f"Status update email sent to {email_address}")
                    else:
                    ...
                    print("Status updated but email notification failed")
    ...
    def bulk_operations_menu(self):
        ...
        print("3. Bulk Notification Send")
        print("4. Bulk Tag Assignment")
        print("5. Bulk Document Expiry Update")
    ...
    def bulk_status_update(self):
        ...
        print("Select documents to update:")
    ...
    def document_versioning_menu(self):
        ...
        print("2. Compare Document Versions")
    ...
    def ocr_integration_menu(self):
        ...
        print("3. OCR Settings")
        print("4. View OCR Results")
        print("5. Return to Main Menu")
...
- Document Number: ABC123456789
            ...
            if save_text == 'y':
                ...
                conn.commit()
                print("✅ OCR results saved to database.")
...
<body>
    ...
    <div class="container">
        ...
        try:
            ...
            print("✅ Mobile interface generated successfully!")
    ...
    def export_data_menu(self):
        ...
        print("3. Export Compliance Report")
        print("4. Export User Activity Log")
        print("5. Export Custom Dataset")
        print("6. Return to Main Menu")
        
        choice = input("Choose export option (1-6): ").strip()
    ...
    def manage_document_templates(self):
        ...
        print("2. Add New Document Type")
        print("3. Modify Document Type")
        print("4. Set Course Requirements")
        print("5. Template Analytics")
        print("6. Return to Main Menu")
    ...
    def generate_reports_menu(self):
        ...
        print("2. Expiry Report")
        print("3. Department Analysis")
        print("4. Monthly Summary")
        print("5. Student Progress Report")
    ...
    def add_document_type(self):
        ...
        try:
            ...
            type_name = input("Document type name: ").strip()
            if not type_name:
                print("Type name is required.")
                return
    ...
    def document_type_management(self):
        ...
        if choice == '1':
            ...
            try:
                ...
                conn.commit()
                conn.close()
                print("✅ Document type deactivated.")
            except sqlite3.Error as e:
                print(f"Database error: {e}")
    ...
    def bulk_expiry_update(self):
        ...
        try:
            ...
            if not documents:
                print("No documents found for this type.")
                conn.close()
                return
