...
def configure_email_settings():
    ...
    print("\nEmail Mode:")
    current_mode = "Database Only" if config.get('database_only_mode', True) else "SMTP Sending"
    ...
    if mode_choice == '1':
        ...
        print("Set to Database Only mode - emails will be stored in database instead of sent.")
    elif mode_choice == '2':
        config['database_only_mode'] = False
        print("Set to SMTP Sending mode - emails will be actually sent via SMTP.")
