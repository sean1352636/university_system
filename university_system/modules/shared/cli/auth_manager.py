...
try:
    from university_system.infrastructure.auth import set_auth_instance as _test_auth
    from university_system.infrastructure.auth import MFA_AVAILABLE
    HAS_AUTH = True
except ImportError:
    HAS_AUTH = False
    MFA_AVAILABLE = False
...
try:
    from university_system.infrastructure.security import session_management
...
try:
    from university_system.infrastructure.security import comprehensive_security
...
try:
    from university_system.infrastructure.security import data_encryption
...
try:
    from university_system.infrastructure.auth import email_otp_service
...
try:
    from university_system.infrastructure.auth import sms_provider
