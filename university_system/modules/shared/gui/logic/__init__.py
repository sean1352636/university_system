...
Example usage:
    from university_system.modules.shared.gui.logic import StudentFormLogic
...
from university_system.modules.shared.gui.logic.student_form_logic import StudentFormLogic
