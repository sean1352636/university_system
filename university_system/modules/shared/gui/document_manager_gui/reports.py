    ...
    def generate_compliance_report(self):
        ...
        try:
            ...
            ttk.Button(button_frame, text="📄 Export to CSV",
                      command=lambda: self.gui.export_compliance_to_csv(compliance_data)).pack(side='left', padx=5)
            ttk.Button(button_frame, text="🖨️ Print Report",
                      command=lambda: self.gui.print_report(compliance_data)).pack(side='left', padx=5)
