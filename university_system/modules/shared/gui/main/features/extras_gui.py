...
try:
    from university_system.modules.shared.gui.pdf_export_gui import show_pdf_export_gui as _pdf_export_gui_func
...
def show_police_station_gui(self):
    ...
    try:
        from university_system.modules.domain.campus.gui.security.police_station_gui import PoliceStationApp
        window = tk.Toplevel(self.root)
...
def show_security_desk_gui(self):
    ...
    try:
        from university_system.modules.domain.campus.gui.security.security_desk_gui import SecurityDesk
        window = tk.Toplevel(self.root)
...
def show_academic_misconduct_gui(self):
    ...
    try:
        from university_system.modules.domain.academics.gui.misconduct.academic_misconduct_gui import AcademicMisconductPanel
        window = tk.Toplevel(self.root)
...
def show_todo_app_gui(self):
    ...
    try:
        from university_system.modules.shared.gui.tools.todo_app_gui import TodoApp
        window = tk.Toplevel(self.root)
...
def show_church_management_gui(self):
    ...
    try:
        from university_system.modules.domain.campus.gui.community.church_management_gui import ChurchManagementSystem
        window = tk.Toplevel(self.root)
...
def show_bank_app_gui(self):
    ...
    try:
        from university_system.modules.domain.finance.gui.bank_app import BankApp
        window = tk.Toplevel(self.root)
...
def show_exam_scheduler_gui(self):
    """Launch the Exam Scheduler GUI"""
    try:
        from university_system.modules.domain.academics.gui.exam_scheduler import ExamSchedulerApp
        window = tk.Toplevel(self.root)
