...
def show_integrated_dashboard(self):
    ...
    try:
        ...
        if role == 'student':
            from university_system.modules.shared.gui.main.dashboard.student_dashboard import create_student_dashboard
            ...
            from university_system.modules.shared.gui.main.dashboard.instructor_dashboard import create_instructor_dashboard
            create_instructor_dashboard(my_dash_frame, self.auth, dash_service)
            notebook.add(my_dash_frame, text="My Dashboard")
        elif role == 'admin':
            from university_system.modules.shared.gui.main.dashboard.admin_dashboard import create_admin_dashboard
    ...
    if role == 'admin':
        try:
            from university_system.modules.shared.services.dashboard.dashboard_service import DashboardService as _DS
            _admin_svc = _DS()
            ...
            from university_system.modules.shared.gui.main.dashboard.login_analytics_dashboard import create_login_analytics_tab
            ...
            from university_system.modules.shared.gui.main.dashboard.operations_dashboard import create_operations_tab
            ...
            from university_system.modules.shared.gui.main.dashboard.system_health_dashboard import create_system_health_tab
    ...
    if self.health_portal_gui:
        ...
        def refresh_health():
            try:
                ...
                try:
                    from university_system.infrastructure.database.pool_metrics import get_pool_metrics
                ...
                try:
                    from university_system.modules.shared.constants import paths as _paths
