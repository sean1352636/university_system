...
from university_system.modules.domain.commerce.gui.grocery_gui import GroceryGUI, GroceryManagementGUI
try:
...
# Optional modules ---------------------------------------------------------
try:
    from university_system.modules.shared.gui.advanced_search import AdvancedSearchGUI
...
try:
    from university_system.modules.domain.academics.gui.module_scheduling import ModuleSchedulingGUI, launch_module_scheduling_gui
...
try:
    from university_system.modules.shared.gui.enhanced_reporting import (
        ReportingSystemGUI,
...
try:
    from university_system.modules.shared.gui.pdf_export_gui import PDFExportGUI, show_pdf_export_gui
...
try:
    from university_system.modules.domain.housing.gui.housing_accommodation_gui.main_gui import HousingGUI as HousingAccommodationGUI
...
try:
    from university_system.modules.domain.academics.gui.parent_portal import ParentPortalGUI
...
try:
    from university_system.modules.domain.student_affairs.gui.alumni import AlumniGUIApp
...
try:
    from university_system.modules.shared.gui.database.backup_gui import BackupGUI
...
try:
    from university_system.modules.domain.health.gui.medical_accommodation_gui import AccommodationGUI
...
try:
    from university_system.modules.domain.academics.gui.ai_detector import AIDetectorGUI
...
try:
    from university_system.modules.shared.gui.batch_operations import BatchOperationsGUI
...
try:
    from university_system.modules.domain.finance.gui.finance_reporting import FinancialManagementGUI
...
try:
    from university_system.modules.services.gui.charity_shop_gui import CharityShopApp
...
try:
    from university_system.modules.domain.academics.gui.attendance_tracker import AttendanceGUI
...
try:
    from university_system.extras.launcher import launch_as_toplevel as launch_extras_gui
...
try:
    from university_system.modules.domain.legal.gui.legal_services_gui import LegalServicesGUI, launch_legal_services_gui
...
try:
    from university_system.modules.domain.betting.gui.betting_shop_gui import BettingShopGUI, launch_betting_shop_gui
...
try:
    from university_system.modules.domain.mail.gui.mail_post_gui import MailPostGUI, launch_mail_post_gui
...
try:
    from university_system.modules.domain.gym.gui.gym_gui import GymGUI, launch_gym_gui
...
try:
    from university_system.modules.domain.dentist.gui.dentist_gui import DentistGUI, launch_dentist_gui
...
# Butcher Shop GUI
try:
    from university_system.modules.domain.butcher.gui.butcher_gui import ButcherGUI, launch_butcher_gui
...
# Barber Shop GUI
try:
    from university_system.modules.domain.barber.gui.barber_gui import BarberGUI, launch_barber_gui
...
# Nail Bar/Salon GUI
try:
    from university_system.modules.domain.nailbar.gui.nailbar_gui import NailBarGUI, launch_nailbar_gui
...
# Car Rental GUI
try:
    from university_system.modules.domain.carrental.gui.carrental_gui import CarRentalGUI, launch_carrental_gui
...
try:
    from university_system.modules.domain.equipment.gui.equipment_gui import EquipmentRentalGUI as EquipmentGUI, launch_equipment_gui
...
# Phone Shop GUI
try:
    from university_system.modules.domain.phoneshop.gui.phoneshop_gui import PhoneShopGUI, launch_phoneshop_gui
...
try:
    from university_system.modules.domain.staff_hr.gui.staff_hr_gui import StaffHRGUI, launch_staff_hr_gui
...
# Train Station GUI
try:
    from university_system.modules.domain.mobility.gui.train_station_gui import TrainStationApp
...
# Cinema Booking GUI
try:
    from university_system.modules.domain.cinema.gui.cinema_gui.core.main_gui import CinemaApp
    from university_system.modules.domain.cinema.gui.cinema_gui.database import init_database as init_cinema_database
