...
# Import i18n
from university_system.modules.shared.utils.i18n import get_text as _t, get_current_language_name, init_i18n
...
def create_header(self, parent):
    ...
    self.login_logout_btn = ttk.Button(button_frame, text=_t("common.login"), command=lambda: self.toggle_login_logout())
...
def create_navigation_panel(self, parent):
    ...
    authentication_buttons_data = [
        ('login', _t("nav.buttons.login"), self.show_login),
...
def show_main_interface(self):
    ...
    if self.auth.current_user:
        ...
        self.status_var.set("Loading menu...")  # Show loading message
    else:
