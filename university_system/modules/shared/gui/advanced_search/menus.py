...
def show_analytics_dashboard(self):
    ...
    try:
        ...
        self._show_report_viewer(result, "Search Analytics Dashboard")
...
def show_demographics_reports(self):
    ...
    try:
        ...
        self._show_report_viewer(result, "Student Demographics Report")
        self.update_status("Demographics report generated")
    except Exception as e:
...
def show_advanced_demographics_window(self):
    ...
    # Use the existing demographics report functionality
    try:
        result = self.capture_function_output(show_demographics_reports, self)
        self._show_report_viewer(result, "Student Demographics Report")
        self.update_status("Demographics report generated")
    except Exception as e:
...
def show_advanced_demographic_report(self):
    ...
    try:
        result = self.capture_function_output(show_demographics_reports, self)
        self._show_report_viewer(result, "Advanced Demographic Analysis")
        self.update_status("Advanced demographic analysis complete")
    except Exception as e:
...
def show_performance_analysis(self):
    ...
    try:
        ...
        self._show_report_viewer(result, "Academic Performance Analysis")
