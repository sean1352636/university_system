...
def show_text_search(self):
    ...
    ttk.Label(field_frame, text="_t('advanced_search.search_field')").pack(side=tk.LEFT)
    ...
    def execute_text_search():
        ...
        if not pattern:
            messagebox.showwarning("_t('advanced_search.missing_pattern')", "Please enter a search pattern.")
            return
