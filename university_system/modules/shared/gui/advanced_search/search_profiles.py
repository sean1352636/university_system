...
def show_search_profile_manager(self):
    ...
    def save_current_as_profile():
        ...
        if not name:
            messagebox.showwarning("_t('advanced_search.missing_name')", "Please enter a profile name.")
            return
...
def load_selected_profile(self):
    ...
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a profile to load.")
        return
...
def delete_selected_profile(self):
    ...
    selection = self.profiles_tree.selection()
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a profile to delete.")
        return
...
def share_selected_profile(self):
    ...
    selection = self.profiles_tree.selection()
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a profile to share.")
        return
...
def export_selected_profile(self):
    ...
    selection = self.profiles_tree.selection()
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a profile to export.")
        return
...
def load_selected_search(self):
    ...
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a search to load.")
        return
...
def delete_selected_search(self):
    ...
    selection = self.saved_tree.selection()
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a search to delete.")
        return
...
def share_search_profile(self):
    ...
    selection = self.saved_tree.selection()
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a search to share.")
        return
