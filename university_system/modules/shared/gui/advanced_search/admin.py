...
def modify_user_permissions_dialog(self):
    ...
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a user to modify.")
        return
...
def remove_user_permissions_dialog(self):
    ...
    selection = self.permissions_tree.selection()
    if not selection:
        messagebox.showwarning("_t('advanced_search.no_selection')", "Please select a user to remove.")
        return
