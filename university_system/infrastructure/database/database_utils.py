...
def init_db():
    ...
    try:
        ...
        from university_system.modules.setup_unified_database import create_unified_database
...
def init_db_parking():
    ...
    try:
        with DatabaseManager() as db:
            ...
            if not columns:
                print("Users table not found. Will be created by main system.")
            ...
            if lot_count == 0:
                ...
                print("Default parking lots created!")
