...
from university_system.infrastructure.analytics.data_warehouse import get_data_warehouse
            ...
            with get_connection() as conn:
                cursor = conn.execute('''
                    SELECT
                        ...
                        COUNT(DISTINCT CASE WHEN s.enrollment_status = 'enrolled' THEN s.student_id END) as active_students,
                        COUNT(DISTINCT CASE WHEN s.enrollment_status = 'graduated' THEN s.student_id END) as graduated_students,
