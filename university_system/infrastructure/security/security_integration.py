...
try:
    from university_system.infrastructure.auth.enhanced_auth import (
        EnhancedAuth,
...
class SecurityManager:
    ...
    Usage:
        from university_system.infrastructure.security.security_integration import SecurityManager
