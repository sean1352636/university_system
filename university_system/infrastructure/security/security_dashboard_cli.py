...
try:
    from university_system.infrastructure.auth import user_authentication as auth_module
...
def display_security_dashboard_menu(admin_user_id: int = 1):
    ...
    while True:
        ...
        print("="*80)
        print("\n📊 MONITORING & REPORTS")
        print("1. Security Overview")
        print("2. Active Sessions")
        print("3. Encryption Status")
        print("4. API Security & Keys")
        print("5. Security Audit Log (Advanced)")
        print("6. Security Incidents")
        print("7. Data Loss Prevention (Exports)")
        print("8. Vulnerability Scans")
        print("\n🔧 MANAGEMENT TOOLS")
        print("11. Session Management")
        print("12. API Key Management")
        print("13. Incident Management")
        print("14. Encryption Key Management")
        print("15. Password Security Management")
        print("16. Data Export Approval")
        print("17. User Management (CRUD)")
        print("18. Role & Permission Management")
        print("19. My Account Settings")
        print("\n📋 COMPLIANCE & REPORTING")
        print("21. Generate FERPA Compliance Report")
        print("22. Generate GDPR Compliance Report")
        print("23. Security Events Report")
        print("24. Access Audit Report")
        print("\n🔍 SECURITY SCANNING")
        print("31. Run Vulnerability Scan")
        print("32. Password Strength Checker")
        print("33. Compromised Password Check")
        print("\n🔬 DEVELOPER TOOLS")
        print("41. Module Explorer (View All Available Functions)")
        print("42. Quick Module Info")
        print("\n0. Back to Main Menu")
        print("="*80)
