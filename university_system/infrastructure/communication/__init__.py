...
from university_system.infrastructure.communication.push_notifications import (
    PushNotificationService,
    get_push_notification_service,
)

from university_system.infrastructure.communication.webhooks import (
    WebhookDispatcher,
    get_webhook_dispatcher,
)

from university_system.infrastructure.communication.in_app_notifications import (
    InAppNotificationService,
    get_in_app_notification_service,
)

from university_system.infrastructure.communication.slack_integration import (
    SlackNotifier,
    get_slack_notifier,
)

from university_system.infrastructure.communication.teams_integration import (
    TeamsNotifier,
    get_teams_notifier,
)

from university_system.infrastructure.communication.notification_manager import (
    NotificationManager,
