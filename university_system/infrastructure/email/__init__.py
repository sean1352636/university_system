...
from university_system.infrastructure.email import email_service as _email_service_module
...
from university_system.infrastructure.email.smtp import (
    SMTPClient,
    SMTPConfig,
    EmailService,
)
...
try:
    from university_system.infrastructure.email.email_fallback import (
        EmailServiceWithFallback,
        EmailServiceUnavailable,
        Email,
        SendResult,
...
from university_system.infrastructure.email import email_manager as _email_manager  # noqa: E402  (import after __all__ setup)
