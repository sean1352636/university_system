...
def generate_report_form():
    ...
    if choice == '1':
        ...
        try:
            ...
            start_day = int(input("Start Day (DD): "))
            ...
            print("Invalid date. Please enter valid numbers.")
            return
    else:
    ...
    if output_format == 'json':
        ...
        print(f"\nEmail Report for {start_date} to {end_date}:")
        print("=" * 80)
        
        print("Daily Metrics:")
        print(f"{'Date':<15}{'Sent':<10}{'Failed':<10}{'Success Rate':<15}{'Opened':<10}{'Clicked':<10}")
        print("-" * 80)
        ...
        print("\nTotal Metrics:")
        print(f"Total Sent: {report['totals']['sent']}")
        print(f"Total Failed: {report['totals']['failed']}")
        print(f"Overall Success Rate: {report['totals']['success_rate']:.2f}%")
        print(f"Total Opened: {report['totals']['opened']}")
        print(f"Total Clicked: {report['totals']['clicked']}")
        print(f"Overall Open Rate: {report['totals']['open_rate']:.2f}%")
        print(f"Overall Click Rate: {report['totals']['click_rate']:.2f}%")
    else:
        # CSV file was generated
        print(f"\nReport generated and saved to: {report['file_path']}")
