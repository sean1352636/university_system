...
def display_chat_rooms_menu(*args, **kwargs) -> None:
    ...
    """
    print("\n" + "=" * 60)
    print("CHAT ROOMS MANAGEMENT MENU".center(60))
    print("=" * 60)
    print("\n1. View All Chat Rooms")
    print("2. Create New Chat Room")
    print("3. Archive Chat Room")
    print("4. View Chat Room Statistics")
    print("5. Manage Chat Room Members")
