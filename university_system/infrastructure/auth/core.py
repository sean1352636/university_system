...
from university_system.infrastructure.auth.core_utils.constants import ROLES, PERMISSIONS
...
class UserAuth:
    ...
    def __init__(self, db_path=None, config_path=None):
        ...
        try:
            ...
            from university_system.infrastructure.auth.managers.database_manager import DatabaseConnectionManager
            from university_system.infrastructure.auth.managers import password_manager
            from university_system.infrastructure.auth.managers.session_manager import SessionManager
            from university_system.infrastructure.auth.managers.user_manager import UserManager
            from university_system.infrastructure.auth.managers.permission_manager import PermissionManager
            from university_system.infrastructure.auth.managers.role_manager import RoleManager
    ...
    def login(self, username, password, ip_address=None):
        ...
        Delegates to LoginManager for authentication logic.
        """
    ...
    def ensure_staff_account_exists(self):
        ...
        try:
            with self.db_manager.get_connection() as conn:
                ...
                if cursor.fetchone():
                    logger.info("Staff account created successfully (username: staff)")
                    return True
    ...
    def setup_chatbot_permissions(self):
        ...
        """
        from university_system.infrastructure.auth.integrations.chatbot_integration import (
