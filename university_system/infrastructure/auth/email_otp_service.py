...
class SMTPEmailProvider(EmailProvider):
    ...
    def __init__(self, smtp_server: str = None, smtp_port: int = None,
        ...
        self.smtp_server = smtp_server or os.getenv('SMTP_SERVER') or config.get('smtp_server', 'smtp.gmail.com')
        self.smtp_port = smtp_port or int(os.getenv('SMTP_PORT', '0') or config.get('smtp_port', 587))
        self.username = username or os.getenv('SMTP_USERNAME') or config.get('username')
        self.password = password or os.getenv('SMTP_PASSWORD') or config.get('password')
        self.from_email = from_email or os.getenv('SMTP_FROM_EMAIL') or config.get('sender_email', self.username)
        self.from_name = from_name or os.getenv('SMTP_FROM_NAME') or config.get('sender_name', 'University System')
