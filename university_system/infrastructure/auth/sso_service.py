...
try:
    from university_system.infrastructure.auth.sso_providers import SAMLProvider
    SAML_AVAILABLE = True
except ImportError:
    SAMLProvider = None
...
try:
    from university_system.infrastructure.auth.sso_providers import OIDCProvider
    OIDC_AVAILABLE = True
except ImportError:
    OIDCProvider = None
