...
def _check_cli_remember_me_token(auth):
    ...
    try:
        from university_system.infrastructure.auth.enhanced_auth import EnhancedAuth, create_enhanced_auth
...
def _cli_reenable_mfa(mfa_service, user_id, username, saved_methods):
    ...
    try:
        ...
        if result.get('success'):
            ...
            if email_to_notify:
                try:
                    from university_system.infrastructure.auth.email_otp_service import SMTPEmailProvider
