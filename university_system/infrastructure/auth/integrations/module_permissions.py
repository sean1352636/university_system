...
try:
    from university_system.infrastructure.auth.optional_dependencies import is_chatbot_available
...
def initialize_complete_system():
    ...
    try:
        ...
        from university_system.infrastructure.auth.chatbot_integration import setup_chatbot_permissions
        setup_chatbot_permissions(auth)
        
        # Initialize chatbot integration
        print("3. Initializing chatbot integration...")
        from university_system.infrastructure.auth.chatbot_integration import initialize_chatbot_integration
