...
Usage:
    from university_system.infrastructure.auth.webauthn_service import WebAuthnService
...
class WebAuthnService:
    ...
    Examples
    --------
    >>> from university_system.infrastructure.auth.managers import DatabaseConnectionManager
