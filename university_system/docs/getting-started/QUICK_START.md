...
- [Development Commands](../development/SETUP.md#make-commands) - Make commands reference
...
See [Development Setup](../development/SETUP.md) for complete development environment setup.

---

**Estimated Time**: 5 minutes
**Difficulty**: Beginner
**Next**: [Full Installation Guide](INSTALLATION.md)
